 "builtin.module"() <{sym_name = "ir"}> ({
    ...
    "placeholder.global"() <{addr_space = 0 : i32, constant, global_type = !llvm.array<4 x ptr>, linkage = #llvm.linkage<linkonce_odr>, sym_name = "_parameterization_MapIterablePtri32._Ptrf64"}> ({
      ...
      %5132 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      %5133 = "llvm.insertvalue"(%5131, %5132) <{position = array<i64: 1>}> : (!llvm.array<4 x ptr>, !llvm.ptr) -> !llvm.array<4 x ptr>
      %5134 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
    ...
    "placeholder.global"() <{addr_space = 0 : i32, constant, global_type = !llvm.array<4 x ptr>, linkage = #llvm.linkage<linkonce_odr>, sym_name = "_parameterization_FunctionPtri32_to_Ptrf64"}> ({
      ...
      %5123 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      %5124 = "llvm.insertvalue"(%5122, %5123) <{position = array<i64: 1>}> : (!llvm.array<4 x ptr>, !llvm.ptr) -> !llvm.array<4 x ptr>
      %5125 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
    ...
    "func.func"() <{arg_attrs = [{llvm.nest}, {}], function_type = (!llvm.ptr, !llvm.struct<(ptr, i160)>) -> !llvm.struct<(ptr, i160)>, sym_name = "vkmzwadqco"}> ({
    ^bb0(%arg129: !llvm.ptr, %arg130: !llvm.struct<(ptr, i160)>):
      %5099 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, i160)>
      %5100 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i32
      %5101 = "llvm.alloca"(%5100) <{elem_type = !llvm.struct<(ptr, i160)>}> : (i32) -> !llvm.ptr
      "llvm.store"(%arg130, %5101) <{ordering = 0 : i64}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> ()
      %5102 = "llvm.alloca"(%5100) <{elem_type = i32}> : (i32) -> !llvm.ptr
      %5103 = "llvm.getelementptr"(%5101) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %5104 = "llvm.load"(%5103) <{ordering = 0 : i64}> {type = i32} : (!llvm.ptr) -> i32
      "llvm.store"(%5104, %5102) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %5105 = "llvm.load"(%5102) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %5106 = "builtin.unrealized_conversion_cast"(%arg129) : (!llvm.ptr) -> ((i32) -> i32)
      %5107 = "func.call_indirect"(%5106, %5105) : ((i32) -> i32, i32) -> i32
      %5108 = "llvm.alloca"(%5100) <{elem_type = i32}> : (i32) -> !llvm.ptr
      "llvm.store"(%5107, %5108) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %5109 = "llvm.alloca"(%5100) <{elem_type = !llvm.struct<(ptr, i160)>}> : (i32) -> !llvm.ptr
      %5110 = "llvm.getelementptr"(%5109) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %5111 = "placeholder.addressof"() {global_name = @i32_typ} : () -> !llvm.ptr
      "llvm.store"(%5111, %5109) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %5112 = "llvm.load"(%5108) <{ordering = 0 : i64}> {type = i32} : (!llvm.ptr) -> i32
      "llvm.store"(%5112, %5110) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %5113 = "llvm.getelementptr"(%5109) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %5114 = "llvm.load"(%5113) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %5115 = "llvm.insertvalue"(%5099, %5114) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> !llvm.struct<(ptr, i160)>
      %5116 = "llvm.getelementptr"(%5109) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %5117 = "llvm.load"(%5116) <{ordering = 0 : i64}> : (!llvm.ptr) -> i160
      %5118 = "llvm.insertvalue"(%5115, %5117) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, i160)>, i160) -> !llvm.struct<(ptr, i160)>
      "func.return"(%5118) : (!llvm.struct<(ptr, i160)>) -> ()
    }) : () -> ()
    "func.func"() <{arg_attrs = [{llvm.nest}, {}], function_type = (!llvm.ptr, !llvm.struct<(ptr, i160)>) -> !llvm.struct<(ptr, i160)>, sym_name = "wrtvlovfvq"}> ({
    ^bb0(%arg127: !llvm.ptr, %arg128: !llvm.struct<(ptr, i160)>):
      %5079 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, i160)>
      %5080 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i32
      %5081 = "llvm.alloca"(%5080) <{elem_type = !llvm.struct<(ptr, i160)>}> : (i32) -> !llvm.ptr
      "llvm.store"(%arg128, %5081) <{ordering = 0 : i64}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> ()
      %5082 = "llvm.alloca"(%5080) <{elem_type = i32}> : (i32) -> !llvm.ptr
      %5083 = "llvm.getelementptr"(%5081) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %5084 = "llvm.load"(%5083) <{ordering = 0 : i64}> {type = i32} : (!llvm.ptr) -> i32
      "llvm.store"(%5084, %5082) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %5085 = "llvm.load"(%5082) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %5086 = "builtin.unrealized_conversion_cast"(%arg127) : (!llvm.ptr) -> ((i32) -> f64)
      %5087 = "func.call_indirect"(%5086, %5085) : ((i32) -> f64, i32) -> f64
      %5088 = "llvm.alloca"(%5080) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%5087, %5088) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %5089 = "llvm.alloca"(%5080) <{elem_type = !llvm.struct<(ptr, i160)>}> : (i32) -> !llvm.ptr
      %5090 = "llvm.getelementptr"(%5089) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %5091 = "placeholder.addressof"() {global_name = @f64_typ} : () -> !llvm.ptr
      "llvm.store"(%5091, %5089) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %5092 = "llvm.load"(%5088) <{ordering = 0 : i64}> {type = f64} : (!llvm.ptr) -> f64
      "llvm.store"(%5092, %5090) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %5093 = "llvm.getelementptr"(%5089) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %5094 = "llvm.load"(%5093) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %5095 = "llvm.insertvalue"(%5079, %5094) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> !llvm.struct<(ptr, i160)>
      %5096 = "llvm.getelementptr"(%5089) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %5097 = "llvm.load"(%5096) <{ordering = 0 : i64}> : (!llvm.ptr) -> i160
      %5098 = "llvm.insertvalue"(%5095, %5097) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, i160)>, i160) -> !llvm.struct<(ptr, i160)>
      "func.return"(%5098) : (!llvm.struct<(ptr, i160)>) -> ()
    }) : () -> ()
    "placeholder.global"() <{addr_space = 0 : i32, constant, global_type = !llvm.array<4 x ptr>, linkage = #llvm.linkage<linkonce_odr>, sym_name = "_parameterization_FunctionPtri32_to_Ptri32"}> ({
      ...
      %5071 = "llvm.mlir.undef"() : () -> !llvm.array<4 x ptr>
      %5072 = "placeholder.addressof"() {global_name = @function_typ} : () -> !llvm.ptr
      %5073 = "llvm.insertvalue"(%5071, %5072) <{position = array<i64: 0>}> : (!llvm.array<4 x ptr>, !llvm.ptr) -> !llvm.array<4 x ptr>
      %5074 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      %5075 = "llvm.insertvalue"(%5073, %5074) <{position = array<i64: 1>}> : (!llvm.array<4 x ptr>, !llvm.ptr) -> !llvm.array<4 x ptr>
      %5076 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      %5077 = "llvm.insertvalue"(%5075, %5076) <{position = array<i64: 2>}> : (!llvm.array<4 x ptr>, !llvm.ptr) -> !llvm.array<4 x ptr>
      %5078 = "llvm.insertvalue"(%5077, %5070) <{position = array<i64: 3>}> : (!llvm.array<4 x ptr>, !llvm.ptr) -> !llvm.array<4 x ptr>
      "llvm.return"(%5078) : (!llvm.array<4 x ptr>) -> ()
    }) : () -> ()
    "func.func"() <{arg_attrs = [{llvm.nest}, {}], function_type = (!llvm.ptr, !llvm.struct<(ptr, i160)>) -> !llvm.struct<(ptr, i160)>, sym_name = "reafbmmyuo"}> ({
    ^bb0(%arg125: !llvm.ptr, %arg126: !llvm.struct<(ptr, i160)>):
      %5050 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, i160)>
      %5051 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i32
      %5052 = "llvm.alloca"(%5051) <{elem_type = !llvm.struct<(ptr, i160)>}> : (i32) -> !llvm.ptr
      "llvm.store"(%arg126, %5052) <{ordering = 0 : i64}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> ()
      %5053 = "llvm.alloca"(%5051) <{elem_type = i32}> : (i32) -> !llvm.ptr
      %5054 = "llvm.getelementptr"(%5052) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %5055 = "llvm.load"(%5054) <{ordering = 0 : i64}> {type = i32} : (!llvm.ptr) -> i32
      "llvm.store"(%5055, %5053) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %5056 = "llvm.load"(%5053) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %5057 = "builtin.unrealized_conversion_cast"(%arg125) : (!llvm.ptr) -> ((i32) -> i32)
      %5058 = "func.call_indirect"(%5057, %5056) : ((i32) -> i32, i32) -> i32
      %5059 = "llvm.alloca"(%5051) <{elem_type = i32}> : (i32) -> !llvm.ptr
      "llvm.store"(%5058, %5059) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %5060 = "llvm.alloca"(%5051) <{elem_type = !llvm.struct<(ptr, i160)>}> : (i32) -> !llvm.ptr
      %5061 = "llvm.getelementptr"(%5060) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %5062 = "placeholder.addressof"() {global_name = @i32_typ} : () -> !llvm.ptr
      "llvm.store"(%5062, %5060) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %5063 = "llvm.load"(%5059) <{ordering = 0 : i64}> {type = i32} : (!llvm.ptr) -> i32
      "llvm.store"(%5063, %5061) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %5064 = "llvm.getelementptr"(%5060) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %5065 = "llvm.load"(%5064) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %5066 = "llvm.insertvalue"(%5050, %5065) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> !llvm.struct<(ptr, i160)>
      %5067 = "llvm.getelementptr"(%5060) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %5068 = "llvm.load"(%5067) <{ordering = 0 : i64}> : (!llvm.ptr) -> i160
      %5069 = "llvm.insertvalue"(%5066, %5068) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, i160)>, i160) -> !llvm.struct<(ptr, i160)>
      "func.return"(%5069) : (!llvm.struct<(ptr, i160)>) -> ()
    }) : () -> ()
    "placeholder.global"() <{addr_space = 0 : i32, constant, global_type = !llvm.array<5 x ptr>, linkage = #llvm.linkage<linkonce_odr>, sym_name = "_parameterization_FunctionPtri32._Ptri32_to_Ptri32"}> ({
      %5039 = "llvm.mlir.zero"() : () -> !llvm.ptr
      %5040 = "llvm.mlir.undef"() : () -> !llvm.array<5 x ptr>
      %5041 = "placeholder.addressof"() {global_name = @function_typ} : () -> !llvm.ptr
      %5042 = "llvm.insertvalue"(%5040, %5041) <{position = array<i64: 0>}> : (!llvm.array<5 x ptr>, !llvm.ptr) -> !llvm.array<5 x ptr>
      %5043 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      %5044 = "llvm.insertvalue"(%5042, %5043) <{position = array<i64: 1>}> : (!llvm.array<5 x ptr>, !llvm.ptr) -> !llvm.array<5 x ptr>
      %5045 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      %5046 = "llvm.insertvalue"(%5044, %5045) <{position = array<i64: 2>}> : (!llvm.array<5 x ptr>, !llvm.ptr) -> !llvm.array<5 x ptr>
      %5047 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      %5048 = "llvm.insertvalue"(%5046, %5047) <{position = array<i64: 3>}> : (!llvm.array<5 x ptr>, !llvm.ptr) -> !llvm.array<5 x ptr>
      %5049 = "llvm.insertvalue"(%5048, %5039) <{position = array<i64: 4>}> : (!llvm.array<5 x ptr>, !llvm.ptr) -> !llvm.array<5 x ptr>
      "llvm.return"(%5049) : (!llvm.array<5 x ptr>) -> ()
    }) : () -> ()
    "func.func"() <{arg_attrs = [{llvm.nest}, {}, {}], function_type = (!llvm.ptr, !llvm.struct<(ptr, i160)>, !llvm.struct<(ptr, i160)>) -> !llvm.struct<(ptr, i160)>, sym_name = "mcfjmclrrl"}> ({
    ^bb0(%arg122: !llvm.ptr, %arg123: !llvm.struct<(ptr, i160)>, %arg124: !llvm.struct<(ptr, i160)>):
      %5014 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, i160)>
      %5015 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i32
      %5016 = "llvm.alloca"(%5015) <{elem_type = !llvm.struct<(ptr, i160)>}> : (i32) -> !llvm.ptr
      "llvm.store"(%arg123, %5016) <{ordering = 0 : i64}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> ()
      %5017 = "llvm.alloca"(%5015) <{elem_type = !llvm.struct<(ptr, i160)>}> : (i32) -> !llvm.ptr
      "llvm.store"(%arg124, %5017) <{ordering = 0 : i64}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> ()
      %5018 = "llvm.alloca"(%5015) <{elem_type = i32}> : (i32) -> !llvm.ptr
      %5019 = "llvm.getelementptr"(%5016) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %5020 = "llvm.load"(%5019) <{ordering = 0 : i64}> {type = i32} : (!llvm.ptr) -> i32
      "llvm.store"(%5020, %5018) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %5021 = "llvm.alloca"(%5015) <{elem_type = i32}> : (i32) -> !llvm.ptr
      %5022 = "llvm.getelementptr"(%5017) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %5023 = "llvm.load"(%5022) <{ordering = 0 : i64}> {type = i32} : (!llvm.ptr) -> i32
      "llvm.store"(%5023, %5021) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %5024 = "llvm.load"(%5018) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %5025 = "llvm.load"(%5021) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %5026 = "builtin.unrealized_conversion_cast"(%arg122) : (!llvm.ptr) -> ((i32, i32) -> i32)
      %5027 = "func.call_indirect"(%5026, %5024, %5025) : ((i32, i32) -> i32, i32, i32) -> i32
      %5028 = "llvm.alloca"(%5015) <{elem_type = i32}> : (i32) -> !llvm.ptr
      "llvm.store"(%5027, %5028) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %5029 = "llvm.alloca"(%5015) <{elem_type = !llvm.struct<(ptr, i160)>}> : (i32) -> !llvm.ptr
      %5030 = "llvm.getelementptr"(%5029) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %5031 = "placeholder.addressof"() {global_name = @i32_typ} : () -> !llvm.ptr
      "llvm.store"(%5031, %5029) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %5032 = "llvm.load"(%5028) <{ordering = 0 : i64}> {type = i32} : (!llvm.ptr) -> i32
      "llvm.store"(%5032, %5030) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %5033 = "llvm.getelementptr"(%5029) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %5034 = "llvm.load"(%5033) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %5035 = "llvm.insertvalue"(%5014, %5034) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> !llvm.struct<(ptr, i160)>
      %5036 = "llvm.getelementptr"(%5029) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %5037 = "llvm.load"(%5036) <{ordering = 0 : i64}> : (!llvm.ptr) -> i160
      %5038 = "llvm.insertvalue"(%5035, %5037) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, i160)>, i160) -> !llvm.struct<(ptr, i160)>
      "func.return"(%5038) : (!llvm.struct<(ptr, i160)>) -> ()
    }) : () -> ()
    "placeholder.global"() <{addr_space = 0 : i32, constant, global_type = !llvm.array<6 x ptr>, linkage = #llvm.linkage<linkonce_odr>, sym_name = "_parameterization_Tuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64_"}> ({
      %5001 = "llvm.mlir.zero"() : () -> !llvm.ptr
      %5002 = "llvm.mlir.undef"() : () -> !llvm.array<6 x ptr>
      %5003 = "placeholder.addressof"() {global_name = @tuple_typ} : () -> !llvm.ptr
      %5004 = "llvm.insertvalue"(%5002, %5003) <{position = array<i64: 0>}> : (!llvm.array<6 x ptr>, !llvm.ptr) -> !llvm.array<6 x ptr>
      %5005 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      %5006 = "llvm.insertvalue"(%5004, %5005) <{position = array<i64: 1>}> : (!llvm.array<6 x ptr>, !llvm.ptr) -> !llvm.array<6 x ptr>
      %5007 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      %5008 = "llvm.insertvalue"(%5006, %5007) <{position = array<i64: 2>}> : (!llvm.array<6 x ptr>, !llvm.ptr) -> !llvm.array<6 x ptr>
      %5009 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      %5010 = "llvm.insertvalue"(%5008, %5009) <{position = array<i64: 3>}> : (!llvm.array<6 x ptr>, !llvm.ptr) -> !llvm.array<6 x ptr>
      %5011 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      %5012 = "llvm.insertvalue"(%5010, %5011) <{position = array<i64: 4>}> : (!llvm.array<6 x ptr>, !llvm.ptr) -> !llvm.array<6 x ptr>
      %5013 = "llvm.insertvalue"(%5012, %5001) <{position = array<i64: 5>}> : (!llvm.array<6 x ptr>, !llvm.ptr) -> !llvm.array<6 x ptr>
      "llvm.return"(%5013) : (!llvm.array<6 x ptr>) -> ()
    }) : () -> ()
    "placeholder.global"() <{addr_space = 0 : i32, constant, global_type = !llvm.array<2 x ptr>, linkage = #llvm.linkage<linkonce_odr>, sym_name = "_parameterization_Ptri64"}> ({
      %4996 = "llvm.mlir.zero"() : () -> !llvm.ptr
      %4997 = "llvm.mlir.undef"() : () -> !llvm.array<2 x ptr>
      %4998 = "placeholder.addressof"() {global_name = @i64_typ} : () -> !llvm.ptr
      %4999 = "llvm.insertvalue"(%4997, %4998) <{position = array<i64: 0>}> : (!llvm.array<2 x ptr>, !llvm.ptr) -> !llvm.array<2 x ptr>
      %5000 = "llvm.insertvalue"(%4999, %4996) <{position = array<i64: 1>}> : (!llvm.array<2 x ptr>, !llvm.ptr) -> !llvm.array<2 x ptr>
      "llvm.return"(%5000) : (!llvm.array<2 x ptr>) -> ()
    }) : () -> ()
    "placeholder.global"() <{addr_space = 0 : i32, constant, global_type = !llvm.array<2 x ptr>, linkage = #llvm.linkage<linkonce_odr>, sym_name = "_parameterization_Float64"}> ({
      %4991 = "llvm.mlir.zero"() : () -> !llvm.ptr
      %4992 = "llvm.mlir.undef"() : () -> !llvm.array<2 x ptr>
      %4993 = "placeholder.addressof"() {global_name = @Float64} : () -> !llvm.ptr
      %4994 = "llvm.insertvalue"(%4992, %4993) <{position = array<i64: 0>}> : (!llvm.array<2 x ptr>, !llvm.ptr) -> !llvm.array<2 x ptr>
      %4995 = "llvm.insertvalue"(%4994, %4991) <{position = array<i64: 1>}> : (!llvm.array<2 x ptr>, !llvm.ptr) -> !llvm.array<2 x ptr>
      "llvm.return"(%4995) : (!llvm.array<2 x ptr>) -> ()
    }) : () -> ()
    "placeholder.global"() <{addr_space = 0 : i32, constant, global_type = !llvm.array<2 x ptr>, linkage = #llvm.linkage<linkonce_odr>, sym_name = "_parameterization_Ptri32"}> ({
      %4986 = "llvm.mlir.zero"() : () -> !llvm.ptr
      %4987 = "llvm.mlir.undef"() : () -> !llvm.array<2 x ptr>
      %4988 = "placeholder.addressof"() {global_name = @i32_typ} : () -> !llvm.ptr
      %4989 = "llvm.insertvalue"(%4987, %4988) <{position = array<i64: 0>}> : (!llvm.array<2 x ptr>, !llvm.ptr) -> !llvm.array<2 x ptr>
      %4990 = "llvm.insertvalue"(%4989, %4986) <{position = array<i64: 1>}> : (!llvm.array<2 x ptr>, !llvm.ptr) -> !llvm.array<2 x ptr>
      "llvm.return"(%4990) : (!llvm.array<2 x ptr>) -> ()
    }) : () -> ()
    "placeholder.global"() <{addr_space = 0 : i32, constant, global_type = !llvm.array<2 x ptr>, linkage = #llvm.linkage<linkonce_odr>, sym_name = "_parameterization_Ptrf64"}> ({
      %4981 = "llvm.mlir.zero"() : () -> !llvm.ptr
      %4982 = "llvm.mlir.undef"() : () -> !llvm.array<2 x ptr>
      %4983 = "placeholder.addressof"() {global_name = @f64_typ} : () -> !llvm.ptr
      %4984 = "llvm.insertvalue"(%4982, %4983) <{position = array<i64: 0>}> : (!llvm.array<2 x ptr>, !llvm.ptr) -> !llvm.array<2 x ptr>
      %4985 = "llvm.insertvalue"(%4984, %4981) <{position = array<i64: 1>}> : (!llvm.array<2 x ptr>, !llvm.ptr) -> !llvm.array<2 x ptr>
      "llvm.return"(%4985) : (!llvm.array<2 x ptr>) -> ()
    }) : () -> ()
    ...
    "placeholder.global"() <{addr_space = 0 : i32, constant, global_type = !llvm.struct<(array<3 x i64>, array<7 x ptr>, array<20 x ptr>)>, linkage = #llvm.linkage<external>, sym_name = "FancyPair"}> ({
      ...
      %4931 = "placeholder.addressof"() {global_name = @FancyPair_B_init_firstTuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64__secondPtrf64} : () -> !llvm.ptr
      ...
      %4937 = "placeholder.addressof"() {global_name = @FancyPair_init_firstTuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64__secondPtrf64} : () -> !llvm.ptr
      ...
      %4951 = "placeholder.addressof"() {global_name = @FancyPair_B_init_firstTuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64__secondPtrf64} : () -> !llvm.ptr
      ...
      %4957 = "placeholder.addressof"() {global_name = @FancyPair_init_firstTuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64__secondPtrf64} : () -> !llvm.ptr
    ...
    "placeholder.global"() <{addr_space = 0 : i32, constant, global_type = !llvm.struct<(array<3 x i64>, array<7 x ptr>, array<18 x ptr>)>, linkage = #llvm.linkage<external>, sym_name = "Float64"}> ({
      ...
      %4795 = "placeholder.addressof"() {global_name = @Float64_B_init_valuePtrf64} : () -> !llvm.ptr
      ...
      %4799 = "placeholder.addressof"() {global_name = @Float64_B__ADD_otherFloat64__ADD_otherInt32} : () -> !llvm.ptr
      %4800 = "llvm.insertvalue"(%4798, %4799) <{position = array<i64: 5>}> : (!llvm.array<18 x ptr>, !llvm.ptr) -> !llvm.array<18 x ptr>
      %4801 = "placeholder.addressof"() {global_name = @Float64_init_valuePtrf64} : () -> !llvm.ptr
      ...
      %4805 = "placeholder.addressof"() {global_name = @Float64__ADD_otherFloat64} : () -> !llvm.ptr
      %4806 = "llvm.insertvalue"(%4804, %4805) <{position = array<i64: 8>}> : (!llvm.array<18 x ptr>, !llvm.ptr) -> !llvm.array<18 x ptr>
      %4807 = "placeholder.addressof"() {global_name = @Float64__ADD_otherInt32} : () -> !llvm.ptr
      ...
      %4813 = "placeholder.addressof"() {global_name = @Float64_B__ADD_otherFloat64__ADD_otherInt32} : () -> !llvm.ptr
      %4814 = "llvm.insertvalue"(%4812, %4813) <{position = array<i64: 12>}> : (!llvm.array<18 x ptr>, !llvm.ptr) -> !llvm.array<18 x ptr>
      %4815 = "placeholder.addressof"() {global_name = @Float64_init_valuePtrf64} : () -> !llvm.ptr
      ...
      %4821 = "placeholder.addressof"() {global_name = @Float64_B__ADD_otherFloat64__ADD_otherInt32} : () -> !llvm.ptr
      %4822 = "llvm.insertvalue"(%4820, %4821) <{position = array<i64: 16>}> : (!llvm.array<18 x ptr>, !llvm.ptr) -> !llvm.array<18 x ptr>
      %4823 = "placeholder.addressof"() {global_name = @Float64_init_valuePtrf64} : () -> !llvm.ptr
    ...
    "placeholder.global"() <{addr_space = 0 : i32, constant, global_type = !llvm.struct<(array<3 x i64>, array<7 x ptr>, array<17 x ptr>)>, linkage = #llvm.linkage<external>, sym_name = "Int32"}> ({
      ...
      %4705 = "placeholder.addressof"() {global_name = @Int32_B_init_valuePtri32} : () -> !llvm.ptr
      ...
      %4709 = "placeholder.addressof"() {global_name = @Int32_B__ADD_otherFloat64__ADD_otherInt32} : () -> !llvm.ptr
      %4710 = "llvm.insertvalue"(%4708, %4709) <{position = array<i64: 4>}> : (!llvm.array<17 x ptr>, !llvm.ptr) -> !llvm.array<17 x ptr>
      %4711 = "placeholder.addressof"() {global_name = @Int32_init_valuePtri32} : () -> !llvm.ptr
      ...
      %4715 = "placeholder.addressof"() {global_name = @Int32__ADD_otherFloat64} : () -> !llvm.ptr
      %4716 = "llvm.insertvalue"(%4714, %4715) <{position = array<i64: 7>}> : (!llvm.array<17 x ptr>, !llvm.ptr) -> !llvm.array<17 x ptr>
      %4717 = "placeholder.addressof"() {global_name = @Int32__ADD_otherInt32} : () -> !llvm.ptr
      ...
      %4723 = "placeholder.addressof"() {global_name = @Int32_B__ADD_otherFloat64__ADD_otherInt32} : () -> !llvm.ptr
      %4724 = "llvm.insertvalue"(%4722, %4723) <{position = array<i64: 11>}> : (!llvm.array<17 x ptr>, !llvm.ptr) -> !llvm.array<17 x ptr>
      %4725 = "placeholder.addressof"() {global_name = @Int32_init_valuePtri32} : () -> !llvm.ptr
      ...
      %4731 = "placeholder.addressof"() {global_name = @Int32_B__ADD_otherFloat64__ADD_otherInt32} : () -> !llvm.ptr
      %4732 = "llvm.insertvalue"(%4730, %4731) <{position = array<i64: 15>}> : (!llvm.array<17 x ptr>, !llvm.ptr) -> !llvm.array<17 x ptr>
      %4733 = "placeholder.addressof"() {global_name = @Int32_init_valuePtri32} : () -> !llvm.ptr
    ...
    ^bb0(%arg120: !llvm.ptr):
      ...
      %4522 = "placeholder.addressof"() {global_name = @_parameterization_Tuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64_} : () -> !llvm.ptr
    ...
    ^bb0(%arg118: !llvm.ptr, %arg119: !llvm.struct<(ptr, i160)>):
      ...
      %4509 = "placeholder.addressof"() {global_name = @_parameterization_Tuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64_} : () -> !llvm.ptr
    ...
    ^bb0(%arg117: !llvm.ptr):
      ...
      %4490 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
    ...
    ^bb0(%arg115: !llvm.ptr, %arg116: !llvm.struct<(ptr, i160)>):
      ...
      %4467 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
    ...
    ^bb0(%arg114: !llvm.ptr):
      %4442 = "placeholder.addressof"() {global_name = @_parameterization_Tuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64_} : () -> !llvm.ptr
      "func.return"(%4442) : (!llvm.ptr) -> ()
    }) : () -> ()
    "func.func"() <{function_type = (!llvm.ptr) -> !llvm.ptr, sym_name = "FancyPair_field_FancyPair_1"}> ({
    ^bb0(%arg113: !llvm.ptr):
      %4441 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
    ...
    "func.func"() <{function_type = (i32, i32) -> i32, sym_name = "_functionliteral_jeqlaaxvcn"}> ({
    ...
    "func.func"() <{function_type = (i32) -> i32, sym_name = "_functionliteral_wjkkoxgcnk"}> ({
    ^bb0(%arg96: i32):
    ...
    "func.func"() <{function_type = (f64) -> f64, sym_name = "_functionliteral_lgzgdkneqe"}> ({
    ^bb0(%arg95: f64):
    ...
    "func.func"() <{function_type = (i32) -> i32, sym_name = "_functionliteral_itdpwfrgxd"}> ({
    ^bb0(%arg94: i32):
    ...
    "func.func"() <{function_type = (i32) -> f64, sym_name = "_functionliteral_mvxsvfubgb"}> ({
    ^bb0(%arg93: i32):
    ...
    ^bb0(%arg67: !llvm.struct<(ptr, ptr, ptr, i32)>, %arg68: !llvm.struct<(ptr, ptr, ptr, i32)>, %arg69: !llvm.ptr, %arg70: !llvm.struct<(ptr, i160)>):
      %3852 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i64
      %3853 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i64
      %3854 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3855 = "llvm.mlir.constant"() <{value = 144 : i64}> : () -> i64
      %3856 = "llvm.mlir.constant"() <{value = 10 : i32}> : () -> i32
      %3857 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i32
      %3858 = "llvm.alloca"(%3857) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      "llvm.store"(%arg67, %3858) <{ordering = 0 : i64}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> ()
      %3859 = "llvm.alloca"(%3857) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3860 = "llvm.getelementptr"(%3858) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3861 = "llvm.getelementptr"(%3859) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3862 = "llvm.load"(%3860) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3862, %3861) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3863 = "llvm.getelementptr"(%3858) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3864 = "llvm.getelementptr"(%3859) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3865 = "llvm.load"(%3863) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3865, %3864) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3866 = "llvm.getelementptr"(%3858) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3867 = "llvm.getelementptr"(%3859) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3868 = "llvm.load"(%3866) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3868, %3867) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3869 = "llvm.getelementptr"(%3858) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3870 = "llvm.getelementptr"(%3859) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3871 = "llvm.load"(%3869) <{ordering = 0 : i64}> {type = i32} : (!llvm.ptr) -> i32
      "llvm.store"(%3871, %3870) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3872 = "placeholder.addressof"() {global_name = @Float64} : () -> !llvm.ptr
      "llvm.call"(%3859, %3872) {callee = @set_offset, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>} : (!llvm.ptr, !llvm.ptr) -> ()
      %3873 = "llvm.alloca"(%3857) <{elem_type = !llvm.struct<(ptr, i160)>}> : (i32) -> !llvm.ptr
      "llvm.store"(%arg70, %3873) <{ordering = 0 : i64}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> ()
      %3874 = "llvm.alloca"(%3857) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3875 = "llvm.getelementptr"(%3873) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3876 = "llvm.getelementptr"(%3874) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3877 = "llvm.load"(%3875) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3877, %3876) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3878 = "llvm.getelementptr"(%3873) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3879 = "llvm.getelementptr"(%3874) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3880 = "llvm.load"(%3878) <{ordering = 0 : i64}> {type = i160} : (!llvm.ptr) -> i160
      "llvm.store"(%3880, %3879) <{ordering = 0 : i64}> : (i160, !llvm.ptr) -> ()
      %3881 = "placeholder.addressof"() {global_name = @Float64} : () -> !llvm.ptr
      "llvm.call"(%3874, %3881) {callee = @set_offset, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>} : (!llvm.ptr, !llvm.ptr) -> ()
      %3882 = "llvm.getelementptr"(%3859) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3883 = "llvm.load"(%3882) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3884 = "llvm.load"(%3859) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3885 = "llvm.call_intrinsic"(%3855, %3884) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3886 = "llvm.getelementptr"(%3859) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3887 = "llvm.load"(%3886) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3888 = "llvm.getelementptr"(%3884, %3887) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3889 = "llvm.load"(%3888) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3890 = "llvm.getelementptr"(%3889) <{elem_type = !llvm.struct<(ptr, ptr)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3891 = "llvm.load"(%3890) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3892 = "llvm.call"(%3891, %3883) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<f64 (ptr)>, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = readwrite>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, will_return}> : (!llvm.ptr, !llvm.ptr) -> f64
      %3893 = "llvm.alloca"(%3857) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3892, %3893) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3894 = "llvm.getelementptr"(%3874) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3895 = "llvm.load"(%3894) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3896 = "llvm.insertvalue"(%3854, %3895) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3897 = "llvm.getelementptr"(%3874) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3898 = "llvm.load"(%3897) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3899 = "llvm.insertvalue"(%3896, %3898) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3900 = "llvm.getelementptr"(%3874) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3901 = "llvm.load"(%3900) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3902 = "llvm.insertvalue"(%3899, %3901) <{position = array<i64: 2>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3903 = "llvm.getelementptr"(%3874) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3904 = "llvm.load"(%3903) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3905 = "llvm.insertvalue"(%3902, %3904) <{position = array<i64: 3>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, i32) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3906 = "llvm.alloca"(%3857) <{elem_type = !llvm.array<0 x ptr>}> : (i32) -> !llvm.ptr
      %3907 = "llvm.call_intrinsic"(%3853, %3906) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3908 = "llvm.call_intrinsic"(%3855, %3895) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3909 = "llvm.getelementptr"(%3895, %3904) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3910 = "llvm.getelementptr"(%3909) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 4>}> : (!llvm.ptr) -> !llvm.ptr
      %3911 = "llvm.load"(%3910) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3912 = "llvm.alloca"(%3857) <{elem_type = !llvm.struct<()>}> : (i32) -> !llvm.ptr
      %3913 = "llvm.call"(%3911, %3905, %3912) <{CConv = #llvm.cconv<ccc>, callee = @behavior_wrapper, callee_type = !llvm.func<ptr (ptr, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.ptr
      %3914 = "llvm.call"(%3913, %3905, %3905, %3906) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<f64 (struct<(ptr, ptr, ptr, i32)>, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> f64
      %3915 = "llvm.alloca"(%3857) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3914, %3915) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3916 = "llvm.load"(%3893) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3917 = "llvm.load"(%3915) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3918 = "arith.addf"(%3916, %3917) <{fastmath = #arith.fastmath<none>}> : (f64, f64) -> f64
      %3919 = "llvm.alloca"(%3857) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3918, %3919) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3920 = "placeholder.addressof"() {global_name = @Float64} : () -> !llvm.ptr
      %3921 = "llvm.alloca"(%3857) <{elem_type = !llvm.array<1 x ptr>}> : (i32) -> !llvm.ptr
      "llvm.store"(%3920, %3921) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3922 = "llvm.load"(%3921) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3923 = "llvm.getelementptr"(%3922) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 6>}> : (!llvm.ptr) -> !llvm.ptr
      %3924 = "llvm.load"(%3923) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3925 = "llvm.call"(%3924, %3921) {callee = @size_wrapper, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>} : (!llvm.ptr, !llvm.ptr) -> !llvm.struct<(i64, i64)>
      %3926 = "llvm.extractvalue"(%3925) <{position = array<i64: 0>}> : (!llvm.struct<(i64, i64)>) -> i64
      %3927 = "llvm.call"(%3926) <{CConv = #llvm.cconv<ccc>, callee = @bump_malloc, callee_type = !llvm.func<ptr (i64)>, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (i64) -> !llvm.ptr
      %3928 = "llvm.alloca"(%3857) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3929 = "llvm.getelementptr"(%3928) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3930 = "llvm.getelementptr"(%3928) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3920, %3928) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      "llvm.store"(%3927, %3929) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      "llvm.store"(%3856, %3930) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3931 = "llvm.getelementptr"(%3859) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3932 = "llvm.load"(%3931) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3933 = "llvm.load"(%3859) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3934 = "llvm.call_intrinsic"(%3855, %3933) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3935 = "llvm.getelementptr"(%3859) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3936 = "llvm.load"(%3935) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3937 = "llvm.getelementptr"(%3933, %3936) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3938 = "llvm.load"(%3937) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3939 = "llvm.getelementptr"(%3938) <{elem_type = !llvm.struct<(ptr, ptr)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3940 = "llvm.load"(%3939) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3941 = "llvm.call"(%3940, %3932) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<f64 (ptr)>, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = readwrite>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, will_return}> : (!llvm.ptr, !llvm.ptr) -> f64
      %3942 = "llvm.alloca"(%3857) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3941, %3942) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3943 = "llvm.getelementptr"(%3874) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3944 = "llvm.load"(%3943) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3945 = "llvm.insertvalue"(%3854, %3944) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3946 = "llvm.getelementptr"(%3874) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3947 = "llvm.load"(%3946) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3948 = "llvm.insertvalue"(%3945, %3947) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3949 = "llvm.getelementptr"(%3874) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3950 = "llvm.load"(%3949) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3951 = "llvm.insertvalue"(%3948, %3950) <{position = array<i64: 2>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3952 = "llvm.getelementptr"(%3874) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3953 = "llvm.load"(%3952) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3954 = "llvm.insertvalue"(%3951, %3953) <{position = array<i64: 3>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, i32) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3955 = "llvm.alloca"(%3857) <{elem_type = !llvm.array<0 x ptr>}> : (i32) -> !llvm.ptr
      %3956 = "llvm.call_intrinsic"(%3853, %3955) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3957 = "llvm.call_intrinsic"(%3855, %3944) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3958 = "llvm.getelementptr"(%3944, %3953) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3959 = "llvm.getelementptr"(%3958) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 4>}> : (!llvm.ptr) -> !llvm.ptr
      %3960 = "llvm.load"(%3959) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3961 = "llvm.alloca"(%3857) <{elem_type = !llvm.struct<()>}> : (i32) -> !llvm.ptr
      %3962 = "llvm.call"(%3960, %3954, %3961) <{CConv = #llvm.cconv<ccc>, callee = @behavior_wrapper, callee_type = !llvm.func<ptr (ptr, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.ptr
      %3963 = "llvm.call"(%3962, %3954, %3954, %3955) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<f64 (struct<(ptr, ptr, ptr, i32)>, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> f64
      %3964 = "llvm.alloca"(%3857) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3963, %3964) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3965 = "llvm.load"(%3942) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3966 = "llvm.load"(%3964) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3967 = "arith.addf"(%3965, %3966) <{fastmath = #arith.fastmath<none>}> : (f64, f64) -> f64
      %3968 = "llvm.alloca"(%3857) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3967, %3968) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3969 = "llvm.load"(%3968) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3970 = "llvm.getelementptr"(%3928) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3971 = "llvm.load"(%3970) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3972 = "llvm.insertvalue"(%3854, %3971) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3973 = "llvm.getelementptr"(%3928) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %3976 = "llvm.getelementptr"(%3928) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %3979 = "llvm.getelementptr"(%3928) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %3982 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      %3983 = "llvm.alloca"(%3857) <{elem_type = !llvm.array<1 x ptr>}> : (i32) -> !llvm.ptr
      ...
      %3985 = "llvm.call_intrinsic"(%3852, %3983) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3986 = "llvm.call_intrinsic"(%3855, %3971) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      ...
      %3990 = "llvm.alloca"(%3857) <{elem_type = !llvm.struct<(ptr)>}> : (i32) -> !llvm.ptr
      ...
      %3994 = "llvm.alloca"(%3857) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3995 = "llvm.getelementptr"(%3928) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %3998 = "llvm.getelementptr"(%3928) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %4001 = "llvm.getelementptr"(%3928) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %4004 = "llvm.getelementptr"(%3928) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %4010 = "llvm.insertvalue"(%3854, %4009) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
    ...
    ^bb0(%arg63: !llvm.struct<(ptr, ptr, ptr, i32)>, %arg64: !llvm.struct<(ptr, ptr, ptr, i32)>, %arg65: !llvm.ptr, %arg66: !llvm.struct<(ptr, i160)>):
      ...
      %3703 = "llvm.mlir.constant"() <{value = 144 : i64}> : () -> i64
      %3704 = "llvm.mlir.constant"() <{value = 136 : i64}> : () -> i64
      %3705 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i64
      %3706 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3707 = "llvm.mlir.constant"() <{value = 10 : i32}> : () -> i32
      %3708 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i32
      %3709 = "llvm.alloca"(%3708) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      "llvm.store"(%arg63, %3709) <{ordering = 0 : i64}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> ()
      %3710 = "llvm.alloca"(%3708) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3711 = "llvm.getelementptr"(%3709) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3712 = "llvm.getelementptr"(%3710) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %3715 = "llvm.getelementptr"(%3710) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %3718 = "llvm.getelementptr"(%3710) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3719 = "llvm.load"(%3717) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3719, %3718) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3720 = "llvm.getelementptr"(%3709) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3721 = "llvm.getelementptr"(%3710) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3722 = "llvm.load"(%3720) <{ordering = 0 : i64}> {type = i32} : (!llvm.ptr) -> i32
      "llvm.store"(%3722, %3721) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3723 = "placeholder.addressof"() {global_name = @Float64} : () -> !llvm.ptr
      "llvm.call"(%3710, %3723) {callee = @set_offset, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>} : (!llvm.ptr, !llvm.ptr) -> ()
      %3724 = "llvm.alloca"(%3708) <{elem_type = !llvm.struct<(ptr, i160)>}> : (i32) -> !llvm.ptr
      "llvm.store"(%arg66, %3724) <{ordering = 0 : i64}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> ()
      %3725 = "llvm.alloca"(%3708) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3726 = "llvm.getelementptr"(%3724) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3727 = "llvm.getelementptr"(%3725) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3728 = "llvm.load"(%3726) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3728, %3727) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3729 = "llvm.getelementptr"(%3724) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3730 = "llvm.getelementptr"(%3725) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3731 = "llvm.load"(%3729) <{ordering = 0 : i64}> {type = i160} : (!llvm.ptr) -> i160
      "llvm.store"(%3731, %3730) <{ordering = 0 : i64}> : (i160, !llvm.ptr) -> ()
      %3732 = "placeholder.addressof"() {global_name = @Int32} : () -> !llvm.ptr
      "llvm.call"(%3725, %3732) {callee = @set_offset, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>} : (!llvm.ptr, !llvm.ptr) -> ()
      %3733 = "llvm.getelementptr"(%3725) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3734 = "llvm.load"(%3733) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3735 = "llvm.insertvalue"(%3706, %3734) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3736 = "llvm.getelementptr"(%3725) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3737 = "llvm.load"(%3736) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3738 = "llvm.insertvalue"(%3735, %3737) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3739 = "llvm.getelementptr"(%3725) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3740 = "llvm.load"(%3739) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3741 = "llvm.insertvalue"(%3738, %3740) <{position = array<i64: 2>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3742 = "llvm.getelementptr"(%3725) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3743 = "llvm.load"(%3742) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3744 = "llvm.insertvalue"(%3741, %3743) <{position = array<i64: 3>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, i32) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3745 = "llvm.alloca"(%3708) <{elem_type = !llvm.array<0 x ptr>}> : (i32) -> !llvm.ptr
      %3746 = "llvm.call_intrinsic"(%3705, %3745) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3747 = "llvm.call_intrinsic"(%3704, %3734) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3748 = "llvm.getelementptr"(%3734, %3743) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3749 = "llvm.getelementptr"(%3748) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3750 = "llvm.load"(%3749) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3751 = "llvm.alloca"(%3708) <{elem_type = !llvm.struct<()>}> : (i32) -> !llvm.ptr
      %3752 = "llvm.call"(%3750, %3744, %3751) <{CConv = #llvm.cconv<ccc>, callee = @behavior_wrapper, callee_type = !llvm.func<ptr (ptr, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.ptr
      %3753 = "llvm.call"(%3752, %3744, %3744, %3745) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<i32 (struct<(ptr, ptr, ptr, i32)>, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> i32
      %3754 = "llvm.alloca"(%3708) <{elem_type = i32}> : (i32) -> !llvm.ptr
      "llvm.store"(%3753, %3754) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3755 = "llvm.alloca"(%3708) <{elem_type = f64}> : (i32) -> !llvm.ptr
      %3756 = "llvm.load"(%3754) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3757 = "arith.sitofp"(%3756) : (i32) -> f64
      "llvm.store"(%3757, %3755) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3758 = "llvm.getelementptr"(%3710) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3759 = "llvm.load"(%3758) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3760 = "llvm.load"(%3710) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3761 = "llvm.call_intrinsic"(%3703, %3760) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3762 = "llvm.getelementptr"(%3710) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3763 = "llvm.load"(%3762) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3764 = "llvm.getelementptr"(%3760, %3763) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3765 = "llvm.load"(%3764) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3766 = "llvm.getelementptr"(%3765) <{elem_type = !llvm.struct<(ptr, ptr)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3767 = "llvm.load"(%3766) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3768 = "llvm.call"(%3767, %3759) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<f64 (ptr)>, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = readwrite>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, will_return}> : (!llvm.ptr, !llvm.ptr) -> f64
      %3769 = "llvm.alloca"(%3708) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3768, %3769) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3770 = "llvm.load"(%3769) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3771 = "llvm.load"(%3755) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3772 = "arith.addf"(%3770, %3771) <{fastmath = #arith.fastmath<none>}> : (f64, f64) -> f64
      %3773 = "llvm.alloca"(%3708) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3772, %3773) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3774 = "placeholder.addressof"() {global_name = @Float64} : () -> !llvm.ptr
      %3775 = "llvm.alloca"(%3708) <{elem_type = !llvm.array<1 x ptr>}> : (i32) -> !llvm.ptr
      "llvm.store"(%3774, %3775) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3776 = "llvm.load"(%3775) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3777 = "llvm.getelementptr"(%3776) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 6>}> : (!llvm.ptr) -> !llvm.ptr
      %3778 = "llvm.load"(%3777) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3779 = "llvm.call"(%3778, %3775) {callee = @size_wrapper, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>} : (!llvm.ptr, !llvm.ptr) -> !llvm.struct<(i64, i64)>
      %3780 = "llvm.extractvalue"(%3779) <{position = array<i64: 0>}> : (!llvm.struct<(i64, i64)>) -> i64
      %3781 = "llvm.call"(%3780) <{CConv = #llvm.cconv<ccc>, callee = @bump_malloc, callee_type = !llvm.func<ptr (i64)>, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (i64) -> !llvm.ptr
      %3782 = "llvm.alloca"(%3708) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3783 = "llvm.getelementptr"(%3782) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3784 = "llvm.getelementptr"(%3782) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3774, %3782) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      "llvm.store"(%3781, %3783) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      "llvm.store"(%3707, %3784) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3785 = "llvm.getelementptr"(%3710) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3786 = "llvm.load"(%3785) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3787 = "llvm.load"(%3710) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3788 = "llvm.call_intrinsic"(%3703, %3787) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3789 = "llvm.getelementptr"(%3710) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3790 = "llvm.load"(%3789) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3791 = "llvm.getelementptr"(%3787, %3790) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3792 = "llvm.load"(%3791) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3793 = "llvm.getelementptr"(%3792) <{elem_type = !llvm.struct<(ptr, ptr)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3794 = "llvm.load"(%3793) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3795 = "llvm.call"(%3794, %3786) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<f64 (ptr)>, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = readwrite>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, will_return}> : (!llvm.ptr, !llvm.ptr) -> f64
      %3796 = "llvm.alloca"(%3708) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3795, %3796) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3797 = "llvm.load"(%3796) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3798 = "llvm.load"(%3755) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3799 = "arith.addf"(%3797, %3798) <{fastmath = #arith.fastmath<none>}> : (f64, f64) -> f64
      %3800 = "llvm.alloca"(%3708) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3799, %3800) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3801 = "llvm.load"(%3800) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3802 = "llvm.getelementptr"(%3782) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3803 = "llvm.load"(%3802) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3804 = "llvm.insertvalue"(%3706, %3803) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3805 = "llvm.getelementptr"(%3782) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3806 = "llvm.load"(%3805) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3807 = "llvm.insertvalue"(%3804, %3806) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3808 = "llvm.getelementptr"(%3782) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3809 = "llvm.load"(%3808) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3810 = "llvm.insertvalue"(%3807, %3809) <{position = array<i64: 2>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3811 = "llvm.getelementptr"(%3782) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3812 = "llvm.load"(%3811) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3813 = "llvm.insertvalue"(%3810, %3812) <{position = array<i64: 3>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, i32) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3814 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      %3815 = "llvm.alloca"(%3708) <{elem_type = !llvm.array<1 x ptr>}> : (i32) -> !llvm.ptr
      %3816 = "llvm.getelementptr"(%3815) <{elem_type = !llvm.array<1 x ptr>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3814, %3816) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3817 = "llvm.call_intrinsic"(%3702, %3815) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3818 = "llvm.call_intrinsic"(%3703, %3803) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3819 = "llvm.getelementptr"(%3803, %3812) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3820 = "llvm.getelementptr"(%3819) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3821 = "llvm.load"(%3820) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3822 = "llvm.alloca"(%3708) <{elem_type = !llvm.struct<(ptr)>}> : (i32) -> !llvm.ptr
      %3823 = "placeholder.addressof"() {global_name = @f64_typ} : () -> !llvm.ptr
      %3824 = "llvm.getelementptr"(%3822) <{elem_type = !llvm.struct<(ptr)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3823, %3824) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3825 = "llvm.call"(%3821, %3813, %3822) <{CConv = #llvm.cconv<ccc>, callee = @behavior_wrapper, callee_type = !llvm.func<ptr (ptr, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.ptr
      "llvm.call"(%3825, %3813, %3813, %3815, %3801) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<void (struct<(ptr, ptr, ptr, i32)>, struct<(ptr, ptr, ptr, i32)>, ptr, f64)>, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 5, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr, f64) -> ()
      %3826 = "llvm.alloca"(%3708) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3827 = "llvm.getelementptr"(%3782) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3828 = "llvm.getelementptr"(%3826) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3829 = "llvm.load"(%3827) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3829, %3828) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3830 = "llvm.getelementptr"(%3782) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3831 = "llvm.getelementptr"(%3826) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3832 = "llvm.load"(%3830) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3832, %3831) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3833 = "llvm.getelementptr"(%3782) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3834 = "llvm.getelementptr"(%3826) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3835 = "llvm.load"(%3833) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3835, %3834) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3836 = "llvm.getelementptr"(%3782) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3837 = "llvm.getelementptr"(%3826) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3838 = "llvm.load"(%3836) <{ordering = 0 : i64}> {type = i32} : (!llvm.ptr) -> i32
      "llvm.store"(%3838, %3837) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3839 = "placeholder.addressof"() {global_name = @Float64} : () -> !llvm.ptr
      "llvm.call"(%3826, %3839) {callee = @set_offset, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>} : (!llvm.ptr, !llvm.ptr) -> ()
      %3840 = "llvm.getelementptr"(%3826) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3841 = "llvm.load"(%3840) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3842 = "llvm.insertvalue"(%3706, %3841) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3843 = "llvm.getelementptr"(%3826) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3844 = "llvm.load"(%3843) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3845 = "llvm.insertvalue"(%3842, %3844) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3846 = "llvm.getelementptr"(%3826) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3847 = "llvm.load"(%3846) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3848 = "llvm.insertvalue"(%3845, %3847) <{position = array<i64: 2>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3849 = "llvm.getelementptr"(%3826) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3850 = "llvm.load"(%3849) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3851 = "llvm.insertvalue"(%3848, %3850) <{position = array<i64: 3>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, i32) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      "cf.br"()[^bb1] : () -> ()
    ^bb1:  // pred: ^bb0
      "func.return"(%3851) : (!llvm.struct<(ptr, ptr, ptr, i32)>) -> ()
    }) : () -> ()
    ...
    ^bb0(%arg61: !llvm.struct<(ptr, ptr, ptr, i32)>, %arg62: !llvm.ptr):
      ...
      %3624 = "llvm.mlir.constant"() <{value = 8 : i32}> : () -> i32
      %3625 = "llvm.mlir.constant"() <{value = 9 : i32}> : () -> i32
    ...
    ^bb0(%arg41: !llvm.struct<(ptr, ptr, ptr, i32)>, %arg42: !llvm.struct<(ptr, ptr, ptr, i32)>, %arg43: !llvm.ptr, %arg44: !llvm.struct<(ptr, i160)>):
      %3345 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, i160)>
      %3346 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i64
      %3347 = "llvm.mlir.constant"() <{value = 144 : i64}> : () -> i64
      %3348 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i64
      %3349 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3350 = "llvm.mlir.constant"() <{value = 136 : i64}> : () -> i64
      %3351 = "llvm.mlir.constant"() <{value = 10 : i32}> : () -> i32
      %3352 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i32
      %3353 = "llvm.alloca"(%3352) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      "llvm.store"(%arg41, %3353) <{ordering = 0 : i64}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> ()
      %3354 = "llvm.alloca"(%3352) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3355 = "llvm.getelementptr"(%3353) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3356 = "llvm.getelementptr"(%3354) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3357 = "llvm.load"(%3355) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3357, %3356) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3358 = "llvm.getelementptr"(%3353) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3359 = "llvm.getelementptr"(%3354) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3360 = "llvm.load"(%3358) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3360, %3359) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3361 = "llvm.getelementptr"(%3353) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3362 = "llvm.getelementptr"(%3354) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3363 = "llvm.load"(%3361) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3363, %3362) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3364 = "llvm.getelementptr"(%3353) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3365 = "llvm.getelementptr"(%3354) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3366 = "llvm.load"(%3364) <{ordering = 0 : i64}> {type = i32} : (!llvm.ptr) -> i32
      "llvm.store"(%3366, %3365) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3367 = "placeholder.addressof"() {global_name = @Int32} : () -> !llvm.ptr
      "llvm.call"(%3354, %3367) {callee = @set_offset, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>} : (!llvm.ptr, !llvm.ptr) -> ()
      %3368 = "llvm.alloca"(%3352) <{elem_type = !llvm.struct<(ptr, i160)>}> : (i32) -> !llvm.ptr
      "llvm.store"(%arg44, %3368) <{ordering = 0 : i64}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> ()
      %3369 = "llvm.alloca"(%3352) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3370 = "llvm.getelementptr"(%3368) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3371 = "llvm.getelementptr"(%3369) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3372 = "llvm.load"(%3370) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3372, %3371) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3373 = "llvm.getelementptr"(%3368) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3374 = "llvm.getelementptr"(%3369) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3375 = "llvm.load"(%3373) <{ordering = 0 : i64}> {type = i160} : (!llvm.ptr) -> i160
      "llvm.store"(%3375, %3374) <{ordering = 0 : i64}> : (i160, !llvm.ptr) -> ()
      %3376 = "placeholder.addressof"() {global_name = @Float64} : () -> !llvm.ptr
      "llvm.call"(%3369, %3376) {callee = @set_offset, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>} : (!llvm.ptr, !llvm.ptr) -> ()
      %3377 = "llvm.getelementptr"(%3354) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3378 = "llvm.load"(%3377) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3379 = "llvm.load"(%3354) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3380 = "llvm.call_intrinsic"(%3350, %3379) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3381 = "llvm.getelementptr"(%3354) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3382 = "llvm.load"(%3381) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3383 = "llvm.getelementptr"(%3379, %3382) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3384 = "llvm.load"(%3383) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3385 = "llvm.getelementptr"(%3384) <{elem_type = !llvm.struct<(ptr, ptr)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3386 = "llvm.load"(%3385) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3387 = "llvm.call"(%3386, %3378) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<i32 (ptr)>, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = readwrite>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, will_return}> : (!llvm.ptr, !llvm.ptr) -> i32
      %3388 = "llvm.alloca"(%3352) <{elem_type = i32}> : (i32) -> !llvm.ptr
      "llvm.store"(%3387, %3388) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3389 = "llvm.alloca"(%3352) <{elem_type = f64}> : (i32) -> !llvm.ptr
      %3390 = "llvm.load"(%3388) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3391 = "arith.sitofp"(%3390) : (i32) -> f64
      "llvm.store"(%3391, %3389) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3392 = "llvm.getelementptr"(%3369) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3393 = "llvm.load"(%3392) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3394 = "llvm.insertvalue"(%3349, %3393) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3395 = "llvm.getelementptr"(%3369) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3396 = "llvm.load"(%3395) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3397 = "llvm.insertvalue"(%3394, %3396) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3398 = "llvm.getelementptr"(%3369) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3399 = "llvm.load"(%3398) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3400 = "llvm.insertvalue"(%3397, %3399) <{position = array<i64: 2>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3401 = "llvm.getelementptr"(%3369) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3402 = "llvm.load"(%3401) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3403 = "llvm.insertvalue"(%3400, %3402) <{position = array<i64: 3>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, i32) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3404 = "llvm.alloca"(%3352) <{elem_type = !llvm.array<0 x ptr>}> : (i32) -> !llvm.ptr
      %3405 = "llvm.call_intrinsic"(%3348, %3404) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3406 = "llvm.call_intrinsic"(%3347, %3393) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3407 = "llvm.getelementptr"(%3393, %3402) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3408 = "llvm.getelementptr"(%3407) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 4>}> : (!llvm.ptr) -> !llvm.ptr
      %3409 = "llvm.load"(%3408) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3410 = "llvm.alloca"(%3352) <{elem_type = !llvm.struct<()>}> : (i32) -> !llvm.ptr
      %3411 = "llvm.call"(%3409, %3403, %3410) <{CConv = #llvm.cconv<ccc>, callee = @behavior_wrapper, callee_type = !llvm.func<ptr (ptr, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.ptr
      %3412 = "llvm.call"(%3411, %3403, %3403, %3404) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<f64 (struct<(ptr, ptr, ptr, i32)>, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> f64
      %3413 = "llvm.alloca"(%3352) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3412, %3413) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3414 = "llvm.load"(%3389) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3415 = "llvm.load"(%3413) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3416 = "arith.addf"(%3414, %3415) <{fastmath = #arith.fastmath<none>}> : (f64, f64) -> f64
      %3417 = "llvm.alloca"(%3352) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3416, %3417) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3418 = "placeholder.addressof"() {global_name = @Float64} : () -> !llvm.ptr
      %3419 = "llvm.alloca"(%3352) <{elem_type = !llvm.array<1 x ptr>}> : (i32) -> !llvm.ptr
      "llvm.store"(%3418, %3419) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3420 = "llvm.load"(%3419) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3421 = "llvm.getelementptr"(%3420) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 6>}> : (!llvm.ptr) -> !llvm.ptr
      %3422 = "llvm.load"(%3421) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3423 = "llvm.call"(%3422, %3419) {callee = @size_wrapper, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>} : (!llvm.ptr, !llvm.ptr) -> !llvm.struct<(i64, i64)>
      %3424 = "llvm.extractvalue"(%3423) <{position = array<i64: 0>}> : (!llvm.struct<(i64, i64)>) -> i64
      %3425 = "llvm.call"(%3424) <{CConv = #llvm.cconv<ccc>, callee = @bump_malloc, callee_type = !llvm.func<ptr (i64)>, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (i64) -> !llvm.ptr
      %3426 = "llvm.alloca"(%3352) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3427 = "llvm.getelementptr"(%3426) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3428 = "llvm.getelementptr"(%3426) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3418, %3426) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      "llvm.store"(%3425, %3427) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      "llvm.store"(%3351, %3428) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3429 = "llvm.getelementptr"(%3369) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3430 = "llvm.load"(%3429) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3431 = "llvm.insertvalue"(%3349, %3430) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3432 = "llvm.getelementptr"(%3369) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %3435 = "llvm.getelementptr"(%3369) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %3438 = "llvm.getelementptr"(%3369) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %3441 = "llvm.alloca"(%3352) <{elem_type = !llvm.array<0 x ptr>}> : (i32) -> !llvm.ptr
      %3442 = "llvm.call_intrinsic"(%3348, %3441) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3443 = "llvm.call_intrinsic"(%3347, %3430) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3444 = "llvm.getelementptr"(%3430, %3439) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3445 = "llvm.getelementptr"(%3444) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 4>}> : (!llvm.ptr) -> !llvm.ptr
      %3446 = "llvm.load"(%3445) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3447 = "llvm.alloca"(%3352) <{elem_type = !llvm.struct<()>}> : (i32) -> !llvm.ptr
      ...
      %3450 = "llvm.alloca"(%3352) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3449, %3450) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3451 = "llvm.load"(%3389) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3452 = "llvm.load"(%3450) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3453 = "arith.addf"(%3451, %3452) <{fastmath = #arith.fastmath<none>}> : (f64, f64) -> f64
      %3454 = "llvm.alloca"(%3352) <{elem_type = f64}> : (i32) -> !llvm.ptr
      "llvm.store"(%3453, %3454) <{ordering = 0 : i64}> : (f64, !llvm.ptr) -> ()
      %3455 = "llvm.load"(%3454) <{ordering = 0 : i64}> : (!llvm.ptr) -> f64
      %3456 = "llvm.getelementptr"(%3426) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3457 = "llvm.load"(%3456) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3458 = "llvm.insertvalue"(%3349, %3457) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3459 = "llvm.getelementptr"(%3426) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %3462 = "llvm.getelementptr"(%3426) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %3465 = "llvm.getelementptr"(%3426) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      ...
      %3468 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      %3469 = "llvm.alloca"(%3352) <{elem_type = !llvm.array<1 x ptr>}> : (i32) -> !llvm.ptr
      ...
      %3471 = "llvm.call_intrinsic"(%3346, %3469) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3472 = "llvm.call_intrinsic"(%3347, %3457) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3473 = "llvm.getelementptr"(%3457, %3466) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3474 = "llvm.getelementptr"(%3473) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3475 = "llvm.load"(%3474) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3476 = "llvm.alloca"(%3352) <{elem_type = !llvm.struct<(ptr)>}> : (i32) -> !llvm.ptr
      %3477 = "placeholder.addressof"() {global_name = @f64_typ} : () -> !llvm.ptr
      ...
      %3480 = "llvm.getelementptr"(%3426) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3481 = "llvm.load"(%3480) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3482 = "llvm.insertvalue"(%3345, %3481) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> !llvm.struct<(ptr, i160)>
      %3483 = "llvm.getelementptr"(%3426) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
    ...
    ^bb0(%arg37: !llvm.struct<(ptr, ptr, ptr, i32)>, %arg38: !llvm.struct<(ptr, ptr, ptr, i32)>, %arg39: !llvm.ptr, %arg40: !llvm.struct<(ptr, i160)>):
      ...
      %3198 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i64
      %3199 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3200 = "llvm.mlir.constant"() <{value = 136 : i64}> : () -> i64
      %3201 = "llvm.mlir.constant"() <{value = 10 : i32}> : () -> i32
      %3202 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i32
      %3203 = "llvm.alloca"(%3202) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      "llvm.store"(%arg37, %3203) <{ordering = 0 : i64}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> ()
      %3204 = "llvm.alloca"(%3202) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3205 = "llvm.getelementptr"(%3203) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3206 = "llvm.getelementptr"(%3204) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3207 = "llvm.load"(%3205) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3207, %3206) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3208 = "llvm.getelementptr"(%3203) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3209 = "llvm.getelementptr"(%3204) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3210 = "llvm.load"(%3208) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3210, %3209) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3211 = "llvm.getelementptr"(%3203) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3212 = "llvm.getelementptr"(%3204) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3213 = "llvm.load"(%3211) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3213, %3212) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3214 = "llvm.getelementptr"(%3203) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3215 = "llvm.getelementptr"(%3204) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3216 = "llvm.load"(%3214) <{ordering = 0 : i64}> {type = i32} : (!llvm.ptr) -> i32
      "llvm.store"(%3216, %3215) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3217 = "placeholder.addressof"() {global_name = @Int32} : () -> !llvm.ptr
      "llvm.call"(%3204, %3217) {callee = @set_offset, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>} : (!llvm.ptr, !llvm.ptr) -> ()
      %3218 = "llvm.alloca"(%3202) <{elem_type = !llvm.struct<(ptr, i160)>}> : (i32) -> !llvm.ptr
      "llvm.store"(%arg40, %3218) <{ordering = 0 : i64}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> ()
      %3219 = "llvm.alloca"(%3202) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3220 = "llvm.getelementptr"(%3218) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3221 = "llvm.getelementptr"(%3219) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3222 = "llvm.load"(%3220) <{ordering = 0 : i64}> {type = !llvm.ptr} : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3222, %3221) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3223 = "llvm.getelementptr"(%3218) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3224 = "llvm.getelementptr"(%3219) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3225 = "llvm.load"(%3223) <{ordering = 0 : i64}> {type = i160} : (!llvm.ptr) -> i160
      "llvm.store"(%3225, %3224) <{ordering = 0 : i64}> : (i160, !llvm.ptr) -> ()
      %3226 = "placeholder.addressof"() {global_name = @Int32} : () -> !llvm.ptr
      "llvm.call"(%3219, %3226) {callee = @set_offset, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>} : (!llvm.ptr, !llvm.ptr) -> ()
      %3227 = "llvm.getelementptr"(%3204) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3228 = "llvm.load"(%3227) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3229 = "llvm.load"(%3204) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3230 = "llvm.call_intrinsic"(%3200, %3229) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3231 = "llvm.getelementptr"(%3204) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3232 = "llvm.load"(%3231) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3233 = "llvm.getelementptr"(%3229, %3232) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3234 = "llvm.load"(%3233) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3235 = "llvm.getelementptr"(%3234) <{elem_type = !llvm.struct<(ptr, ptr)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3236 = "llvm.load"(%3235) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3237 = "llvm.call"(%3236, %3228) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<i32 (ptr)>, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = readwrite>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, will_return}> : (!llvm.ptr, !llvm.ptr) -> i32
      %3238 = "llvm.alloca"(%3202) <{elem_type = i32}> : (i32) -> !llvm.ptr
      "llvm.store"(%3237, %3238) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3239 = "llvm.getelementptr"(%3219) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3240 = "llvm.load"(%3239) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3241 = "llvm.insertvalue"(%3199, %3240) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3242 = "llvm.getelementptr"(%3219) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3243 = "llvm.load"(%3242) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3244 = "llvm.insertvalue"(%3241, %3243) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3245 = "llvm.getelementptr"(%3219) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3246 = "llvm.load"(%3245) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3247 = "llvm.insertvalue"(%3244, %3246) <{position = array<i64: 2>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3248 = "llvm.getelementptr"(%3219) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3249 = "llvm.load"(%3248) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3250 = "llvm.insertvalue"(%3247, %3249) <{position = array<i64: 3>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, i32) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3251 = "llvm.alloca"(%3202) <{elem_type = !llvm.array<0 x ptr>}> : (i32) -> !llvm.ptr
      %3252 = "llvm.call_intrinsic"(%3198, %3251) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3253 = "llvm.call_intrinsic"(%3200, %3240) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3254 = "llvm.getelementptr"(%3240, %3249) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3255 = "llvm.getelementptr"(%3254) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3256 = "llvm.load"(%3255) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3257 = "llvm.alloca"(%3202) <{elem_type = !llvm.struct<()>}> : (i32) -> !llvm.ptr
      %3258 = "llvm.call"(%3256, %3250, %3257) <{CConv = #llvm.cconv<ccc>, callee = @behavior_wrapper, callee_type = !llvm.func<ptr (ptr, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.ptr
      %3259 = "llvm.call"(%3258, %3250, %3250, %3251) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<i32 (struct<(ptr, ptr, ptr, i32)>, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> i32
      %3260 = "llvm.alloca"(%3202) <{elem_type = i32}> : (i32) -> !llvm.ptr
      "llvm.store"(%3259, %3260) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3261 = "llvm.load"(%3238) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3262 = "llvm.load"(%3260) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3263 = "arith.addi"(%3261, %3262) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
      %3264 = "llvm.alloca"(%3202) <{elem_type = i32}> : (i32) -> !llvm.ptr
      "llvm.store"(%3263, %3264) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3265 = "placeholder.addressof"() {global_name = @Int32} : () -> !llvm.ptr
      %3266 = "llvm.alloca"(%3202) <{elem_type = !llvm.array<1 x ptr>}> : (i32) -> !llvm.ptr
      "llvm.store"(%3265, %3266) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3267 = "llvm.load"(%3266) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3268 = "llvm.getelementptr"(%3267) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 6>}> : (!llvm.ptr) -> !llvm.ptr
      %3269 = "llvm.load"(%3268) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3270 = "llvm.call"(%3269, %3266) {callee = @size_wrapper, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>} : (!llvm.ptr, !llvm.ptr) -> !llvm.struct<(i64, i64)>
      %3271 = "llvm.extractvalue"(%3270) <{position = array<i64: 0>}> : (!llvm.struct<(i64, i64)>) -> i64
      %3272 = "llvm.call"(%3271) <{CConv = #llvm.cconv<ccc>, callee = @bump_malloc, callee_type = !llvm.func<ptr (i64)>, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (i64) -> !llvm.ptr
      %3273 = "llvm.alloca"(%3202) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>}> : (i32) -> !llvm.ptr
      %3274 = "llvm.getelementptr"(%3273) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3275 = "llvm.getelementptr"(%3273) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3265, %3273) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      "llvm.store"(%3272, %3274) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      "llvm.store"(%3201, %3275) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3276 = "llvm.getelementptr"(%3204) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3277 = "llvm.load"(%3276) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3278 = "llvm.load"(%3204) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3279 = "llvm.call_intrinsic"(%3200, %3278) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3280 = "llvm.getelementptr"(%3204) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3281 = "llvm.load"(%3280) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3282 = "llvm.getelementptr"(%3278, %3281) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3283 = "llvm.load"(%3282) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3284 = "llvm.getelementptr"(%3283) <{elem_type = !llvm.struct<(ptr, ptr)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3285 = "llvm.load"(%3284) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3286 = "llvm.call"(%3285, %3277) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<i32 (ptr)>, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = readwrite>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, will_return}> : (!llvm.ptr, !llvm.ptr) -> i32
      %3287 = "llvm.alloca"(%3202) <{elem_type = i32}> : (i32) -> !llvm.ptr
      "llvm.store"(%3286, %3287) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3288 = "llvm.getelementptr"(%3219) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3289 = "llvm.load"(%3288) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3290 = "llvm.insertvalue"(%3199, %3289) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3291 = "llvm.getelementptr"(%3219) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3292 = "llvm.load"(%3291) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3293 = "llvm.insertvalue"(%3290, %3292) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3294 = "llvm.getelementptr"(%3219) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3295 = "llvm.load"(%3294) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3296 = "llvm.insertvalue"(%3293, %3295) <{position = array<i64: 2>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3297 = "llvm.getelementptr"(%3219) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3298 = "llvm.load"(%3297) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3299 = "llvm.insertvalue"(%3296, %3298) <{position = array<i64: 3>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, i32) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3300 = "llvm.alloca"(%3202) <{elem_type = !llvm.array<0 x ptr>}> : (i32) -> !llvm.ptr
      %3301 = "llvm.call_intrinsic"(%3198, %3300) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3302 = "llvm.call_intrinsic"(%3200, %3289) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3303 = "llvm.getelementptr"(%3289, %3298) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3304 = "llvm.getelementptr"(%3303) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3305 = "llvm.load"(%3304) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3306 = "llvm.alloca"(%3202) <{elem_type = !llvm.struct<()>}> : (i32) -> !llvm.ptr
      %3307 = "llvm.call"(%3305, %3299, %3306) <{CConv = #llvm.cconv<ccc>, callee = @behavior_wrapper, callee_type = !llvm.func<ptr (ptr, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.ptr
      %3308 = "llvm.call"(%3307, %3299, %3299, %3300) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<i32 (struct<(ptr, ptr, ptr, i32)>, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> i32
      %3309 = "llvm.alloca"(%3202) <{elem_type = i32}> : (i32) -> !llvm.ptr
      "llvm.store"(%3308, %3309) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3310 = "llvm.load"(%3287) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3311 = "llvm.load"(%3309) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3312 = "arith.addi"(%3310, %3311) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
      %3313 = "llvm.alloca"(%3202) <{elem_type = i32}> : (i32) -> !llvm.ptr
      "llvm.store"(%3312, %3313) <{ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
      %3314 = "llvm.load"(%3313) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3315 = "llvm.getelementptr"(%3273) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3316 = "llvm.load"(%3315) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3317 = "llvm.insertvalue"(%3199, %3316) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3318 = "llvm.getelementptr"(%3273) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3319 = "llvm.load"(%3318) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3320 = "llvm.insertvalue"(%3317, %3319) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3321 = "llvm.getelementptr"(%3273) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3322 = "llvm.load"(%3321) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3323 = "llvm.insertvalue"(%3320, %3322) <{position = array<i64: 2>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3324 = "llvm.getelementptr"(%3273) <{elem_type = !llvm.struct<(ptr, ptr, ptr, i32)>, rawConstantIndices = array<i32: 0, 3>}> : (!llvm.ptr) -> !llvm.ptr
      %3325 = "llvm.load"(%3324) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
      %3326 = "llvm.insertvalue"(%3323, %3325) <{position = array<i64: 3>}> : (!llvm.struct<(ptr, ptr, ptr, i32)>, i32) -> !llvm.struct<(ptr, ptr, ptr, i32)>
      %3327 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      %3328 = "llvm.alloca"(%3202) <{elem_type = !llvm.array<1 x ptr>}> : (i32) -> !llvm.ptr
      %3329 = "llvm.getelementptr"(%3328) <{elem_type = !llvm.array<1 x ptr>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3327, %3329) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3330 = "llvm.call_intrinsic"(%3197, %3328) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3331 = "llvm.call_intrinsic"(%3200, %3316) <{fastmathFlags = #llvm.fastmath<none>, intrin = "llvm.invariant.start.p0", op_bundle_sizes = array<i32>, op_bundle_tags = [], operandSegmentSizes = array<i32: 2, 0>}> : (i64, !llvm.ptr) -> !llvm.ptr
      %3332 = "llvm.getelementptr"(%3316, %3325) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %3333 = "llvm.getelementptr"(%3332) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 2>}> : (!llvm.ptr) -> !llvm.ptr
      %3334 = "llvm.load"(%3333) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3335 = "llvm.alloca"(%3202) <{elem_type = !llvm.struct<(ptr)>}> : (i32) -> !llvm.ptr
      %3336 = "placeholder.addressof"() {global_name = @i32_typ} : () -> !llvm.ptr
      %3337 = "llvm.getelementptr"(%3335) <{elem_type = !llvm.struct<(ptr)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%3336, %3337) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %3338 = "llvm.call"(%3334, %3326, %3335) <{CConv = #llvm.cconv<ccc>, callee = @behavior_wrapper, callee_type = !llvm.func<ptr (ptr, struct<(ptr, ptr, ptr, i32)>, ptr)>, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr) -> !llvm.ptr
      "llvm.call"(%3338, %3326, %3326, %3328, %3314) <{CConv = #llvm.cconv<ccc>, callee_type = !llvm.func<void (struct<(ptr, ptr, ptr, i32)>, struct<(ptr, ptr, ptr, i32)>, ptr, i32)>, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 5, 0>}> : (!llvm.ptr, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.struct<(ptr, ptr, ptr, i32)>, !llvm.ptr, i32) -> ()
      %3339 = "llvm.getelementptr"(%3273) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 0>}> : (!llvm.ptr) -> !llvm.ptr
      %3340 = "llvm.load"(%3339) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
      %3341 = "llvm.insertvalue"(%3196, %3340) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, i160)>, !llvm.ptr) -> !llvm.struct<(ptr, i160)>
      %3342 = "llvm.getelementptr"(%3273) <{elem_type = !llvm.struct<(ptr, i160)>, rawConstantIndices = array<i32: 0, 1>}> : (!llvm.ptr) -> !llvm.ptr
      %3343 = "llvm.load"(%3342) <{ordering = 0 : i64}> : (!llvm.ptr) -> i160
      %3344 = "llvm.insertvalue"(%3341, %3343) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, i160)>, i160) -> !llvm.struct<(ptr, i160)>
      "cf.br"()[^bb1] : () -> ()
    ^bb1:  // pred: ^bb0
      "func.return"(%3344) : (!llvm.struct<(ptr, i160)>) -> ()
    }) : () -> ()
    ...
    ^bb2:  // pred: ^bb0
      ...
      %3128 = "placeholder.addressof"() {global_name = @Int32} : () -> !llvm.ptr
    ...
    ^bb3:  // pred: ^bb2
      ...
      %3144 = "placeholder.addressof"() {global_name = @Float64} : () -> !llvm.ptr
    ...
    ^bb4:  // 2 preds: ^bb2, ^bb3
      ...
      %3160 = "placeholder.addressof"() {global_name = @Float64} : () -> !llvm.ptr
    ...
    ^bb5:  // pred: ^bb4
      ...
      %3176 = "placeholder.addressof"() {global_name = @Int32} : () -> !llvm.ptr
    ...
    ^bb0(%arg34: !llvm.struct<(ptr, ptr, ptr, i32)>):
      ...
      %3026 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
    ...
    ^bb0(%arg20: !llvm.struct<(ptr, ptr, ptr, i32)>, %arg21: !llvm.struct<(ptr, ptr, ptr, i32)>, %arg22: !llvm.ptr):
      ...
      %2688 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
    ...
    ^bb0(%arg2: !llvm.struct<(ptr, ptr, ptr, i32)>, %arg3: !llvm.struct<(ptr, ptr, ptr, i32)>, %arg4: !llvm.ptr):
      ...
      %2489 = "placeholder.addressof"() {global_name = @_parameterization_Ptri64} : () -> !llvm.ptr
    ...
    ^bb13:  // pred: ^bb12
      ...
      %377 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      %378 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      ...
      %444 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      ...
      %453 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      %454 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %498 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      %499 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %565 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %582 = "placeholder.addressof"() {global_name = @_parameterization_Tuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64_} : () -> !llvm.ptr
      %583 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      ...
      %650 = "placeholder.addressof"() {global_name = @_parameterization_Tuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64_} : () -> !llvm.ptr
      %651 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      ...
      %730 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
    ...
    ^bb17:  // pred: ^bb16
      ...
      %809 = "placeholder.addressof"() {global_name = @_parameterization_Tuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64_} : () -> !llvm.ptr
      %810 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      ...
      %876 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      ...
      %885 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %988 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %1023 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %1058 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %1093 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %1116 = "placeholder.addressof"() {global_name = @_functionliteral_jeqlaaxvcn} : () -> !llvm.ptr
      ...
      %1129 = "placeholder.addressof"() {global_name = @mcfjmclrrl} : () -> !llvm.ptr
      ...
      %1148 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      %1149 = "placeholder.addressof"() {global_name = @_parameterization_FunctionPtri32._Ptri32_to_Ptri32} : () -> !llvm.ptr
      ...
      %1173 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %1182 = "placeholder.addressof"() {global_name = @_functionliteral_wjkkoxgcnk} : () -> !llvm.ptr
      "llvm.store"(%1182, %172) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %1183 = "placeholder.addressof"() {global_name = @_functionliteral_lgzgdkneqe} : () -> !llvm.ptr
      "llvm.store"(%1183, %173) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %1184 = "placeholder.addressof"() {global_name = @_functionliteral_itdpwfrgxd} : () -> !llvm.ptr
      "llvm.store"(%1184, %174) <{ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
      %1185 = "placeholder.addressof"() {global_name = @_functionliteral_mvxsvfubgb} : () -> !llvm.ptr
      ...
      %1189 = "placeholder.addressof"() {global_name = @reafbmmyuo} : () -> !llvm.ptr
      ...
      %1208 = "placeholder.addressof"() {global_name = @_parameterization_FunctionPtri32_to_Ptri32} : () -> !llvm.ptr
      ...
      %1260 = "placeholder.addressof"() {global_name = @wrtvlovfvq} : () -> !llvm.ptr
      ...
      %1270 = "placeholder.addressof"() {global_name = @vkmzwadqco} : () -> !llvm.ptr
      ...
      %1289 = "placeholder.addressof"() {global_name = @_parameterization_FunctionPtri32_to_Ptri32} : () -> !llvm.ptr
      ...
      %1325 = "placeholder.addressof"() {global_name = @_parameterization_FunctionPtri32_to_Ptrf64} : () -> !llvm.ptr
    ...
    ^bb18:  // 2 preds: ^bb17, ^bb19
      ...
      "cf.cond_br"(%1464)[^bb19, ^bb20] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb19:  // pred: ^bb18
      ...
      %1476 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %1494 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
    ...
    ^bb20:  // pred: ^bb18
      ...
      %1541 = "placeholder.addressof"() {global_name = @_parameterization_MapIterablePtri32._Ptrf64} : () -> !llvm.ptr
    ...
    ^bb21:  // 2 preds: ^bb20, ^bb22
      ...
      "cf.cond_br"(%1673)[^bb22, ^bb23] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb22:  // pred: ^bb21
      ...
      %1711 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %1750 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
    ...
    ^bb33:  // pred: ^bb32
      ...
      %1806 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %1863 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %2001 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
    ...
    ^bb37:  // pred: ^bb36
      ...
      %2032 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %2076 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %2211 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
      ...
      %2242 = "placeholder.addressof"() {global_name = @_parameterization_Ptri32} : () -> !llvm.ptr
      ...
      %2352 = "placeholder.addressof"() {global_name = @_parameterization_Ptrf64} : () -> !llvm.ptr
