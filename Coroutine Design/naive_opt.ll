...
@calling_fn_1_resume_result = internal thread_local unnamed_addr global i32 0
...
alloc.i:                                          ; preds = %0
  ...
  %buf_invariant.i = tail call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull %copy)
...
define ptr @load_calling_fn_1_sp() local_unnamed_addr #12 {
  %value = load ptr, ptr @calling_fn_1_caller_sp, align 8
  ret ptr %value
}
...
define void @store_calling_fn_1_resume_result(i32 %value) local_unnamed_addr #13 {
  store i32 %value, ptr @calling_fn_1_resume_result, align 4
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(read, argmem: none, inaccessiblemem: none)
define i32 @load_calling_fn_1_resume_result() local_unnamed_addr #12 {
  %value = load i32, ptr @calling_fn_1_resume_result, align 4
  ret i32 %value
}
...
define i32 @yielding_fn(i32 %n) local_unnamed_addr {
  ...
  store i64 %size.i.i, ptr getelementptr inbounds (i8, ptr @yielding_fn_copy, i64 8), align 8
  %size_invariant.i = call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull getelementptr inbounds (i8, ptr @yielding_fn_copy, i64 8))
  %buf.i.i = load ptr, ptr @yielding_fn_copy, align 8
...
alloc.i.i:                                        ; preds = %0
  ...
  store ptr %new_buf.i.i, ptr @yielding_fn_copy, align 8
  %buf_invariant.i.i = call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @yielding_fn_copy)
...
define i32 @yielding_fn_1(ptr nest nocapture readonly %n_ptr) {
  ...
  %bottom_i.i.i = ptrtoint ptr %bottom_sp to i64
  %size.i.i = sub i64 %top_i.i.i, %bottom_i.i.i
  store i64 %size.i.i, ptr getelementptr inbounds (i8, ptr @yielding_fn_1_copy, i64 8), align 8
  %size_invariant.i = call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull getelementptr inbounds (i8, ptr @yielding_fn_1_copy, i64 8))
  %buf.i.i = load ptr, ptr @yielding_fn_1_copy, align 8
  %missing.i.i = icmp eq ptr %buf.i.i, null
  br i1 %missing.i.i, label %alloc.i.i, label %save_copy.exit

alloc.i.i:                                        ; preds = %0
  %new_buf.i.i = call ptr @malloc(i64 %size.i.i)
  store ptr %new_buf.i.i, ptr @yielding_fn_1_copy, align 8
  %buf_invariant.i.i = call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @yielding_fn_1_copy)
  br label %save_copy.exit
...
define i32 @yielding_fn_2(ptr nest nocapture readonly %n1_ptr) {
  ...
  %bottom_i.i.i = ptrtoint ptr %bottom_sp to i64
  %size.i.i = sub i64 %top_i.i.i, %bottom_i.i.i
  store i64 %size.i.i, ptr getelementptr inbounds (i8, ptr @yielding_fn_2_copy, i64 8), align 8
  %size_invariant.i = call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull getelementptr inbounds (i8, ptr @yielding_fn_2_copy, i64 8))
  %buf.i.i = load ptr, ptr @yielding_fn_2_copy, align 8
  %missing.i.i = icmp eq ptr %buf.i.i, null
  br i1 %missing.i.i, label %alloc.i.i, label %save_copy.exit

alloc.i.i:                                        ; preds = %0
  %new_buf.i.i = call ptr @malloc(i64 %size.i.i)
  store ptr %new_buf.i.i, ptr @yielding_fn_2_copy, align 8
  %buf_invariant.i.i = call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @yielding_fn_2_copy)
  br label %save_copy.exit
...
define i32 @passthru_fn(i32 %n) local_unnamed_addr {
  ...
  store i64 %size.i.i.i, ptr getelementptr inbounds (i8, ptr @yielding_fn_copy, i64 8), align 8
  %size_invariant.i.i = call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull getelementptr inbounds (i8, ptr @yielding_fn_copy, i64 8))
  %buf.i.i.i = load ptr, ptr @yielding_fn_copy, align 8
...
alloc.i.i.i:                                      ; preds = %0
  ...
  store ptr %new_buf.i.i.i, ptr @yielding_fn_copy, align 8
  %buf_invariant.i.i.i = call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @yielding_fn_copy)
...
define void @calling_fn(i32 %n) local_unnamed_addr {
  ...
  store i64 %size.i.i.i.i, ptr getelementptr inbounds (i8, ptr @yielding_fn_copy, i64 8), align 8
  %size_invariant.i.i.i = call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull getelementptr inbounds (i8, ptr @yielding_fn_copy, i64 8))
  %buf.i.i.i.i = load ptr, ptr @yielding_fn_copy, align 8
...
alloc.i.i.i.i:                                    ; preds = %0
  ...
  store ptr %new_buf.i.i.i.i, ptr @yielding_fn_copy, align 8
  %buf_invariant.i.i.i.i = call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @yielding_fn_copy)
...
passthru_fn.exit:                                 ; preds = %0, %alloc.i.i.i.i
  ...
  %bottom_i.i.i.i = ptrtoint ptr %bottom_sp.i to i64
  %size.i.i.i = sub i64 %top_i.i.i.i, %bottom_i.i.i.i
  store i64 %size.i.i.i, ptr getelementptr inbounds (i8, ptr @yielding_fn_1_copy, i64 8), align 8
  %size_invariant.i.i = call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull getelementptr inbounds (i8, ptr @yielding_fn_1_copy, i64 8))
  %buf.i.i.i = load ptr, ptr @yielding_fn_1_copy, align 8
  %missing.i.i.i = icmp eq ptr %buf.i.i.i, null
  br i1 %missing.i.i.i, label %alloc.i.i.i, label %yielding_fn_1.exit

alloc.i.i.i:                                      ; preds = %passthru_fn.exit
  %new_buf.i.i.i = call ptr @malloc(i64 %size.i.i.i)
  store ptr %new_buf.i.i.i, ptr @yielding_fn_1_copy, align 8
  %buf_invariant.i.i.i = call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @yielding_fn_1_copy)
...
yielding_fn_1.exit:                               ; preds = %passthru_fn.exit, %alloc.i.i.i
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %tramp.i)
  call void @store_calling_fn_1_resume_result(i32 0)
  %return_sp.i = call ptr @load_calling_fn_1_sp()
...
define i32 @calling_fn_1(ptr nest nocapture readonly %n_ptr) {
  ...
  %buf.i = load ptr, ptr @yielding_fn_copy, align 8
  %size.i = load i64, ptr getelementptr inbounds (i8, ptr @yielding_fn_copy, i64 8), align 8
...
attributes #12 = { mustprogress nofree noinline norecurse nosync nounwind willreturn memory(read, argmem: none, inaccessiblemem: none) }
attributes #13 = { mustprogress nofree noinline norecurse nosync nounwind willreturn memory(write, argmem: none, inaccessiblemem: none) }
