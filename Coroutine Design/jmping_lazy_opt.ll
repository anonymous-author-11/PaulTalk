...
define i32 @save_ip(ptr nocapture writeonly %buf) local_unnamed_addr #9 {
...
define ptr @prev_slot(ptr readnone returned %state) local_unnamed_addr #11 {
  ret ptr %state
}

; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @caller_buf(ptr readnone %state) local_unnamed_addr #11 {
  %buf = getelementptr i8, ptr %state, i64 8
  ret ptr %buf
}

; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @callee_buf(ptr readnone %state) local_unnamed_addr #11 {
  %buf = getelementptr i8, ptr %state, i64 32
  ret ptr %buf
}

; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @copy_slot(ptr readnone %state) local_unnamed_addr #11 {
  %copy = getelementptr i8, ptr %state, i64 56
  ret ptr %copy
}

; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @top_slot(ptr readnone %state) local_unnamed_addr #11 {
  %slot = getelementptr i8, ptr %state, i64 80
  ret ptr %slot
}

; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @fn_slot(ptr readnone %state) local_unnamed_addr #11 {
  %slot = getelementptr i8, ptr %state, i64 88
  ret ptr %slot
}

; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @tramp_slot(ptr readnone %state) local_unnamed_addr #11 {
  %slot = getelementptr i8, ptr %state, i64 96
  ret ptr %slot
}

; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @args_slot(ptr readnone %state) local_unnamed_addr #11 {
...
define ptr @fn_of(ptr nocapture readonly %state) local_unnamed_addr #12 {
...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read)
define ptr @tramp_of(ptr nocapture readonly %state) local_unnamed_addr #12 {
...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @started_slot(ptr readnone %state) local_unnamed_addr #11 {
...
define void @mark_started(ptr nocapture writeonly %state) local_unnamed_addr #13 {
...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @done_slot(ptr readnone %state) local_unnamed_addr #11 {
  %slot = getelementptr i8, ptr %state, i64 113
  ret ptr %slot
}

; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @mark_done(ptr nocapture writeonly %state) local_unnamed_addr #13 {
...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @frame_size_slot(ptr readnone %state) local_unnamed_addr #11 {
  %slot = getelementptr i8, ptr %state, i64 120
  ret ptr %slot
}

; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @copy_in_bottom_slot(ptr readnone %state) local_unnamed_addr #11 {
  %slot = getelementptr i8, ptr %state, i64 128
  ret ptr %slot
}

; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @copy_in_top_slot(ptr readnone %state) local_unnamed_addr #11 {
...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define ptr @ptr_add(ptr %base, i64 %offset) local_unnamed_addr #11 {
...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read)
define ptr @load_context_sp(ptr nocapture readonly %buf) local_unnamed_addr #12 {
...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @store_context_sp(ptr nocapture writeonly %buf, ptr %sp) local_unnamed_addr #13 {
  %slot = getelementptr i8, ptr %buf, i64 16
...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @save_context(ptr nocapture writeonly %buf, ptr %sp, ptr %fp) local_unnamed_addr #13 {
...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @init_coroutine(ptr nocapture writeonly %state, ptr %fn, ptr %tramp) local_unnamed_addr #13 {
...
define void @enter_coroutine(ptr %state) local_unnamed_addr #14 {
...
define void @leave_coroutine() local_unnamed_addr #15 {
  %active = tail call align 8 ptr @llvm.threadlocal.address.p0(ptr @active_coroutine) #35
...
define ptr @load_prepare_top() local_unnamed_addr #16 {
...
define void @save_frame_copy(ptr nocapture readonly %copy, ptr nocapture readonly %bottom_sp, i64 %size) local_unnamed_addr #19 {
  %buf = load ptr, ptr %copy, align 8
...
; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define void @commit_stack(ptr nocapture readnone %sp, i64 %size) local_unnamed_addr #11 {
exit:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: none, inaccessiblemem: none)
define i64 @observe_sink() local_unnamed_addr #20 {
...
define i64 @copy_rest_inner(ptr %state, ptr nocapture readonly %copy, ptr %top_sp, i64 %frame_size, i64 %size) local_unnamed_addr #21 {
...
define void @copy_rest(ptr %state) local_unnamed_addr #22 {
entry:
...
do_copy:                                          ; preds = %entry
  ...
  %rest_size = tail call i64 @copy_rest_inner(ptr nonnull %state, ptr %copy.i, ptr %top_sp, i64 %frame_size, i64 %size) #37
  br label %exit
...
define void @coro_yield_slow(ptr %sp, ptr %state, ptr %frame_top, ptr %caller_buf, ptr nocapture %callee_copy, ptr %caller_sp) local_unnamed_addr #24 {
entry:
...
do_full_copy:                                     ; preds = %entry
  %size_slot.i4 = getelementptr i8, ptr %state, i64 64
  %size.i5 = load i64, ptr %size_slot.i4, align 8
  %zero_frame.i = icmp eq i64 %saved_frame_size, 0
  %full_frame.i = icmp uge i64 %saved_frame_size, %size.i5
  %skip.i = or i1 %zero_frame.i, %full_frame.i
  br i1 %skip.i, label %copy_rest.exit, label %do_copy.i

do_copy.i:                                        ; preds = %do_full_copy
  %slot.i.i = getelementptr i8, ptr %state, i64 80
  %copy.i.i = getelementptr i8, ptr %state, i64 56
  %top_sp.i = load ptr, ptr %slot.i.i, align 8
  %rest_size.i = tail call i64 @copy_rest_inner(ptr nonnull %state, ptr %copy.i.i, ptr %top_sp.i, i64 %saved_frame_size, i64 %size.i5) #37
  br label %copy_rest.exit

copy_rest.exit:                                   ; preds = %do_full_copy, %do_copy.i
  %token.i = phi i64 [ 0, %do_full_copy ], [ %rest_size.i, %do_copy.i ]
  %sink.i = tail call align 8 ptr @llvm.threadlocal.address.p0(ptr @sink) #35
  store i64 %token.i, ptr %sink.i, align 8
...
alloc.i.i:                                        ; preds = %copy_rest.exit
...
save_copy.exit:                                   ; preds = %copy_rest.exit, %alloc.i.i
  %result.i.i = phi ptr [ %new_buf.i.i, %alloc.i.i ], [ %buf.i.i, %copy_rest.exit ]
...
do_full_copy.i:                                   ; preds = %slow
  %size_slot.i4.i = getelementptr i8, ptr %state, i64 64
  %size.i5.i = load i64, ptr %size_slot.i4.i, align 8
  %zero_frame.i.i = icmp eq i64 %saved_frame_size.i, 0
  %full_frame.i.i = icmp uge i64 %saved_frame_size.i, %size.i5.i
  %skip.i.i = or i1 %zero_frame.i.i, %full_frame.i.i
  br i1 %skip.i.i, label %copy_rest.exit.i, label %do_copy.i.i

do_copy.i.i:                                      ; preds = %do_full_copy.i
  %slot.i.i.i = getelementptr i8, ptr %state, i64 80
  %top_sp.i.i = load ptr, ptr %slot.i.i.i, align 8
  %rest_size.i.i = call i64 @copy_rest_inner(ptr nonnull %state, ptr %copy.i, ptr %top_sp.i.i, i64 %saved_frame_size.i, i64 %size.i5.i) #37
  br label %copy_rest.exit.i

copy_rest.exit.i:                                 ; preds = %do_copy.i.i, %do_full_copy.i
  %token.i.i = phi i64 [ 0, %do_full_copy.i ], [ %rest_size.i.i, %do_copy.i.i ]
  store i64 %token.i.i, ptr %sink, align 8
  %top_i.i.i.i = ptrtoint ptr %sp.i to i64
  %size.i.i.i = sub i64 %top_i.i.i.i, %bottom_i.i.i
  store i64 %size.i.i.i, ptr %size_slot.i4.i, align 8
...
alloc.i.i.i:                                      ; preds = %copy_rest.exit.i
...
save_copy.exit.i:                                 ; preds = %alloc.i.i.i, %copy_rest.exit.i
  %result.i.i.i = phi ptr [ %new_buf.i.i.i, %alloc.i.i.i ], [ %buf.i.i.i, %copy_rest.exit.i ]
...
exit:                                             ; preds = %0
  ...
  %zero_frame.i = icmp eq ptr %frame_top, %sp
  %full_frame.i = icmp uge i64 %size.i, %size.i5
  %skip.i = or i1 %zero_frame.i, %full_frame.i
  br i1 %skip.i, label %copy_rest.exit, label %do_copy.i
...
do_copy.i:                                        ; preds = %exit
  ...
  %copy.i.i = getelementptr i8, ptr %state, i64 56
  %top_sp.i = load ptr, ptr %slot.i.i, align 8
  %rest_size.i = call i64 @copy_rest_inner(ptr nonnull %state, ptr %copy.i.i, ptr %top_sp.i, i64 %size.i, i64 %size.i5) #37
  br label %copy_rest.exit
...
define i32 @yielding_fn(i32 %n) local_unnamed_addr #4 {
  %new_slot.i.i107 = alloca [3 x ptr], align 8
  ...
  %active.i108 = tail call align 8 ptr @llvm.threadlocal.address.p0(ptr @active_coroutine) #35
  %state.i109 = load ptr, ptr %active.i108, align 8
  %sp.i110 = tail call ptr @llvm.stacksave.p0() #35
  %frame_top.i111 = tail call ptr @llvm.addressofreturnaddress.p0() #35
  %sink.i112 = tail call align 8 ptr @llvm.threadlocal.address.p0(ptr @sink) #35
  %buf.i1.i113 = getelementptr i8, ptr %state.i109, i64 32
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %new_slot.i.i107)
  %local_ip_slot.i.i114 = getelementptr inbounds i8, ptr %new_slot.i.i107, i64 8
  %buf_ip_slot.i.i115 = getelementptr i8, ptr %state.i109, i64 40
  %flag.i.i116 = call i32 @llvm.eh.sjlj.setjmp(ptr nonnull %new_slot.i.i107) #32
  %ip.i.i117 = load ptr, ptr %local_ip_slot.i.i114, align 8
  store ptr %ip.i.i117, ptr %buf_ip_slot.i.i115, align 8
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %new_slot.i.i107)
  store i64 0, ptr %sink.i112, align 8
  %do_yield.i118 = icmp eq i32 %flag.i.i116, 0
  br i1 %do_yield.i118, label %yield.i140, label %exit.i119

yield.i140:                                       ; preds = %0
  %fp.i141 = tail call ptr @llvm.localaddress() #35
  %slot_2.i.i142 = getelementptr i8, ptr %state.i109, i64 48
  store ptr %fp.i141, ptr %buf.i1.i113, align 8
  store ptr %sp.i110, ptr %slot_2.i.i142, align 8
  %buf.i.i143 = getelementptr i8, ptr %state.i109, i64 8
  %copy.i.i144 = getelementptr i8, ptr %state.i109, i64 56
  %slot.i4.i145 = getelementptr i8, ptr %state.i109, i64 24
  %sp.i.i146 = load ptr, ptr %slot.i4.i145, align 8
  %same_sp.i147 = icmp eq ptr %sp.i.i146, %sp.i110
  br i1 %same_sp.i147, label %do_jmp.i202, label %slow.i148

slow.i148:                                        ; preds = %yield.i140
  %top_i.i.i.i149 = ptrtoint ptr %frame_top.i111 to i64
  %bottom_i.i.i.i150 = ptrtoint ptr %sp.i110 to i64
  %size.i.i.i151 = sub i64 %top_i.i.i.i149, %bottom_i.i.i.i150
  %slot.i1.i6.i152 = getelementptr i8, ptr %state.i109, i64 120
  %saved_frame_size.i.i153 = load i64, ptr %slot.i1.i6.i152, align 8
  %slot.i2.i.i154 = getelementptr i8, ptr %state.i109, i64 128
  %slot.i3.i.i155 = getelementptr i8, ptr %state.i109, i64 136
  %copy_in_bottom.i.i156 = load ptr, ptr %slot.i2.i.i154, align 8
  %copy_in_top.i.i157 = load ptr, ptr %slot.i3.i.i155, align 8
  %same_bottom.i.i158 = icmp eq ptr %copy_in_bottom.i.i156, %sp.i110
  %same_top.i.i159 = icmp eq ptr %copy_in_top.i.i157, %frame_top.i111
  %same_size.i.i160 = icmp eq i64 %saved_frame_size.i.i153, %size.i.i.i151
  %same_top_bottom.i.i161 = and i1 %same_bottom.i.i158, %same_top.i.i159
  %same_frame.i.i162 = and i1 %same_size.i.i160, %same_top_bottom.i.i161
  br i1 %same_frame.i.i162, label %do_frame_copy.i.i200, label %do_full_copy.i.i163

do_frame_copy.i.i200:                             ; preds = %slow.i148
  %buf.i.i.i201 = load ptr, ptr %copy.i.i144, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %buf.i.i.i201, ptr align 1 %sp.i110, i64 %size.i.i.i151, i1 false) #36
  br label %do_jmp.i.i194

do_full_copy.i.i163:                              ; preds = %slow.i148
  %size_slot.i4.i.i165 = getelementptr i8, ptr %state.i109, i64 64
  %size.i5.i.i166 = load i64, ptr %size_slot.i4.i.i165, align 8
  %zero_frame.i.i.i170 = icmp eq i64 %saved_frame_size.i.i153, 0
  %full_frame.i.i.i171 = icmp uge i64 %saved_frame_size.i.i153, %size.i5.i.i166
  %skip.i.i.i172 = or i1 %zero_frame.i.i.i170, %full_frame.i.i.i171
  br i1 %skip.i.i.i172, label %copy_rest.exit.i.i176, label %do_copy.i.i.i173

do_copy.i.i.i173:                                 ; preds = %do_full_copy.i.i163
  %slot.i.i.i.i169 = getelementptr i8, ptr %state.i109, i64 80
  %top_sp.i.i.i174 = load ptr, ptr %slot.i.i.i.i169, align 8
  %rest_size.i.i.i175 = call i64 @copy_rest_inner(ptr nonnull %state.i109, ptr %copy.i.i144, ptr %top_sp.i.i.i174, i64 %saved_frame_size.i.i153, i64 %size.i5.i.i166) #37
  br label %copy_rest.exit.i.i176

copy_rest.exit.i.i176:                            ; preds = %do_copy.i.i.i173, %do_full_copy.i.i163
  %token.i.i.i177 = phi i64 [ 0, %do_full_copy.i.i163 ], [ %rest_size.i.i.i175, %do_copy.i.i.i173 ]
  store i64 %token.i.i.i177, ptr %sink.i112, align 8
  %top_i.i.i.i.i179 = ptrtoint ptr %sp.i.i146 to i64
  %size.i.i.i.i181 = sub i64 %top_i.i.i.i.i179, %bottom_i.i.i.i150
  store i64 %size.i.i.i.i181, ptr %size_slot.i4.i.i165, align 8
  %buf.i.i.i.i184 = load ptr, ptr %copy.i.i144, align 8
  %capacity_slot.i.i.i.i185 = getelementptr i8, ptr %state.i109, i64 72
  %capacity.i.i.i.i186 = load i64, ptr %capacity_slot.i.i.i.i185, align 8
  %missing.i.i.i.i187 = icmp eq ptr %buf.i.i.i.i184, null
  %not_enough.i.i.i.i188 = icmp ult i64 %capacity.i.i.i.i186, %size.i.i.i.i181
  %would_need_alloc.i.i.i.i189 = or i1 %missing.i.i.i.i187, %not_enough.i.i.i.i188
  br i1 %would_need_alloc.i.i.i.i189, label %alloc.i.i.i.i198, label %save_copy.exit.i.i191

alloc.i.i.i.i198:                                 ; preds = %copy_rest.exit.i.i176
  %new_buf.i.i.i.i199 = call ptr @malloc(i64 %size.i.i.i.i181)
  store ptr %new_buf.i.i.i.i199, ptr %copy.i.i144, align 8
  store i64 %size.i.i.i.i181, ptr %capacity_slot.i.i.i.i185, align 8
  br label %save_copy.exit.i.i191

save_copy.exit.i.i191:                            ; preds = %alloc.i.i.i.i198, %copy_rest.exit.i.i176
  %result.i.i.i.i192 = phi ptr [ %new_buf.i.i.i.i199, %alloc.i.i.i.i198 ], [ %buf.i.i.i.i184, %copy_rest.exit.i.i176 ]
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %result.i.i.i.i192, ptr align 1 %sp.i110, i64 %size.i.i.i.i181, i1 false) #36
  store i64 %size.i.i.i151, ptr %slot.i1.i6.i152, align 8
  br label %do_jmp.i.i194

do_jmp.i.i194:                                    ; preds = %save_copy.exit.i.i191, %do_frame_copy.i.i200
  %prev.i.i.i197 = load ptr, ptr %state.i109, align 8
  store ptr %prev.i.i.i197, ptr %active.i108, align 8
  call void @llvm.eh.sjlj.longjmp(ptr %buf.i.i143) #31
  unreachable

do_jmp.i202:                                      ; preds = %yield.i140
  %prev.i.i205 = load ptr, ptr %state.i109, align 8
  store ptr %prev.i.i205, ptr %active.i108, align 8
  call void @llvm.eh.sjlj.longjmp(ptr %buf.i.i143) #31
  unreachable

exit.i119:                                        ; preds = %0
  %slot.i2.i120 = getelementptr i8, ptr %state.i109, i64 128
  %slot.i3.i121 = getelementptr i8, ptr %state.i109, i64 136
  %slot.i.i122 = getelementptr i8, ptr %state.i109, i64 120
  %top_i.i.i123 = ptrtoint ptr %frame_top.i111 to i64
  %bottom_i.i.i124 = ptrtoint ptr %sp.i110 to i64
  %size.i.i125 = sub i64 %top_i.i.i123, %bottom_i.i.i124
  store ptr %sp.i110, ptr %slot.i2.i120, align 8
  store ptr %frame_top.i111, ptr %slot.i3.i121, align 8
  store i64 %size.i.i125, ptr %slot.i.i122, align 8
  %copy.i.i.i126 = getelementptr i8, ptr %state.i109, i64 56
  %size_slot.i.i127 = getelementptr i8, ptr %state.i109, i64 64
  %size.i5.i128 = load i64, ptr %size_slot.i.i127, align 8
  %slot.i.i.i131 = getelementptr i8, ptr %state.i109, i64 80
  %zero_frame.i.i132 = icmp eq ptr %frame_top.i111, %sp.i110
  %full_frame.i.i133 = icmp uge i64 %size.i.i125, %size.i5.i128
  %skip.i.i134 = or i1 %zero_frame.i.i132, %full_frame.i.i133
  %n1 = add i32 %n, 1
  ...
  %local_ip_slot.i.i14 = getelementptr inbounds i8, ptr %new_slot.i.i7, i64 8
  %flag.i.i16 = call i32 @llvm.eh.sjlj.setjmp(ptr nonnull %new_slot.i.i7) #32
  %ip.i.i17 = load ptr, ptr %local_ip_slot.i.i14, align 8
  store ptr %ip.i.i17, ptr %buf_ip_slot.i.i115, align 8
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %new_slot.i.i7)
  store i64 0, ptr %sink.i112, align 8
  %do_yield.i18 = icmp eq i32 %flag.i.i16, 0
  br i1 %do_yield.i18, label %yield.i40, label %exit.i19

yield.i40:                                        ; preds = %exit.i119
  %fp.i41 = tail call ptr @llvm.localaddress() #35
  %slot_2.i.i42 = getelementptr i8, ptr %state.i109, i64 48
  store ptr %fp.i41, ptr %buf.i1.i113, align 8
  store ptr %sp.i110, ptr %slot_2.i.i42, align 8
  %buf.i.i43 = getelementptr i8, ptr %state.i109, i64 8
  %slot.i4.i45 = getelementptr i8, ptr %state.i109, i64 24
  %sp.i.i46 = load ptr, ptr %slot.i4.i45, align 8
  %same_sp.i47 = icmp eq ptr %sp.i.i46, %sp.i110
  br i1 %same_sp.i47, label %do_jmp.i102, label %do_jmp.i.i94

do_jmp.i.i94:                                     ; preds = %yield.i40
  %buf.i.i.i101 = load ptr, ptr %copy.i.i.i126, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %buf.i.i.i101, ptr align 1 %sp.i110, i64 %size.i.i125, i1 false) #36
  %prev.i.i.i97.pre = load ptr, ptr %state.i109, align 8
  store ptr %prev.i.i.i97.pre, ptr %active.i108, align 8
  call void @llvm.eh.sjlj.longjmp(ptr %buf.i.i43) #31
  unreachable

do_jmp.i102:                                      ; preds = %yield.i40
  %prev.i.i105 = load ptr, ptr %state.i109, align 8
  store ptr %prev.i.i105, ptr %active.i108, align 8
  call void @llvm.eh.sjlj.longjmp(ptr %buf.i.i43) #31
  unreachable

exit.i19:                                         ; preds = %exit.i119
  store ptr %sp.i110, ptr %slot.i2.i120, align 8
  store ptr %frame_top.i111, ptr %slot.i3.i121, align 8
  store i64 %size.i.i125, ptr %slot.i.i122, align 8
  %n2 = add i32 %n, 2
  ...
  store ptr %ip.i.i, ptr %buf_ip_slot.i.i115, align 8
...
yield.i:                                          ; preds = %exit.i19
  %fp.i = tail call ptr @llvm.localaddress() #35
  %slot_2.i.i = getelementptr i8, ptr %state.i109, i64 48
  store ptr %fp.i, ptr %buf.i1.i113, align 8
  store ptr %sp.i110, ptr %slot_2.i.i, align 8
  %buf.i.i = getelementptr i8, ptr %state.i109, i64 8
  %slot.i4.i = getelementptr i8, ptr %state.i109, i64 24
  %sp.i.i = load ptr, ptr %slot.i4.i, align 8
  %same_sp.i = icmp eq ptr %sp.i.i, %sp.i110
  br i1 %same_sp.i, label %do_jmp.i, label %do_jmp.i.i

do_jmp.i.i:                                       ; preds = %yield.i
  %buf.i.i.i = load ptr, ptr %copy.i.i.i126, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %buf.i.i.i, ptr align 1 %sp.i110, i64 %size.i.i125, i1 false) #36
  %prev.i.i.i.pre = load ptr, ptr %state.i109, align 8
  store ptr %prev.i.i.i.pre, ptr %active.i108, align 8
  call void @llvm.eh.sjlj.longjmp(ptr %buf.i.i) #31
  unreachable

do_jmp.i:                                         ; preds = %yield.i
  %prev.i.i = load ptr, ptr %state.i109, align 8
  store ptr %prev.i.i, ptr %active.i108, align 8
  call void @llvm.eh.sjlj.longjmp(ptr %buf.i.i) #31
  unreachable

exit.i:                                           ; preds = %exit.i19
  store ptr %sp.i110, ptr %slot.i2.i120, align 8
  store ptr %frame_top.i111, ptr %slot.i3.i121, align 8
  store i64 %size.i.i125, ptr %slot.i.i122, align 8
  br i1 %skip.i.i134, label %coro_yield.exit, label %do_copy.i.i

do_copy.i.i:                                      ; preds = %exit.i
  %top_sp.i.i = load ptr, ptr %slot.i.i.i131, align 8
  %rest_size.i.i = call i64 @copy_rest_inner(ptr nonnull %state.i109, ptr %copy.i.i.i126, ptr %top_sp.i.i, i64 %size.i.i125, i64 %size.i5.i128) #37
  br label %coro_yield.exit

coro_yield.exit:                                  ; preds = %exit.i, %do_copy.i.i
  %token.i.i = phi i64 [ 0, %exit.i ], [ %rest_size.i.i, %do_copy.i.i ]
  store i64 %token.i.i, ptr %sink.i112, align 8
  %n3 = add i32 %n, 3
...
define i32 @passthru_fn(i32 %n) #4 {
  %new_slot.i.i107.i = alloca [3 x ptr], align 8
  ...
  %active.i108.i = tail call align 8 ptr @llvm.threadlocal.address.p0(ptr @active_coroutine) #35
  %state.i109.i = load ptr, ptr %active.i108.i, align 8
  %sp.i110.i = tail call ptr @llvm.stacksave.p0() #35
  %frame_top.i111.i = tail call ptr @llvm.addressofreturnaddress.p0() #35
  %sink.i112.i = tail call align 8 ptr @llvm.threadlocal.address.p0(ptr @sink) #35
  %buf.i1.i113.i = getelementptr i8, ptr %state.i109.i, i64 32
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %new_slot.i.i107.i)
  %local_ip_slot.i.i114.i = getelementptr inbounds i8, ptr %new_slot.i.i107.i, i64 8
  %buf_ip_slot.i.i115.i = getelementptr i8, ptr %state.i109.i, i64 40
  %flag.i.i116.i = call i32 @llvm.eh.sjlj.setjmp(ptr nonnull %new_slot.i.i107.i) #32
  %ip.i.i117.i = load ptr, ptr %local_ip_slot.i.i114.i, align 8
  store ptr %ip.i.i117.i, ptr %buf_ip_slot.i.i115.i, align 8
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %new_slot.i.i107.i)
  store i64 0, ptr %sink.i112.i, align 8
  %do_yield.i118.i = icmp eq i32 %flag.i.i116.i, 0
  br i1 %do_yield.i118.i, label %yield.i140.i, label %exit.i119.i

yield.i140.i:                                     ; preds = %0
  %fp.i141.i = tail call ptr @llvm.localaddress() #35
  %slot_2.i.i142.i = getelementptr i8, ptr %state.i109.i, i64 48
  store ptr %fp.i141.i, ptr %buf.i1.i113.i, align 8
  store ptr %sp.i110.i, ptr %slot_2.i.i142.i, align 8
  %buf.i.i143.i = getelementptr i8, ptr %state.i109.i, i64 8
  %copy.i.i144.i = getelementptr i8, ptr %state.i109.i, i64 56
  %slot.i4.i145.i = getelementptr i8, ptr %state.i109.i, i64 24
  %sp.i.i146.i = load ptr, ptr %slot.i4.i145.i, align 8
  %same_sp.i147.i = icmp eq ptr %sp.i.i146.i, %sp.i110.i
  br i1 %same_sp.i147.i, label %do_jmp.i202.i, label %slow.i148.i

slow.i148.i:                                      ; preds = %yield.i140.i
  %top_i.i.i.i149.i = ptrtoint ptr %frame_top.i111.i to i64
  %bottom_i.i.i.i150.i = ptrtoint ptr %sp.i110.i to i64
  %size.i.i.i151.i = sub i64 %top_i.i.i.i149.i, %bottom_i.i.i.i150.i
  %slot.i1.i6.i152.i = getelementptr i8, ptr %state.i109.i, i64 120
  %saved_frame_size.i.i153.i = load i64, ptr %slot.i1.i6.i152.i, align 8
  %slot.i2.i.i154.i = getelementptr i8, ptr %state.i109.i, i64 128
  %slot.i3.i.i155.i = getelementptr i8, ptr %state.i109.i, i64 136
  %copy_in_bottom.i.i156.i = load ptr, ptr %slot.i2.i.i154.i, align 8
  %copy_in_top.i.i157.i = load ptr, ptr %slot.i3.i.i155.i, align 8
  %same_bottom.i.i158.i = icmp eq ptr %copy_in_bottom.i.i156.i, %sp.i110.i
  %same_top.i.i159.i = icmp eq ptr %copy_in_top.i.i157.i, %frame_top.i111.i
  %same_size.i.i160.i = icmp eq i64 %saved_frame_size.i.i153.i, %size.i.i.i151.i
  %same_top_bottom.i.i161.i = and i1 %same_bottom.i.i158.i, %same_top.i.i159.i
  %same_frame.i.i162.i = and i1 %same_size.i.i160.i, %same_top_bottom.i.i161.i
  br i1 %same_frame.i.i162.i, label %do_frame_copy.i.i200.i, label %do_full_copy.i.i163.i

do_frame_copy.i.i200.i:                           ; preds = %slow.i148.i
  %buf.i.i.i201.i = load ptr, ptr %copy.i.i144.i, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %buf.i.i.i201.i, ptr align 1 %sp.i110.i, i64 %size.i.i.i151.i, i1 false) #36
  br label %do_jmp.i.i194.i

do_full_copy.i.i163.i:                            ; preds = %slow.i148.i
  %size_slot.i4.i.i165.i = getelementptr i8, ptr %state.i109.i, i64 64
  %size.i5.i.i166.i = load i64, ptr %size_slot.i4.i.i165.i, align 8
  %zero_frame.i.i.i170.i = icmp eq i64 %saved_frame_size.i.i153.i, 0
  %full_frame.i.i.i171.i = icmp uge i64 %saved_frame_size.i.i153.i, %size.i5.i.i166.i
  %skip.i.i.i172.i = or i1 %zero_frame.i.i.i170.i, %full_frame.i.i.i171.i
  br i1 %skip.i.i.i172.i, label %copy_rest.exit.i.i176.i, label %do_copy.i.i.i173.i

do_copy.i.i.i173.i:                               ; preds = %do_full_copy.i.i163.i
  %slot.i.i.i.i169.i = getelementptr i8, ptr %state.i109.i, i64 80
  %top_sp.i.i.i174.i = load ptr, ptr %slot.i.i.i.i169.i, align 8
  %rest_size.i.i.i175.i = call i64 @copy_rest_inner(ptr nonnull %state.i109.i, ptr %copy.i.i144.i, ptr %top_sp.i.i.i174.i, i64 %saved_frame_size.i.i153.i, i64 %size.i5.i.i166.i) #37
  br label %copy_rest.exit.i.i176.i

copy_rest.exit.i.i176.i:                          ; preds = %do_copy.i.i.i173.i, %do_full_copy.i.i163.i
  %token.i.i.i177.i = phi i64 [ 0, %do_full_copy.i.i163.i ], [ %rest_size.i.i.i175.i, %do_copy.i.i.i173.i ]
  store i64 %token.i.i.i177.i, ptr %sink.i112.i, align 8
  %top_i.i.i.i.i179.i = ptrtoint ptr %sp.i.i146.i to i64
  %size.i.i.i.i181.i = sub i64 %top_i.i.i.i.i179.i, %bottom_i.i.i.i150.i
  store i64 %size.i.i.i.i181.i, ptr %size_slot.i4.i.i165.i, align 8
  %buf.i.i.i.i184.i = load ptr, ptr %copy.i.i144.i, align 8
  %capacity_slot.i.i.i.i185.i = getelementptr i8, ptr %state.i109.i, i64 72
  %capacity.i.i.i.i186.i = load i64, ptr %capacity_slot.i.i.i.i185.i, align 8
  %missing.i.i.i.i187.i = icmp eq ptr %buf.i.i.i.i184.i, null
  %not_enough.i.i.i.i188.i = icmp ult i64 %capacity.i.i.i.i186.i, %size.i.i.i.i181.i
  %would_need_alloc.i.i.i.i189.i = or i1 %missing.i.i.i.i187.i, %not_enough.i.i.i.i188.i
  br i1 %would_need_alloc.i.i.i.i189.i, label %alloc.i.i.i.i198.i, label %save_copy.exit.i.i191.i

alloc.i.i.i.i198.i:                               ; preds = %copy_rest.exit.i.i176.i
  %new_buf.i.i.i.i199.i = call ptr @malloc(i64 %size.i.i.i.i181.i)
  store ptr %new_buf.i.i.i.i199.i, ptr %copy.i.i144.i, align 8
  store i64 %size.i.i.i.i181.i, ptr %capacity_slot.i.i.i.i185.i, align 8
  br label %save_copy.exit.i.i191.i

save_copy.exit.i.i191.i:                          ; preds = %alloc.i.i.i.i198.i, %copy_rest.exit.i.i176.i
  %result.i.i.i.i192.i = phi ptr [ %new_buf.i.i.i.i199.i, %alloc.i.i.i.i198.i ], [ %buf.i.i.i.i184.i, %copy_rest.exit.i.i176.i ]
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %result.i.i.i.i192.i, ptr align 1 %sp.i110.i, i64 %size.i.i.i.i181.i, i1 false) #36
  store i64 %size.i.i.i151.i, ptr %slot.i1.i6.i152.i, align 8
  br label %do_jmp.i.i194.i

do_jmp.i.i194.i:                                  ; preds = %save_copy.exit.i.i191.i, %do_frame_copy.i.i200.i
  %prev.i.i.i197.i = load ptr, ptr %state.i109.i, align 8
  store ptr %prev.i.i.i197.i, ptr %active.i108.i, align 8
  call void @llvm.eh.sjlj.longjmp(ptr %buf.i.i143.i) #31
  unreachable

do_jmp.i202.i:                                    ; preds = %yield.i140.i
  %prev.i.i205.i = load ptr, ptr %state.i109.i, align 8
  store ptr %prev.i.i205.i, ptr %active.i108.i, align 8
  call void @llvm.eh.sjlj.longjmp(ptr %buf.i.i143.i) #31
  unreachable

exit.i119.i:                                      ; preds = %0
  %slot.i2.i120.i = getelementptr i8, ptr %state.i109.i, i64 128
  %slot.i3.i121.i = getelementptr i8, ptr %state.i109.i, i64 136
  %slot.i.i122.i = getelementptr i8, ptr %state.i109.i, i64 120
  %top_i.i.i123.i = ptrtoint ptr %frame_top.i111.i to i64
  %bottom_i.i.i124.i = ptrtoint ptr %sp.i110.i to i64
  %size.i.i125.i = sub i64 %top_i.i.i123.i, %bottom_i.i.i124.i
  store ptr %sp.i110.i, ptr %slot.i2.i120.i, align 8
  store ptr %frame_top.i111.i, ptr %slot.i3.i121.i, align 8
  store i64 %size.i.i125.i, ptr %slot.i.i122.i, align 8
  %copy.i.i.i126.i = getelementptr i8, ptr %state.i109.i, i64 56
  %size_slot.i.i127.i = getelementptr i8, ptr %state.i109.i, i64 64
  %size.i5.i128.i = load i64, ptr %size_slot.i.i127.i, align 8
  %slot.i.i.i131.i = getelementptr i8, ptr %state.i109.i, i64 80
  %zero_frame.i.i132.i = icmp eq ptr %frame_top.i111.i, %sp.i110.i
  %full_frame.i.i133.i = icmp uge i64 %size.i.i125.i, %size.i5.i128.i
  %skip.i.i134.i = or i1 %zero_frame.i.i132.i, %full_frame.i.i133.i
  %n1.i = add i32 %n, 1
  ...
  %local_ip_slot.i.i14.i = getelementptr inbounds i8, ptr %new_slot.i.i7.i, i64 8
  %flag.i.i16.i = call i32 @llvm.eh.sjlj.setjmp(ptr nonnull %new_slot.i.i7.i) #32
  %ip.i.i17.i = load ptr, ptr %local_ip_slot.i.i14.i, align 8
  store ptr %ip.i.i17.i, ptr %buf_ip_slot.i.i115.i, align 8
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %new_slot.i.i7.i)
  store i64 0, ptr %sink.i112.i, align 8
  %do_yield.i18.i = icmp eq i32 %flag.i.i16.i, 0
  br i1 %do_yield.i18.i, label %yield.i40.i, label %exit.i19.i

yield.i40.i:                                      ; preds = %exit.i119.i
  %fp.i41.i = tail call ptr @llvm.localaddress() #35
  %slot_2.i.i42.i = getelementptr i8, ptr %state.i109.i, i64 48
  store ptr %fp.i41.i, ptr %buf.i1.i113.i, align 8
  store ptr %sp.i110.i, ptr %slot_2.i.i42.i, align 8
  %buf.i.i43.i = getelementptr i8, ptr %state.i109.i, i64 8
  %slot.i4.i45.i = getelementptr i8, ptr %state.i109.i, i64 24
  %sp.i.i46.i = load ptr, ptr %slot.i4.i45.i, align 8
  %same_sp.i47.i = icmp eq ptr %sp.i.i46.i, %sp.i110.i
  br i1 %same_sp.i47.i, label %do_jmp.i102.i, label %do_jmp.i.i94.i

do_jmp.i.i94.i:                                   ; preds = %yield.i40.i
  %buf.i.i.i101.i = load ptr, ptr %copy.i.i.i126.i, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %buf.i.i.i101.i, ptr align 1 %sp.i110.i, i64 %size.i.i125.i, i1 false) #36
  %prev.i.i.i97.pre.i = load ptr, ptr %state.i109.i, align 8
  store ptr %prev.i.i.i97.pre.i, ptr %active.i108.i, align 8
  call void @llvm.eh.sjlj.longjmp(ptr %buf.i.i43.i) #31
  unreachable

do_jmp.i102.i:                                    ; preds = %yield.i40.i
  %prev.i.i105.i = load ptr, ptr %state.i109.i, align 8
  store ptr %prev.i.i105.i, ptr %active.i108.i, align 8
  call void @llvm.eh.sjlj.longjmp(ptr %buf.i.i43.i) #31
  unreachable

exit.i19.i:                                       ; preds = %exit.i119.i
  store ptr %sp.i110.i, ptr %slot.i2.i120.i, align 8
  store ptr %frame_top.i111.i, ptr %slot.i3.i121.i, align 8
  store i64 %size.i.i125.i, ptr %slot.i.i122.i, align 8
  %n2.i = add i32 %n, 2
  ...
  store ptr %ip.i.i.i, ptr %buf_ip_slot.i.i115.i, align 8
...
yield.i.i:                                        ; preds = %exit.i19.i
  %fp.i.i = tail call ptr @llvm.localaddress() #35
  %slot_2.i.i.i = getelementptr i8, ptr %state.i109.i, i64 48
  store ptr %fp.i.i, ptr %buf.i1.i113.i, align 8
  store ptr %sp.i110.i, ptr %slot_2.i.i.i, align 8
  %buf.i.i.i = getelementptr i8, ptr %state.i109.i, i64 8
  %slot.i4.i.i = getelementptr i8, ptr %state.i109.i, i64 24
  %sp.i.i.i = load ptr, ptr %slot.i4.i.i, align 8
  %same_sp.i.i = icmp eq ptr %sp.i.i.i, %sp.i110.i
  br i1 %same_sp.i.i, label %do_jmp.i.i, label %do_jmp.i.i.i

do_jmp.i.i.i:                                     ; preds = %yield.i.i
  %buf.i.i.i.i = load ptr, ptr %copy.i.i.i126.i, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %buf.i.i.i.i, ptr align 1 %sp.i110.i, i64 %size.i.i125.i, i1 false) #36
  %prev.i.i.i.pre.i = load ptr, ptr %state.i109.i, align 8
  store ptr %prev.i.i.i.pre.i, ptr %active.i108.i, align 8
  call void @llvm.eh.sjlj.longjmp(ptr %buf.i.i.i) #31
  unreachable

do_jmp.i.i:                                       ; preds = %yield.i.i
  %prev.i.i.i = load ptr, ptr %state.i109.i, align 8
  store ptr %prev.i.i.i, ptr %active.i108.i, align 8
  call void @llvm.eh.sjlj.longjmp(ptr %buf.i.i.i) #31
  unreachable

exit.i.i:                                         ; preds = %exit.i19.i
  store ptr %sp.i110.i, ptr %slot.i2.i120.i, align 8
  store ptr %frame_top.i111.i, ptr %slot.i3.i121.i, align 8
  store i64 %size.i.i125.i, ptr %slot.i.i122.i, align 8
  br i1 %skip.i.i134.i, label %yielding_fn.exit, label %do_copy.i.i.i

do_copy.i.i.i:                                    ; preds = %exit.i.i
  %top_sp.i.i.i = load ptr, ptr %slot.i.i.i131.i, align 8
  %rest_size.i.i.i = call i64 @copy_rest_inner(ptr nonnull %state.i109.i, ptr %copy.i.i.i126.i, ptr %top_sp.i.i.i, i64 %size.i.i125.i, i64 %size.i5.i128.i) #37
...
yielding_fn.exit:                                 ; preds = %exit.i.i, %do_copy.i.i.i
  ...
  store i64 %token.i.i.i, ptr %sink.i112.i, align 8
  %n3.i = add i32 %n, 3
...
define void @calling_fn(i32 %n) local_unnamed_addr #26 {
  %new_slot.i.i107.i.i = alloca [3 x ptr], align 8
...
start.i:                                          ; preds = %0
  ...
  %frame_top.i111.i.i = tail call ptr @llvm.addressofreturnaddress.p0() #35
  %sink.i112.i.i = call align 8 ptr @llvm.threadlocal.address.p0(ptr @sink) #35
  %buf.i1.i113.i.i = getelementptr inbounds i8, ptr %state, i64 32
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %new_slot.i.i107.i.i)
  %local_ip_slot.i.i114.i.i = getelementptr inbounds i8, ptr %new_slot.i.i107.i.i, i64 8
  %buf_ip_slot.i.i115.i.i = getelementptr inbounds i8, ptr %state, i64 40
  %flag.i.i116.i.i = call i32 @llvm.eh.sjlj.setjmp(ptr nonnull %new_slot.i.i107.i.i) #32
  %ip.i.i117.i.i = load ptr, ptr %local_ip_slot.i.i114.i.i, align 8
  store ptr %ip.i.i117.i.i, ptr %buf_ip_slot.i.i115.i.i, align 8
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %new_slot.i.i107.i.i)
  store i64 0, ptr %sink.i112.i.i, align 8
  %do_yield.i118.i.i = icmp eq i32 %flag.i.i116.i.i, 0
  br i1 %do_yield.i118.i.i, label %do_jmp.i202.i.i, label %exit.i119.i.i

do_jmp.i202.i.i:                                  ; preds = %start.i
  %slot_2.i.i142.i.i = getelementptr inbounds i8, ptr %state, i64 48
  store ptr %fp.i9, ptr %buf.i1.i113.i.i, align 8
  store ptr %sp.i8, ptr %slot_2.i.i142.i.i, align 8
  store ptr %prev.i7.i, ptr %active.i6.i, align 8
  call void @llvm.eh.sjlj.longjmp(ptr nonnull %buf.i.i7) #31
  unreachable

exit.i119.i.i:                                    ; preds = %start.i
  %slot.i2.i120.i.i = getelementptr inbounds i8, ptr %state, i64 128
  %slot.i3.i121.i.i = getelementptr inbounds i8, ptr %state, i64 136
  %top_i.i.i123.i.i = ptrtoint ptr %frame_top.i111.i.i to i64
  %bottom_i.i.i124.i.i = ptrtoint ptr %sp.i8 to i64
  %size.i.i125.i.i = sub i64 %top_i.i.i123.i.i, %bottom_i.i.i124.i.i
  store ptr %sp.i8, ptr %slot.i2.i120.i.i, align 8
  store ptr %frame_top.i111.i.i, ptr %slot.i3.i121.i.i, align 8
  store i64 %size.i.i125.i.i, ptr %slot.i5.i, align 8
  %n1.i.i = add i32 %n, 1
  ...
  %local_ip_slot.i.i14.i.i = getelementptr inbounds i8, ptr %new_slot.i.i7.i.i, i64 8
  %flag.i.i16.i.i = call i32 @llvm.eh.sjlj.setjmp(ptr nonnull %new_slot.i.i7.i.i) #32
  %ip.i.i17.i.i = load ptr, ptr %local_ip_slot.i.i14.i.i, align 8
  store ptr %ip.i.i17.i.i, ptr %buf_ip_slot.i.i115.i.i, align 8
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %new_slot.i.i7.i.i)
  store i64 0, ptr %sink.i112.i.i, align 8
  %do_yield.i18.i.i = icmp eq i32 %flag.i.i16.i.i, 0
  br i1 %do_yield.i18.i.i, label %do_jmp.i102.i.i, label %exit.i19.i.i

do_jmp.i102.i.i:                                  ; preds = %exit.i119.i.i
  %slot_2.i.i42.i.i = getelementptr inbounds i8, ptr %state, i64 48
  store ptr %fp.i9, ptr %buf.i1.i113.i.i, align 8
  store ptr %sp.i8, ptr %slot_2.i.i42.i.i, align 8
  store ptr %prev.i7.i, ptr %active.i6.i, align 8
  call void @llvm.eh.sjlj.longjmp(ptr nonnull %buf.i.i7) #31
  unreachable

exit.i19.i.i:                                     ; preds = %exit.i119.i.i
  store ptr %sp.i8, ptr %slot.i2.i120.i.i, align 8
  store ptr %frame_top.i111.i.i, ptr %slot.i3.i121.i.i, align 8
  store i64 %size.i.i125.i.i, ptr %slot.i5.i, align 8
  %n2.i.i = add i32 %n, 2
  ...
  store ptr %ip.i.i.i.i, ptr %buf_ip_slot.i.i115.i.i, align 8
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %new_slot.i.i.i.i)
  store i64 0, ptr %sink.i112.i.i, align 8
  %do_yield.i.i.i = icmp eq i32 %flag.i.i.i.i, 0
  br i1 %do_yield.i.i.i, label %do_jmp.i.i.i, label %passthru_fn.exit

do_jmp.i.i.i:                                     ; preds = %exit.i19.i.i
...
passthru_fn.exit:                                 ; preds = %exit.i19.i.i
  store ptr %sp.i8, ptr %slot.i2.i120.i.i, align 8
  store ptr %frame_top.i111.i.i, ptr %slot.i3.i121.i.i, align 8
  store i64 %size.i.i125.i.i, ptr %slot.i5.i, align 8
  %n3.i.i = add i32 %n, 3
...
define noundef i32 @main() local_unnamed_addr #26 {
  %new_slot.i.i107.i.i.i = alloca [3 x ptr], align 8
...
start.i.i:                                        ; preds = %0
  ...
  %frame_top.i111.i.i.i = tail call ptr @llvm.addressofreturnaddress.p0() #35
  %sink.i112.i.i.i = call align 8 ptr @llvm.threadlocal.address.p0(ptr @sink) #35
  %buf.i1.i113.i.i.i = getelementptr inbounds i8, ptr %state.i, i64 32
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %new_slot.i.i107.i.i.i)
  %local_ip_slot.i.i114.i.i.i = getelementptr inbounds i8, ptr %new_slot.i.i107.i.i.i, i64 8
  %buf_ip_slot.i.i115.i.i.i = getelementptr inbounds i8, ptr %state.i, i64 40
  %flag.i.i116.i.i.i = call i32 @llvm.eh.sjlj.setjmp(ptr nonnull %new_slot.i.i107.i.i.i) #32
  %ip.i.i117.i.i.i = load ptr, ptr %local_ip_slot.i.i114.i.i.i, align 8
  store ptr %ip.i.i117.i.i.i, ptr %buf_ip_slot.i.i115.i.i.i, align 8
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %new_slot.i.i107.i.i.i)
  store i64 0, ptr %sink.i112.i.i.i, align 8
  %do_yield.i118.i.i.i = icmp eq i32 %flag.i.i116.i.i.i, 0
  br i1 %do_yield.i118.i.i.i, label %do_jmp.i202.i.i.i, label %exit.i119.i.i.i

do_jmp.i202.i.i.i:                                ; preds = %start.i.i
  %slot_2.i.i142.i.i.i = getelementptr inbounds i8, ptr %state.i, i64 48
  store ptr %fp.i9.i, ptr %buf.i1.i113.i.i.i, align 8
  store ptr %sp.i8.i, ptr %slot_2.i.i142.i.i.i, align 8
  call void @llvm.eh.sjlj.longjmp(ptr nonnull %buf.i.i7.i) #31
  unreachable

exit.i119.i.i.i:                                  ; preds = %start.i.i
  %slot.i2.i120.i.i.i = getelementptr inbounds i8, ptr %state.i, i64 128
  %slot.i3.i121.i.i.i = getelementptr inbounds i8, ptr %state.i, i64 136
  %top_i.i.i123.i.i.i = ptrtoint ptr %frame_top.i111.i.i.i to i64
  %bottom_i.i.i124.i.i.i = ptrtoint ptr %sp.i8.i to i64
  %size.i.i125.i.i.i = sub i64 %top_i.i.i123.i.i.i, %bottom_i.i.i124.i.i.i
  store ptr %sp.i8.i, ptr %slot.i2.i120.i.i.i, align 8
  store ptr %frame_top.i111.i.i.i, ptr %slot.i3.i121.i.i.i, align 8
  store i64 %size.i.i125.i.i.i, ptr %slot.i5.i.i, align 8
  ...
  %local_ip_slot.i.i14.i.i.i = getelementptr inbounds i8, ptr %new_slot.i.i7.i.i.i, i64 8
  %flag.i.i16.i.i.i = call i32 @llvm.eh.sjlj.setjmp(ptr nonnull %new_slot.i.i7.i.i.i) #32
  %ip.i.i17.i.i.i = load ptr, ptr %local_ip_slot.i.i14.i.i.i, align 8
  store ptr %ip.i.i17.i.i.i, ptr %buf_ip_slot.i.i115.i.i.i, align 8
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %new_slot.i.i7.i.i.i)
  store i64 0, ptr %sink.i112.i.i.i, align 8
  %do_yield.i18.i.i.i = icmp eq i32 %flag.i.i16.i.i.i, 0
  br i1 %do_yield.i18.i.i.i, label %do_jmp.i102.i.i.i, label %exit.i19.i.i.i

do_jmp.i102.i.i.i:                                ; preds = %exit.i119.i.i.i
  %slot_2.i.i42.i.i.i = getelementptr inbounds i8, ptr %state.i, i64 48
  store ptr %fp.i9.i, ptr %buf.i1.i113.i.i.i, align 8
  store ptr %sp.i8.i, ptr %slot_2.i.i42.i.i.i, align 8
  call void @llvm.eh.sjlj.longjmp(ptr nonnull %buf.i.i7.i) #31
  unreachable

exit.i19.i.i.i:                                   ; preds = %exit.i119.i.i.i
  store ptr %sp.i8.i, ptr %slot.i2.i120.i.i.i, align 8
  store ptr %frame_top.i111.i.i.i, ptr %slot.i3.i121.i.i.i, align 8
  store i64 %size.i.i125.i.i.i, ptr %slot.i5.i.i, align 8
  ...
  store ptr %ip.i.i.i.i.i, ptr %buf_ip_slot.i.i115.i.i.i, align 8
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %new_slot.i.i.i.i.i)
  store i64 0, ptr %sink.i112.i.i.i, align 8
  %do_yield.i.i.i.i = icmp eq i32 %flag.i.i.i.i.i, 0
  br i1 %do_yield.i.i.i.i, label %do_jmp.i.i.i.i, label %passthru_fn.exit.i

do_jmp.i.i.i.i:                                   ; preds = %exit.i19.i.i.i
...
passthru_fn.exit.i:                               ; preds = %exit.i19.i.i.i
  store ptr %sp.i8.i, ptr %slot.i2.i120.i.i.i, align 8
  store ptr %frame_top.i111.i.i.i, ptr %slot.i3.i121.i.i.i, align 8
  store i64 %size.i.i125.i.i.i, ptr %slot.i5.i.i, align 8
...
attributes #9 = { alwaysinline mustprogress nounwind willreturn memory(argmem: write) }
attributes #10 = { alwaysinline mustprogress nofree nounwind willreturn memory(inaccessiblemem: readwrite) }
attributes #11 = { alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none) }
attributes #12 = { alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) }
attributes #13 = { alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write) }
attributes #14 = { alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: write, inaccessiblemem: none) }
attributes #15 = { alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: read, inaccessiblemem: none) }
...
attributes #18 = { alwaysinline mustprogress nofree nounwind willreturn }
attributes #19 = { alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) }
