builtin.module attributes  {"sym_name" = "ir"} {
  ...
  }) {"func_name" = "_functionliteral_dlvlcacdmh", "result_type" = i32, "yield_type" = !mini.union<[!mini.fatptr<"Exception">, !mini.nil]>} : () -> ()
  "mini.func"() ({
  ^bb14(%66 : i32):
  ...
  }) {"func_name" = "_functionliteral_ojrlrqcyna", "result_type" = i32, "yield_type" = !mini.union<[!mini.fatptr<"Exception">, !mini.nil]>} : () -> ()
  "mini.func"() ({
  ^bb15(%74 : f64):
  ...
  }) {"func_name" = "_functionliteral_xvakdxboiy", "result_type" = f64, "yield_type" = !mini.union<[!mini.fatptr<"Exception">, !mini.nil]>} : () -> ()
  "mini.func"() ({
  ^bb16(%82 : i32):
  ...
  }) {"func_name" = "_functionliteral_ypudappvfk", "result_type" = i32, "yield_type" = !mini.union<[!mini.fatptr<"Exception">, !mini.nil]>} : () -> ()
  "mini.func"() ({
  ^bb17(%85 : i32):
  ...
  }) {"func_name" = "_functionliteral_tzurwdwgoc", "result_type" = f64, "yield_type" = !mini.union<[!mini.fatptr<"Exception">, !mini.nil]>} : () -> ()
  ...
  ^bb31(%141 : !llvm.struct<(!llvm.ptr, !llvm.ptr, !llvm.ptr, i32)>, %142 : !llvm.struct<(!llvm.ptr, !llvm.ptr, !llvm.ptr, i32)>, %143 : !llvm.ptr, %144 : !llvm.struct<(!llvm.ptr, i160)>):
    ...
    %148 = "hi.cast"(%147) {"from_typ" = !mini.union<[!mini.fatptr<"Float64">, !mini.fatptr<"Int32">]>, "to_typ" = !mini.fatptr<"Float64">, "from_typ_name" = "union_typ", "to_typ_name" = "Float64"} : (!mini.union<[!mini.fatptr<"Float64">, !mini.fatptr<"Int32">]>) -> !mini.fatptr<"Float64">
  ...
  ^bb32(%175 : !llvm.struct<(!llvm.ptr, !llvm.ptr, !llvm.ptr, i32)>, %176 : !llvm.struct<(!llvm.ptr, !llvm.ptr, !llvm.ptr, i32)>, %177 : !llvm.ptr, %178 : !llvm.struct<(!llvm.ptr, i160)>):
    ...
    %181 = "mini.wrap"(%178) : (!llvm.struct<(!llvm.ptr, i160)>) -> !mini.union<[!mini.fatptr<"Float64">, !mini.fatptr<"Int32">]>
    %182 = "hi.cast"(%181) {"from_typ" = !mini.union<[!mini.fatptr<"Float64">, !mini.fatptr<"Int32">]>, "to_typ" = !mini.fatptr<"Int32">, "from_typ_name" = "union_typ", "to_typ_name" = "Int32"} : (!mini.union<[!mini.fatptr<"Float64">, !mini.fatptr<"Int32">]>) -> !mini.fatptr<"Int32">
  ...
  ^bb79(%472 : !llvm.struct<(!llvm.ptr, !llvm.ptr, !llvm.ptr, i32)>, %473 : !llvm.struct<(!llvm.ptr, !llvm.ptr, !llvm.ptr, i32)>, %474 : !llvm.ptr):
    ...
    %481 = "hi.cast"(%480) {"from_typ" = !mini.ptr<i64>, "to_typ" = !mini.union<[!mini.ptr<i32>, !mini.ptr<i1>, !mini.ptr<i64>, !mini.ptr<i8>, !mini.ptr<f64>, !mini.nil, !mini.fatptr<"Character">, !mini.fatptr<"Representable">]>, "from_typ_name" = "i64_typ", "to_typ_name" = "union_typ"} : (!llvm.ptr) -> !mini.union<[!mini.ptr<i32>, !mini.ptr<i1>, !mini.ptr<i64>, !mini.ptr<i8>, !mini.ptr<f64>, !mini.nil, !mini.fatptr<"Character">, !mini.fatptr<"Representable">]>
    %482 = "mini.unwrap"(%481) : (!mini.union<[!mini.ptr<i32>, !mini.ptr<i1>, !mini.ptr<i64>, !mini.ptr<i8>, !mini.ptr<f64>, !mini.nil, !mini.fatptr<"Character">, !mini.fatptr<"Representable">]>) -> !llvm.struct<(!llvm.ptr, i160)>
