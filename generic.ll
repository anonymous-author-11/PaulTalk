...
@uvivw_genericmini = internal constant [12 x i8] c"generic.mini"
...
define { ptr, i160 } @oipatlspkp(ptr nest %0, { ptr, i160 } %1) {
...
define { ptr, i160 } @bpkieeocxj(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @cknpmlawdf(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @ujngcgckdg(ptr nest %0, { ptr, i160 } %1, { ptr, i160 } %2) {
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr %2, i32 %3) {
  ...
  %96 = load i96, ptr @uvivw_genericmini, align 4
...
define i32 @_functionliteral_sksyzftyjk(i32 %0, i32 %1) {
  %3 = add i32 %0, %1
  ret i32 %3
}

define i32 @_functionliteral_yokwmoafwe(i32 %0) {
  %2 = mul i32 %0, 2
  ret i32 %2
}

define double @_functionliteral_ycunntskpa(double %0) {
  %2 = fmul double %0, 2.000000e+00
  ret double %2
}

define i32 @_functionliteral_fturufyakl(i32 %0) {
  ret i32 %0
}

define double @_functionliteral_lwxnkmlrly(i32 %0) {
...
define i32 @main() {
  ...
  store ptr @_functionliteral_sksyzftyjk, ptr %750, align 8
  ...
  call void @llvm.init.trampoline(ptr %759, ptr @ujngcgckdg, ptr %760)
  ...
  call void @llvm.init.trampoline(ptr %908, ptr @cknpmlawdf, ptr @_functionliteral_yokwmoafwe)
  ...
  call void @llvm.init.trampoline(ptr %983, ptr @bpkieeocxj, ptr @_functionliteral_lwxnkmlrly)
  ...
  call void @llvm.init.trampoline(ptr %991, ptr @oipatlspkp, ptr @_functionliteral_fturufyakl)
