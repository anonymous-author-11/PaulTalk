...
@hpocz_genericmini = internal constant [12 x i8] c"generic.mini"
...
define { ptr, i160 } @qtocqwqnsn(ptr nest %0, { ptr, i160 } %1) {
...
define { ptr, i160 } @uistxpvfyz(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = alloca i32, align 4
  %5 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
...
define { ptr, i160 } @mcquszmxqr(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = alloca i32, align 4
  %5 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
...
define { ptr, i160 } @ovwkfvwuuu(ptr nest %0, { ptr, i160 } %1, { ptr, i160 } %2) {
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr %2, i32 %3) {
  ...
  %64 = load <12 x i8>, ptr @hpocz_genericmini, align 16
...
define i32 @_functionliteral_tmddbjaqkw(i32 %0, i32 %1) {
...
define i32 @_functionliteral_nvjfvyracd(i32 %0) {
...
define double @_functionliteral_qezucqhybk(double %0) {
...
define i32 @_functionliteral_ccyugoazpz(i32 %0) {
  %2 = alloca i32, align 4
  store i32 %0, ptr %2, align 4
...
define double @_functionliteral_nlbdulauqt(i32 %0) {
  %2 = alloca i32, align 4
  store i32 %0, ptr %2, align 4
  %3 = alloca double, align 8
  %4 = load i32, ptr %2, align 4
...
define i32 @main() {
  ...
  %291 = alloca [0 x ptr], align 8
  %292 = alloca {}, align 8
  %293 = alloca { ptr, i160 }, align 8
  ...
  %411 = getelementptr ptr, ptr %3, i32 1
  store ptr @_parameterization_Ptri32, ptr %411, align 8
  %412 = getelementptr ptr, ptr %3, i32 2
  store ptr @_parameterization_Ptrf64, ptr %412, align 8
  %413 = load ptr, ptr %3, align 8
  %414 = getelementptr ptr, ptr %413, i32 6
  %415 = load ptr, ptr %414, align 8
  %416 = call { i64, i64 } @size_wrapper(ptr %415, ptr %3)
  ...
  store ptr @_parameterization_Ptrf64, ptr %419, align 8
  %420 = call ptr @llvm.invariant.start.p0(i64 16, ptr %418)
  ...
  %439 = getelementptr [2 x ptr], ptr %14, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %439, align 8
  %440 = getelementptr [2 x ptr], ptr %14, i32 0, i32 1
  store ptr @_parameterization_Ptrf64, ptr %440, align 8
  %441 = call ptr @llvm.invariant.start.p0(i64 4, ptr %14)
  %442 = call ptr @llvm.invariant.start.p0(i64 80, ptr %431)
  %443 = getelementptr ptr, ptr %431, i32 %437
  %444 = getelementptr ptr, ptr %443, i32 4
  %445 = load ptr, ptr %444, align 8
  %446 = getelementptr { ptr, ptr }, ptr %15, i32 0, i32 0
  store ptr %422, ptr %446, align 8
  %447 = getelementptr { ptr, ptr }, ptr %15, i32 0, i32 1
  store ptr %427, ptr %447, align 8
  %448 = call ptr @behavior_wrapper(ptr %445, { ptr, ptr, ptr, i32 } %438, ptr %15)
  call void %448({ ptr, ptr, ptr, i32 } %438, { ptr, ptr, ptr, i32 } %438, ptr %14, { ptr, i160 } %425, { ptr, i160 } %430) #3
  %449 = getelementptr { ptr, ptr, ptr, i32 }, ptr %16, i32 0, i32 0
  %450 = load ptr, ptr %7, align 8
  store ptr %450, ptr %449, align 8
  %451 = getelementptr { ptr, ptr, ptr, i32 }, ptr %16, i32 0, i32 1
  %452 = load ptr, ptr %6, align 8
  store ptr %452, ptr %451, align 8
  %453 = getelementptr { ptr, ptr, ptr, i32 }, ptr %16, i32 0, i32 2
  ...
  %466 = insertvalue { ptr, ptr, ptr, i32 } %464, ptr %465, 2
  %467 = load i32, ptr %17, align 4
  %468 = insertvalue { ptr, ptr, ptr, i32 } %466, i32 %467, 3
  %469 = call ptr @llvm.invariant.start.p0(i64 0, ptr %21)
  %470 = call ptr @llvm.invariant.start.p0(i64 80, ptr %461)
  %471 = getelementptr ptr, ptr %461, i32 %467
  %472 = getelementptr ptr, ptr %471, i32 6
  %473 = load ptr, ptr %472, align 8
  %474 = call ptr @behavior_wrapper(ptr %473, { ptr, ptr, ptr, i32 } %468, ptr %22)
  %475 = call { ptr, i160 } %474({ ptr, ptr, ptr, i32 } %468, { ptr, ptr, ptr, i32 } %468, ptr %21) #3
  store { ptr, i160 } %475, ptr %23, align 8
  %476 = getelementptr { ptr, i160 }, ptr %23, i32 0, i32 1
  %477 = load double, ptr %476, align 8
  store double %477, ptr %24, align 8
  %478 = load double, ptr %24, align 8
  store double %478, ptr %25, align 8
  store i64 ptrtoint (ptr @f64_typ to i64), ptr %27, align 4
  %479 = load i64, ptr %27, align 4
  store i64 %479, ptr %26, align 4
  %480 = load ptr, ptr %26, align 8
  %481 = insertvalue { ptr, i160 } undef, ptr %480, 0
  %482 = load i160, ptr %25, align 4
  %483 = insertvalue { ptr, i160 } %481, i160 %482, 1
  %484 = getelementptr [1 x ptr], ptr %28, i32 0, i32 0
  store ptr @_parameterization_Ptrf64, ptr %484, align 8
  %485 = call ptr @llvm.invariant.start.p0(i64 1, ptr %28)
  %486 = call ptr @llvm.invariant.start.p0(i64 80, ptr @IO)
  %487 = load ptr, ptr getelementptr (ptr, ptr @IO, i32 10), align 8
  %488 = getelementptr { ptr }, ptr %29, i32 0, i32 0
  store ptr %480, ptr %488, align 8
  %489 = call ptr @class_behavior_wrapper(ptr %487, ptr %29)
  call void %489(ptr %28, { ptr, i160 } %483) #3
  store double 7.000000e+00, ptr %30, align 8
  store i32 9, ptr %31, align 4
  store ptr @Pair, ptr %32, align 8
  %490 = getelementptr ptr, ptr %32, i32 1
  store ptr @_parameterization_Ptrf64, ptr %490, align 8
  %491 = getelementptr ptr, ptr %32, i32 2
  store ptr @_parameterization_Ptri32, ptr %491, align 8
  %492 = load ptr, ptr %32, align 8
  %493 = getelementptr ptr, ptr %492, i32 6
  %494 = load ptr, ptr %493, align 8
  %495 = call { i64, i64 } @size_wrapper(ptr %494, ptr %32)
  %496 = extractvalue { i64, i64 } %495, 0
  %497 = call ptr @bump_malloc(i64 %496)
  store ptr @_parameterization_Ptrf64, ptr %497, align 8
  %498 = getelementptr ptr, ptr %497, i32 1
  store ptr @_parameterization_Ptri32, ptr %498, align 8
  %499 = call ptr @llvm.invariant.start.p0(i64 16, ptr %497)
  store ptr @Pair, ptr %36, align 8
  store ptr %497, ptr %35, align 8
  store i32 10, ptr %33, align 4
  store double 7.000000e+00, ptr %37, align 8
  store i32 9, ptr %38, align 4
  store ptr @f64_typ, ptr %40, align 8
  %500 = load double, ptr %37, align 8
  store double %500, ptr %39, align 8
  %501 = load ptr, ptr %40, align 8
  %502 = insertvalue { ptr, i160 } undef, ptr %501, 0
  %503 = load i160, ptr %39, align 4
  %504 = insertvalue { ptr, i160 } %502, i160 %503, 1
  store ptr @i32_typ, ptr %42, align 8
  %505 = load i32, ptr %38, align 4
  store i32 %505, ptr %41, align 4
  %506 = load ptr, ptr %42, align 8
  %507 = insertvalue { ptr, i160 } undef, ptr %506, 0
  %508 = load i160, ptr %41, align 4
  ...
  %518 = getelementptr [2 x ptr], ptr %43, i32 0, i32 0
  store ptr @_parameterization_Ptrf64, ptr %518, align 8
  %519 = getelementptr [2 x ptr], ptr %43, i32 0, i32 1
  store ptr @_parameterization_Ptri32, ptr %519, align 8
  %520 = call ptr @llvm.invariant.start.p0(i64 4, ptr %43)
  %521 = call ptr @llvm.invariant.start.p0(i64 80, ptr %510)
  %522 = getelementptr ptr, ptr %510, i32 %516
  %523 = getelementptr ptr, ptr %522, i32 4
  %524 = load ptr, ptr %523, align 8
  %525 = getelementptr { ptr, ptr }, ptr %44, i32 0, i32 0
  store ptr %501, ptr %525, align 8
  %526 = getelementptr { ptr, ptr }, ptr %44, i32 0, i32 1
  store ptr %506, ptr %526, align 8
  %527 = call ptr @behavior_wrapper(ptr %524, { ptr, ptr, ptr, i32 } %517, ptr %44)
  call void %527({ ptr, ptr, ptr, i32 } %517, { ptr, ptr, ptr, i32 } %517, ptr %43, { ptr, i160 } %504, { ptr, i160 } %509) #3
  %528 = getelementptr { ptr, ptr, ptr, i32 }, ptr %45, i32 0, i32 0
  %529 = load ptr, ptr %36, align 8
  store ptr %529, ptr %528, align 8
  %530 = getelementptr { ptr, ptr, ptr, i32 }, ptr %45, i32 0, i32 1
  %531 = load ptr, ptr %35, align 8
  store ptr %531, ptr %530, align 8
  %532 = getelementptr { ptr, ptr, ptr, i32 }, ptr %45, i32 0, i32 2
  %533 = load ptr, ptr %34, align 8
  store ptr %533, ptr %532, align 8
  %534 = getelementptr { ptr, ptr, ptr, i32 }, ptr %45, i32 0, i32 3
  ...
  %548 = call ptr @llvm.invariant.start.p0(i64 0, ptr %50)
  %549 = call ptr @llvm.invariant.start.p0(i64 80, ptr %540)
  %550 = getelementptr ptr, ptr %540, i32 %546
  %551 = getelementptr ptr, ptr %550, i32 6
  %552 = load ptr, ptr %551, align 8
  %553 = call ptr @behavior_wrapper(ptr %552, { ptr, ptr, ptr, i32 } %547, ptr %51)
  %554 = call { ptr, i160 } %553({ ptr, ptr, ptr, i32 } %547, { ptr, ptr, ptr, i32 } %547, ptr %50) #3
  store { ptr, i160 } %554, ptr %52, align 8
  %555 = getelementptr { ptr, i160 }, ptr %52, i32 0, i32 1
  %556 = load i32, ptr %555, align 4
  store i32 %556, ptr %53, align 4
  %557 = load i32, ptr %53, align 4
  store i32 %557, ptr %54, align 4
  store i64 ptrtoint (ptr @i32_typ to i64), ptr %56, align 4
  %558 = load i64, ptr %56, align 4
  store i64 %558, ptr %55, align 4
  %559 = load ptr, ptr %55, align 8
  %560 = insertvalue { ptr, i160 } undef, ptr %559, 0
  %561 = load i160, ptr %54, align 4
  %562 = insertvalue { ptr, i160 } %560, i160 %561, 1
  %563 = getelementptr [1 x ptr], ptr %57, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %563, align 8
  %564 = call ptr @llvm.invariant.start.p0(i64 1, ptr %57)
  %565 = call ptr @llvm.invariant.start.p0(i64 80, ptr @IO)
  %566 = load ptr, ptr getelementptr (ptr, ptr @IO, i32 10), align 8
  %567 = getelementptr { ptr }, ptr %58, i32 0, i32 0
  store ptr %559, ptr %567, align 8
  %568 = call ptr @class_behavior_wrapper(ptr %566, ptr %58)
  call void %568(ptr %57, { ptr, i160 } %562) #3
  store double 1.000000e+00, ptr %59, align 8
  store double 2.000000e+00, ptr %60, align 8
  store double 3.000000e+00, ptr %61, align 8
  store double 4.000000e+00, ptr %62, align 8
  %569 = load double, ptr %59, align 8
  %570 = load double, ptr %60, align 8
  %571 = load double, ptr %61, align 8
  %572 = load double, ptr %62, align 8
  store double %569, ptr %66, align 8
  store double %570, ptr %65, align 8
  store double %571, ptr %64, align 8
  store double %572, ptr %63, align 8
  store double 5.000000e+00, ptr %67, align 8
  store ptr @Pair, ptr %68, align 8
  %573 = getelementptr ptr, ptr %68, i32 1
  store ptr @_parameterization_Tuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64_, ptr %573, align 8
  %574 = getelementptr ptr, ptr %68, i32 2
  store ptr @_parameterization_Ptrf64, ptr %574, align 8
  %575 = load ptr, ptr %68, align 8
  %576 = getelementptr ptr, ptr %575, i32 6
  %577 = load ptr, ptr %576, align 8
  %578 = call { i64, i64 } @size_wrapper(ptr %577, ptr %68)
  ...
  store double 2.000000e+00, ptr %74, align 8
  store double 3.000000e+00, ptr %75, align 8
  store double 4.000000e+00, ptr %76, align 8
  %583 = load double, ptr %73, align 8
  %584 = load double, ptr %74, align 8
  %585 = load double, ptr %75, align 8
  %586 = load double, ptr %76, align 8
  store double %583, ptr %80, align 8
  store double %584, ptr %79, align 8
  store double %585, ptr %78, align 8
  store double %586, ptr %77, align 8
  store double 5.000000e+00, ptr %81, align 8
  ...
  %621 = getelementptr { ptr, ptr }, ptr %87, i32 0, i32 0
  store ptr %597, ptr %621, align 8
  %622 = getelementptr { ptr, ptr }, ptr %87, i32 0, i32 1
  store ptr %602, ptr %622, align 8
  %623 = call ptr @behavior_wrapper(ptr %620, { ptr, ptr, ptr, i32 } %613, ptr %87)
  call void %623({ ptr, ptr, ptr, i32 } %613, { ptr, ptr, ptr, i32 } %613, ptr %86, { ptr, i160 } %600, { ptr, i160 } %605) #3
  %624 = getelementptr { ptr, ptr, ptr, i32 }, ptr %88, i32 0, i32 0
  %625 = load ptr, ptr %72, align 8
  store ptr %625, ptr %624, align 8
  %626 = getelementptr { ptr, ptr, ptr, i32 }, ptr %88, i32 0, i32 1
  %627 = load ptr, ptr %71, align 8
  store ptr %627, ptr %626, align 8
  %628 = getelementptr { ptr, ptr, ptr, i32 }, ptr %88, i32 0, i32 2
  %629 = load ptr, ptr %70, align 8
  store ptr %629, ptr %628, align 8
  %630 = getelementptr { ptr, ptr, ptr, i32 }, ptr %88, i32 0, i32 3
  %631 = load i32, ptr %69, align 4
  store i32 %631, ptr %630, align 4
  call void @set_offset(ptr %88, ptr @Pair)
  %632 = load ptr, ptr %624, align 8
  store ptr %632, ptr %92, align 8
  %633 = load ptr, ptr %626, align 8
  store ptr %633, ptr %91, align 8
  %634 = load ptr, ptr %628, align 8
  store ptr %634, ptr %90, align 8
  ...
  %649 = call ptr @behavior_wrapper(ptr %648, { ptr, ptr, ptr, i32 } %643, ptr %94)
  %650 = call { ptr, i160 } %649({ ptr, ptr, ptr, i32 } %643, { ptr, ptr, ptr, i32 } %643, ptr %93) #3
  store { ptr, i160 } %650, ptr %95, align 8
  %651 = getelementptr { ptr, i160 }, ptr %95, i32 0, i32 1
  %652 = load ptr, ptr %651, align 8
  %653 = getelementptr { double, double, double, double }, ptr %652, i32 0, i32 0
  %654 = load double, ptr %653, align 8
  store double %654, ptr %99, align 8
  %655 = getelementptr { double, double, double, double }, ptr %652, i32 0, i32 1
  %656 = load double, ptr %655, align 8
  store double %656, ptr %98, align 8
  ...
  store double %660, ptr %96, align 8
  %661 = load double, ptr %96, align 8
  store double %661, ptr %100, align 8
  store i64 ptrtoint (ptr @f64_typ to i64), ptr %102, align 4
  %662 = load i64, ptr %102, align 4
  store i64 %662, ptr %101, align 4
  %663 = load ptr, ptr %101, align 8
  %664 = insertvalue { ptr, i160 } undef, ptr %663, 0
  %665 = load i160, ptr %100, align 4
  %666 = insertvalue { ptr, i160 } %664, i160 %665, 1
  %667 = getelementptr [1 x ptr], ptr %103, i32 0, i32 0
  store ptr @_parameterization_Ptrf64, ptr %667, align 8
  %668 = call ptr @llvm.invariant.start.p0(i64 1, ptr %103)
  %669 = call ptr @llvm.invariant.start.p0(i64 80, ptr @IO)
  %670 = load ptr, ptr getelementptr (ptr, ptr @IO, i32 10), align 8
  %671 = getelementptr { ptr }, ptr %104, i32 0, i32 0
  store ptr %663, ptr %671, align 8
  %672 = call ptr @class_behavior_wrapper(ptr %670, ptr %104)
  call void %672(ptr %103, { ptr, i160 } %666) #3
  store double 1.000000e+00, ptr %105, align 8
  store double 2.000000e+00, ptr %106, align 8
  store double 3.000000e+00, ptr %107, align 8
  store double 4.000000e+00, ptr %108, align 8
  %673 = load double, ptr %105, align 8
  %674 = load double, ptr %106, align 8
  %675 = load double, ptr %107, align 8
  %676 = load double, ptr %108, align 8
  store double %673, ptr %112, align 8
  store double %674, ptr %111, align 8
  store double %675, ptr %110, align 8
  store double %676, ptr %109, align 8
  store double 5.000000e+00, ptr %113, align 8
  store ptr @FancyPair, ptr %114, align 8
  %677 = load ptr, ptr %114, align 8
  %678 = getelementptr ptr, ptr %677, i32 6
  %679 = load ptr, ptr %678, align 8
  %680 = call { i64, i64 } @size_wrapper(ptr %679, ptr %114)
  %681 = extractvalue { i64, i64 } %680, 0
  %682 = call ptr @bump_malloc(i64 %681)
  store ptr @FancyPair, ptr %118, align 8
  ...
  store double 3.000000e+00, ptr %121, align 8
  store double 4.000000e+00, ptr %122, align 8
  %683 = load double, ptr %119, align 8
  %684 = load double, ptr %120, align 8
  %685 = load double, ptr %121, align 8
  %686 = load double, ptr %122, align 8
  store double %683, ptr %126, align 8
  store double %684, ptr %125, align 8
  store double %685, ptr %124, align 8
  store double %686, ptr %123, align 8
  store double 5.000000e+00, ptr %127, align 8
  %687 = call ptr @bump_malloc(i64 ptrtoint (ptr getelementptr ({ double, double, double, double }, ptr null, i32 1) to i64))
  %688 = getelementptr { double, double, double, double }, ptr %687, i32 0, i32 0
  %689 = load double, ptr %126, align 8
  store double %689, ptr %688, align 8
  %690 = getelementptr { double, double, double, double }, ptr %687, i32 0, i32 1
  %691 = load double, ptr %125, align 8
  store double %691, ptr %690, align 8
  %692 = getelementptr { double, double, double, double }, ptr %687, i32 0, i32 2
  %693 = load double, ptr %124, align 8
  store double %693, ptr %692, align 8
  %694 = getelementptr { double, double, double, double }, ptr %687, i32 0, i32 3
  %695 = load double, ptr %123, align 8
  store double %695, ptr %694, align 8
  store ptr @tuple_typ, ptr %129, align 8
  %696 = call ptr @llvm.invariant.start.p0(i64 1, ptr %687)
  store ptr %687, ptr %128, align 8
  %697 = load ptr, ptr %129, align 8
  %698 = insertvalue { ptr, i160 } undef, ptr %697, 0
  %699 = load i160, ptr %128, align 4
  %700 = insertvalue { ptr, i160 } %698, i160 %699, 1
  store ptr @f64_typ, ptr %131, align 8
  %701 = load double, ptr %127, align 8
  store double %701, ptr %130, align 8
  %702 = load ptr, ptr %131, align 8
  %703 = insertvalue { ptr, i160 } undef, ptr %702, 0
  %704 = load i160, ptr %130, align 4
  %705 = insertvalue { ptr, i160 } %703, i160 %704, 1
  %706 = load ptr, ptr %118, align 8
  %707 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %706, 0
  %708 = load ptr, ptr %117, align 8
  %709 = insertvalue { ptr, ptr, ptr, i32 } %707, ptr %708, 1
  %710 = load ptr, ptr %116, align 8
  %711 = insertvalue { ptr, ptr, ptr, i32 } %709, ptr %710, 2
  %712 = load i32, ptr %115, align 4
  %713 = insertvalue { ptr, ptr, ptr, i32 } %711, i32 %712, 3
  %714 = getelementptr [2 x ptr], ptr %132, i32 0, i32 0
  store ptr @_parameterization_Tuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64_, ptr %714, align 8
  %715 = getelementptr [2 x ptr], ptr %132, i32 0, i32 1
  store ptr @_parameterization_Ptrf64, ptr %715, align 8
  %716 = call ptr @llvm.invariant.start.p0(i64 4, ptr %132)
  %717 = call ptr @llvm.invariant.start.p0(i64 160, ptr %706)
  %718 = getelementptr ptr, ptr %706, i32 %712
  %719 = getelementptr ptr, ptr %718, i32 4
  %720 = load ptr, ptr %719, align 8
  %721 = getelementptr { ptr, ptr }, ptr %133, i32 0, i32 0
  store ptr %697, ptr %721, align 8
  %722 = getelementptr { ptr, ptr }, ptr %133, i32 0, i32 1
  store ptr %702, ptr %722, align 8
  %723 = call ptr @behavior_wrapper(ptr %720, { ptr, ptr, ptr, i32 } %713, ptr %133)
  call void %723({ ptr, ptr, ptr, i32 } %713, { ptr, ptr, ptr, i32 } %713, ptr %132, { ptr, i160 } %700, { ptr, i160 } %705) #3
  %724 = getelementptr { ptr, ptr, ptr, i32 }, ptr %134, i32 0, i32 0
  %725 = load ptr, ptr %118, align 8
  store ptr %725, ptr %724, align 8
  %726 = getelementptr { ptr, ptr, ptr, i32 }, ptr %134, i32 0, i32 1
  %727 = load ptr, ptr %117, align 8
  store ptr %727, ptr %726, align 8
  %728 = getelementptr { ptr, ptr, ptr, i32 }, ptr %134, i32 0, i32 2
  %729 = load ptr, ptr %116, align 8
  store ptr %729, ptr %728, align 8
  %730 = getelementptr { ptr, ptr, ptr, i32 }, ptr %134, i32 0, i32 3
  %731 = load i32, ptr %115, align 4
  store i32 %731, ptr %730, align 4
  call void @set_offset(ptr %134, ptr @FancyPair)
  %732 = load ptr, ptr %724, align 8
  store ptr %732, ptr %138, align 8
  %733 = load ptr, ptr %726, align 8
  store ptr %733, ptr %137, align 8
  %734 = load ptr, ptr %728, align 8
  store ptr %734, ptr %136, align 8
  %735 = load i32, ptr %730, align 4
  store i32 %735, ptr %135, align 4
  %736 = load ptr, ptr %138, align 8
  %737 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %736, 0
  %738 = load ptr, ptr %137, align 8
  %739 = insertvalue { ptr, ptr, ptr, i32 } %737, ptr %738, 1
  %740 = load ptr, ptr %136, align 8
  %741 = insertvalue { ptr, ptr, ptr, i32 } %739, ptr %740, 2
  %742 = load i32, ptr %135, align 4
  %743 = insertvalue { ptr, ptr, ptr, i32 } %741, i32 %742, 3
  %744 = call ptr @llvm.invariant.start.p0(i64 0, ptr %139)
  %745 = call ptr @llvm.invariant.start.p0(i64 160, ptr %736)
  %746 = getelementptr ptr, ptr %736, i32 %742
  %747 = getelementptr ptr, ptr %746, i32 6
  %748 = load ptr, ptr %747, align 8
  %749 = call ptr @behavior_wrapper(ptr %748, { ptr, ptr, ptr, i32 } %743, ptr %140)
  %750 = call { ptr, i160 } %749({ ptr, ptr, ptr, i32 } %743, { ptr, ptr, ptr, i32 } %743, ptr %139) #3
  store { ptr, i160 } %750, ptr %141, align 8
  %751 = getelementptr { ptr, i160 }, ptr %141, i32 0, i32 1
  %752 = load double, ptr %751, align 8
  store double %752, ptr %142, align 8
  %753 = load double, ptr %142, align 8
  store double %753, ptr %143, align 8
  store i64 ptrtoint (ptr @f64_typ to i64), ptr %145, align 4
  %754 = load i64, ptr %145, align 4
  store i64 %754, ptr %144, align 4
  %755 = load ptr, ptr %144, align 8
  %756 = insertvalue { ptr, i160 } undef, ptr %755, 0
  %757 = load i160, ptr %143, align 4
  %758 = insertvalue { ptr, i160 } %756, i160 %757, 1
  %759 = getelementptr [1 x ptr], ptr %146, i32 0, i32 0
  store ptr @_parameterization_Ptrf64, ptr %759, align 8
  %760 = call ptr @llvm.invariant.start.p0(i64 1, ptr %146)
  %761 = call ptr @llvm.invariant.start.p0(i64 80, ptr @IO)
  %762 = load ptr, ptr getelementptr (ptr, ptr @IO, i32 10), align 8
  %763 = getelementptr { ptr }, ptr %147, i32 0, i32 0
  store ptr %755, ptr %763, align 8
  %764 = call ptr @class_behavior_wrapper(ptr %762, ptr %147)
  call void %764(ptr %146, { ptr, i160 } %758) #3
  store ptr @Array, ptr %148, align 8
  %765 = getelementptr ptr, ptr %148, i32 1
  store ptr @_parameterization_Ptri32, ptr %765, align 8
  %766 = load ptr, ptr %148, align 8
  %767 = getelementptr ptr, ptr %766, i32 6
  %768 = load ptr, ptr %767, align 8
  %769 = call { i64, i64 } @size_wrapper(ptr %768, ptr %148)
  %770 = extractvalue { i64, i64 } %769, 0
  %771 = call ptr @bump_malloc(i64 %770)
  store ptr @_parameterization_Ptri32, ptr %771, align 8
  %772 = call ptr @llvm.invariant.start.p0(i64 8, ptr %771)
  store ptr @Array, ptr %152, align 8
  ...
  %776 = insertvalue { ptr, ptr, ptr, i32 } %774, ptr %775, 1
  %777 = load ptr, ptr %150, align 8
  %778 = insertvalue { ptr, ptr, ptr, i32 } %776, ptr %777, 2
  %779 = load i32, ptr %149, align 4
  %780 = insertvalue { ptr, ptr, ptr, i32 } %778, i32 %779, 3
  %781 = call ptr @llvm.invariant.start.p0(i64 0, ptr %153)
  %782 = call ptr @llvm.invariant.start.p0(i64 600, ptr %773)
  %783 = getelementptr ptr, ptr %773, i32 %779
  %784 = getelementptr ptr, ptr %783, i32 5
  %785 = load ptr, ptr %784, align 8
  %786 = call ptr @behavior_wrapper(ptr %785, { ptr, ptr, ptr, i32 } %780, ptr %154)
  call void %786({ ptr, ptr, ptr, i32 } %780, { ptr, ptr, ptr, i32 } %780, ptr %153) #3
  %787 = getelementptr { ptr, ptr, ptr, i32 }, ptr %155, i32 0, i32 0
  %788 = load ptr, ptr %152, align 8
  store ptr %788, ptr %787, align 8
  %789 = getelementptr { ptr, ptr, ptr, i32 }, ptr %155, i32 0, i32 1
  %790 = load ptr, ptr %151, align 8
  store ptr %790, ptr %789, align 8
  %791 = getelementptr { ptr, ptr, ptr, i32 }, ptr %155, i32 0, i32 2
  %792 = load ptr, ptr %150, align 8
  store ptr %792, ptr %791, align 8
  %793 = getelementptr { ptr, ptr, ptr, i32 }, ptr %155, i32 0, i32 3
  %794 = load i32, ptr %149, align 4
  store i32 %794, ptr %793, align 4
  call void @set_offset(ptr %155, ptr @Array)
  %795 = load ptr, ptr %787, align 8
  store ptr %795, ptr %159, align 8
  %796 = load ptr, ptr %789, align 8
  store ptr %796, ptr %158, align 8
  %797 = load ptr, ptr %791, align 8
  store ptr %797, ptr %157, align 8
  %798 = load i32, ptr %793, align 4
  store i32 %798, ptr %156, align 4
  store i32 8, ptr %160, align 4
  store ptr @i32_typ, ptr %162, align 8
  %799 = load i32, ptr %160, align 4
  store i32 %799, ptr %161, align 4
  %800 = load ptr, ptr %162, align 8
  %801 = insertvalue { ptr, i160 } undef, ptr %800, 0
  %802 = load i160, ptr %161, align 4
  %803 = insertvalue { ptr, i160 } %801, i160 %802, 1
  store i32 7, ptr %163, align 4
  store ptr @i32_typ, ptr %165, align 8
  %804 = load i32, ptr %163, align 4
  store i32 %804, ptr %164, align 4
  %805 = load ptr, ptr %165, align 8
  %806 = insertvalue { ptr, i160 } undef, ptr %805, 0
  %807 = load i160, ptr %164, align 4
  %808 = insertvalue { ptr, i160 } %806, i160 %807, 1
  store i32 6, ptr %166, align 4
  store ptr @i32_typ, ptr %168, align 8
  %809 = load i32, ptr %166, align 4
  store i32 %809, ptr %167, align 4
  %810 = load ptr, ptr %168, align 8
  %811 = insertvalue { ptr, i160 } undef, ptr %810, 0
  %812 = load i160, ptr %167, align 4
  %813 = insertvalue { ptr, i160 } %811, i160 %812, 1
  store i32 5, ptr %169, align 4
  store ptr @i32_typ, ptr %171, align 8
  %814 = load i32, ptr %169, align 4
  store i32 %814, ptr %170, align 4
  %815 = load ptr, ptr %171, align 8
  %816 = insertvalue { ptr, i160 } undef, ptr %815, 0
  %817 = load i160, ptr %170, align 4
  %818 = insertvalue { ptr, i160 } %816, i160 %817, 1
  %819 = load ptr, ptr %159, align 8
  %820 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %819, 0
  %821 = load ptr, ptr %158, align 8
  %822 = insertvalue { ptr, ptr, ptr, i32 } %820, ptr %821, 1
  %823 = load ptr, ptr %157, align 8
  %824 = insertvalue { ptr, ptr, ptr, i32 } %822, ptr %823, 2
  %825 = load i32, ptr %156, align 4
  %826 = insertvalue { ptr, ptr, ptr, i32 } %824, i32 %825, 3
  %827 = getelementptr [1 x ptr], ptr %172, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %827, align 8
  %828 = call ptr @llvm.invariant.start.p0(i64 1, ptr %172)
  %829 = call ptr @llvm.invariant.start.p0(i64 600, ptr %819)
  %830 = getelementptr ptr, ptr %819, i32 %825
  %831 = getelementptr ptr, ptr %830, i32 10
  %832 = load ptr, ptr %831, align 8
  %833 = getelementptr { ptr }, ptr %173, i32 0, i32 0
  store ptr %815, ptr %833, align 8
  %834 = call ptr @behavior_wrapper(ptr %832, { ptr, ptr, ptr, i32 } %826, ptr %173)
  %835 = call { ptr, ptr, ptr, i32 } %834({ ptr, ptr, ptr, i32 } %826, { ptr, ptr, ptr, i32 } %826, ptr %172, { ptr, i160 } %818) #3
  store { ptr, ptr, ptr, i32 } %835, ptr %174, align 8
  %836 = getelementptr { ptr, ptr, ptr, i32 }, ptr %174, i32 0, i32 0
  %837 = getelementptr { ptr, ptr, ptr, i32 }, ptr %175, i32 0, i32 0
  %838 = load ptr, ptr %836, align 8
  store ptr %838, ptr %837, align 8
  %839 = getelementptr { ptr, ptr, ptr, i32 }, ptr %174, i32 0, i32 1
  %840 = getelementptr { ptr, ptr, ptr, i32 }, ptr %175, i32 0, i32 1
  %841 = load ptr, ptr %839, align 8
  store ptr %841, ptr %840, align 8
  %842 = getelementptr { ptr, ptr, ptr, i32 }, ptr %174, i32 0, i32 2
  %843 = getelementptr { ptr, ptr, ptr, i32 }, ptr %175, i32 0, i32 2
  %844 = load ptr, ptr %842, align 8
  store ptr %844, ptr %843, align 8
  %845 = getelementptr { ptr, ptr, ptr, i32 }, ptr %174, i32 0, i32 3
  %846 = getelementptr { ptr, ptr, ptr, i32 }, ptr %175, i32 0, i32 3
  %847 = load i32, ptr %845, align 4
  store i32 %847, ptr %846, align 4
  call void @set_offset(ptr %175, ptr @Array)
  %848 = load ptr, ptr %837, align 8
  %849 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %848, 0
  %850 = load ptr, ptr %840, align 8
  ...
  %856 = getelementptr [1 x ptr], ptr %176, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %856, align 8
  %857 = call ptr @llvm.invariant.start.p0(i64 1, ptr %176)
  %858 = call ptr @llvm.invariant.start.p0(i64 600, ptr %848)
  %859 = getelementptr ptr, ptr %848, i32 %854
  %860 = getelementptr ptr, ptr %859, i32 10
  %861 = load ptr, ptr %860, align 8
  %862 = getelementptr { ptr }, ptr %177, i32 0, i32 0
  store ptr %810, ptr %862, align 8
  %863 = call ptr @behavior_wrapper(ptr %861, { ptr, ptr, ptr, i32 } %855, ptr %177)
  %864 = call { ptr, ptr, ptr, i32 } %863({ ptr, ptr, ptr, i32 } %855, { ptr, ptr, ptr, i32 } %855, ptr %176, { ptr, i160 } %813) #3
  store { ptr, ptr, ptr, i32 } %864, ptr %178, align 8
  %865 = getelementptr { ptr, ptr, ptr, i32 }, ptr %178, i32 0, i32 0
  %866 = getelementptr { ptr, ptr, ptr, i32 }, ptr %179, i32 0, i32 0
  %867 = load ptr, ptr %865, align 8
  store ptr %867, ptr %866, align 8
  %868 = getelementptr { ptr, ptr, ptr, i32 }, ptr %178, i32 0, i32 1
  %869 = getelementptr { ptr, ptr, ptr, i32 }, ptr %179, i32 0, i32 1
  %870 = load ptr, ptr %868, align 8
  store ptr %870, ptr %869, align 8
  %871 = getelementptr { ptr, ptr, ptr, i32 }, ptr %178, i32 0, i32 2
  %872 = getelementptr { ptr, ptr, ptr, i32 }, ptr %179, i32 0, i32 2
  %873 = load ptr, ptr %871, align 8
  store ptr %873, ptr %872, align 8
  %874 = getelementptr { ptr, ptr, ptr, i32 }, ptr %178, i32 0, i32 3
  %875 = getelementptr { ptr, ptr, ptr, i32 }, ptr %179, i32 0, i32 3
  %876 = load i32, ptr %874, align 4
  store i32 %876, ptr %875, align 4
  call void @set_offset(ptr %179, ptr @Array)
  %877 = load ptr, ptr %866, align 8
  %878 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %877, 0
  %879 = load ptr, ptr %869, align 8
  %880 = insertvalue { ptr, ptr, ptr, i32 } %878, ptr %879, 1
  %881 = load ptr, ptr %872, align 8
  %882 = insertvalue { ptr, ptr, ptr, i32 } %880, ptr %881, 2
  %883 = load i32, ptr %875, align 4
  %884 = insertvalue { ptr, ptr, ptr, i32 } %882, i32 %883, 3
  %885 = getelementptr [1 x ptr], ptr %180, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %885, align 8
  %886 = call ptr @llvm.invariant.start.p0(i64 1, ptr %180)
  %887 = call ptr @llvm.invariant.start.p0(i64 600, ptr %877)
  %888 = getelementptr ptr, ptr %877, i32 %883
  %889 = getelementptr ptr, ptr %888, i32 10
  %890 = load ptr, ptr %889, align 8
  %891 = getelementptr { ptr }, ptr %181, i32 0, i32 0
  store ptr %805, ptr %891, align 8
  %892 = call ptr @behavior_wrapper(ptr %890, { ptr, ptr, ptr, i32 } %884, ptr %181)
  %893 = call { ptr, ptr, ptr, i32 } %892({ ptr, ptr, ptr, i32 } %884, { ptr, ptr, ptr, i32 } %884, ptr %180, { ptr, i160 } %808) #3
  store { ptr, ptr, ptr, i32 } %893, ptr %182, align 8
  %894 = getelementptr { ptr, ptr, ptr, i32 }, ptr %182, i32 0, i32 0
  %895 = getelementptr { ptr, ptr, ptr, i32 }, ptr %183, i32 0, i32 0
  %896 = load ptr, ptr %894, align 8
  store ptr %896, ptr %895, align 8
  %897 = getelementptr { ptr, ptr, ptr, i32 }, ptr %182, i32 0, i32 1
  %898 = getelementptr { ptr, ptr, ptr, i32 }, ptr %183, i32 0, i32 1
  %899 = load ptr, ptr %897, align 8
  store ptr %899, ptr %898, align 8
  %900 = getelementptr { ptr, ptr, ptr, i32 }, ptr %182, i32 0, i32 2
  %901 = getelementptr { ptr, ptr, ptr, i32 }, ptr %183, i32 0, i32 2
  %902 = load ptr, ptr %900, align 8
  store ptr %902, ptr %901, align 8
  %903 = getelementptr { ptr, ptr, ptr, i32 }, ptr %182, i32 0, i32 3
  %904 = getelementptr { ptr, ptr, ptr, i32 }, ptr %183, i32 0, i32 3
  ...
  %914 = getelementptr [1 x ptr], ptr %184, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %914, align 8
  %915 = call ptr @llvm.invariant.start.p0(i64 1, ptr %184)
  %916 = call ptr @llvm.invariant.start.p0(i64 600, ptr %906)
  %917 = getelementptr ptr, ptr %906, i32 %912
  %918 = getelementptr ptr, ptr %917, i32 10
  %919 = load ptr, ptr %918, align 8
  %920 = getelementptr { ptr }, ptr %185, i32 0, i32 0
  store ptr %800, ptr %920, align 8
  %921 = call ptr @behavior_wrapper(ptr %919, { ptr, ptr, ptr, i32 } %913, ptr %185)
  %922 = call { ptr, ptr, ptr, i32 } %921({ ptr, ptr, ptr, i32 } %913, { ptr, ptr, ptr, i32 } %913, ptr %184, { ptr, i160 } %803) #3
  store { ptr, ptr, ptr, i32 } %922, ptr %186, align 8
  %923 = getelementptr { ptr, ptr, ptr, i32 }, ptr %186, i32 0, i32 0
  %924 = getelementptr { ptr, ptr, ptr, i32 }, ptr %187, i32 0, i32 0
  %925 = load ptr, ptr %923, align 8
  store ptr %925, ptr %924, align 8
  %926 = getelementptr { ptr, ptr, ptr, i32 }, ptr %186, i32 0, i32 1
  %927 = getelementptr { ptr, ptr, ptr, i32 }, ptr %187, i32 0, i32 1
  %928 = load ptr, ptr %926, align 8
  store ptr %928, ptr %927, align 8
  %929 = getelementptr { ptr, ptr, ptr, i32 }, ptr %186, i32 0, i32 2
  %930 = getelementptr { ptr, ptr, ptr, i32 }, ptr %187, i32 0, i32 2
  %931 = load ptr, ptr %929, align 8
  store ptr %931, ptr %930, align 8
  %932 = getelementptr { ptr, ptr, ptr, i32 }, ptr %186, i32 0, i32 3
  %933 = getelementptr { ptr, ptr, ptr, i32 }, ptr %187, i32 0, i32 3
  %934 = load i32, ptr %932, align 4
  store i32 %934, ptr %933, align 4
  call void @set_offset(ptr %187, ptr @Array)
  store ptr @_functionliteral_tmddbjaqkw, ptr %188, align 8
  store i32 0, ptr %189, align 4
  store ptr @i32_typ, ptr %191, align 8
  %935 = load i32, ptr %189, align 4
  store i32 %935, ptr %190, align 4
  %936 = load ptr, ptr %191, align 8
  %937 = insertvalue { ptr, i160 } undef, ptr %936, 0
  %938 = load i160, ptr %190, align 4
  %939 = insertvalue { ptr, i160 } %937, i160 %938, 1
  %940 = call ptr @bump_malloc(i64 ptrtoint (ptr getelementptr ([24 x i8], ptr null, i32 1) to i64))
  call void @anoint_trampoline(ptr %940)
  %941 = load ptr, ptr %188, align 8
  call void @llvm.init.trampoline(ptr %940, ptr @ovwkfvwuuu, ptr %941)
  %942 = call ptr @adjust_trampoline(ptr %940)
  store ptr %942, ptr %192, align 8
  %943 = call ptr @llvm.invariant.start.p0(i64 24, ptr %940)
  %944 = getelementptr { ptr }, ptr %192, i32 0, i32 0
  %945 = load ptr, ptr %944, align 8
  %946 = insertvalue { ptr } undef, ptr %945, 0
  %947 = load ptr, ptr %159, align 8
  %948 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %947, 0
  %949 = load ptr, ptr %158, align 8
  %950 = insertvalue { ptr, ptr, ptr, i32 } %948, ptr %949, 1
  %951 = load ptr, ptr %157, align 8
  %952 = insertvalue { ptr, ptr, ptr, i32 } %950, ptr %951, 2
  %953 = load i32, ptr %156, align 4
  %954 = insertvalue { ptr, ptr, ptr, i32 } %952, i32 %953, 3
  %955 = getelementptr [2 x ptr], ptr %193, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %955, align 8
  %956 = getelementptr [2 x ptr], ptr %193, i32 0, i32 1
  store ptr @_parameterization_FunctionPtri32._Ptri32_to_Ptri32, ptr %956, align 8
  %957 = call ptr @llvm.invariant.start.p0(i64 4, ptr %193)
  %958 = call ptr @llvm.invariant.start.p0(i64 600, ptr %947)
  %959 = getelementptr ptr, ptr %947, i32 %953
  %960 = getelementptr ptr, ptr %959, i32 19
  %961 = load ptr, ptr %960, align 8
  %962 = getelementptr { ptr, ptr }, ptr %194, i32 0, i32 0
  store ptr %936, ptr %962, align 8
  %963 = getelementptr { ptr, ptr }, ptr %194, i32 0, i32 1
  store ptr @function_typ, ptr %963, align 8
  %964 = call ptr @behavior_wrapper(ptr %961, { ptr, ptr, ptr, i32 } %954, ptr %194)
  %965 = call { ptr, i160 } %964({ ptr, ptr, ptr, i32 } %954, { ptr, ptr, ptr, i32 } %954, ptr %193, { ptr, i160 } %939, { ptr } %946) #3
  store { ptr, i160 } %965, ptr %195, align 8
  %966 = getelementptr { ptr, i160 }, ptr %195, i32 0, i32 1
  %967 = load i32, ptr %966, align 4
  store i32 %967, ptr %196, align 4
  %968 = load i32, ptr %196, align 4
  store i32 %968, ptr %197, align 4
  store i64 ptrtoint (ptr @i32_typ to i64), ptr %199, align 4
  %969 = load i64, ptr %199, align 4
  store i64 %969, ptr %198, align 4
  %970 = load ptr, ptr %198, align 8
  %971 = insertvalue { ptr, i160 } undef, ptr %970, 0
  %972 = load i160, ptr %197, align 4
  %973 = insertvalue { ptr, i160 } %971, i160 %972, 1
  %974 = getelementptr [1 x ptr], ptr %200, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %974, align 8
  %975 = call ptr @llvm.invariant.start.p0(i64 1, ptr %200)
  %976 = call ptr @llvm.invariant.start.p0(i64 80, ptr @IO)
  %977 = load ptr, ptr getelementptr (ptr, ptr @IO, i32 10), align 8
  %978 = getelementptr { ptr }, ptr %201, i32 0, i32 0
  store ptr %970, ptr %978, align 8
  %979 = call ptr @class_behavior_wrapper(ptr %977, ptr %201)
  call void %979(ptr %200, { ptr, i160 } %973) #3
  store ptr @_functionliteral_nvjfvyracd, ptr %202, align 8
  store ptr @_functionliteral_qezucqhybk, ptr %203, align 8
  store ptr @_functionliteral_ccyugoazpz, ptr %204, align 8
  store ptr @_functionliteral_nlbdulauqt, ptr %205, align 8
  %980 = call ptr @bump_malloc(i64 ptrtoint (ptr getelementptr ([24 x i8], ptr null, i32 1) to i64))
  call void @anoint_trampoline(ptr %980)
  %981 = load ptr, ptr %202, align 8
  call void @llvm.init.trampoline(ptr %980, ptr @mcquszmxqr, ptr %981)
  %982 = call ptr @adjust_trampoline(ptr %980)
  store ptr %982, ptr %206, align 8
  %983 = call ptr @llvm.invariant.start.p0(i64 24, ptr %980)
  %984 = getelementptr { ptr }, ptr %206, i32 0, i32 0
  %985 = load ptr, ptr %984, align 8
  %986 = insertvalue { ptr } undef, ptr %985, 0
  %987 = load ptr, ptr %159, align 8
  %988 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %987, 0
  %989 = load ptr, ptr %158, align 8
  %990 = insertvalue { ptr, ptr, ptr, i32 } %988, ptr %989, 1
  %991 = load ptr, ptr %157, align 8
  %992 = insertvalue { ptr, ptr, ptr, i32 } %990, ptr %991, 2
  %993 = load i32, ptr %156, align 4
  %994 = insertvalue { ptr, ptr, ptr, i32 } %992, i32 %993, 3
  %995 = getelementptr [1 x ptr], ptr %207, i32 0, i32 0
  store ptr @_parameterization_FunctionPtri32_to_Ptri32, ptr %995, align 8
  %996 = call ptr @llvm.invariant.start.p0(i64 1, ptr %207)
  %997 = call ptr @llvm.invariant.start.p0(i64 600, ptr %987)
  %998 = getelementptr ptr, ptr %987, i32 %993
  %999 = getelementptr ptr, ptr %998, i32 22
  %1000 = load ptr, ptr %999, align 8
  %1001 = getelementptr { ptr }, ptr %208, i32 0, i32 0
  store ptr @function_typ, ptr %1001, align 8
  %1002 = call ptr @behavior_wrapper(ptr %1000, { ptr, ptr, ptr, i32 } %994, ptr %208)
  %1003 = call { ptr, ptr, ptr, i32 } %1002({ ptr, ptr, ptr, i32 } %994, { ptr, ptr, ptr, i32 } %994, ptr %207, { ptr } %986) #3
  store { ptr, ptr, ptr, i32 } %1003, ptr %209, align 8
  %1004 = getelementptr { ptr, ptr, ptr, i32 }, ptr %209, i32 0, i32 0
  %1005 = getelementptr { ptr, ptr, ptr, i32 }, ptr %210, i32 0, i32 0
  %1006 = load ptr, ptr %1004, align 8
  store ptr %1006, ptr %1005, align 8
  %1007 = getelementptr { ptr, ptr, ptr, i32 }, ptr %209, i32 0, i32 1
  %1008 = getelementptr { ptr, ptr, ptr, i32 }, ptr %210, i32 0, i32 1
  %1009 = load ptr, ptr %1007, align 8
  store ptr %1009, ptr %1008, align 8
  %1010 = getelementptr { ptr, ptr, ptr, i32 }, ptr %209, i32 0, i32 2
  %1011 = getelementptr { ptr, ptr, ptr, i32 }, ptr %210, i32 0, i32 2
  %1012 = load ptr, ptr %1010, align 8
  store ptr %1012, ptr %1011, align 8
  %1013 = getelementptr { ptr, ptr, ptr, i32 }, ptr %209, i32 0, i32 3
  %1014 = getelementptr { ptr, ptr, ptr, i32 }, ptr %210, i32 0, i32 3
  %1015 = load i32, ptr %1013, align 4
  store i32 %1015, ptr %1014, align 4
  call void @set_offset(ptr %210, ptr @MapIterable2)
  %1016 = getelementptr { ptr, ptr, ptr, i32 }, ptr %211, i32 0, i32 0
  %1017 = load ptr, ptr %1005, align 8
  store ptr %1017, ptr %1016, align 8
  %1018 = getelementptr { ptr, ptr, ptr, i32 }, ptr %211, i32 0, i32 1
  %1019 = load ptr, ptr %1008, align 8
  store ptr %1019, ptr %1018, align 8
  %1020 = getelementptr { ptr, ptr, ptr, i32 }, ptr %211, i32 0, i32 2
  %1021 = load ptr, ptr %1011, align 8
  store ptr %1021, ptr %1020, align 8
  %1022 = getelementptr { ptr, ptr, ptr, i32 }, ptr %211, i32 0, i32 3
  %1023 = load i32, ptr %1014, align 4
  store i32 %1023, ptr %1022, align 4
  call void @set_offset(ptr %211, ptr @MapIterable2)
  %1024 = load ptr, ptr %1016, align 8
  store ptr %1024, ptr %215, align 8
  %1025 = load ptr, ptr %1018, align 8
  store ptr %1025, ptr %214, align 8
  %1026 = load ptr, ptr %1020, align 8
  store ptr %1026, ptr %213, align 8
  %1027 = load i32, ptr %1022, align 4
  store i32 %1027, ptr %212, align 4
  %1028 = call ptr @bump_malloc(i64 ptrtoint (ptr getelementptr ([24 x i8], ptr null, i32 1) to i64))
  call void @anoint_trampoline(ptr %1028)
  %1029 = load ptr, ptr %205, align 8
  call void @llvm.init.trampoline(ptr %1028, ptr @uistxpvfyz, ptr %1029)
  %1030 = call ptr @adjust_trampoline(ptr %1028)
  store ptr %1030, ptr %216, align 8
  %1031 = call ptr @llvm.invariant.start.p0(i64 24, ptr %1028)
  %1032 = getelementptr { ptr }, ptr %216, i32 0, i32 0
  %1033 = load ptr, ptr %1032, align 8
  %1034 = insertvalue { ptr } undef, ptr %1033, 0
  %1035 = call ptr @bump_malloc(i64 ptrtoint (ptr getelementptr ([24 x i8], ptr null, i32 1) to i64))
  call void @anoint_trampoline(ptr %1035)
  %1036 = load ptr, ptr %204, align 8
  call void @llvm.init.trampoline(ptr %1035, ptr @qtocqwqnsn, ptr %1036)
  %1037 = call ptr @adjust_trampoline(ptr %1035)
  store ptr %1037, ptr %217, align 8
  %1038 = call ptr @llvm.invariant.start.p0(i64 24, ptr %1035)
  %1039 = getelementptr { ptr }, ptr %217, i32 0, i32 0
  %1040 = load ptr, ptr %1039, align 8
  %1041 = insertvalue { ptr } undef, ptr %1040, 0
  %1042 = load ptr, ptr %215, align 8
  %1043 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1042, 0
  %1044 = load ptr, ptr %214, align 8
  %1045 = insertvalue { ptr, ptr, ptr, i32 } %1043, ptr %1044, 1
  %1046 = load ptr, ptr %213, align 8
  %1047 = insertvalue { ptr, ptr, ptr, i32 } %1045, ptr %1046, 2
  %1048 = load i32, ptr %212, align 4
  %1049 = insertvalue { ptr, ptr, ptr, i32 } %1047, i32 %1048, 3
  %1050 = getelementptr [1 x ptr], ptr %218, i32 0, i32 0
  store ptr @_parameterization_FunctionPtri32_to_Ptri32, ptr %1050, align 8
  %1051 = call ptr @llvm.invariant.start.p0(i64 1, ptr %218)
  %1052 = call ptr @llvm.invariant.start.p0(i64 408, ptr %1042)
  %1053 = getelementptr ptr, ptr %1042, i32 %1048
  %1054 = getelementptr ptr, ptr %1053, i32 10
  %1055 = load ptr, ptr %1054, align 8
  %1056 = getelementptr { ptr }, ptr %219, i32 0, i32 0
  store ptr @function_typ, ptr %1056, align 8
  %1057 = call ptr @behavior_wrapper(ptr %1055, { ptr, ptr, ptr, i32 } %1049, ptr %219)
  %1058 = call { ptr, ptr, ptr, i32 } %1057({ ptr, ptr, ptr, i32 } %1049, { ptr, ptr, ptr, i32 } %1049, ptr %218, { ptr } %1041) #3
  store { ptr, ptr, ptr, i32 } %1058, ptr %220, align 8
  %1059 = getelementptr { ptr, ptr, ptr, i32 }, ptr %220, i32 0, i32 0
  %1060 = getelementptr { ptr, ptr, ptr, i32 }, ptr %221, i32 0, i32 0
  %1061 = load ptr, ptr %1059, align 8
  store ptr %1061, ptr %1060, align 8
  %1062 = getelementptr { ptr, ptr, ptr, i32 }, ptr %220, i32 0, i32 1
  %1063 = getelementptr { ptr, ptr, ptr, i32 }, ptr %221, i32 0, i32 1
  %1064 = load ptr, ptr %1062, align 8
  store ptr %1064, ptr %1063, align 8
  %1065 = getelementptr { ptr, ptr, ptr, i32 }, ptr %220, i32 0, i32 2
  %1066 = getelementptr { ptr, ptr, ptr, i32 }, ptr %221, i32 0, i32 2
  %1067 = load ptr, ptr %1065, align 8
  store ptr %1067, ptr %1066, align 8
  %1068 = getelementptr { ptr, ptr, ptr, i32 }, ptr %220, i32 0, i32 3
  %1069 = getelementptr { ptr, ptr, ptr, i32 }, ptr %221, i32 0, i32 3
  ...
  %1077 = load i32, ptr %1069, align 4
  %1078 = insertvalue { ptr, ptr, ptr, i32 } %1076, i32 %1077, 3
  %1079 = getelementptr [1 x ptr], ptr %222, i32 0, i32 0
  store ptr @_parameterization_FunctionPtri32_to_Ptrf64, ptr %1079, align 8
  %1080 = call ptr @llvm.invariant.start.p0(i64 1, ptr %222)
  %1081 = call ptr @llvm.invariant.start.p0(i64 408, ptr %1071)
  %1082 = getelementptr ptr, ptr %1071, i32 %1077
  %1083 = getelementptr ptr, ptr %1082, i32 10
  %1084 = load ptr, ptr %1083, align 8
  %1085 = getelementptr { ptr }, ptr %223, i32 0, i32 0
  store ptr @function_typ, ptr %1085, align 8
  %1086 = call ptr @behavior_wrapper(ptr %1084, { ptr, ptr, ptr, i32 } %1078, ptr %223)
  %1087 = call { ptr, ptr, ptr, i32 } %1086({ ptr, ptr, ptr, i32 } %1078, { ptr, ptr, ptr, i32 } %1078, ptr %222, { ptr } %1034) #3
  store { ptr, ptr, ptr, i32 } %1087, ptr %224, align 8
  %1088 = getelementptr { ptr, ptr, ptr, i32 }, ptr %224, i32 0, i32 0
  %1089 = getelementptr { ptr, ptr, ptr, i32 }, ptr %225, i32 0, i32 0
  %1090 = load ptr, ptr %1088, align 8
  store ptr %1090, ptr %1089, align 8
  %1091 = getelementptr { ptr, ptr, ptr, i32 }, ptr %224, i32 0, i32 1
  %1092 = getelementptr { ptr, ptr, ptr, i32 }, ptr %225, i32 0, i32 1
  %1093 = load ptr, ptr %1091, align 8
  store ptr %1093, ptr %1092, align 8
  %1094 = getelementptr { ptr, ptr, ptr, i32 }, ptr %224, i32 0, i32 2
  %1095 = getelementptr { ptr, ptr, ptr, i32 }, ptr %225, i32 0, i32 2
  %1096 = load ptr, ptr %1094, align 8
  store ptr %1096, ptr %1095, align 8
  %1097 = getelementptr { ptr, ptr, ptr, i32 }, ptr %224, i32 0, i32 3
  %1098 = getelementptr { ptr, ptr, ptr, i32 }, ptr %225, i32 0, i32 3
  %1099 = load i32, ptr %1097, align 4
  store i32 %1099, ptr %1098, align 4
  call void @set_offset(ptr %225, ptr @MapIterable2)
  %1100 = getelementptr { ptr, ptr, ptr, i32 }, ptr %226, i32 0, i32 0
  %1101 = load ptr, ptr %1089, align 8
  store ptr %1101, ptr %1100, align 8
  %1102 = getelementptr { ptr, ptr, ptr, i32 }, ptr %226, i32 0, i32 1
  %1103 = load ptr, ptr %1092, align 8
  store ptr %1103, ptr %1102, align 8
  %1104 = getelementptr { ptr, ptr, ptr, i32 }, ptr %226, i32 0, i32 2
  %1105 = load ptr, ptr %1095, align 8
  store ptr %1105, ptr %1104, align 8
  %1106 = getelementptr { ptr, ptr, ptr, i32 }, ptr %226, i32 0, i32 3
  %1107 = load i32, ptr %1098, align 4
  store i32 %1107, ptr %1106, align 4
  call void @set_offset(ptr %226, ptr @MapIterable2)
  %1108 = load ptr, ptr %1100, align 8
  store ptr %1108, ptr %230, align 8
  %1109 = load ptr, ptr %1102, align 8
  store ptr %1109, ptr %229, align 8
  %1110 = load ptr, ptr %1104, align 8
  store ptr %1110, ptr %228, align 8
  %1111 = load i32, ptr %1106, align 4
  store i32 %1111, ptr %227, align 4
  %1112 = load ptr, ptr %230, align 8
  %1113 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1112, 0
  %1114 = load ptr, ptr %229, align 8
  %1115 = insertvalue { ptr, ptr, ptr, i32 } %1113, ptr %1114, 1
  %1116 = load ptr, ptr %228, align 8
  %1117 = insertvalue { ptr, ptr, ptr, i32 } %1115, ptr %1116, 2
  %1118 = load i32, ptr %227, align 4
  %1119 = insertvalue { ptr, ptr, ptr, i32 } %1117, i32 %1118, 3
  %1120 = call ptr @llvm.invariant.start.p0(i64 0, ptr %231)
  %1121 = call ptr @llvm.invariant.start.p0(i64 408, ptr %1112)
  %1122 = getelementptr ptr, ptr %1112, i32 %1118
  %1123 = getelementptr ptr, ptr %1122, i32 5
  %1124 = load ptr, ptr %1123, align 8
  %1125 = call ptr @behavior_wrapper(ptr %1124, { ptr, ptr, ptr, i32 } %1119, ptr %232)
  %1126 = call { ptr, ptr, ptr, i32 } %1125({ ptr, ptr, ptr, i32 } %1119, { ptr, ptr, ptr, i32 } %1119, ptr %231) #3
  store { ptr, ptr, ptr, i32 } %1126, ptr %233, align 8
  %1127 = getelementptr { ptr, ptr, ptr, i32 }, ptr %233, i32 0, i32 0
  %1128 = getelementptr { ptr, ptr, ptr, i32 }, ptr %234, i32 0, i32 0
  %1129 = load ptr, ptr %1127, align 8
  store ptr %1129, ptr %1128, align 8
  %1130 = getelementptr { ptr, ptr, ptr, i32 }, ptr %233, i32 0, i32 1
  %1131 = getelementptr { ptr, ptr, ptr, i32 }, ptr %234, i32 0, i32 1
  %1132 = load ptr, ptr %1130, align 8
  store ptr %1132, ptr %1131, align 8
  %1133 = getelementptr { ptr, ptr, ptr, i32 }, ptr %233, i32 0, i32 2
  %1134 = getelementptr { ptr, ptr, ptr, i32 }, ptr %234, i32 0, i32 2
  %1135 = load ptr, ptr %1133, align 8
  store ptr %1135, ptr %1134, align 8
  %1136 = getelementptr { ptr, ptr, ptr, i32 }, ptr %233, i32 0, i32 3
  %1137 = getelementptr { ptr, ptr, ptr, i32 }, ptr %234, i32 0, i32 3
  %1138 = load i32, ptr %1136, align 4
  store i32 %1138, ptr %1137, align 4
  call void @set_offset(ptr %234, ptr @MapIterator2)
  %1139 = getelementptr { ptr, ptr, ptr, i32 }, ptr %235, i32 0, i32 0
  %1140 = load ptr, ptr %1128, align 8
  store ptr %1140, ptr %1139, align 8
  %1141 = getelementptr { ptr, ptr, ptr, i32 }, ptr %235, i32 0, i32 1
  %1142 = load ptr, ptr %1131, align 8
  store ptr %1142, ptr %1141, align 8
  %1143 = getelementptr { ptr, ptr, ptr, i32 }, ptr %235, i32 0, i32 2
  %1144 = load ptr, ptr %1134, align 8
  store ptr %1144, ptr %1143, align 8
  %1145 = getelementptr { ptr, ptr, ptr, i32 }, ptr %235, i32 0, i32 3
  %1146 = load i32, ptr %1137, align 4
  store i32 %1146, ptr %1145, align 4
  call void @set_offset(ptr %235, ptr @MapIterator2)
  %1147 = load ptr, ptr %1139, align 8
  store ptr %1147, ptr %239, align 8
  %1148 = load ptr, ptr %1141, align 8
  store ptr %1148, ptr %238, align 8
  %1149 = load ptr, ptr %1143, align 8
  store ptr %1149, ptr %237, align 8
  %1150 = load i32, ptr %1145, align 4
  store i32 %1150, ptr %236, align 4
  %1151 = getelementptr { ptr, i64 }, ptr %242, i32 0, i32 0
  %1152 = getelementptr { ptr, i64 }, ptr %242, i32 0, i32 1
  br label %1153

1153:                                             ; preds = %1205, %0
  %1154 = load ptr, ptr %239, align 8
  %1155 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1154, 0
  %1156 = load ptr, ptr %238, align 8
  %1157 = insertvalue { ptr, ptr, ptr, i32 } %1155, ptr %1156, 1
  %1158 = load ptr, ptr %237, align 8
  %1159 = insertvalue { ptr, ptr, ptr, i32 } %1157, ptr %1158, 2
  %1160 = load i32, ptr %236, align 4
  %1161 = insertvalue { ptr, ptr, ptr, i32 } %1159, i32 %1160, 3
  %1162 = call ptr @llvm.invariant.start.p0(i64 0, ptr %240)
  %1163 = call ptr @llvm.invariant.start.p0(i64 88, ptr %1154)
  %1164 = getelementptr ptr, ptr %1154, i32 %1160
  %1165 = getelementptr ptr, ptr %1164, i32 5
  %1166 = load ptr, ptr %1165, align 8
  %1167 = call ptr @behavior_wrapper(ptr %1166, { ptr, ptr, ptr, i32 } %1161, ptr %241)
  %1168 = call { ptr, i160 } %1167({ ptr, ptr, ptr, i32 } %1161, { ptr, ptr, ptr, i32 } %1161, ptr %240) #3
  store { ptr, i160 } %1168, ptr %242, align 8
  %1169 = load ptr, ptr %1151, align 8
  store ptr %1169, ptr %243, align 8
  %1170 = load i64, ptr %1152, align 4
  store i64 %1170, ptr %244, align 4
  %1171 = load ptr, ptr %243, align 8
  %1172 = ptrtoint ptr %1171 to i64
  %1173 = icmp eq i64 %1172, ptrtoint (ptr @nil_typ to i64)
  %1174 = icmp eq i64 %1172, 0
  %1175 = or i1 %1173, %1174
  %1176 = icmp eq i1 %1175, false
  store i1 %1176, ptr %245, align 1
  %1177 = load i1, ptr %245, align 1
  br i1 %1177, label %1178, label %1205

1178:                                             ; preds = %1153
  %1179 = load double, ptr %244, align 8
  store double %1179, ptr %246, align 8
  store i32 55, ptr %247, align 4
  %1180 = load i32, ptr %247, align 4
  store i32 %1180, ptr %248, align 4
  store i64 ptrtoint (ptr @i32_typ to i64), ptr %250, align 4
  %1181 = load i64, ptr %250, align 4
  store i64 %1181, ptr %249, align 4
  %1182 = load ptr, ptr %249, align 8
  %1183 = insertvalue { ptr, i160 } undef, ptr %1182, 0
  %1184 = load i160, ptr %248, align 4
  %1185 = insertvalue { ptr, i160 } %1183, i160 %1184, 1
  %1186 = getelementptr [1 x ptr], ptr %251, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %1186, align 8
  %1187 = call ptr @llvm.invariant.start.p0(i64 1, ptr %251)
  %1188 = call ptr @llvm.invariant.start.p0(i64 80, ptr @IO)
  %1189 = load ptr, ptr getelementptr (ptr, ptr @IO, i32 10), align 8
  %1190 = getelementptr { ptr }, ptr %252, i32 0, i32 0
  store ptr %1182, ptr %1190, align 8
  %1191 = call ptr @class_behavior_wrapper(ptr %1189, ptr %252)
  call void %1191(ptr %251, { ptr, i160 } %1185) #3
  %1192 = load double, ptr %246, align 8
  store double %1192, ptr %253, align 8
  store i64 ptrtoint (ptr @f64_typ to i64), ptr %255, align 4
  %1193 = load i64, ptr %255, align 4
  store i64 %1193, ptr %254, align 4
  %1194 = load ptr, ptr %254, align 8
  %1195 = insertvalue { ptr, i160 } undef, ptr %1194, 0
  %1196 = load i160, ptr %253, align 4
  %1197 = insertvalue { ptr, i160 } %1195, i160 %1196, 1
  %1198 = getelementptr [1 x ptr], ptr %256, i32 0, i32 0
  store ptr @_parameterization_Ptrf64, ptr %1198, align 8
  %1199 = call ptr @llvm.invariant.start.p0(i64 1, ptr %256)
  %1200 = call ptr @llvm.invariant.start.p0(i64 80, ptr @IO)
  %1201 = load ptr, ptr getelementptr (ptr, ptr @IO, i32 10), align 8
  %1202 = getelementptr { ptr }, ptr %257, i32 0, i32 0
  store ptr %1194, ptr %1202, align 8
  %1203 = call ptr @class_behavior_wrapper(ptr %1201, ptr %257)
  call void %1203(ptr %256, { ptr, i160 } %1197) #3
  %1204 = load double, ptr %246, align 8
  store double %1204, ptr %243, align 8
  br label %1205

1205:                                             ; preds = %1178, %1153
  br i1 %1177, label %1153, label %1206

1206:                                             ; preds = %1205
  %1207 = getelementptr { ptr, ptr, ptr, i32 }, ptr %258, i32 0, i32 0
  %1208 = load ptr, ptr %230, align 8
  store ptr %1208, ptr %1207, align 8
  %1209 = getelementptr { ptr, ptr, ptr, i32 }, ptr %258, i32 0, i32 1
  %1210 = load ptr, ptr %229, align 8
  store ptr %1210, ptr %1209, align 8
  %1211 = getelementptr { ptr, ptr, ptr, i32 }, ptr %258, i32 0, i32 2
  %1212 = load ptr, ptr %228, align 8
  store ptr %1212, ptr %1211, align 8
  %1213 = getelementptr { ptr, ptr, ptr, i32 }, ptr %258, i32 0, i32 3
  %1214 = load i32, ptr %227, align 4
  ...
  %1220 = insertvalue { ptr, ptr, ptr, i32 } %1218, ptr %1219, 2
  %1221 = load i32, ptr %1213, align 4
  %1222 = insertvalue { ptr, ptr, ptr, i32 } %1220, i32 %1221, 3
  %1223 = load ptr, ptr %159, align 8
  ...
  %1227 = load ptr, ptr %157, align 8
  %1228 = insertvalue { ptr, ptr, ptr, i32 } %1226, ptr %1227, 2
  %1229 = load i32, ptr %156, align 4
  %1230 = insertvalue { ptr, ptr, ptr, i32 } %1228, i32 %1229, 3
  %1231 = getelementptr [1 x ptr], ptr %259, i32 0, i32 0
  store ptr @_parameterization_MapIterable2Ptri32._Ptrf64, ptr %1231, align 8
  %1232 = call ptr @llvm.invariant.start.p0(i64 1, ptr %259)
  %1233 = call ptr @llvm.invariant.start.p0(i64 600, ptr %1223)
  %1234 = getelementptr ptr, ptr %1223, i32 %1229
  %1235 = getelementptr ptr, ptr %1234, i32 26
  %1236 = load ptr, ptr %1235, align 8
  %1237 = getelementptr { ptr }, ptr %260, i32 0, i32 0
  store ptr %1215, ptr %1237, align 8
  %1238 = call ptr @behavior_wrapper(ptr %1236, { ptr, ptr, ptr, i32 } %1230, ptr %260)
  %1239 = call { ptr, ptr, ptr, i32 } %1238({ ptr, ptr, ptr, i32 } %1230, { ptr, ptr, ptr, i32 } %1230, ptr %259, { ptr, ptr, ptr, i32 } %1222) #3
  store { ptr, ptr, ptr, i32 } %1239, ptr %261, align 8
  %1240 = getelementptr { ptr, ptr, ptr, i32 }, ptr %261, i32 0, i32 0
  %1241 = getelementptr { ptr, ptr, ptr, i32 }, ptr %262, i32 0, i32 0
  %1242 = load ptr, ptr %1240, align 8
  store ptr %1242, ptr %1241, align 8
  %1243 = getelementptr { ptr, ptr, ptr, i32 }, ptr %261, i32 0, i32 1
  %1244 = getelementptr { ptr, ptr, ptr, i32 }, ptr %262, i32 0, i32 1
  %1245 = load ptr, ptr %1243, align 8
  store ptr %1245, ptr %1244, align 8
  %1246 = getelementptr { ptr, ptr, ptr, i32 }, ptr %261, i32 0, i32 2
  %1247 = getelementptr { ptr, ptr, ptr, i32 }, ptr %262, i32 0, i32 2
  %1248 = load ptr, ptr %1246, align 8
  store ptr %1248, ptr %1247, align 8
  %1249 = getelementptr { ptr, ptr, ptr, i32 }, ptr %261, i32 0, i32 3
  %1250 = getelementptr { ptr, ptr, ptr, i32 }, ptr %262, i32 0, i32 3
  %1251 = load i32, ptr %1249, align 4
  store i32 %1251, ptr %1250, align 4
  call void @set_offset(ptr %262, ptr @ZipIterable2)
  %1252 = getelementptr { ptr, ptr, ptr, i32 }, ptr %263, i32 0, i32 0
  %1253 = load ptr, ptr %1241, align 8
  store ptr %1253, ptr %1252, align 8
  %1254 = getelementptr { ptr, ptr, ptr, i32 }, ptr %263, i32 0, i32 1
  %1255 = load ptr, ptr %1244, align 8
  store ptr %1255, ptr %1254, align 8
  %1256 = getelementptr { ptr, ptr, ptr, i32 }, ptr %263, i32 0, i32 2
  %1257 = load ptr, ptr %1247, align 8
  store ptr %1257, ptr %1256, align 8
  %1258 = getelementptr { ptr, ptr, ptr, i32 }, ptr %263, i32 0, i32 3
  %1259 = load i32, ptr %1250, align 4
  store i32 %1259, ptr %1258, align 4
  call void @set_offset(ptr %263, ptr @ZipIterable2)
  %1260 = load ptr, ptr %1252, align 8
  store ptr %1260, ptr %267, align 8
  %1261 = load ptr, ptr %1254, align 8
  store ptr %1261, ptr %266, align 8
  %1262 = load ptr, ptr %1256, align 8
  store ptr %1262, ptr %265, align 8
  %1263 = load i32, ptr %1258, align 4
  store i32 %1263, ptr %264, align 4
  %1264 = load ptr, ptr %267, align 8
  %1265 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1264, 0
  %1266 = load ptr, ptr %266, align 8
  %1267 = insertvalue { ptr, ptr, ptr, i32 } %1265, ptr %1266, 1
  %1268 = load ptr, ptr %265, align 8
  %1269 = insertvalue { ptr, ptr, ptr, i32 } %1267, ptr %1268, 2
  %1270 = load i32, ptr %264, align 4
  %1271 = insertvalue { ptr, ptr, ptr, i32 } %1269, i32 %1270, 3
  %1272 = call ptr @llvm.invariant.start.p0(i64 0, ptr %268)
  %1273 = call ptr @llvm.invariant.start.p0(i64 416, ptr %1264)
  %1274 = getelementptr ptr, ptr %1264, i32 %1270
  %1275 = getelementptr ptr, ptr %1274, i32 6
  %1276 = load ptr, ptr %1275, align 8
  %1277 = call ptr @behavior_wrapper(ptr %1276, { ptr, ptr, ptr, i32 } %1271, ptr %269)
  %1278 = call { ptr, ptr, ptr, i32 } %1277({ ptr, ptr, ptr, i32 } %1271, { ptr, ptr, ptr, i32 } %1271, ptr %268) #3
  store { ptr, ptr, ptr, i32 } %1278, ptr %270, align 8
  %1279 = getelementptr { ptr, ptr, ptr, i32 }, ptr %270, i32 0, i32 0
  %1280 = getelementptr { ptr, ptr, ptr, i32 }, ptr %271, i32 0, i32 0
  %1281 = load ptr, ptr %1279, align 8
  store ptr %1281, ptr %1280, align 8
  %1282 = getelementptr { ptr, ptr, ptr, i32 }, ptr %270, i32 0, i32 1
  %1283 = getelementptr { ptr, ptr, ptr, i32 }, ptr %271, i32 0, i32 1
  %1284 = load ptr, ptr %1282, align 8
  store ptr %1284, ptr %1283, align 8
  %1285 = getelementptr { ptr, ptr, ptr, i32 }, ptr %270, i32 0, i32 2
  %1286 = getelementptr { ptr, ptr, ptr, i32 }, ptr %271, i32 0, i32 2
  %1287 = load ptr, ptr %1285, align 8
  store ptr %1287, ptr %1286, align 8
  %1288 = getelementptr { ptr, ptr, ptr, i32 }, ptr %270, i32 0, i32 3
  %1289 = getelementptr { ptr, ptr, ptr, i32 }, ptr %271, i32 0, i32 3
  %1290 = load i32, ptr %1288, align 4
  store i32 %1290, ptr %1289, align 4
  call void @set_offset(ptr %271, ptr @ZipIterator2)
  %1291 = getelementptr { ptr, ptr, ptr, i32 }, ptr %272, i32 0, i32 0
  %1292 = load ptr, ptr %1280, align 8
  store ptr %1292, ptr %1291, align 8
  %1293 = getelementptr { ptr, ptr, ptr, i32 }, ptr %272, i32 0, i32 1
  %1294 = load ptr, ptr %1283, align 8
  store ptr %1294, ptr %1293, align 8
  %1295 = getelementptr { ptr, ptr, ptr, i32 }, ptr %272, i32 0, i32 2
  %1296 = load ptr, ptr %1286, align 8
  store ptr %1296, ptr %1295, align 8
  %1297 = getelementptr { ptr, ptr, ptr, i32 }, ptr %272, i32 0, i32 3
  %1298 = load i32, ptr %1289, align 4
  store i32 %1298, ptr %1297, align 4
  call void @set_offset(ptr %272, ptr @ZipIterator2)
  %1299 = load ptr, ptr %1291, align 8
  store ptr %1299, ptr %276, align 8
  %1300 = load ptr, ptr %1293, align 8
  store ptr %1300, ptr %275, align 8
  %1301 = load ptr, ptr %1295, align 8
  store ptr %1301, ptr %274, align 8
  %1302 = load i32, ptr %1297, align 4
  store i32 %1302, ptr %273, align 4
  br label %1303

1303:                                             ; preds = %1411, %1206
  %1304 = load ptr, ptr %276, align 8
  %1305 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1304, 0
  %1306 = load ptr, ptr %275, align 8
  %1307 = insertvalue { ptr, ptr, ptr, i32 } %1305, ptr %1306, 1
  %1308 = load ptr, ptr %274, align 8
  %1309 = insertvalue { ptr, ptr, ptr, i32 } %1307, ptr %1308, 2
  %1310 = load i32, ptr %273, align 4
  %1311 = insertvalue { ptr, ptr, ptr, i32 } %1309, i32 %1310, 3
  %1312 = call ptr @llvm.invariant.start.p0(i64 0, ptr %277)
  %1313 = call ptr @llvm.invariant.start.p0(i64 96, ptr %1304)
  %1314 = getelementptr ptr, ptr %1304, i32 %1310
  %1315 = getelementptr ptr, ptr %1314, i32 6
  %1316 = load ptr, ptr %1315, align 8
  %1317 = call ptr @behavior_wrapper(ptr %1316, { ptr, ptr, ptr, i32 } %1311, ptr %278)
  %1318 = call { ptr, i160 } %1317({ ptr, ptr, ptr, i32 } %1311, { ptr, ptr, ptr, i32 } %1311, ptr %277) #3
  store { ptr, i160 } %1318, ptr %279, align 8
  %1319 = load ptr, ptr %279, align 8
  %1320 = ptrtoint ptr %1319 to i64
  %1321 = icmp eq i64 %1320, ptrtoint (ptr @nil_typ to i64)
  %1322 = icmp eq i64 %1320, 0
  %1323 = or i1 %1321, %1322
  %1324 = icmp eq i1 %1323, false
  store i1 %1324, ptr %280, align 1
  %1325 = load i1, ptr %280, align 1
  br i1 %1325, label %1326, label %1411

1326:                                             ; preds = %1303
  %1327 = getelementptr { ptr, i160 }, ptr %279, i32 0, i32 0
  %1328 = getelementptr { ptr, i160 }, ptr %281, i32 0, i32 0
  %1329 = load ptr, ptr %1327, align 8
  store ptr %1329, ptr %1328, align 8
  %1330 = getelementptr { ptr, i160 }, ptr %279, i32 0, i32 1
  %1331 = getelementptr { ptr, i160 }, ptr %281, i32 0, i32 1
  %1332 = load i160, ptr %1330, align 4
  store i160 %1332, ptr %1331, align 4
  call void @set_offset(ptr %281, ptr @Pair)
  %1333 = getelementptr { ptr, ptr, ptr, i32 }, ptr %281, i32 0, i32 0
  %1334 = load ptr, ptr %1333, align 8
  %1335 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1334, 0
  %1336 = getelementptr { ptr, ptr, ptr, i32 }, ptr %281, i32 0, i32 1
  %1337 = load ptr, ptr %1336, align 8
  %1338 = insertvalue { ptr, ptr, ptr, i32 } %1335, ptr %1337, 1
  %1339 = getelementptr { ptr, ptr, ptr, i32 }, ptr %281, i32 0, i32 2
  %1340 = load ptr, ptr %1339, align 8
  %1341 = insertvalue { ptr, ptr, ptr, i32 } %1338, ptr %1340, 2
  %1342 = getelementptr { ptr, ptr, ptr, i32 }, ptr %281, i32 0, i32 3
  %1343 = load i32, ptr %1342, align 4
  %1344 = insertvalue { ptr, ptr, ptr, i32 } %1341, i32 %1343, 3
  %1345 = call ptr @llvm.invariant.start.p0(i64 0, ptr %282)
  %1346 = call ptr @llvm.invariant.start.p0(i64 80, ptr %1334)
  %1347 = getelementptr ptr, ptr %1334, i32 %1343
  %1348 = getelementptr ptr, ptr %1347, i32 5
  %1349 = load ptr, ptr %1348, align 8
  %1350 = call ptr @behavior_wrapper(ptr %1349, { ptr, ptr, ptr, i32 } %1344, ptr %283)
  %1351 = call { ptr, i160 } %1350({ ptr, ptr, ptr, i32 } %1344, { ptr, ptr, ptr, i32 } %1344, ptr %282) #3
  store { ptr, i160 } %1351, ptr %284, align 8
  %1352 = getelementptr { ptr, i160 }, ptr %284, i32 0, i32 1
  %1353 = load i32, ptr %1352, align 4
  store i32 %1353, ptr %285, align 4
  %1354 = load i32, ptr %285, align 4
  store i32 %1354, ptr %286, align 4
  store i64 ptrtoint (ptr @i32_typ to i64), ptr %288, align 4
  %1355 = load i64, ptr %288, align 4
  store i64 %1355, ptr %287, align 4
  %1356 = load ptr, ptr %287, align 8
  %1357 = insertvalue { ptr, i160 } undef, ptr %1356, 0
  %1358 = load i160, ptr %286, align 4
  %1359 = insertvalue { ptr, i160 } %1357, i160 %1358, 1
  %1360 = getelementptr [1 x ptr], ptr %289, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %1360, align 8
  %1361 = call ptr @llvm.invariant.start.p0(i64 1, ptr %289)
  %1362 = call ptr @llvm.invariant.start.p0(i64 80, ptr @IO)
  %1363 = load ptr, ptr getelementptr (ptr, ptr @IO, i32 10), align 8
  %1364 = getelementptr { ptr }, ptr %290, i32 0, i32 0
  store ptr %1356, ptr %1364, align 8
  %1365 = call ptr @class_behavior_wrapper(ptr %1363, ptr %290)
  call void %1365(ptr %289, { ptr, i160 } %1359) #3
  %1366 = load ptr, ptr %1333, align 8
  ...
  %1370 = load ptr, ptr %1339, align 8
  %1371 = insertvalue { ptr, ptr, ptr, i32 } %1369, ptr %1370, 2
  %1372 = load i32, ptr %1342, align 4
  %1373 = insertvalue { ptr, ptr, ptr, i32 } %1371, i32 %1372, 3
  %1374 = call ptr @llvm.invariant.start.p0(i64 0, ptr %291)
  %1375 = call ptr @llvm.invariant.start.p0(i64 80, ptr %1366)
  %1376 = getelementptr ptr, ptr %1366, i32 %1372
  %1377 = getelementptr ptr, ptr %1376, i32 6
  %1378 = load ptr, ptr %1377, align 8
  %1379 = call ptr @behavior_wrapper(ptr %1378, { ptr, ptr, ptr, i32 } %1373, ptr %292)
  %1380 = call { ptr, i160 } %1379({ ptr, ptr, ptr, i32 } %1373, { ptr, ptr, ptr, i32 } %1373, ptr %291) #3
  store { ptr, i160 } %1380, ptr %293, align 8
  %1381 = getelementptr { ptr, i160 }, ptr %293, i32 0, i32 1
  %1382 = load double, ptr %1381, align 8
  store double %1382, ptr %294, align 8
  %1383 = load double, ptr %294, align 8
  store double %1383, ptr %295, align 8
  store i64 ptrtoint (ptr @f64_typ to i64), ptr %297, align 4
  %1384 = load i64, ptr %297, align 4
  store i64 %1384, ptr %296, align 4
  %1385 = load ptr, ptr %296, align 8
  %1386 = insertvalue { ptr, i160 } undef, ptr %1385, 0
  %1387 = load i160, ptr %295, align 4
  %1388 = insertvalue { ptr, i160 } %1386, i160 %1387, 1
  %1389 = getelementptr [1 x ptr], ptr %298, i32 0, i32 0
  store ptr @_parameterization_Ptrf64, ptr %1389, align 8
  %1390 = call ptr @llvm.invariant.start.p0(i64 1, ptr %298)
  %1391 = call ptr @llvm.invariant.start.p0(i64 80, ptr @IO)
  %1392 = load ptr, ptr getelementptr (ptr, ptr @IO, i32 10), align 8
  %1393 = getelementptr { ptr }, ptr %299, i32 0, i32 0
  store ptr %1385, ptr %1393, align 8
  %1394 = call ptr @class_behavior_wrapper(ptr %1392, ptr %299)
  call void %1394(ptr %298, { ptr, i160 } %1388) #3
  %1395 = getelementptr { ptr, ptr, ptr, i32 }, ptr %300, i32 0, i32 0
  %1396 = load ptr, ptr %1333, align 8
  store ptr %1396, ptr %1395, align 8
  %1397 = getelementptr { ptr, ptr, ptr, i32 }, ptr %300, i32 0, i32 1
  %1398 = load ptr, ptr %1336, align 8
  store ptr %1398, ptr %1397, align 8
  %1399 = getelementptr { ptr, ptr, ptr, i32 }, ptr %300, i32 0, i32 2
  %1400 = load ptr, ptr %1339, align 8
  store ptr %1400, ptr %1399, align 8
  %1401 = getelementptr { ptr, ptr, ptr, i32 }, ptr %300, i32 0, i32 3
  %1402 = load i32, ptr %1342, align 4
  store i32 %1402, ptr %1401, align 4
  call void @set_offset(ptr %300, ptr @Pair)
  %1403 = getelementptr { ptr, ptr, ptr, i32 }, ptr %279, i32 0, i32 0
  %1404 = load ptr, ptr %1395, align 8
  store ptr %1404, ptr %1403, align 8
  %1405 = getelementptr { ptr, ptr, ptr, i32 }, ptr %279, i32 0, i32 1
  %1406 = load ptr, ptr %1397, align 8
  store ptr %1406, ptr %1405, align 8
  %1407 = getelementptr { ptr, ptr, ptr, i32 }, ptr %279, i32 0, i32 2
  %1408 = load ptr, ptr %1399, align 8
  store ptr %1408, ptr %1407, align 8
  %1409 = getelementptr { ptr, ptr, ptr, i32 }, ptr %279, i32 0, i32 3
  %1410 = load i32, ptr %1401, align 4
  store i32 %1410, ptr %1409, align 4
  br label %1411

1411:                                             ; preds = %1326, %1303
  br i1 %1325, label %1303, label %1412

1412:                                             ; preds = %1411
  store i32 5, ptr %301, align 4
  store ptr @Int32, ptr %302, align 8
  %1413 = load ptr, ptr %302, align 8
  %1414 = getelementptr ptr, ptr %1413, i32 6
  %1415 = load ptr, ptr %1414, align 8
  %1416 = call { i64, i64 } @size_wrapper(ptr %1415, ptr %302)
  %1417 = extractvalue { i64, i64 } %1416, 0
  %1418 = call ptr @bump_malloc(i64 %1417)
  store ptr @Int32, ptr %306, align 8
  store ptr %1418, ptr %305, align 8
  store i32 10, ptr %303, align 4
  store i32 5, ptr %307, align 4
  %1419 = load i32, ptr %307, align 4
  %1420 = load ptr, ptr %306, align 8
  %1421 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1420, 0
  %1422 = load ptr, ptr %305, align 8
  %1423 = insertvalue { ptr, ptr, ptr, i32 } %1421, ptr %1422, 1
  %1424 = load ptr, ptr %304, align 8
  %1425 = insertvalue { ptr, ptr, ptr, i32 } %1423, ptr %1424, 2
  %1426 = load i32, ptr %303, align 4
  %1427 = insertvalue { ptr, ptr, ptr, i32 } %1425, i32 %1426, 3
  %1428 = getelementptr [1 x ptr], ptr %308, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %1428, align 8
  %1429 = call ptr @llvm.invariant.start.p0(i64 1, ptr %308)
  %1430 = call ptr @llvm.invariant.start.p0(i64 136, ptr %1420)
  %1431 = getelementptr ptr, ptr %1420, i32 %1426
  %1432 = getelementptr ptr, ptr %1431, i32 2
  %1433 = load ptr, ptr %1432, align 8
  %1434 = getelementptr { ptr }, ptr %309, i32 0, i32 0
  store ptr @i32_typ, ptr %1434, align 8
  %1435 = call ptr @behavior_wrapper(ptr %1433, { ptr, ptr, ptr, i32 } %1427, ptr %309)
  call void %1435({ ptr, ptr, ptr, i32 } %1427, { ptr, ptr, ptr, i32 } %1427, ptr %308, i32 %1419) #3
  %1436 = getelementptr { ptr, ptr, ptr, i32 }, ptr %310, i32 0, i32 0
  %1437 = load ptr, ptr %306, align 8
  store ptr %1437, ptr %1436, align 8
  %1438 = getelementptr { ptr, ptr, ptr, i32 }, ptr %310, i32 0, i32 1
  %1439 = load ptr, ptr %305, align 8
  store ptr %1439, ptr %1438, align 8
  %1440 = getelementptr { ptr, ptr, ptr, i32 }, ptr %310, i32 0, i32 2
  %1441 = load ptr, ptr %304, align 8
  store ptr %1441, ptr %1440, align 8
  %1442 = getelementptr { ptr, ptr, ptr, i32 }, ptr %310, i32 0, i32 3
  %1443 = load i32, ptr %303, align 4
  store i32 %1443, ptr %1442, align 4
  call void @set_offset(ptr %310, ptr @Int32)
  %1444 = load ptr, ptr %1436, align 8
  store ptr %1444, ptr %314, align 8
  %1445 = load ptr, ptr %1438, align 8
  store ptr %1445, ptr %313, align 8
  %1446 = load ptr, ptr %1440, align 8
  store ptr %1446, ptr %312, align 8
  %1447 = load i32, ptr %1442, align 4
  store i32 %1447, ptr %311, align 4
  store i32 7, ptr %315, align 4
  store ptr @Int32, ptr %316, align 8
  %1448 = load ptr, ptr %316, align 8
  %1449 = getelementptr ptr, ptr %1448, i32 6
  %1450 = load ptr, ptr %1449, align 8
  %1451 = call { i64, i64 } @size_wrapper(ptr %1450, ptr %316)
  %1452 = extractvalue { i64, i64 } %1451, 0
  %1453 = call ptr @bump_malloc(i64 %1452)
  store ptr @Int32, ptr %320, align 8
  store ptr %1453, ptr %319, align 8
  store i32 10, ptr %317, align 4
  store i32 7, ptr %321, align 4
  %1454 = load i32, ptr %321, align 4
  %1455 = load ptr, ptr %320, align 8
  %1456 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1455, 0
  %1457 = load ptr, ptr %319, align 8
  %1458 = insertvalue { ptr, ptr, ptr, i32 } %1456, ptr %1457, 1
  %1459 = load ptr, ptr %318, align 8
  %1460 = insertvalue { ptr, ptr, ptr, i32 } %1458, ptr %1459, 2
  %1461 = load i32, ptr %317, align 4
  %1462 = insertvalue { ptr, ptr, ptr, i32 } %1460, i32 %1461, 3
  %1463 = getelementptr [1 x ptr], ptr %322, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %1463, align 8
  %1464 = call ptr @llvm.invariant.start.p0(i64 1, ptr %322)
  %1465 = call ptr @llvm.invariant.start.p0(i64 136, ptr %1455)
  %1466 = getelementptr ptr, ptr %1455, i32 %1461
  %1467 = getelementptr ptr, ptr %1466, i32 2
  %1468 = load ptr, ptr %1467, align 8
  %1469 = getelementptr { ptr }, ptr %323, i32 0, i32 0
  store ptr @i32_typ, ptr %1469, align 8
  %1470 = call ptr @behavior_wrapper(ptr %1468, { ptr, ptr, ptr, i32 } %1462, ptr %323)
  call void %1470({ ptr, ptr, ptr, i32 } %1462, { ptr, ptr, ptr, i32 } %1462, ptr %322, i32 %1454) #3
  %1471 = getelementptr { ptr, ptr, ptr, i32 }, ptr %324, i32 0, i32 0
  %1472 = load ptr, ptr %320, align 8
  store ptr %1472, ptr %1471, align 8
  %1473 = getelementptr { ptr, ptr, ptr, i32 }, ptr %324, i32 0, i32 1
  %1474 = load ptr, ptr %319, align 8
  store ptr %1474, ptr %1473, align 8
  %1475 = getelementptr { ptr, ptr, ptr, i32 }, ptr %324, i32 0, i32 2
  %1476 = load ptr, ptr %318, align 8
  store ptr %1476, ptr %1475, align 8
  %1477 = getelementptr { ptr, ptr, ptr, i32 }, ptr %324, i32 0, i32 3
  %1478 = load i32, ptr %317, align 4
  store i32 %1478, ptr %1477, align 4
  call void @set_offset(ptr %324, ptr @Int32)
  %1479 = getelementptr { ptr, ptr, ptr, i32 }, ptr %325, i32 0, i32 0
  %1480 = load ptr, ptr %1471, align 8
  store ptr %1480, ptr %1479, align 8
  %1481 = getelementptr { ptr, ptr, ptr, i32 }, ptr %325, i32 0, i32 1
  %1482 = load ptr, ptr %1473, align 8
  store ptr %1482, ptr %1481, align 8
  %1483 = getelementptr { ptr, ptr, ptr, i32 }, ptr %325, i32 0, i32 2
  %1484 = load ptr, ptr %1475, align 8
  store ptr %1484, ptr %1483, align 8
  %1485 = getelementptr { ptr, ptr, ptr, i32 }, ptr %325, i32 0, i32 3
  %1486 = load i32, ptr %1477, align 4
  store i32 %1486, ptr %1485, align 4
  %1487 = getelementptr { ptr, i160 }, ptr %325, i32 0, i32 0
  %1488 = load ptr, ptr %1487, align 8
  %1489 = insertvalue { ptr, i160 } undef, ptr %1488, 0
  %1490 = getelementptr { ptr, i160 }, ptr %325, i32 0, i32 1
  %1491 = load i160, ptr %1490, align 4
  %1492 = insertvalue { ptr, i160 } %1489, i160 %1491, 1
  %1493 = load ptr, ptr %314, align 8
  %1494 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1493, 0
  %1495 = load ptr, ptr %313, align 8
  %1496 = insertvalue { ptr, ptr, ptr, i32 } %1494, ptr %1495, 1
  %1497 = load ptr, ptr %312, align 8
  %1498 = insertvalue { ptr, ptr, ptr, i32 } %1496, ptr %1497, 2
  %1499 = load i32, ptr %311, align 4
  %1500 = insertvalue { ptr, ptr, ptr, i32 } %1498, i32 %1499, 3
  %1501 = getelementptr [1 x ptr], ptr %326, i32 0, i32 0
  store ptr @_parameterization_Int32, ptr %1501, align 8
  %1502 = call ptr @llvm.invariant.start.p0(i64 1, ptr %326)
  %1503 = call ptr @llvm.invariant.start.p0(i64 136, ptr %1493)
  %1504 = getelementptr ptr, ptr %1493, i32 %1499
  %1505 = getelementptr ptr, ptr %1504, i32 4
  %1506 = load ptr, ptr %1505, align 8
  %1507 = getelementptr { ptr }, ptr %327, i32 0, i32 0
  store ptr %1488, ptr %1507, align 8
  %1508 = call ptr @behavior_wrapper(ptr %1506, { ptr, ptr, ptr, i32 } %1500, ptr %327)
  %1509 = call { ptr, i160 } %1508({ ptr, ptr, ptr, i32 } %1500, { ptr, ptr, ptr, i32 } %1500, ptr %326, { ptr, i160 } %1492) #3
  store { ptr, i160 } %1509, ptr %328, align 8
  %1510 = getelementptr { ptr, i160 }, ptr %328, i32 0, i32 0
  %1511 = getelementptr { ptr, i160 }, ptr %329, i32 0, i32 0
  %1512 = load ptr, ptr %1510, align 8
  store ptr %1512, ptr %1511, align 8
  %1513 = getelementptr { ptr, i160 }, ptr %328, i32 0, i32 1
  %1514 = getelementptr { ptr, i160 }, ptr %329, i32 0, i32 1
  %1515 = load i160, ptr %1513, align 4
  store i160 %1515, ptr %1514, align 4
  call void @set_offset(ptr %329, ptr @Int32)
  %1516 = getelementptr { ptr, ptr, ptr, i32 }, ptr %329, i32 0, i32 0
  %1517 = getelementptr { ptr, ptr, ptr, i32 }, ptr %330, i32 0, i32 0
  %1518 = load ptr, ptr %1516, align 8
  store ptr %1518, ptr %1517, align 8
  %1519 = getelementptr { ptr, ptr, ptr, i32 }, ptr %329, i32 0, i32 1
  %1520 = getelementptr { ptr, ptr, ptr, i32 }, ptr %330, i32 0, i32 1
  %1521 = load ptr, ptr %1519, align 8
  store ptr %1521, ptr %1520, align 8
  %1522 = getelementptr { ptr, ptr, ptr, i32 }, ptr %329, i32 0, i32 2
  %1523 = getelementptr { ptr, ptr, ptr, i32 }, ptr %330, i32 0, i32 2
  %1524 = load ptr, ptr %1522, align 8
  store ptr %1524, ptr %1523, align 8
  %1525 = getelementptr { ptr, ptr, ptr, i32 }, ptr %329, i32 0, i32 3
  %1526 = getelementptr { ptr, ptr, ptr, i32 }, ptr %330, i32 0, i32 3
  %1527 = load i32, ptr %1525, align 4
  store i32 %1527, ptr %1526, align 4
  call void @set_offset(ptr %330, ptr @Int32)
  %1528 = load ptr, ptr %1517, align 8
  store ptr %1528, ptr %334, align 8
  %1529 = load ptr, ptr %1520, align 8
  store ptr %1529, ptr %333, align 8
  %1530 = load ptr, ptr %1523, align 8
  store ptr %1530, ptr %332, align 8
  %1531 = load i32, ptr %1526, align 4
  store i32 %1531, ptr %331, align 4
  %1532 = load ptr, ptr %334, align 8
  ...
  %1536 = load ptr, ptr %332, align 8
  %1537 = insertvalue { ptr, ptr, ptr, i32 } %1535, ptr %1536, 2
  %1538 = load i32, ptr %331, align 4
  %1539 = insertvalue { ptr, ptr, ptr, i32 } %1537, i32 %1538, 3
  %1540 = call { ptr, ptr, ptr, i32 } @add_five({ ptr, ptr, ptr, i32 } %1539)
  store { ptr, ptr, ptr, i32 } %1540, ptr %335, align 8
  %1541 = getelementptr { ptr, ptr, ptr, i32 }, ptr %335, i32 0, i32 0
  %1542 = load ptr, ptr %1541, align 8
  %1543 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1542, 0
  %1544 = getelementptr { ptr, ptr, ptr, i32 }, ptr %335, i32 0, i32 1
  %1545 = load ptr, ptr %1544, align 8
  %1546 = insertvalue { ptr, ptr, ptr, i32 } %1543, ptr %1545, 1
  %1547 = getelementptr { ptr, ptr, ptr, i32 }, ptr %335, i32 0, i32 2
  %1548 = load ptr, ptr %1547, align 8
  %1549 = insertvalue { ptr, ptr, ptr, i32 } %1546, ptr %1548, 2
  %1550 = getelementptr { ptr, ptr, ptr, i32 }, ptr %335, i32 0, i32 3
  %1551 = load i32, ptr %1550, align 4
  %1552 = insertvalue { ptr, ptr, ptr, i32 } %1549, i32 %1551, 3
  %1553 = call ptr @llvm.invariant.start.p0(i64 0, ptr %336)
  %1554 = call ptr @llvm.invariant.start.p0(i64 144, ptr %1542)
  %1555 = getelementptr ptr, ptr %1542, i32 %1551
  %1556 = getelementptr ptr, ptr %1555, i32 4
  %1557 = load ptr, ptr %1556, align 8
  %1558 = call ptr @behavior_wrapper(ptr %1557, { ptr, ptr, ptr, i32 } %1552, ptr %337)
  %1559 = call double %1558({ ptr, ptr, ptr, i32 } %1552, { ptr, ptr, ptr, i32 } %1552, ptr %336) #3
  store double %1559, ptr %338, align 8
  %1560 = load double, ptr %338, align 8
  store double %1560, ptr %339, align 8
  store i64 ptrtoint (ptr @f64_typ to i64), ptr %341, align 4
  %1561 = load i64, ptr %341, align 4
  store i64 %1561, ptr %340, align 4
  %1562 = load ptr, ptr %340, align 8
  %1563 = insertvalue { ptr, i160 } undef, ptr %1562, 0
  %1564 = load i160, ptr %339, align 4
  %1565 = insertvalue { ptr, i160 } %1563, i160 %1564, 1
  %1566 = getelementptr [1 x ptr], ptr %342, i32 0, i32 0
  store ptr @_parameterization_Ptrf64, ptr %1566, align 8
  %1567 = call ptr @llvm.invariant.start.p0(i64 1, ptr %342)
  %1568 = call ptr @llvm.invariant.start.p0(i64 80, ptr @IO)
  %1569 = load ptr, ptr getelementptr (ptr, ptr @IO, i32 10), align 8
  %1570 = getelementptr { ptr }, ptr %343, i32 0, i32 0
  store ptr %1562, ptr %1570, align 8
  %1571 = call ptr @class_behavior_wrapper(ptr %1569, ptr %343)
  call void %1571(ptr %342, { ptr, i160 } %1565) #3
  store i32 6, ptr %344, align 4
  store ptr @Int32, ptr %345, align 8
  %1572 = load ptr, ptr %345, align 8
  %1573 = getelementptr ptr, ptr %1572, i32 6
  %1574 = load ptr, ptr %1573, align 8
  %1575 = call { i64, i64 } @size_wrapper(ptr %1574, ptr %345)
  %1576 = extractvalue { i64, i64 } %1575, 0
  %1577 = call ptr @bump_malloc(i64 %1576)
  store ptr @Int32, ptr %349, align 8
  store ptr %1577, ptr %348, align 8
  store i32 10, ptr %346, align 4
  store i32 6, ptr %350, align 4
  %1578 = load i32, ptr %350, align 4
  %1579 = load ptr, ptr %349, align 8
  %1580 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1579, 0
  %1581 = load ptr, ptr %348, align 8
  %1582 = insertvalue { ptr, ptr, ptr, i32 } %1580, ptr %1581, 1
  %1583 = load ptr, ptr %347, align 8
  %1584 = insertvalue { ptr, ptr, ptr, i32 } %1582, ptr %1583, 2
  %1585 = load i32, ptr %346, align 4
  %1586 = insertvalue { ptr, ptr, ptr, i32 } %1584, i32 %1585, 3
  %1587 = getelementptr [1 x ptr], ptr %351, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %1587, align 8
  %1588 = call ptr @llvm.invariant.start.p0(i64 1, ptr %351)
  %1589 = call ptr @llvm.invariant.start.p0(i64 136, ptr %1579)
  %1590 = getelementptr ptr, ptr %1579, i32 %1585
  %1591 = getelementptr ptr, ptr %1590, i32 2
  %1592 = load ptr, ptr %1591, align 8
  %1593 = getelementptr { ptr }, ptr %352, i32 0, i32 0
  store ptr @i32_typ, ptr %1593, align 8
  %1594 = call ptr @behavior_wrapper(ptr %1592, { ptr, ptr, ptr, i32 } %1586, ptr %352)
  call void %1594({ ptr, ptr, ptr, i32 } %1586, { ptr, ptr, ptr, i32 } %1586, ptr %351, i32 %1578) #3
  store ptr @Holder, ptr %353, align 8
  %1595 = getelementptr ptr, ptr %353, i32 1
  store ptr @_parameterization_Int32, ptr %1595, align 8
  %1596 = load ptr, ptr %353, align 8
  %1597 = getelementptr ptr, ptr %1596, i32 6
  %1598 = load ptr, ptr %1597, align 8
  %1599 = call { i64, i64 } @size_wrapper(ptr %1598, ptr %353)
  %1600 = extractvalue { i64, i64 } %1599, 0
  %1601 = call ptr @bump_malloc(i64 %1600)
  store ptr @_parameterization_Int32, ptr %1601, align 8
  %1602 = call ptr @llvm.invariant.start.p0(i64 8, ptr %1601)
  store ptr @Holder, ptr %357, align 8
  store ptr %1601, ptr %356, align 8
  store i32 10, ptr %354, align 4
  store i32 6, ptr %358, align 4
  store ptr @Int32, ptr %359, align 8
  %1603 = load ptr, ptr %359, align 8
  %1604 = getelementptr ptr, ptr %1603, i32 6
  %1605 = load ptr, ptr %1604, align 8
  %1606 = call { i64, i64 } @size_wrapper(ptr %1605, ptr %359)
  %1607 = extractvalue { i64, i64 } %1606, 0
  %1608 = call ptr @bump_malloc(i64 %1607)
  store ptr @Int32, ptr %363, align 8
  store ptr %1608, ptr %362, align 8
  store i32 10, ptr %360, align 4
  store i32 6, ptr %364, align 4
  %1609 = load i32, ptr %364, align 4
  %1610 = load ptr, ptr %363, align 8
  %1611 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1610, 0
  %1612 = load ptr, ptr %362, align 8
  %1613 = insertvalue { ptr, ptr, ptr, i32 } %1611, ptr %1612, 1
  %1614 = load ptr, ptr %361, align 8
  %1615 = insertvalue { ptr, ptr, ptr, i32 } %1613, ptr %1614, 2
  %1616 = load i32, ptr %360, align 4
  %1617 = insertvalue { ptr, ptr, ptr, i32 } %1615, i32 %1616, 3
  %1618 = getelementptr [1 x ptr], ptr %365, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %1618, align 8
  %1619 = call ptr @llvm.invariant.start.p0(i64 1, ptr %365)
  %1620 = call ptr @llvm.invariant.start.p0(i64 136, ptr %1610)
  %1621 = getelementptr ptr, ptr %1610, i32 %1616
  %1622 = getelementptr ptr, ptr %1621, i32 2
  %1623 = load ptr, ptr %1622, align 8
  %1624 = getelementptr { ptr }, ptr %366, i32 0, i32 0
  store ptr @i32_typ, ptr %1624, align 8
  %1625 = call ptr @behavior_wrapper(ptr %1623, { ptr, ptr, ptr, i32 } %1617, ptr %366)
  call void %1625({ ptr, ptr, ptr, i32 } %1617, { ptr, ptr, ptr, i32 } %1617, ptr %365, i32 %1609) #3
  %1626 = getelementptr { ptr, ptr, ptr, i32 }, ptr %367, i32 0, i32 0
  %1627 = load ptr, ptr %363, align 8
  store ptr %1627, ptr %1626, align 8
  %1628 = getelementptr { ptr, ptr, ptr, i32 }, ptr %367, i32 0, i32 1
  %1629 = load ptr, ptr %362, align 8
  store ptr %1629, ptr %1628, align 8
  %1630 = getelementptr { ptr, ptr, ptr, i32 }, ptr %367, i32 0, i32 2
  %1631 = load ptr, ptr %361, align 8
  store ptr %1631, ptr %1630, align 8
  %1632 = getelementptr { ptr, ptr, ptr, i32 }, ptr %367, i32 0, i32 3
  %1633 = load i32, ptr %360, align 4
  store i32 %1633, ptr %1632, align 4
  call void @set_offset(ptr %367, ptr @Addable)
  %1634 = getelementptr { ptr, i160 }, ptr %367, i32 0, i32 0
  %1635 = load ptr, ptr %1634, align 8
  %1636 = insertvalue { ptr, i160 } undef, ptr %1635, 0
  %1637 = getelementptr { ptr, i160 }, ptr %367, i32 0, i32 1
  %1638 = load i160, ptr %1637, align 4
  %1639 = insertvalue { ptr, i160 } %1636, i160 %1638, 1
  %1640 = load ptr, ptr %357, align 8
  %1641 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1640, 0
  %1642 = load ptr, ptr %356, align 8
  %1643 = insertvalue { ptr, ptr, ptr, i32 } %1641, ptr %1642, 1
  %1644 = load ptr, ptr %355, align 8
  %1645 = insertvalue { ptr, ptr, ptr, i32 } %1643, ptr %1644, 2
  %1646 = load i32, ptr %354, align 4
  %1647 = insertvalue { ptr, ptr, ptr, i32 } %1645, i32 %1646, 3
  %1648 = getelementptr [1 x ptr], ptr %368, i32 0, i32 0
  store ptr @_parameterization_Int32, ptr %1648, align 8
  %1649 = call ptr @llvm.invariant.start.p0(i64 1, ptr %368)
  %1650 = call ptr @llvm.invariant.start.p0(i64 64, ptr %1640)
  %1651 = getelementptr ptr, ptr %1640, i32 %1646
  %1652 = getelementptr ptr, ptr %1651, i32 2
  %1653 = load ptr, ptr %1652, align 8
  %1654 = getelementptr { ptr }, ptr %369, i32 0, i32 0
  store ptr %1635, ptr %1654, align 8
  %1655 = call ptr @behavior_wrapper(ptr %1653, { ptr, ptr, ptr, i32 } %1647, ptr %369)
  call void %1655({ ptr, ptr, ptr, i32 } %1647, { ptr, ptr, ptr, i32 } %1647, ptr %368, { ptr, i160 } %1639) #3
  %1656 = getelementptr { ptr, ptr, ptr, i32 }, ptr %370, i32 0, i32 0
  %1657 = load ptr, ptr %357, align 8
  store ptr %1657, ptr %1656, align 8
  %1658 = getelementptr { ptr, ptr, ptr, i32 }, ptr %370, i32 0, i32 1
  %1659 = load ptr, ptr %356, align 8
  store ptr %1659, ptr %1658, align 8
  %1660 = getelementptr { ptr, ptr, ptr, i32 }, ptr %370, i32 0, i32 2
  %1661 = load ptr, ptr %355, align 8
  store ptr %1661, ptr %1660, align 8
  %1662 = getelementptr { ptr, ptr, ptr, i32 }, ptr %370, i32 0, i32 3
  %1663 = load i32, ptr %354, align 4
  store i32 %1663, ptr %1662, align 4
  call void @set_offset(ptr %370, ptr @Holder)
  %1664 = load ptr, ptr %1656, align 8
  store ptr %1664, ptr %374, align 8
  %1665 = load ptr, ptr %1658, align 8
  store ptr %1665, ptr %373, align 8
  %1666 = load ptr, ptr %1660, align 8
  store ptr %1666, ptr %372, align 8
  %1667 = load i32, ptr %1662, align 4
  store i32 %1667, ptr %371, align 4
  %1668 = load ptr, ptr %374, align 8
  %1669 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1668, 0
  %1670 = load ptr, ptr %373, align 8
  %1671 = insertvalue { ptr, ptr, ptr, i32 } %1669, ptr %1670, 1
  %1672 = load ptr, ptr %372, align 8
  %1673 = insertvalue { ptr, ptr, ptr, i32 } %1671, ptr %1672, 2
  %1674 = load i32, ptr %371, align 4
  %1675 = insertvalue { ptr, ptr, ptr, i32 } %1673, i32 %1674, 3
  %1676 = call ptr @llvm.invariant.start.p0(i64 0, ptr %375)
  %1677 = call ptr @llvm.invariant.start.p0(i64 64, ptr %1668)
  %1678 = getelementptr ptr, ptr %1668, i32 %1674
  %1679 = getelementptr ptr, ptr %1678, i32 3
  %1680 = load ptr, ptr %1679, align 8
  %1681 = call ptr @behavior_wrapper(ptr %1680, { ptr, ptr, ptr, i32 } %1675, ptr %376)
  %1682 = call { ptr, ptr, ptr, i32 } %1681({ ptr, ptr, ptr, i32 } %1675, { ptr, ptr, ptr, i32 } %1675, ptr %375) #3
  store { ptr, ptr, ptr, i32 } %1682, ptr %377, align 8
  %1683 = getelementptr { ptr, ptr, ptr, i32 }, ptr %377, i32 0, i32 0
  %1684 = getelementptr { ptr, ptr, ptr, i32 }, ptr %378, i32 0, i32 0
  %1685 = load ptr, ptr %1683, align 8
  store ptr %1685, ptr %1684, align 8
  %1686 = getelementptr { ptr, ptr, ptr, i32 }, ptr %377, i32 0, i32 1
  %1687 = getelementptr { ptr, ptr, ptr, i32 }, ptr %378, i32 0, i32 1
  %1688 = load ptr, ptr %1686, align 8
  store ptr %1688, ptr %1687, align 8
  %1689 = getelementptr { ptr, ptr, ptr, i32 }, ptr %377, i32 0, i32 2
  %1690 = getelementptr { ptr, ptr, ptr, i32 }, ptr %378, i32 0, i32 2
  %1691 = load ptr, ptr %1689, align 8
  store ptr %1691, ptr %1690, align 8
  %1692 = getelementptr { ptr, ptr, ptr, i32 }, ptr %377, i32 0, i32 3
  %1693 = getelementptr { ptr, ptr, ptr, i32 }, ptr %378, i32 0, i32 3
  %1694 = load i32, ptr %1692, align 4
  store i32 %1694, ptr %1693, align 4
  call void @set_offset(ptr %378, ptr @Float64)
  %1695 = load ptr, ptr %1684, align 8
  %1696 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1695, 0
  %1697 = load ptr, ptr %1687, align 8
  %1698 = insertvalue { ptr, ptr, ptr, i32 } %1696, ptr %1697, 1
  %1699 = load ptr, ptr %1690, align 8
  %1700 = insertvalue { ptr, ptr, ptr, i32 } %1698, ptr %1699, 2
  %1701 = load i32, ptr %1693, align 4
  %1702 = insertvalue { ptr, ptr, ptr, i32 } %1700, i32 %1701, 3
  %1703 = call ptr @llvm.invariant.start.p0(i64 0, ptr %379)
  %1704 = call ptr @llvm.invariant.start.p0(i64 144, ptr %1695)
  %1705 = getelementptr ptr, ptr %1695, i32 %1701
  %1706 = getelementptr ptr, ptr %1705, i32 4
  %1707 = load ptr, ptr %1706, align 8
  %1708 = call ptr @behavior_wrapper(ptr %1707, { ptr, ptr, ptr, i32 } %1702, ptr %380)
  %1709 = call double %1708({ ptr, ptr, ptr, i32 } %1702, { ptr, ptr, ptr, i32 } %1702, ptr %379) #3
  store double %1709, ptr %381, align 8
  %1710 = load double, ptr %381, align 8
  store double %1710, ptr %382, align 8
  store i64 ptrtoint (ptr @f64_typ to i64), ptr %384, align 4
  %1711 = load i64, ptr %384, align 4
  store i64 %1711, ptr %383, align 4
  %1712 = load ptr, ptr %383, align 8
  %1713 = insertvalue { ptr, i160 } undef, ptr %1712, 0
  %1714 = load i160, ptr %382, align 4
  %1715 = insertvalue { ptr, i160 } %1713, i160 %1714, 1
  %1716 = getelementptr [1 x ptr], ptr %385, i32 0, i32 0
  store ptr @_parameterization_Ptrf64, ptr %1716, align 8
  %1717 = call ptr @llvm.invariant.start.p0(i64 1, ptr %385)
  %1718 = call ptr @llvm.invariant.start.p0(i64 80, ptr @IO)
  %1719 = load ptr, ptr getelementptr (ptr, ptr @IO, i32 10), align 8
  %1720 = getelementptr { ptr }, ptr %386, i32 0, i32 0
  store ptr %1712, ptr %1720, align 8
  %1721 = call ptr @class_behavior_wrapper(ptr %1719, ptr %386)
  call void %1721(ptr %385, { ptr, i160 } %1715) #3
  store i32 77, ptr %387, align 4
  store ptr @Int32, ptr %388, align 8
  %1722 = load ptr, ptr %388, align 8
  %1723 = getelementptr ptr, ptr %1722, i32 6
  %1724 = load ptr, ptr %1723, align 8
  %1725 = call { i64, i64 } @size_wrapper(ptr %1724, ptr %388)
  %1726 = extractvalue { i64, i64 } %1725, 0
  %1727 = call ptr @bump_malloc(i64 %1726)
  store ptr @Int32, ptr %392, align 8
  store ptr %1727, ptr %391, align 8
  store i32 10, ptr %389, align 4
  store i32 77, ptr %393, align 4
  %1728 = load i32, ptr %393, align 4
  %1729 = load ptr, ptr %392, align 8
  %1730 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1729, 0
  %1731 = load ptr, ptr %391, align 8
  %1732 = insertvalue { ptr, ptr, ptr, i32 } %1730, ptr %1731, 1
  %1733 = load ptr, ptr %390, align 8
  %1734 = insertvalue { ptr, ptr, ptr, i32 } %1732, ptr %1733, 2
  %1735 = load i32, ptr %389, align 4
  %1736 = insertvalue { ptr, ptr, ptr, i32 } %1734, i32 %1735, 3
  %1737 = getelementptr [1 x ptr], ptr %394, i32 0, i32 0
  store ptr @_parameterization_Ptri32, ptr %1737, align 8
  %1738 = call ptr @llvm.invariant.start.p0(i64 1, ptr %394)
  %1739 = call ptr @llvm.invariant.start.p0(i64 136, ptr %1729)
  %1740 = getelementptr ptr, ptr %1729, i32 %1735
  %1741 = getelementptr ptr, ptr %1740, i32 2
  %1742 = load ptr, ptr %1741, align 8
  %1743 = getelementptr { ptr }, ptr %395, i32 0, i32 0
  store ptr @i32_typ, ptr %1743, align 8
  %1744 = call ptr @behavior_wrapper(ptr %1742, { ptr, ptr, ptr, i32 } %1736, ptr %395)
  call void %1744({ ptr, ptr, ptr, i32 } %1736, { ptr, ptr, ptr, i32 } %1736, ptr %394, i32 %1728) #3
  %1745 = getelementptr { ptr, ptr, ptr, i32 }, ptr %396, i32 0, i32 0
  %1746 = load ptr, ptr %392, align 8
  store ptr %1746, ptr %1745, align 8
  %1747 = getelementptr { ptr, ptr, ptr, i32 }, ptr %396, i32 0, i32 1
  %1748 = load ptr, ptr %391, align 8
  store ptr %1748, ptr %1747, align 8
  %1749 = getelementptr { ptr, ptr, ptr, i32 }, ptr %396, i32 0, i32 2
  %1750 = load ptr, ptr %390, align 8
  store ptr %1750, ptr %1749, align 8
  %1751 = getelementptr { ptr, ptr, ptr, i32 }, ptr %396, i32 0, i32 3
  %1752 = load i32, ptr %389, align 4
  store i32 %1752, ptr %1751, align 4
  call void @set_offset(ptr %396, ptr @Addable)
  %1753 = getelementptr { ptr, i160 }, ptr %396, i32 0, i32 0
  %1754 = load ptr, ptr %1753, align 8
  %1755 = insertvalue { ptr, i160 } undef, ptr %1754, 0
  %1756 = getelementptr { ptr, i160 }, ptr %396, i32 0, i32 1
  %1757 = load i160, ptr %1756, align 4
  %1758 = insertvalue { ptr, i160 } %1755, i160 %1757, 1
  %1759 = load ptr, ptr %374, align 8
  %1760 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1759, 0
  %1761 = load ptr, ptr %373, align 8
  ...
  %1765 = load i32, ptr %371, align 4
  %1766 = insertvalue { ptr, ptr, ptr, i32 } %1764, i32 %1765, 3
  %1767 = getelementptr [1 x ptr], ptr %397, i32 0, i32 0
  store ptr @_parameterization_Int32, ptr %1767, align 8
  %1768 = call ptr @llvm.invariant.start.p0(i64 1, ptr %397)
  %1769 = call ptr @llvm.invariant.start.p0(i64 64, ptr %1759)
  %1770 = getelementptr ptr, ptr %1759, i32 %1765
  %1771 = getelementptr ptr, ptr %1770, i32 4
  %1772 = load ptr, ptr %1771, align 8
  %1773 = getelementptr { ptr }, ptr %398, i32 0, i32 0
  store ptr %1754, ptr %1773, align 8
  %1774 = call ptr @behavior_wrapper(ptr %1772, { ptr, ptr, ptr, i32 } %1766, ptr %398)
  call void %1774({ ptr, ptr, ptr, i32 } %1766, { ptr, ptr, ptr, i32 } %1766, ptr %397, { ptr, i160 } %1758) #3
  %1775 = load ptr, ptr %374, align 8
  %1776 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %1775, 0
  %1777 = load ptr, ptr %373, align 8
  %1778 = insertvalue { ptr, ptr, ptr, i32 } %1776, ptr %1777, 1
  %1779 = load ptr, ptr %372, align 8
  %1780 = insertvalue { ptr, ptr, ptr, i32 } %1778, ptr %1779, 2
  %1781 = load i32, ptr %371, align 4
  %1782 = insertvalue { ptr, ptr, ptr, i32 } %1780, i32 %1781, 3
  %1783 = call ptr @llvm.invariant.start.p0(i64 0, ptr %399)
  %1784 = call ptr @llvm.invariant.start.p0(i64 64, ptr %1775)
  %1785 = getelementptr ptr, ptr %1775, i32 %1781
  %1786 = getelementptr ptr, ptr %1785, i32 3
  %1787 = load ptr, ptr %1786, align 8
  %1788 = call ptr @behavior_wrapper(ptr %1787, { ptr, ptr, ptr, i32 } %1782, ptr %400)
  %1789 = call { ptr, ptr, ptr, i32 } %1788({ ptr, ptr, ptr, i32 } %1782, { ptr, ptr, ptr, i32 } %1782, ptr %399) #3
  store { ptr, ptr, ptr, i32 } %1789, ptr %401, align 8
  %1790 = getelementptr { ptr, ptr, ptr, i32 }, ptr %401, i32 0, i32 0
  %1791 = getelementptr { ptr, ptr, ptr, i32 }, ptr %402, i32 0, i32 0
  %1792 = load ptr, ptr %1790, align 8
  store ptr %1792, ptr %1791, align 8
  %1793 = getelementptr { ptr, ptr, ptr, i32 }, ptr %401, i32 0, i32 1
  %1794 = getelementptr { ptr, ptr, ptr, i32 }, ptr %402, i32 0, i32 1
  %1795 = load ptr, ptr %1793, align 8
  store ptr %1795, ptr %1794, align 8
  %1796 = getelementptr { ptr, ptr, ptr, i32 }, ptr %401, i32 0, i32 2
  %1797 = getelementptr { ptr, ptr, ptr, i32 }, ptr %402, i32 0, i32 2
  %1798 = load ptr, ptr %1796, align 8
  store ptr %1798, ptr %1797, align 8
  %1799 = getelementptr { ptr, ptr, ptr, i32 }, ptr %401, i32 0, i32 3
  %1800 = getelementptr { ptr, ptr, ptr, i32 }, ptr %402, i32 0, i32 3
  %1801 = load i32, ptr %1799, align 4
  store i32 %1801, ptr %1800, align 4
  call void @set_offset(ptr %402, ptr @Float64)
  %1802 = load ptr, ptr %1791, align 8
  ...
  %1808 = load i32, ptr %1800, align 4
  %1809 = insertvalue { ptr, ptr, ptr, i32 } %1807, i32 %1808, 3
  %1810 = call ptr @llvm.invariant.start.p0(i64 0, ptr %403)
  %1811 = call ptr @llvm.invariant.start.p0(i64 144, ptr %1802)
  %1812 = getelementptr ptr, ptr %1802, i32 %1808
  %1813 = getelementptr ptr, ptr %1812, i32 4
  %1814 = load ptr, ptr %1813, align 8
  %1815 = call ptr @behavior_wrapper(ptr %1814, { ptr, ptr, ptr, i32 } %1809, ptr %404)
  %1816 = call double %1815({ ptr, ptr, ptr, i32 } %1809, { ptr, ptr, ptr, i32 } %1809, ptr %403) #3
  store double %1816, ptr %405, align 8
  %1817 = load double, ptr %405, align 8
  store double %1817, ptr %406, align 8
  store i64 ptrtoint (ptr @f64_typ to i64), ptr %408, align 4
  %1818 = load i64, ptr %408, align 4
  store i64 %1818, ptr %407, align 4
  %1819 = load ptr, ptr %407, align 8
  %1820 = insertvalue { ptr, i160 } undef, ptr %1819, 0
  %1821 = load i160, ptr %406, align 4
  %1822 = insertvalue { ptr, i160 } %1820, i160 %1821, 1
  %1823 = getelementptr [1 x ptr], ptr %409, i32 0, i32 0
  store ptr @_parameterization_Ptrf64, ptr %1823, align 8
  %1824 = call ptr @llvm.invariant.start.p0(i64 1, ptr %409)
  %1825 = call ptr @llvm.invariant.start.p0(i64 80, ptr @IO)
  %1826 = load ptr, ptr getelementptr (ptr, ptr @IO, i32 10), align 8
  %1827 = getelementptr { ptr }, ptr %410, i32 0, i32 0
  store ptr %1819, ptr %1827, align 8
  %1828 = call ptr @class_behavior_wrapper(ptr %1826, ptr %410)
  call void %1828(ptr %409, { ptr, i160 } %1822) #3
  ret i32 0
}
