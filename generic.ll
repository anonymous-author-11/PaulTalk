...
@lqzpq_genericmini = internal constant [12 x i8] c"generic.mini"
...
define { ptr, i160 } @zkdtgclfvc(ptr nest %0, { ptr, i160 } %1) {
...
define { ptr, i160 } @mziqmnttui(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @uilopgyxlj(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @wvktfjvnre(ptr nest %0, { ptr, i160 } %1, { ptr, i160 } %2) {
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr %2, i32 %3) {
  ...
  %96 = load i96, ptr @lqzpq_genericmini, align 4
...
define i32 @_functionliteral_zmtnpstfsl(i32 %0, i32 %1) {
  %3 = add i32 %0, %1
  ret i32 %3
}

define i32 @_functionliteral_zqzkpxhjkg(i32 %0) {
  %2 = mul i32 %0, 2
  ret i32 %2
}

define double @_functionliteral_mzmxyottmt(double %0) {
  %2 = fmul double %0, 2.000000e+00
  ret double %2
}

define i32 @_functionliteral_rsirxvewyt(i32 %0) {
  ret i32 %0
}

define double @_functionliteral_usfwvztzuq(i32 %0) {
...
define i32 @main() {
  ...
  store ptr @_functionliteral_zmtnpstfsl, ptr %750, align 8
  ...
  call void @llvm.init.trampoline(ptr %759, ptr @wvktfjvnre, ptr %760)
  ...
  call void @llvm.init.trampoline(ptr %908, ptr @uilopgyxlj, ptr @_functionliteral_zqzkpxhjkg)
  ...
  call void @llvm.init.trampoline(ptr %983, ptr @mziqmnttui, ptr @_functionliteral_usfwvztzuq)
  ...
  call void @llvm.init.trampoline(ptr %991, ptr @zkdtgclfvc, ptr @_functionliteral_rsirxvewyt)
