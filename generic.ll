...
@bjnpf_genericmini = internal constant [12 x i8] c"generic.mini"
...
define { ptr, i160 } @zoojkwumxa(ptr nest %0, { ptr, i160 } %1) {
...
define { ptr, i160 } @lwdlrevmri(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @piosxdnonw(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @bwkoxcmrug(ptr nest %0, { ptr, i160 } %1, { ptr, i160 } %2) {
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr %2, i32 %3) {
  ...
  %63 = load i96, ptr @bjnpf_genericmini, align 4
...
define i32 @_functionliteral_qnglvzmlbv(i32 %0, i32 %1) {
  %3 = add i32 %0, %1
  ret i32 %3
}

define i32 @_functionliteral_looasdhrzp(i32 %0) {
  %2 = mul i32 %0, 2
  ret i32 %2
}

define double @_functionliteral_mzubvibcen(double %0) {
  %2 = fmul double %0, 2.000000e+00
  ret double %2
}

define i32 @_functionliteral_kkskglckhn(i32 %0) {
  ret i32 %0
}

define double @_functionliteral_nximwkjvqv(i32 %0) {
...
define i32 @main() {
  ...
  call void @llvm.init.trampoline(ptr %749, ptr @bwkoxcmrug, ptr @_functionliteral_qnglvzmlbv)
  ...
  call void @llvm.init.trampoline(ptr %799, ptr @piosxdnonw, ptr @_functionliteral_looasdhrzp)
  ...
  call void @llvm.init.trampoline(ptr %872, ptr @lwdlrevmri, ptr @_functionliteral_nximwkjvqv)
  ...
  call void @llvm.init.trampoline(ptr %880, ptr @zoojkwumxa, ptr @_functionliteral_kkskglckhn)
