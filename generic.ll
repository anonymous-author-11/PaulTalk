...
@ydwsn_genericmini = internal constant [12 x i8] c"generic.mini"
...
define { ptr, i160 } @blmrrslqlx(ptr nest %0, { ptr, i160 } %1) {
...
define { ptr, i160 } @ilgkwkciqs(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @pgozchtakb(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @ukbywwjhxu(ptr nest %0, { ptr, i160 } %1, { ptr, i160 } %2) {
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr %2, i32 %3) {
  ...
  %96 = load i96, ptr @ydwsn_genericmini, align 4
...
define i32 @_functionliteral_omnbpapuki(i32 %0, i32 %1) {
  %3 = add i32 %0, %1
  ret i32 %3
}

define i32 @_functionliteral_lqnjpoeayu(i32 %0) {
  %2 = mul i32 %0, 2
  ret i32 %2
}

define double @_functionliteral_ecydiinypr(double %0) {
  %2 = fmul double %0, 2.000000e+00
  ret double %2
}

define i32 @_functionliteral_ktkfkytmam(i32 %0) {
  ret i32 %0
}

define double @_functionliteral_herhrlwvxg(i32 %0) {
...
define i32 @main() {
  ...
  store ptr @_functionliteral_omnbpapuki, ptr %750, align 8
  ...
  call void @llvm.init.trampoline(ptr %759, ptr @ukbywwjhxu, ptr %760)
  ...
  call void @llvm.init.trampoline(ptr %908, ptr @pgozchtakb, ptr @_functionliteral_lqnjpoeayu)
  ...
  call void @llvm.init.trampoline(ptr %983, ptr @ilgkwkciqs, ptr @_functionliteral_herhrlwvxg)
  ...
  call void @llvm.init.trampoline(ptr %991, ptr @blmrrslqlx, ptr @_functionliteral_ktkfkytmam)
