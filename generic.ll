...
@mrtnd_genericmini = internal constant [12 x i8] c"generic.mini"
...
define { ptr, i160 } @tjzuoqpvck(ptr nest %0, { ptr, i160 } %1) {
...
define { ptr, i160 } @oeecfhmtuz(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @renbqmmmem(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @nkoibqhvhb(ptr nest %0, { ptr, i160 } %1, { ptr, i160 } %2) {
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr %2, i32 %3) {
  ...
  %63 = load i96, ptr @mrtnd_genericmini, align 4
  ...
  %164 = call ptr %160({ ptr, ptr, ptr, i32 } %143, ptr %161, i32 142, { ptr, ptr, ptr, i32 } %131)
  call void %164({ ptr, ptr, ptr, i32 } %143, { ptr, ptr, ptr, i32 } %143, ptr %153, i32 142, { ptr, ptr, ptr, i32 } %131)
...
define i32 @_functionliteral_thywzqbllw(i32 %0, i32 %1) {
  %3 = add i32 %0, %1
  ret i32 %3
}

define i32 @_functionliteral_pkjtpswimz(i32 %0) {
  %2 = mul i32 %0, 2
  ret i32 %2
}

define double @_functionliteral_wmexajqsfw(double %0) {
  %2 = fmul double %0, 2.000000e+00
  ret double %2
}

define i32 @_functionliteral_owbcivmywy(i32 %0) {
  ret i32 %0
}

define double @_functionliteral_erhzbwnpnf(i32 %0) {
...
define i32 @main() {
  ...
  call void @llvm.init.trampoline(ptr %749, ptr @nkoibqhvhb, ptr @_functionliteral_thywzqbllw)
  ...
  call void @llvm.init.trampoline(ptr %799, ptr @renbqmmmem, ptr @_functionliteral_pkjtpswimz)
  ...
  call void @set_offset(ptr %832, ptr @Iterable2)
  ...
  call void @set_offset(ptr %845, ptr @Iterable2)
  ...
  call void @llvm.init.trampoline(ptr %872, ptr @oeecfhmtuz, ptr @_functionliteral_erhzbwnpnf)
  ...
  call void @llvm.init.trampoline(ptr %880, ptr @tjzuoqpvck, ptr @_functionliteral_owbcivmywy)
  ...
  %903 = call ptr @llvm.invariant.start.p0(i64 184, ptr %889)
  %904 = getelementptr ptr, ptr %889, i32 %898
  %905 = getelementptr ptr, ptr %904, i32 6
  ...
  call void @set_offset(ptr %913, ptr @Iterable2)
  ...
  %941 = call ptr @llvm.invariant.start.p0(i64 184, ptr %927)
  %942 = getelementptr ptr, ptr %927, i32 %936
  %943 = getelementptr ptr, ptr %942, i32 6
  ...
  call void @set_offset(ptr %951, ptr @Iterable2)
  ...
  call void @set_offset(ptr %964, ptr @Iterable2)
  ...
  %1005 = call ptr @llvm.invariant.start.p0(i64 184, ptr %992)
  %1006 = getelementptr ptr, ptr %992, i32 %1001
  %1007 = getelementptr ptr, ptr %1006, i32 1
  ...
  call void @set_offset(ptr %1014, ptr @Iterator2)
  ...
  call void @set_offset(ptr %1027, ptr @Iterator2)
...
1058:                                             ; preds = %1130, %0
  ...
  %1069 = call ptr @llvm.invariant.start.p0(i64 24, ptr %1059)
  %1070 = getelementptr ptr, ptr %1059, i32 %1065
  %1071 = getelementptr ptr, ptr %1070, i32 1
...
1131:                                             ; preds = %1130
  ...
  store ptr @_parameterization_Iterable2Ptrf64, ptr %1170, align 8
  ...
  call void @set_offset(ptr %1245, ptr @Iterator2)
  ...
  call void @set_offset(ptr %1258, ptr @Iterator2)
...
1289:                                             ; preds = %1434, %1131
  ...
  %1300 = call ptr @llvm.invariant.start.p0(i64 24, ptr %1290)
  %1301 = getelementptr ptr, ptr %1290, i32 %1296
  %1302 = getelementptr ptr, ptr %1301, i32 1
