...
@txaoo_genericmini = internal constant [12 x i8] c"generic.mini"
...
define { ptr, i160 } @dioyllvylr(ptr nest %0, { ptr, i160 } %1) {
...
define { ptr, i160 } @kybrmnxgsb(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @ebvapefsfm(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @gbvtrgdfsn(ptr nest %0, { ptr, i160 } %1, { ptr, i160 } %2) {
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr %2, i32 %3) {
  ...
  %95 = load i96, ptr @txaoo_genericmini, align 4
...
define i32 @_functionliteral_lduskrdhhn(i32 %0, i32 %1) {
  %3 = add i32 %0, %1
  ret i32 %3
}

define i32 @_functionliteral_juzvtmbkbo(i32 %0) {
  %2 = mul i32 %0, 2
  ret i32 %2
}

define double @_functionliteral_hmxebxrpta(double %0) {
  %2 = fmul double %0, 2.000000e+00
  ret double %2
}

define i32 @_functionliteral_vufwfxyfiy(i32 %0) {
  ret i32 %0
}

define double @_functionliteral_vsxftzmifx(i32 %0) {
...
define i32 @main() {
  ...
  store ptr @_functionliteral_lduskrdhhn, ptr %772, align 8
  ...
  call void @llvm.init.trampoline(ptr %781, ptr @gbvtrgdfsn, ptr %782)
  ...
  call void @llvm.init.trampoline(ptr %936, ptr @ebvapefsfm, ptr @_functionliteral_juzvtmbkbo)
  ...
  call void @llvm.init.trampoline(ptr %1010, ptr @kybrmnxgsb, ptr @_functionliteral_vsxftzmifx)
  ...
  call void @llvm.init.trampoline(ptr %1018, ptr @dioyllvylr, ptr @_functionliteral_vufwfxyfiy)
