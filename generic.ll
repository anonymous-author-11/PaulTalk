...
@rdiyp_genericmini = internal constant [12 x i8] c"generic.mini"
...
define { ptr, i160 } @nnhkecapqm(ptr nest %0, { ptr, i160 } %1) {
...
define { ptr, i160 } @afflhopemx(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @vonatprokg(ptr nest %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = getelementptr { ptr, i160 }, ptr %3, i32 0, i32 1
  %5 = load i32, ptr %4, align 4
...
define { ptr, i160 } @rwyxkouscn(ptr nest %0, { ptr, i160 } %1, { ptr, i160 } %2) {
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr %2, i32 %3) {
  ...
  %95 = load i96, ptr @rdiyp_genericmini, align 4
...
define i32 @_functionliteral_xtoiggqird(i32 %0, i32 %1) {
  %3 = add i32 %0, %1
  ret i32 %3
}

define i32 @_functionliteral_ltnvswfwma(i32 %0) {
  %2 = mul i32 %0, 2
  ret i32 %2
}

define double @_functionliteral_osgbfplhsq(double %0) {
  %2 = fmul double %0, 2.000000e+00
  ret double %2
}

define i32 @_functionliteral_nsyojwiaoi(i32 %0) {
  ret i32 %0
}

define double @_functionliteral_mdodnerldw(i32 %0) {
...
define i32 @main() {
  ...
  store ptr @_functionliteral_xtoiggqird, ptr %741, align 8
  ...
  call void @llvm.init.trampoline(ptr %750, ptr @rwyxkouscn, ptr %751)
  ...
  call void @llvm.init.trampoline(ptr %899, ptr @vonatprokg, ptr @_functionliteral_ltnvswfwma)
  ...
  call void @llvm.init.trampoline(ptr %972, ptr @afflhopemx, ptr @_functionliteral_mdodnerldw)
  ...
  call void @llvm.init.trampoline(ptr %980, ptr @nnhkecapqm, ptr @_functionliteral_nsyojwiaoi)
