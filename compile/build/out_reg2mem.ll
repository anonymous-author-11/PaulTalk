...
.critedge498:                                     ; preds = %._crit_edge2, %.critedge
  ...
  store ptr @_parameterization_Nil_or_String, ptr %855, align 8
  ...
  store ptr @_parameterization_Nil_or_String, ptr %858, align 8
...
define void @Array_throw_oob_xi32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3) {
  ...
  %26 = call { i64, i64 } @size_wrapper(ptr %25, ptr nonnull %24)
  ...
  %36 = call ptr @llvm.invariant.start.p0(i64 9, ptr nonnull %33)
  %37 = call ptr @llvm.invariant.start.p0(i64 632, ptr nonnull @String)
  ...
  store ptr @i32_typ, ptr %41, align 8
  %42 = call ptr @behavior_wrapper(ptr %38, { ptr, ptr, ptr, i32 } %32, ptr nonnull %39)
  call void %42({ ptr, ptr, ptr, i32 } %32, { ptr, ptr, ptr, i32 } %32, ptr nonnull %33, { ptr } %29, i32 56, i32 57) #23
  %43 = alloca { ptr, ptr, ptr, i32 }, align 8
  ...
  call void @set_offset(ptr nonnull %43, ptr nonnull @String)
  ...
  %58 = call ptr @llvm.invariant.start.p0(i64 104, ptr nonnull @Exception)
  ...
  %62 = call ptr @behavior_wrapper(ptr %59, { ptr, ptr, ptr, i32 } %17, ptr nonnull %60)
  call void %62({ ptr, ptr, ptr, i32 } %17, { ptr, ptr, ptr, i32 } %17, ptr nonnull %55, i32 89, { ptr, ptr, ptr, i32 } %54) #23
