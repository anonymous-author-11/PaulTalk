...
define ptr @FancyPair_B_init_firstTuple_Ptrf64._Ptrf64._Ptrf64._Ptrf64__secondPtrf64({ ptr, ptr, ptr, i32 } %0, ptr nocapture %1) #2 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: readwrite, inaccessiblemem: none)
define ptr @Float64_B_init_valuePtrf64({ ptr, ptr, ptr, i32 } %0, ptr nocapture %1) #2 {
...
define ptr @Float64_B__ADD_otherFloat64__ADD_otherInt32({ ptr, ptr, ptr, i32 } %0, ptr nocapture %1) {
  %3 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr %1)
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: readwrite, inaccessiblemem: none)
define ptr @Int32_B_init_valuePtri32({ ptr, ptr, ptr, i32 } %0, ptr nocapture %1) #2 {
  %3 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr %1)
  %4 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
...
define { ptr, i160 } @navjmtllau(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
...
define { ptr, i160 } @ulbpovolvq(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
  %.sroa.1.8.extract.trunc = trunc i160 %.fca.1.extract to i32
...
define { ptr, i160 } @ngxkvrqvyj(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
  %.sroa.1.8.extract.trunc = trunc i160 %.fca.1.extract to i32
  %3 = tail call i32 %0(i32 %.sroa.1.8.extract.trunc)
  %.sroa.0.0.insert.ext = zext i32 %3 to i160
...
define { ptr, i160 } @wrnidqoeot(ptr nest nocapture readonly %0, { ptr, i160 } %1, { ptr, i160 } %2) {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define double @_functionliteral_bvjxsvdyyz(i32 %0) #1 {
...
define noundef i32 @main() local_unnamed_addr {
  ...
  call void @llvm.init.trampoline(ptr %373, ptr nonnull @wrnidqoeot, ptr nonnull @_functionliteral_otqemehpgd)
  ...
  call void @llvm.init.trampoline(ptr %389, ptr nonnull @ngxkvrqvyj, ptr nonnull @_functionliteral_xemvsqnxcu)
  ...
  call void @llvm.init.trampoline(ptr %413, ptr nonnull @ulbpovolvq, ptr nonnull @_functionliteral_bvjxsvdyyz)
  ...
  call void @llvm.init.trampoline(ptr %417, ptr nonnull @navjmtllau, ptr nonnull @_functionliteral_tdfclbxrpf)
...
define ptr @IO_B__Self_print_xPtri32__Self_print_xString__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xCharacter__Self_print_xNil__Self_print_xPtri8__Self_print_xPtrf64(ptr nocapture %0) {
  %2 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr %0)
  %3 = load ptr, ptr %0, align 8
...
7:                                                ; preds = %5
  ...
  %16 = load i64, ptr @Character, align 8
  %17 = tail call i1 @subtype_test_wrapper(ptr %14, i64 %13, i64 %12, i64 %16, i64 ptrtoint (ptr @Character to i64), ptr %15)
...
26:                                               ; preds = %.critedge
  ...
  %31 = load i64, ptr @String, align 8
  %32 = tail call i1 @subtype_test_wrapper(ptr %29, i64 %28, i64 %27, i64 %31, i64 ptrtoint (ptr @String to i64), ptr %30)
  br i1 %32, label %33, label %.critedge15
...
33:                                               ; preds = %26
  ...
  %38 = tail call i1 @subtype_test_wrapper(ptr %36, i64 %35, i64 %34, i64 %16, i64 ptrtoint (ptr @Character to i64), ptr %37)
  br i1 %38, label %.critedge15, label %64

.critedge15:                                      ; preds = %26, %33
  %39 = icmp eq ptr %3, @nil_typ
...
44:                                               ; preds = %42
  ...
  %50 = tail call i1 @subtype_test_wrapper(ptr %47, i64 %46, i64 %45, i64 %49, i64 ptrtoint (ptr @Representable to i64), ptr %48)
...
51:                                               ; preds = %44
  ...
  %56 = tail call i1 @subtype_test_wrapper(ptr %54, i64 %53, i64 %52, i64 %16, i64 ptrtoint (ptr @Character to i64), ptr %55)
...
57:                                               ; preds = %51
  ...
  %61 = load ptr, ptr %11, align 8
  %62 = tail call i1 @subtype_test_wrapper(ptr %60, i64 %59, i64 %58, i64 %31, i64 ptrtoint (ptr @String to i64), ptr %61)
  %63 = select i1 %62, i32 8, i32 3
  br label %64

64:                                               ; preds = %51, %57, %44, %5, %18, %.critedge, %33, %.critedge15, %42, %1
  %.reg2mem29.0 = phi i32 [ 9, %1 ], [ 1, %5 ], [ 4, %.critedge ], [ 7, %.critedge15 ], [ 5, %42 ], [ 2, %33 ], [ 6, %18 ], [ %63, %57 ], [ 8, %51 ], [ 8, %44 ]
