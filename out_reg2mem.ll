...
define ptr @IO_B__Self_print_xPtri8__Self_print_xNil__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtrf64__Self_print_xCharacter__Self_print_xString(ptr nocapture %0) {
  %2 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr %0)
  %3 = load ptr, ptr %0, align 8
...
18:                                               ; preds = %7
  ...
  %23 = load i64, ptr @Character, align 8
  %24 = tail call i1 @subtype_test_wrapper(ptr %21, i64 %20, i64 %19, i64 %23, i64 ptrtoint (ptr @Character to i64), ptr %22)
...
25:                                               ; preds = %18
  ...
  %30 = load i64, ptr @String, align 8
  %31 = tail call i1 @subtype_test_wrapper(ptr %28, i64 %27, i64 %26, i64 %30, i64 ptrtoint (ptr @String to i64), ptr %29)
  br i1 %31, label %.critedge, label %64
...
38:                                               ; preds = %.critedge
  ...
  br i1 %44, label %.critedge15, label %64

.critedge15:                                      ; preds = %.critedge, %38
  %45 = icmp eq ptr %3, @nil_typ
...
48:                                               ; preds = %.critedge15
  ...
  %53 = load i64, ptr @Character, align 8
  %54 = tail call i1 @subtype_test_wrapper(ptr %51, i64 %50, i64 %49, i64 %53, i64 ptrtoint (ptr @Character to i64), ptr %52)
  br i1 %54, label %55, label %.critedge17
...
55:                                               ; preds = %48
  ...
  %60 = tail call i1 @subtype_test_wrapper(ptr %58, i64 %57, i64 %56, i64 %36, i64 ptrtoint (ptr @String to i64), ptr %59)
  br i1 %60, label %.critedge17, label %64

.critedge17:                                      ; preds = %48, %55
  %61 = icmp eq ptr %3, @i8_typ
  %62 = icmp eq ptr %3, @i64_typ
  %63 = select i1 %62, i32 5, i32 6
  %.reg2mem41.0 = select i1 %61, i32 1, i32 %63
  br label %64

64:                                               ; preds = %5, %25, %.critedge17, %55, %.critedge15, %38, %1
  %.reg2mem29.0 = phi i32 [ 4, %1 ], [ 7, %5 ], [ 2, %.critedge15 ], [ %.reg2mem41.0, %.critedge17 ], [ 8, %55 ], [ 9, %38 ], [ 3, %25 ]
