...
define { ptr, i160 } @wmanxowipb(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
...
define { ptr, i160 } @iqfiqyqkqi(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
  %.sroa.1.8.extract.trunc = trunc i160 %.fca.1.extract to i32
...
define { ptr, i160 } @krxlfxkgvk(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
  %.sroa.1.8.extract.trunc = trunc i160 %.fca.1.extract to i32
  %3 = tail call i32 %0(i32 %.sroa.1.8.extract.trunc)
  %.sroa.0.0.insert.ext = zext i32 %3 to i160
...
define { ptr, i160 } @kllezbeprc(ptr nest nocapture readonly %0, { ptr, i160 } %1, { ptr, i160 } %2) {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define double @_functionliteral_fuyimisztb(i32 %0) #1 {
...
define noundef i32 @main() local_unnamed_addr {
  ...
  call void @llvm.init.trampoline(ptr %373, ptr nonnull @kllezbeprc, ptr nonnull @_functionliteral_ecmkobuhgg)
  ...
  call void @llvm.init.trampoline(ptr %389, ptr nonnull @krxlfxkgvk, ptr nonnull @_functionliteral_kjttqhdbzx)
  ...
  call void @llvm.init.trampoline(ptr %413, ptr nonnull @iqfiqyqkqi, ptr nonnull @_functionliteral_fuyimisztb)
  ...
  call void @llvm.init.trampoline(ptr %417, ptr nonnull @wmanxowipb, ptr nonnull @_functionliteral_tiobwiasjz)
...
define ptr @IO_B__Self_print_xPtri64__Self_print_xNil__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xString__Self_print_xPtrf64__Self_print_xPtri32(ptr nocapture %0) {
  %2 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr %0)
  %3 = load ptr, ptr %0, align 8
  %4 = getelementptr i8, ptr %3, i64 8
  %5 = getelementptr i8, ptr %3, i64 16
...
49:                                               ; preds = %.critedge15
  ...
  %54 = tail call i1 @subtype_test_wrapper(ptr %52, i64 %51, i64 %50, i64 %12, i64 ptrtoint (ptr @String to i64), ptr %53)
...
55:                                               ; preds = %49
  ...
  %60 = tail call i1 @subtype_test_wrapper(ptr %58, i64 %57, i64 %56, i64 %35, i64 ptrtoint (ptr @Character to i64), ptr %59)
  br i1 %60, label %.critedge17, label %63

.critedge17:                                      ; preds = %49, %.critedge15, %55
  %61 = icmp eq ptr %3, @i64_typ
  %62 = select i1 %61, i32 1, i32 6
  br label %63

63:                                               ; preds = %14, %.critedge, %26, %55, %.critedge17, %37, %28, %24
  %.reg2mem27.0 = phi i32 [ 2, %.critedge ], [ 9, %24 ], [ 3, %26 ], [ 8, %28 ], [ %62, %.critedge17 ], [ 5, %55 ], [ 4, %37 ], [ 7, %14 ]
