...
define dso_local void @"?printStack@@YAXXZ"() #0 {
  ...
  %11 = call noalias ptr @calloc(i64 noundef 344, i64 noundef 1) #5
...
declare dllimport i32 @SymInitialize(ptr noundef, ptr noundef, i32 noundef) #1

declare dllimport i16 @RtlCaptureStackBackTrace(i32 noundef, i32 noundef, ptr noundef, ptr noundef) #1

; Function Attrs: allocsize(0,1)
declare dso_local noalias ptr @calloc(i64 noundef, i64 noundef) #2

declare dllimport i32 @SymFromAddr(ptr noundef, i64 noundef, ptr noundef, ptr noundef) #1
...
define linkonce_odr dso_local ptr @__local_stdio_printf_options() #4 comdat {
