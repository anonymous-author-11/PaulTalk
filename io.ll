...
@khgiy_nil = internal constant [3 x i8] c"nil"
@vxvhh_false = internal constant [5 x i8] c"false"
@_parameterization_Ptri32 = linkonce_odr constant [2 x ptr] [ptr @i32_typ, ptr null]
@_parameterization_BufferPtri8 = linkonce_odr constant [2 x ptr] [ptr @buffer_typ, ptr null]
@wzhgw_true = internal constant [4 x i8] c"true"
...
30:                                               ; preds = %2
  ...
  %35 = load <4 x i8>, ptr @wzhgw_true, align 4
...
81:                                               ; preds = %2
  ...
  %86 = load <5 x i8>, ptr @vxvhh_false, align 8
...
define void @IO__Self_print_xNil(ptr %0, { ptr, i160 } %1) {
  ...
  %10 = load <3 x i8>, ptr @khgiy_nil, align 4
...
define ptr @IO_B__Self_print_xPtri8__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri32__Self_print_xCharacter__Self_print_xNil__Self_print_xPtri64__Self_print_xPtrf64(ptr %0) {
...
50:                                               ; preds = %47
  ...
  %61 = call i1 @subtype_test_wrapper(ptr %59, i64 %58, i64 %57, i64 2582149688529881115, i64 ptrtoint (ptr @i8_typ to i64), ptr %60)
...
63:                                               ; preds = %50
  ...
  %74 = call i1 @subtype_test_wrapper(ptr %72, i64 %71, i64 %70, i64 -7469797244461771922, i64 ptrtoint (ptr @i64_typ to i64), ptr %73)
...
76:                                               ; preds = %63
  ...
  %87 = call i1 @subtype_test_wrapper(ptr %85, i64 %84, i64 %83, i64 6499063144389013426, i64 ptrtoint (ptr @String to i64), ptr %86)
  br i1 %87, label %88, label %102

88:                                               ; preds = %76
  %89 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  ...
  %99 = call i1 @subtype_test_wrapper(ptr %97, i64 %96, i64 %95, i64 6681222582356018452, i64 ptrtoint (ptr @Character to i64), ptr %98)
  %100 = xor i1 %99, true
...
140:                                              ; preds = %137
  ...
  %151 = call i1 @subtype_test_wrapper(ptr %149, i64 %148, i64 %147, i64 -757315540097298781, i64 ptrtoint (ptr @f64_typ to i64), ptr %150)
...
153:                                              ; preds = %140
  ...
  %164 = call i1 @subtype_test_wrapper(ptr %162, i64 %161, i64 %160, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr %163)
...
192:                                              ; preds = %191, %189
  %193 = phi i32 [ 4, %191 ], [ %190, %189 ]
  br label %194

194:                                              ; preds = %75, %192
  %195 = phi i32 [ %193, %192 ], [ 8, %75 ]
  br label %196
...
201:                                              ; preds = %200, %199
  ...
  %209 = getelementptr ptr, ptr %208, i32 10
