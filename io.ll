...
@azxlv_nil = internal constant [3 x i8] c"nil"
@patco_false = internal constant [5 x i8] c"false"
@_parameterization_Ptri32 = linkonce_odr constant [1 x ptr] [ptr @i32_typ]
@_parameterization_BufferPtri8 = linkonce_odr constant [1 x ptr] [ptr @buffer_typ]
@ycnfe_true = internal constant [4 x i8] c"true"
...
6:                                                ; preds = %2
  ...
  %24 = load i32, ptr @ycnfe_true, align 4
  store i32 %24, ptr %23, align 4
  %25 = alloca i32, align 4
  store i32 4, ptr %25, align 4
  %26 = alloca i32, align 4
  store i32 5, ptr %26, align 4
  %27 = call ptr @malloc(i64 ptrtoint (ptr getelementptr ({ { ptr }, i32, i32 }, ptr null, i32 1) to i64))
  ...
  %55 = getelementptr [3 x ptr], ptr %51, i32 0, i32 0
...
89:                                               ; preds = %2
  ...
  %107 = load i40, ptr @patco_false, align 4
...
define void @IO__Self_print_xCharacter(ptr %0, { ptr, i160 } %1) {
  ...
  %11 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (i8, ptr null, i32 2) to i64))
  %12 = alloca ptr, align 8
  store ptr %11, ptr %12, align 8
  %13 = alloca { ptr }, align 8
  %14 = getelementptr { ptr }, ptr %12, i32 0, i32 0
...
define void @IO__Self_print_xNil(ptr %0, { ptr, i160 } %1) {
  %3 = alloca { ptr, i160 }, align 8
  store { ptr, i160 } %1, ptr %3, align 8
  %4 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (i8, ptr null, i32 4) to i64))
  ...
  %13 = load i24, ptr @azxlv_nil, align 4
  store i24 %13, ptr %12, align 4
  %14 = call ptr @malloc(i64 ptrtoint (ptr getelementptr ({ { ptr }, i32, i32 }, ptr null, i32 1) to i64))
  ...
  %35 = call ptr @llvm.invariant.start.p0(i64 24, ptr %34)
  %36 = getelementptr [3 x ptr], ptr %34, i32 0, i32 2
  store ptr @_parameterization_Ptri32, ptr %36, align 8
  %37 = getelementptr [3 x ptr], ptr %34, i32 0, i32 1
  store ptr @_parameterization_Ptri32, ptr %37, align 8
  %38 = getelementptr [3 x ptr], ptr %34, i32 0, i32 0
...
define ptr @IO_B__Self_print_xString__Self_print_xPtri8__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xCharacter__Self_print_xPtri32__Self_print_xPtri64__Self_print_xNil__Self_print_xRepresentable(ptr %0, { ptr, i160 } %1) {
...
86:                                               ; preds = %73
  ...
  %97 = call i1 @subtype_test_wrapper(ptr %95, i64 %94, i64 %93, i64 6499063144389013426, i64 ptrtoint (ptr @String to i64), ptr %96)
  %98 = xor i1 %97, true
...
109:                                              ; preds = %106
  ...
  %120 = call i1 @subtype_test_wrapper(ptr %118, i64 %117, i64 %116, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr %119)
...
135:                                              ; preds = %122
  ...
  %146 = call i1 @subtype_test_wrapper(ptr %144, i64 %143, i64 %142, i64 2582149688529881115, i64 ptrtoint (ptr @i8_typ to i64), ptr %145)
...
148:                                              ; preds = %135
  ...
  %159 = call i1 @subtype_test_wrapper(ptr %157, i64 %156, i64 %155, i64 -757315540097298781, i64 ptrtoint (ptr @f64_typ to i64), ptr %158)
  %160 = select i1 %159, i32 4, i32 1
...
174:                                              ; preds = %162
  ...
  %185 = call i1 @subtype_test_wrapper(ptr %183, i64 %182, i64 %181, i64 6681222582356018452, i64 ptrtoint (ptr @Character to i64), ptr %184)
  br label %186
...
204:                                              ; preds = %203, %202
  %205 = phi i32 [ 5, %203 ], [ %201, %202 ]
  br label %206

206:                                              ; preds = %15, %204
  %207 = phi i32 [ %205, %204 ], [ 8, %15 ]
  br label %208
