...
@jjovr_nil = internal constant [3 x i8] c"nil"
@mrnfc_false = internal constant [5 x i8] c"false"
@_parameterization_Ptri32 = linkonce_odr constant [2 x ptr] [ptr @i32_typ, ptr null]
@_parameterization_BufferPtri8 = linkonce_odr constant [2 x ptr] [ptr @buffer_typ, ptr null]
@jktrw_true = internal constant [4 x i8] c"true"
...
24:                                               ; preds = %2
  ...
  %31 = load <4 x i8>, ptr @jktrw_true, align 4
...
89:                                               ; preds = %2
  ...
  %96 = load <5 x i8>, ptr @mrnfc_false, align 8
...
define void @IO__Self_print_xNil(ptr %0, { ptr, i160 } %1) {
  ...
  %12 = load <3 x i8>, ptr @jjovr_nil, align 4
...
define ptr @IO_B__Self_print_xPtri1__Self_print_xString__Self_print_xPtri32__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xNil__Self_print_xRepresentable__Self_print_xCharacter(ptr %0) {
...
50:                                               ; preds = %47
  ...
  %61 = call i1 @subtype_test_wrapper(ptr %59, i64 %58, i64 %57, i64 -757315540097298781, i64 ptrtoint (ptr @f64_typ to i64), ptr %60)
...
63:                                               ; preds = %50
  ...
  %74 = call i1 @subtype_test_wrapper(ptr %72, i64 %71, i64 %70, i64 6681222582356018452, i64 ptrtoint (ptr @Character to i64), ptr %73)
...
75:                                               ; preds = %63
  ...
  %86 = call i1 @subtype_test_wrapper(ptr %84, i64 %83, i64 %82, i64 6499063144389013426, i64 ptrtoint (ptr @String to i64), ptr %85)
  %87 = xor i1 %86, true
...
140:                                              ; preds = %127
  ...
  %151 = call i1 @subtype_test_wrapper(ptr %149, i64 %148, i64 %147, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr %150)
...
166:                                              ; preds = %153
  ...
  %177 = call i1 @subtype_test_wrapper(ptr %175, i64 %174, i64 %173, i64 -5126806859456325683, i64 ptrtoint (ptr @nil_typ to i64), ptr %176)
  %178 = select i1 %177, i32 7, i32 4
...
180:                                              ; preds = %166
  %181 = getelementptr { ptr }, ptr %0, i32 0, i32 0
...
206:                                              ; preds = %205, %203
  %207 = phi i32 [ 9, %205 ], [ %204, %203 ]
  br label %208

208:                                              ; preds = %62, %206
  %209 = phi i32 [ %207, %206 ], [ 5, %62 ]
  br label %210
...
212:                                              ; preds = %211, %210
  %213 = phi i32 [ 8, %211 ], [ %209, %210 ]
  %214 = zext i32 %213 to i64
  %215 = or i64 0, %214
  %216 = inttoptr i64 %215 to ptr
  %217 = ptrtoint ptr %216 to i64
  %218 = trunc i64 %217 to i32
  %219 = getelementptr [10 x ptr], ptr @IO, i32 0, i32 %218
