...
@dkgqc_nil = internal constant [3 x i8] c"nil"
@opqek_false = internal constant [5 x i8] c"false"
@_parameterization_Ptri32 = linkonce_odr constant [1 x ptr] [ptr @i32_typ]
@_parameterization_BufferPtri8 = linkonce_odr constant [1 x ptr] [ptr @buffer_typ]
@zdxli_true = internal constant [4 x i8] c"true"
...
6:                                                ; preds = %2
  ...
  %24 = load i32, ptr @zdxli_true, align 4
...
89:                                               ; preds = %2
  ...
  %107 = load i40, ptr @opqek_false, align 4
...
define void @IO__Self_print_xNil(ptr %0, { ptr, i160 } %1) {
  ...
  %13 = load i24, ptr @dkgqc_nil, align 4
...
define ptr @IO_B__Self_print_xRepresentable__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xCharacter__Self_print_xPtri1__Self_print_xPtri64__Self_print_xNil__Self_print_xString__Self_print_xPtri32(ptr %0, { ptr, i160 } %1) {
...
61:                                               ; preds = %48
  ...
  %72 = call i1 @subtype_test_wrapper(ptr %70, i64 %69, i64 %68, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr %71)
...
74:                                               ; preds = %61
  ...
  %85 = call i1 @subtype_test_wrapper(ptr %83, i64 %82, i64 %81, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr %84)
...
87:                                               ; preds = %74
  ...
  %98 = call i1 @subtype_test_wrapper(ptr %96, i64 %95, i64 %94, i64 6681222582356018452, i64 ptrtoint (ptr @Character to i64), ptr %97)
...
180:                                              ; preds = %177
  ...
  %191 = call i1 @subtype_test_wrapper(ptr %189, i64 %188, i64 %187, i64 -5126806859456325683, i64 ptrtoint (ptr @nil_typ to i64), ptr %190)
  br label %193
...
193:                                              ; preds = %192, %180
  %194 = phi i32 [ 1, %192 ], [ 7, %180 ]
  br label %195

195:                                              ; preds = %131, %193
  %196 = phi i32 [ %194, %193 ], [ 6, %131 ]
  br label %197
...
199:                                              ; preds = %198, %197
  %200 = phi i32 [ 4, %198 ], [ %196, %197 ]
  br label %201

201:                                              ; preds = %86, %199
  %202 = phi i32 [ %200, %199 ], [ 5, %86 ]
  br label %203
...
211:                                              ; preds = %210, %209
  %212 = phi i32 [ 8, %210 ], [ %208, %209 ]
  br label %213

213:                                              ; preds = %15, %211
  %214 = phi i32 [ %212, %211 ], [ 2, %15 ]
  br label %215
