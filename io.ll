...
@lxtpo_false = internal constant [5 x i8] c"false"
@swypp_true = internal constant [4 x i8] c"true"
@_parameterization_Ptri32 = linkonce_odr constant [2 x ptr] [ptr @i32_typ, ptr null]
@_parameterization_BufferPtri8 = linkonce_odr constant [2 x ptr] [ptr @buffer_typ, ptr null]
@hjggf_nil = internal constant [3 x i8] c"nil"
...
define void @IO__Self_print_xNil(ptr %0, { ptr, i160 } %1) {
  ...
  %10 = load <3 x i8>, ptr @hjggf_nil, align 4
...
30:                                               ; preds = %2
  ...
  %35 = load <4 x i8>, ptr @swypp_true, align 4
...
81:                                               ; preds = %2
  ...
  %86 = load <5 x i8>, ptr @lxtpo_false, align 8
...
define ptr @IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri64__Self_print_xRepresentable__Self_print_xPtrf64__Self_print_xCharacter__Self_print_xPtri32__Self_print_xPtri1__Self_print_xPtri8(ptr %0) {
...
15:                                               ; preds = %1
  ...
  %26 = call i1 @subtype_test_wrapper(ptr %24, i64 %23, i64 %22, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr %25)
...
60:                                               ; preds = %57
  ...
  %71 = call i1 @subtype_test_wrapper(ptr %69, i64 %68, i64 %67, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr %70)
...
79:                                               ; preds = %73
  ...
  %90 = call i1 @subtype_test_wrapper(ptr %88, i64 %87, i64 %86, i64 6499063144389013426, i64 ptrtoint (ptr @String to i64), ptr %89)
...
91:                                               ; preds = %79
  ...
  %102 = call i1 @subtype_test_wrapper(ptr %100, i64 %99, i64 %98, i64 6681222582356018452, i64 ptrtoint (ptr @Character to i64), ptr %101)
  %103 = xor i1 %102, true
...
106:                                              ; preds = %91, %105
  %107 = phi i32 [ 0, %105 ], [ %104, %91 ]
  br label %108

108:                                              ; preds = %106
  %109 = zext i32 %107 to i64
  %110 = trunc i64 %109 to i32
  switch i32 %110, label %190 [
    i32 0, label %111
  ]
...
111:                                              ; preds = %108
  ...
  %122 = call i1 @subtype_test_wrapper(ptr %120, i64 %119, i64 %118, i64 -757315540097298781, i64 ptrtoint (ptr @f64_typ to i64), ptr %121)
...
185:                                              ; preds = %184, %172
  %186 = phi i32 [ 4, %184 ], [ 9, %172 ]
  br label %187

187:                                              ; preds = %123, %185
  %188 = phi i32 [ %186, %185 ], [ 5, %123 ]
  br label %189
...
191:                                              ; preds = %190, %189
  %192 = phi i32 [ 2, %190 ], [ %188, %189 ]
  br label %193

193:                                              ; preds = %78, %191
  %194 = phi i32 [ %192, %191 ], [ 1, %78 ]
  br label %195
