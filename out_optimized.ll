...
@jogtm_genericmini = internal unnamed_addr constant [12 x i8] c"generic.mini"
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, i32 %2) {
  ...
  tail call void @llvm.memcpy.inline.p0.p0.i64(ptr align 1 %39, ptr nonnull align 1 @jogtm_genericmini, i64 12, i1 false)
...
define { ptr, i128, i32 } @yphnvckxru({ ptr, i128, i32 } %0) {
  ...
  %2 = load ptr, ptr @lciweddgnw, align 8
...
define { ptr, i128, i32 } @cedrttpdjn({ ptr, i128, i32 } %0) {
  %.fca.1.extract = extractvalue { ptr, i128, i32 } %0, 1
  %.sroa.1.8.extract.trunc = trunc i128 %.fca.1.extract to i32
  %2 = load ptr, ptr @wdiiqadurv, align 8
...
define { ptr, i128, i32 } @unkcnldpyi({ ptr, i128, i32 } %0) {
  %.fca.1.extract = extractvalue { ptr, i128, i32 } %0, 1
  %.sroa.1.8.extract.trunc = trunc i128 %.fca.1.extract to i32
  %2 = load ptr, ptr @jdjeundwgy, align 8
  %3 = tail call i32 %2(i32 %.sroa.1.8.extract.trunc)
  %.sroa.3.8.insert.ext = zext i32 %3 to i128
  %4 = insertvalue { ptr, i128, i32 } { ptr @i32_typ, i128 undef, i32 undef }, i128 %.sroa.3.8.insert.ext, 1
  %5 = insertvalue { ptr, i128, i32 } %4, i32 7, 2
...
define { ptr, i128, i32 } @umkdozjeja({ ptr, i128, i32 } %0, { ptr, i128, i32 } %1) local_unnamed_addr {
  ...
  %.sroa.1.8.extract.trunc = trunc i128 %.fca.1.extract to i32
  %3 = load ptr, ptr @ipnmhwemep, align 8
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define i32 @_functionliteral_ymrngjtryi(i32 %0, i32 %1) #0 {
  %3 = add i32 %1, %0
  ret i32 %3
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define range(i32 0, -1) i32 @_functionliteral_ytfcpvycad(i32 %0) #0 {
  %2 = shl i32 %0, 1
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define double @_functionliteral_fuspofteyy(double %0) local_unnamed_addr #0 {
  %2 = fmul double %0, 2.000000e+00
  ret double %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define i32 @_functionliteral_qbyyyuorqi(i32 returned %0) #0 {
  ret i32 %0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define double @_functionliteral_jydodcqzbj(i32 %0) #0 {
...
ArrayIterator_next_.exit2973:
  ...
  call void @llvm.lifetime.end.p0(i64 0, ptr nonnull %0)
  store ptr @_functionliteral_ymrngjtryi, ptr @ipnmhwemep, align 8
  %35 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @ipnmhwemep)
  ...
  %41 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @jdjeundwgy)
  ...
  store ptr @unkcnldpyi, ptr %48, align 8
  store ptr @_functionliteral_jydodcqzbj, ptr @wdiiqadurv, align 8
  %49 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @wdiiqadurv)
  store ptr @_functionliteral_qbyyyuorqi, ptr @lciweddgnw, align 8
  %50 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @lciweddgnw)
  ...
  store ptr @yphnvckxru, ptr %57, align 8
  ...
  store ptr @cedrttpdjn, ptr %64, align 8
  call void @llvm.lifetime.start.p0(i64 0, ptr nonnull %0)
  call void @llvm.lifetime.start.p0(i64 0, ptr nonnull %0)
...
IO_B__Self_print_xNil__Self_print_xCharacter__Self_print_xPtri1__Self_print_xPtri8__Self_print_xString__Self_print_xRepresentable__Self_print_xPtri32__Self_print_xPtrf64__Self_print_xPtri64.exit999: ; preds = %ZipIterator2_next_.exit2215.thread, %ZipIterator2_next_.exit.thread
  ...
  store ptr @Int32, ptr %367, align 8
  ...
  store ptr @Int32, ptr %375, align 8
  ...
  %401 = call ptr @Int32_B__ADD_otherFloat64__ADD_otherInt32({ ptr, ptr, ptr, i32 } %399, ptr nonnull %9, { ptr, i128, i32 } %398)
  ...
  store ptr @Int32, ptr %419, align 8
  ...
  store ptr @Float64, ptr %7, align 8
  %448 = call ptr @Int32_B__ADD_otherFloat64__ADD_otherInt32({ ptr, ptr, ptr, i32 } %446, ptr nonnull %7, { ptr, i128, i32 } %437)
