...
@ftwfd_CUsersPaulKOneDriveDocumentsPLPyPLtmptitjkgmini = internal unnamed_addr constant [58 x i8] c"C:\\Users\\PaulK\\OneDrive\\Documents\\PL\\PyPL\\tmp8t8itjkg.mini"
@xvlie_An_outofbounds_error_occurred_while_indexing_into_a_collection = internal unnamed_addr constant [65 x i8] c"An out-of-bounds error occurred while indexing into a collection."
@yhsqe_The_size_of_the_collection_being_indexed_was = internal unnamed_addr constant [44 x i8] c"The size of the collection being indexed was"
...
@IO = constant { [3 x i64], [4 x ptr], [10 x ptr] } { [3 x i64] [i64 5359822646784595218, i64 4611686018427388073, i64 1], [4 x ptr] [ptr @subtype_test, ptr @IO_hashtbl, ptr @IO_offset_tbl, ptr getelementptr ({}, ptr null, i32 1)], [10 x ptr] [ptr @IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64, ptr @IO__Self_print_xPtri1, ptr @IO__Self_print_xPtri8, ptr @IO__Self_print_xPtrf64, ptr @IO__Self_print_xRepresentable, ptr @IO__Self_print_xNil, ptr @IO__Self_print_xPtri32, ptr @IO__Self_print_xString, ptr @IO__Self_print_xCharacter, ptr @IO__Self_print_xPtri64] }
...
define ptr @IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64(ptr nocapture %0, { ptr, i160 } %1) #8 {
  ...
  %result.i = tail call i1 %11(i64 %10, i64 %9, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr readonly %12) #20
  br i1 %result.i, label %._crit_edge, label %13

13:                                               ; preds = %2
  %result.i2 = tail call i1 %11(i64 %10, i64 %9, i64 -7469797244461771922, i64 ptrtoint (ptr @i64_typ to i64), ptr readonly %12) #20
  br i1 %result.i2, label %._crit_edge, label %14

14:                                               ; preds = %13
  %result.i3 = tail call i1 %11(i64 %10, i64 %9, i64 -757315540097298781, i64 ptrtoint (ptr @f64_typ to i64), ptr readonly %12) #20
...
15:                                               ; preds = %14
  ...
  br i1 %.reg2mem39.0, label %16, label %._crit_edge

16:                                               ; preds = %15
  %result.i6 = tail call i1 %11(i64 %10, i64 %9, i64 2582149688529881115, i64 ptrtoint (ptr @i8_typ to i64), ptr readonly %12) #20
  br i1 %result.i6, label %._crit_edge, label %17

17:                                               ; preds = %16
  %result.i7 = tail call i1 %11(i64 %10, i64 %9, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr readonly %12) #20
...
19:                                               ; preds = %18
  %result.i10 = tail call i1 %11(i64 %10, i64 %9, i64 -5126806859456325683, i64 ptrtoint (ptr @nil_typ to i64), ptr readonly %12) #20
  %20 = select i1 %result.i10, i32 5, i32 4
  br label %._crit_edge

._crit_edge:                                      ; preds = %19, %13, %17, %18, %16, %15, %14, %2
  %.reg2mem23.0 = phi i32 [ 1, %2 ], [ 9, %13 ], [ 3, %14 ], [ 2, %16 ], [ 6, %17 ], [ 8, %18 ], [ 7, %15 ], [ %20, %19 ]
...
IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit67:
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 16
  ...
  %4 = load i352, ptr @yhsqe_The_size_of_the_collection_being_indexed_was, align 16
...
.lr.ph.i:                                         ; preds = %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit67
...
String_c_string_.exit:                            ; preds = %.lr.ph.i, %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit67
  ...
  %.sroa.2.8.extract.trunc.i82 = trunc i160 %43 to i64
  %45 = inttoptr i64 %.sroa.2.8.extract.trunc.i82 to ptr
  ...
  br i1 %52, label %.lr.ph.i115, label %String_c_string_.exit118

.lr.ph.i115:                                      ; preds = %String_c_string_.exit
  ...
  br label %String_c_string_.exit118

String_c_string_.exit118:                         ; preds = %.lr.ph.i115, %String_c_string_.exit
  %56 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull @String)
  %57 = sext i32 %48 to i64
  %58 = getelementptr i8, ptr %51, i64 %57
  store i8 0, ptr %58, align 1
  %puts.i98 = tail call i32 @puts(ptr nonnull dereferenceable(1) %51)
...
define void @OutOfBounds_init_boundsPtri32_indexPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3, i32 %4) {
  ...
  %36 = load i520, ptr @xvlie_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
...
define void @OutOfBounds_print_message_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %result.i.i = tail call i1 %25(i64 %24, i64 %23, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr readonly %26) #20
  br i1 %result.i.i, label %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit, label %27

27:                                               ; preds = %3
  %result.i2.i = tail call i1 %25(i64 %24, i64 %23, i64 -7469797244461771922, i64 ptrtoint (ptr @i64_typ to i64), ptr readonly %26) #20
  br i1 %result.i2.i, label %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit, label %28

28:                                               ; preds = %27
  %result.i3.i = tail call i1 %25(i64 %24, i64 %23, i64 -757315540097298781, i64 ptrtoint (ptr @f64_typ to i64), ptr readonly %26) #20
  br i1 %result.i3.i, label %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit, label %29
...
29:                                               ; preds = %28
  ...
  %.reg2mem39.0.i = select i1 %not.result.i4.i, i1 true, i1 %result.i5.i
  br i1 %.reg2mem39.0.i, label %30, label %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit

30:                                               ; preds = %29
  %result.i6.i = tail call i1 %25(i64 %24, i64 %23, i64 2582149688529881115, i64 ptrtoint (ptr @i8_typ to i64), ptr readonly %26) #20
  br i1 %result.i6.i, label %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit, label %31

31:                                               ; preds = %30
  %result.i7.i = tail call i1 %25(i64 %24, i64 %23, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr readonly %26) #20
  br i1 %result.i7.i, label %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit, label %32

32:                                               ; preds = %31
  %not.result.i5.i = xor i1 %result.i5.i, true
  %.reg2mem37.0.i = or i1 %result.i4.i, %not.result.i5.i
  br i1 %.reg2mem37.0.i, label %33, label %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit

33:                                               ; preds = %32
  %result.i10.i = tail call i1 %25(i64 %24, i64 %23, i64 -5126806859456325683, i64 ptrtoint (ptr @nil_typ to i64), ptr readonly %26) #20
  %34 = select i1 %result.i10.i, i32 5, i32 4
  br label %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit

IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit: ; preds = %3, %27, %28, %29, %30, %31, %32, %33
  %.reg2mem23.0.i = phi i32 [ 1, %3 ], [ 9, %27 ], [ 3, %28 ], [ 2, %30 ], [ 6, %31 ], [ 8, %32 ], [ 7, %29 ], [ %34, %33 ]
  %35 = zext nneg i32 %.reg2mem23.0.i to i64
...
43:                                               ; preds = %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit
...
._crit_edge:                                      ; preds = %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit, %43
  ret void
}
...
18:                                               ; preds = %4
  ...
  %43 = load i520, ptr @xvlie_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %51 = load i464, ptr @ftwfd_CUsersPaulKOneDriveDocumentsPLPyPLtmptitjkgmini, align 16
...
73:                                               ; preds = %67
  ...
  %98 = load i520, ptr @xvlie_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %106 = load i464, ptr @ftwfd_CUsersPaulKOneDriveDocumentsPLPyPLtmptitjkgmini, align 16
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3) {
  ...
  %42 = load i520, ptr @xvlie_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %52 = load i464, ptr @ftwfd_CUsersPaulKOneDriveDocumentsPLPyPLtmptitjkgmini, align 16
...
IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit36:
...
.lr.ph.i:                                         ; preds = %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit36
...
String_c_string_.exit:                            ; preds = %.lr.ph.i, %IO_B__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtrf64__Self_print_xRepresentable__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtri64.exit36
...
IO__Self_print_xPtri1.exit:                       ; preds = %26, %28
  ...
  %puts.i37 = tail call i32 @puts(ptr nonnull dereferenceable(1) %33)
  ret i32 0
}
