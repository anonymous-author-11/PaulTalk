...
@nmvbn_CUsersPaulKOneDriveDocumentsPLPyPLtmppwcajqfmini = internal unnamed_addr constant [58 x i8] c"C:\\Users\\PaulK\\OneDrive\\Documents\\PL\\PyPL\\tmppwcajq0f.mini"
@qufgh_An_outofbounds_error_occurred_while_indexing_into_a_collection = internal unnamed_addr constant [65 x i8] c"An out-of-bounds error occurred while indexing into a collection."
@isgqy_The_size_of_the_collection_being_indexed_was = internal unnamed_addr constant [44 x i8] c"The size of the collection being indexed was"
...
@IO = constant { [3 x i64], [4 x ptr], [10 x ptr] } { [3 x i64] [i64 5359822646784595218, i64 4611686018427388073, i64 1], [4 x ptr] [ptr @subtype_test, ptr @IO_hashtbl, ptr @IO_offset_tbl, ptr getelementptr ({}, ptr null, i32 1)], [10 x ptr] [ptr @IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil, ptr @IO__Self_print_xPtrf64, ptr @IO__Self_print_xPtri64, ptr @IO__Self_print_xPtri32, ptr @IO__Self_print_xPtri8, ptr @IO__Self_print_xCharacter, ptr @IO__Self_print_xRepresentable, ptr @IO__Self_print_xString, ptr @IO__Self_print_xPtri1, ptr @IO__Self_print_xNil] }
...
define ptr @IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil(ptr nocapture %0, { ptr, i160 } %1) #8 {
...
13:                                               ; preds = %2
  %result.i2 = tail call i1 %11(i64 %10, i64 %9, i64 2582149688529881115, i64 ptrtoint (ptr @i8_typ to i64), ptr readonly %12) #20
...
15:                                               ; preds = %14
  %result.i5 = tail call i1 %11(i64 %10, i64 %9, i64 -7469797244461771922, i64 ptrtoint (ptr @i64_typ to i64), ptr readonly %12) #20
  br i1 %result.i5, label %._crit_edge, label %16

16:                                               ; preds = %15
  %not.result.i4 = xor i1 %result.i4, true
  %.reg2mem37.0 = or i1 %result.i3, %not.result.i4
  br i1 %.reg2mem37.0, label %17, label %._crit_edge

17:                                               ; preds = %16
  %result.i8 = tail call i1 %11(i64 %10, i64 %9, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr readonly %12) #20
  br i1 %result.i8, label %._crit_edge, label %18

18:                                               ; preds = %17
  %result.i9 = tail call i1 %11(i64 %10, i64 %9, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr readonly %12) #20
  br i1 %result.i9, label %._crit_edge, label %19

19:                                               ; preds = %18
  %result.i10 = tail call i1 %11(i64 %10, i64 %9, i64 -5126806859456325683, i64 ptrtoint (ptr @nil_typ to i64), ptr readonly %12) #20
  %20 = select i1 %result.i10, i32 9, i32 6
  br label %._crit_edge

._crit_edge:                                      ; preds = %19, %13, %14, %15, %16, %17, %18, %2
  %.reg2mem23.0 = phi i32 [ 1, %2 ], [ 4, %13 ], [ 2, %15 ], [ 3, %17 ], [ 8, %18 ], [ 7, %16 ], [ 5, %14 ], [ %20, %19 ]
...
IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit67:
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 16
  ...
  %4 = load i352, ptr @isgqy_The_size_of_the_collection_being_indexed_was, align 16
...
.lr.ph.i:                                         ; preds = %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit67
...
String_c_string_.exit:                            ; preds = %.lr.ph.i, %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit67
...
define void @OutOfBounds_init_boundsPtri32_indexPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3, i32 %4) {
  ...
  %36 = load i520, ptr @qufgh_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
...
define void @OutOfBounds_print_message_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  br i1 %result.i.i, label %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit, label %27

27:                                               ; preds = %3
  %result.i2.i = tail call i1 %25(i64 %24, i64 %23, i64 2582149688529881115, i64 ptrtoint (ptr @i8_typ to i64), ptr readonly %26) #20
  br i1 %result.i2.i, label %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit, label %28

28:                                               ; preds = %27
  %result.i3.i = tail call i1 %25(i64 %24, i64 %23, i64 6681222582356018452, i64 ptrtoint (ptr @Character to i64), ptr readonly %26) #20
  ...
  br i1 %.reg2mem39.0.i, label %29, label %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit

29:                                               ; preds = %28
  %result.i5.i = tail call i1 %25(i64 %24, i64 %23, i64 -7469797244461771922, i64 ptrtoint (ptr @i64_typ to i64), ptr readonly %26) #20
  br i1 %result.i5.i, label %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit, label %30

30:                                               ; preds = %29
  %not.result.i4.i = xor i1 %result.i4.i, true
  %.reg2mem37.0.i = or i1 %result.i3.i, %not.result.i4.i
  br i1 %.reg2mem37.0.i, label %31, label %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit

31:                                               ; preds = %30
  %result.i8.i = tail call i1 %25(i64 %24, i64 %23, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr readonly %26) #20
  br i1 %result.i8.i, label %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit, label %32

32:                                               ; preds = %31
  %result.i9.i = tail call i1 %25(i64 %24, i64 %23, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr readonly %26) #20
  br i1 %result.i9.i, label %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit, label %33

33:                                               ; preds = %32
  %result.i10.i = tail call i1 %25(i64 %24, i64 %23, i64 -5126806859456325683, i64 ptrtoint (ptr @nil_typ to i64), ptr readonly %26) #20
  %34 = select i1 %result.i10.i, i32 9, i32 6
  br label %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit

IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit: ; preds = %3, %27, %28, %29, %30, %31, %32, %33
  %.reg2mem23.0.i = phi i32 [ 1, %3 ], [ 4, %27 ], [ 2, %29 ], [ 3, %31 ], [ 8, %32 ], [ 7, %30 ], [ 5, %28 ], [ %34, %33 ]
...
43:                                               ; preds = %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit
...
._crit_edge:                                      ; preds = %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit, %43
  ret void
}
...
18:                                               ; preds = %4
  ...
  %43 = load i520, ptr @qufgh_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %51 = load i464, ptr @nmvbn_CUsersPaulKOneDriveDocumentsPLPyPLtmppwcajqfmini, align 16
...
73:                                               ; preds = %67
  ...
  %98 = load i520, ptr @qufgh_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %106 = load i464, ptr @nmvbn_CUsersPaulKOneDriveDocumentsPLPyPLtmppwcajqfmini, align 16
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3) {
  ...
  %42 = load i520, ptr @qufgh_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %52 = load i464, ptr @nmvbn_CUsersPaulKOneDriveDocumentsPLPyPLtmppwcajqfmini, align 16
...
IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit36:
...
.lr.ph.i:                                         ; preds = %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit36
...
String_c_string_.exit:                            ; preds = %.lr.ph.i, %IO_B__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xPtri32__Self_print_xPtri8__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xString__Self_print_xPtri1__Self_print_xNil.exit36
