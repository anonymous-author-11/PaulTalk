...
@ftxbx_genericmini = internal unnamed_addr constant [12 x i8] c"generic.mini"
...
@string_string.21 = internal constant [4 x i8] c"%s\0A\00"
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, i32 %2) {
  ...
  tail call void @llvm.memcpy.inline.p0.p0.i64(ptr align 1 %39, ptr nonnull align 1 @ftxbx_genericmini, i64 12, i1 false)
...
define { ptr, i128, i32 } @lpqkscpjzl({ ptr, i128, i32 } %0) {
  ...
  %2 = load ptr, ptr @utntkecoup, align 8
...
define { ptr, i128, i32 } @ncnmijfymt({ ptr, i128, i32 } %0) {
  %.fca.1.extract = extractvalue { ptr, i128, i32 } %0, 1
  %.sroa.1.8.extract.trunc = trunc i128 %.fca.1.extract to i32
  %2 = load ptr, ptr @iufscoodtf, align 8
...
define { ptr, i128, i32 } @gnwphtjqwb({ ptr, i128, i32 } %0) {
  %.fca.1.extract = extractvalue { ptr, i128, i32 } %0, 1
  %.sroa.1.8.extract.trunc = trunc i128 %.fca.1.extract to i32
  %2 = load ptr, ptr @llbfmjasxu, align 8
  %3 = tail call i32 %2(i32 %.sroa.1.8.extract.trunc)
  %.sroa.3.8.insert.ext = zext i32 %3 to i128
  %4 = insertvalue { ptr, i128, i32 } { ptr @i32_typ, i128 undef, i32 undef }, i128 %.sroa.3.8.insert.ext, 1
  %5 = insertvalue { ptr, i128, i32 } %4, i32 7, 2
...
define { ptr, i128, i32 } @avmczeopjj({ ptr, i128, i32 } %0, { ptr, i128, i32 } %1) local_unnamed_addr {
  ...
  %.sroa.1.8.extract.trunc = trunc i128 %.fca.1.extract to i32
  %3 = load ptr, ptr @mobvmvehhm, align 8
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define i32 @_functionliteral_kmvujhlfgr(i32 %0, i32 %1) #0 {
  %3 = add i32 %1, %0
  ret i32 %3
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define range(i32 0, -1) i32 @_functionliteral_ukdwvbpofy(i32 %0) #0 {
  %2 = shl i32 %0, 1
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define double @_functionliteral_fniiodvpdv(double %0) local_unnamed_addr #0 {
  %2 = fmul double %0, 2.000000e+00
  ret double %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define i32 @_functionliteral_dapfhcioiz(i32 returned %0) #0 {
  ret i32 %0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define double @_functionliteral_lfbmzejawf(i32 %0) #0 {
...
ArrayIterator_next_.exit2972:
  ...
  call void @llvm.lifetime.end.p0(i64 0, ptr nonnull %0)
  store ptr @_functionliteral_kmvujhlfgr, ptr @mobvmvehhm, align 8
  %35 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @mobvmvehhm)
  ...
  %41 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @llbfmjasxu)
  ...
  store ptr @gnwphtjqwb, ptr %49, align 8
  store ptr @_functionliteral_lfbmzejawf, ptr @iufscoodtf, align 8
  %50 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @iufscoodtf)
  store ptr @_functionliteral_dapfhcioiz, ptr @utntkecoup, align 8
  %51 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @utntkecoup)
  ...
  store ptr @lpqkscpjzl, ptr %59, align 8
  ...
  store ptr @ncnmijfymt, ptr %67, align 8
  call void @llvm.lifetime.start.p0(i64 0, ptr nonnull %0)
  call void @llvm.lifetime.start.p0(i64 0, ptr nonnull %0)
...
define { ptr, ptr, ptr, i32 } @Representable_repr_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1) #9 {
...
define { ptr, ptr, ptr, i32 } @String_repr_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1) #10 {
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %.fca.2.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 2
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 8
...
landing_pad:                                      ; preds = %0
  %ok = tail call i32 @printf(ptr nonnull @string_string.21, ptr nonnull @exception_message)
