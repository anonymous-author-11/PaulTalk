...
@fwxwa_An_outofbounds_error_occurred_while_indexing_into_a_collection = internal unnamed_addr constant [65 x i8] c"An out-of-bounds error occurred while indexing into a collection."
@_parameterization_String = linkonce_odr constant [1 x ptr] [ptr @String]
@_parameterization_Ptri32 = linkonce_odr constant [1 x ptr] [ptr @i32_typ]
@aaqcj_The_size_of_the_collection_being_indexed_was = internal unnamed_addr constant [44 x i8] c"The size of the collection being indexed was"
...
@string_string.11 = internal constant [4 x i8] c"%s\0A\00"
...
define { ptr, ptr, ptr, i32 } @Array__Self_from_iterable_iterableIterable2T(ptr nocapture readnone %0, { ptr, ptr, ptr, i32 } %1) {
  ...
  %29 = call ptr @llvm.invariant.start.p0(i64 24, ptr nonnull %.fca.0.extract)
  %30 = sext i32 %offset.i.i61 to i64
  ...
  %.fca.0.extract9153 = extractvalue { ptr, i160 } %35, 0
...
._crit_edge:                                      ; preds = %2, %Array_append_xT.exit
  ...
  %.fca.1.extract11 = extractvalue { ptr, i160 } %38, 1
...
39:                                               ; preds = %._crit_edge
  ...
  %.idx.i227 = shl nsw i64 %41, 5
  %42 = call ptr @malloc(i64 %.idx.i227)
...
._crit_edge.i:                                    ; preds = %39, %._crit_edge.i
  %.reg2mem13.0.i255 = phi i32 [ %52, %._crit_edge.i ], [ 0, %39 ]
  %45 = zext nneg i32 %.reg2mem13.0.i255 to i64
  %.idx80.i = shl nuw nsw i64 %45, 5
  %46 = getelementptr i8, ptr %36, i64 %.idx80.i
  %47 = getelementptr i8, ptr %42, i64 %.idx80.i
  %48 = load ptr, ptr %46, align 8
  %49 = getelementptr i8, ptr %46, i64 8
  %50 = load i160, ptr %49, align 4
  %hash_coef_ptr.i.i228 = getelementptr i8, ptr %48, i64 8
  %tbl_size_ptr.i.i229 = getelementptr i8, ptr %48, i64 16
  %offset_tbl_ptr.i.i230 = getelementptr i8, ptr %48, i64 40
  %hash_coef.i.i231 = load i64, ptr %hash_coef_ptr.i.i228, align 4
  %tbl_size.i.i232 = load i64, ptr %tbl_size_ptr.i.i229, align 4
  %offset_tbl.i.i233 = load ptr, ptr %offset_tbl_ptr.i.i230, align 8
  %product.i.i.i234 = mul i64 %hash_coef.i.i231, 3282773614056351330
  ...
  %.sroa.5.24.insert.ext = zext i32 %offset.i.i239 to i160
  ...
  %52 = add nuw nsw i32 %.reg2mem13.0.i255, 1
...
Array_append_xT.exit:                             ; preds = %._crit_edge.i, %39, %._crit_edge
  ...
  %.sroa.5224.24.insert.ext = zext i32 %offset.i.i192 to i160
  %.sroa.5224.24.insert.shift = shl nuw i160 %.sroa.5224.24.insert.ext, 128
  %.sroa.5224.24.insert.insert = or disjoint i160 %.sroa.5224.24.insert.shift, %.sroa.3.8.insert.ext
  store ptr %.fca.0.extract9155, ptr %58, align 8
  %59 = getelementptr i8, ptr %58, i64 8
  store i160 %.sroa.5224.24.insert.insert, ptr %59, align 4
  ...
  %.fca.0.extract9 = extractvalue { ptr, i160 } %65, 0
  %.not = icmp eq ptr %.fca.0.extract9, @nil_typ
  br i1 %.not, label %.critedge, label %._crit_edge

.critedge:                                        ; preds = %Array_append_xT.exit, %2
  %.pre226 = insertvalue { ptr, ptr, ptr, i32 } { ptr @Array, ptr undef, ptr undef, i32 undef }, ptr %5, 1
  %66 = insertvalue { ptr, ptr, ptr, i32 } %.pre226, ptr undef, 2
...
define { ptr, ptr, ptr, i32 } @Array_append_xT({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr, i160 } %3) {
  ...
  store ptr %.fca.0.extract73, ptr %6, align 8
  %7 = getelementptr inbounds i8, ptr %6, i64 8
  store ptr %.fca.1.extract75, ptr %7, align 8
  ...
  %11 = tail call ptr @llvm.invariant.start.p0(i64 552, ptr %.fca.0.extract73)
  %12 = sext i32 %offset.i.i to i64
  %13 = getelementptr ptr, ptr %.fca.0.extract73, i64 %12
  %14 = getelementptr i8, ptr %13, i64 8
  %15 = load ptr, ptr %14, align 8
  %16 = tail call ptr %15(ptr %.fca.1.extract75)
  %17 = tail call ptr @llvm.invariant.start.p0(i64 552, ptr %.fca.0.extract73)
  %18 = getelementptr i8, ptr %13, i64 16
  %19 = load ptr, ptr %18, align 8
  %20 = tail call ptr %19(ptr %.fca.1.extract75)
  %21 = load i32, ptr %16, align 4
  %22 = load i32, ptr %20, align 4
  %.not = icmp slt i32 %21, %22
  %.pre = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %.fca.0.extract73, 0
  %.pre128 = insertvalue { ptr, ptr, ptr, i32 } %.pre, ptr %.fca.1.extract75, 1
  br i1 %.not, label %._crit_edge, label %23

23:                                               ; preds = %4
  %24 = insertvalue { ptr, ptr, ptr, i32 } %.pre128, ptr %.fca.2.extract, 2
  %25 = insertvalue { ptr, ptr, ptr, i32 } %24, i32 %offset.i.i, 3
  %26 = tail call ptr @llvm.invariant.start.p0(i64 552, ptr nonnull %.fca.0.extract73)
  %27 = getelementptr i8, ptr %13, i64 24
  %28 = load ptr, ptr %27, align 8
  %29 = tail call ptr %28(ptr %.fca.1.extract75)
  %30 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %5)
  %31 = tail call ptr @llvm.invariant.start.p0(i64 552, ptr nonnull %.fca.0.extract73)
  %32 = getelementptr i8, ptr %13, i64 80
  %33 = load ptr, ptr %32, align 8
  %34 = call ptr %33({ ptr, ptr, ptr, i32 } %25, ptr nonnull %5)
  call void %34({ ptr, ptr, ptr, i32 } %25, { ptr, ptr, ptr, i32 } %25, ptr nonnull %5)
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %4, %23
  ...
  %35 = call ptr @llvm.invariant.start.p0(i64 552, ptr nonnull %.fca.0.extract73)
  %36 = load ptr, ptr %13, align 8
  %37 = call ptr %36(ptr %.fca.1.extract75)
  %38 = call ptr @llvm.invariant.start.p0(i64 552, ptr nonnull %.fca.0.extract73)
  %39 = load ptr, ptr %14, align 8
  %40 = call ptr %39(ptr %.fca.1.extract75)
  %41 = load ptr, ptr %37, align 8
  %42 = load i32, ptr %40, align 4
  %43 = sext i32 %42 to i64
  %.idx = shl nsw i64 %43, 5
  %44 = getelementptr i8, ptr %41, i64 %.idx
  %hash_coef.i.i97 = load i64, ptr %hash_coef_ptr.i.i80, align 4
  %tbl_size.i.i98 = load i64, ptr %tbl_size_ptr.i.i81, align 4
  %offset_tbl.i.i99 = load ptr, ptr %offset_tbl_ptr.i.i82, align 8
  %product.i.i.i100 = mul i64 %hash_coef.i.i97, 3282773614056351330
  ...
  %.sroa.5126.8.insert.ext = zext i32 %offset.i.i105 to i160
  %.sroa.5126.8.insert.shift = shl nuw i160 %.sroa.5126.8.insert.ext, 128
  %.sroa.3.8.insert.ext123 = and i160 %.fca.1.extract, 340282366920938463463374607431768211455
  %.sroa.3.8.insert.insert125 = or disjoint i160 %.sroa.5126.8.insert.shift, %.sroa.3.8.insert.ext123
  store i160 %.sroa.3.8.insert.insert125, ptr %45, align 4
  %46 = call ptr @llvm.invariant.start.p0(i64 552, ptr nonnull %.fca.0.extract73)
  %47 = load ptr, ptr %14, align 8
  %48 = call ptr %47(ptr %.fca.1.extract75)
  %49 = load i32, ptr %48, align 4
  %50 = add i32 %49, 1
  %51 = call ptr @llvm.invariant.start.p0(i64 552, ptr nonnull %.fca.0.extract73)
  %52 = load ptr, ptr %14, align 8
  %53 = call ptr %52(ptr %.fca.1.extract75)
  store i32 %50, ptr %53, align 4
  %54 = load ptr, ptr %8, align 8
  %hash_coef.i.i111 = load i64, ptr %hash_coef_ptr.i.i, align 4
  %tbl_size.i.i112 = load i64, ptr %tbl_size_ptr.i.i, align 4
  %offset_tbl.i.i113 = load ptr, ptr %offset_tbl_ptr.i.i, align 8
  %product.i.i.i114 = mul i64 %hash_coef.i.i111, -5261542750394134544
  %shifted.i.i.i115 = lshr i64 %product.i.i.i114, 32
  %xored.i.i.i116 = xor i64 %shifted.i.i.i115, %product.i.i.i114
  %hash.i.i.i117 = and i64 %xored.i.i.i116, %tbl_size.i.i112
  %offset_ptr.i.i118 = getelementptr i32, ptr %offset_tbl.i.i113, i64 %hash.i.i.i117
  %offset.i.i119 = load i32, ptr %offset_ptr.i.i118, align 4
  %55 = insertvalue { ptr, ptr, ptr, i32 } %.pre128, ptr %54, 2
  %56 = insertvalue { ptr, ptr, ptr, i32 } %55, i32 %offset.i.i119, 3
...
define { ptr, i160 } @Array__index_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3) {
  ...
  %offset_ptr.i.i = getelementptr i32, ptr %offset_tbl.i.i, i64 %hash.i.i.i
  %offset.i.i = load i32, ptr %offset_ptr.i.i, align 4
  %7 = tail call ptr @llvm.invariant.start.p0(i64 552, ptr %.fca.0.extract)
...
23:                                               ; preds = %4
  ...
  %35 = call ptr %34({ ptr, ptr, ptr, i32 } %27, ptr nonnull %5, i32 %3)
  call void %35({ ptr, ptr, ptr, i32 } %27, { ptr, ptr, ptr, i32 } %27, ptr nonnull %6, i32 %3)
  br label %._crit_edge
...
43:                                               ; preds = %._crit_edge, %37
  ...
  %hash_coef_ptr.i.i54 = getelementptr i8, ptr %50, i64 8
  %tbl_size_ptr.i.i55 = getelementptr i8, ptr %50, i64 16
  %offset_tbl_ptr.i.i56 = getelementptr i8, ptr %50, i64 40
  ...
  %product.i.i.i60 = mul i64 %hash_coef.i.i57, 3282773614056351330
  ...
  %.sroa.5.8.insert.ext = zext i32 %offset.i.i65 to i160
  %.sroa.5.8.insert.shift = shl nuw i160 %.sroa.5.8.insert.ext, 128
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3) {
  ...
  %42 = load i520, ptr @fwxwa_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %51 = tail call dereferenceable_or_null(17) ptr @malloc(i64 17)
  store i128 140142230515108953610783479201033645923, ptr %51, align 4
  %52 = tail call dereferenceable_or_null(16) ptr @malloc(i64 16)
  %53 = tail call ptr @llvm.invariant.start.p0(i64 552, ptr %.fca.0.extract)
  ...
  %59 = tail call ptr @llvm.invariant.start.p0(i64 552, ptr %.fca.0.extract)
  %60 = load ptr, ptr %22, align 8
  %61 = tail call ptr %60(ptr %.fca.1.extract)
  %62 = tail call ptr @llvm.invariant.start.p0(i64 232, ptr nonnull @OutOfBounds)
  store i32 112, ptr %33, align 4
  %63 = tail call ptr @llvm.invariant.start.p0(i64 104, ptr nonnull @OutOfBounds)
  store ptr @String, ptr %38, align 8
  store ptr %52, ptr %39, align 8
  store i32 7, ptr %40, align 4
  %64 = load i160, ptr %14, align 8
  %65 = insertvalue { ptr, i160 } { ptr @OutOfBounds, i160 undef }, i160 %64, 1
  %current_coroutine.i = load ptr, ptr @current_coroutine, align 8
  %66 = getelementptr i8, ptr %current_coroutine.i, i64 48
...
define { ptr, ptr, ptr, i32 } @Array_iterator_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %hash_coef.i.i48 = load i64, ptr %hash_coef_ptr.i.i, align 4
  %tbl_size.i.i49 = load i64, ptr %tbl_size_ptr.i.i, align 4
  %offset_tbl.i.i50 = load ptr, ptr %offset_tbl_ptr.i.i, align 8
  %product.i.i.i51 = mul i64 %hash_coef.i.i48, -5261542750394134544
  ...
  store i32 %offset.i.i56, ptr %22, align 4
...
define void @Iterable2_each_fFunctionT_to_Nothing({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr } %3) {
  ...
  %6 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %.fca.0.extract19, 0
  %7 = insertvalue { ptr, ptr, ptr, i32 } %6, ptr %.fca.1.extract21, 1
  %8 = insertvalue { ptr, ptr, ptr, i32 } %7, ptr %.fca.2.extract23, 2
  %9 = insertvalue { ptr, ptr, ptr, i32 } %8, i32 %offset.i.i, 3
  %10 = tail call ptr @llvm.invariant.start.p0(i64 184, ptr %.fca.0.extract19)
  %11 = sext i32 %offset.i.i to i64
  %12 = getelementptr ptr, ptr %.fca.0.extract19, i64 %11
  %13 = load ptr, ptr %12, align 8
  %14 = tail call ptr %13(ptr %.fca.1.extract21)
  %15 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %5)
  %16 = tail call ptr @llvm.invariant.start.p0(i64 184, ptr %.fca.0.extract19)
  ...
  %hash_coef.i.i49 = load i64, ptr %hash_coef_ptr.i.i32, align 4
  %tbl_size.i.i50 = load i64, ptr %tbl_size_ptr.i.i33, align 4
  %offset_tbl.i.i51 = load ptr, ptr %offset_tbl_ptr.i.i34, align 8
  ...
  %25 = call ptr @llvm.invariant.start.p0(i64 184, ptr %.fca.0.extract19)
  %26 = load ptr, ptr %12, align 8
  %27 = call ptr %26(ptr %.fca.1.extract21)
  %28 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %5)
  %29 = call ptr @llvm.invariant.start.p0(i64 24, ptr nonnull %.fca.0.extract)
  %30 = sext i32 %offset.i.i57 to i64
  %gep = getelementptr ptr, ptr %hash_coef_ptr.i.i32, i64 %30
  %31 = load ptr, ptr %gep, align 8
  %32 = call ptr %31({ ptr, ptr, ptr, i32 } %24, ptr nonnull %5)
  %33 = call { ptr, i160 } %32({ ptr, ptr, ptr, i32 } %24, { ptr, ptr, ptr, i32 } %24, ptr nonnull %5)
  %.fca.0.extract27121 = extractvalue { ptr, i160 } %33, 0
  %.not122 = icmp eq ptr %.fca.0.extract27121, @nil_typ
  br i1 %.not122, label %.critedge, label %._crit_edge

._crit_edge:                                      ; preds = %4, %._crit_edge
  %.fca.0.extract27123 = phi ptr [ %.fca.0.extract27, %._crit_edge ], [ %.fca.0.extract27121, %4 ]
  %34 = phi { ptr, i160 } [ %43, %._crit_edge ], [ %33, %4 ]
  %.fca.1.extract29 = extractvalue { ptr, i160 } %34, 1
  %hash_coef_ptr.i.i60 = getelementptr i8, ptr %.fca.0.extract27123, i64 8
  %tbl_size_ptr.i.i61 = getelementptr i8, ptr %.fca.0.extract27123, i64 16
  %offset_tbl_ptr.i.i62 = getelementptr i8, ptr %.fca.0.extract27123, i64 40
  ...
  %product.i.i.i66 = mul i64 %hash_coef.i.i63, 3282773614056351330
  ...
  %.sroa.7.8.insert.ext = zext i32 %offset.i.i71 to i160
  %.sroa.7.8.insert.shift = shl nuw i160 %.sroa.7.8.insert.ext, 128
  %35 = insertvalue { ptr, i160 } undef, ptr %.fca.0.extract27123, 0
  %.sroa.3.8.insert.ext = and i160 %.fca.1.extract29, 340282366920938463463374607431768211455
  %.sroa.3.8.insert.insert = or disjoint i160 %.sroa.7.8.insert.shift, %.sroa.3.8.insert.ext
  %36 = insertvalue { ptr, i160 } %35, i160 %.sroa.3.8.insert.insert, 1
  call void %.fca.0.extract1({ ptr, i160 } %36)
  %37 = load ptr, ptr %12, align 8
  %38 = call ptr %37(ptr %.fca.1.extract21)
  %39 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %5)
  %40 = call ptr @llvm.invariant.start.p0(i64 24, ptr nonnull %.fca.0.extract)
  %41 = load ptr, ptr %gep, align 8
  %42 = call ptr %41({ ptr, ptr, ptr, i32 } %24, ptr nonnull %5)
  %43 = call { ptr, i160 } %42({ ptr, ptr, ptr, i32 } %24, { ptr, ptr, ptr, i32 } %24, ptr nonnull %5)
  %.fca.0.extract27 = extractvalue { ptr, i160 } %43, 0
  %.not = icmp eq ptr %.fca.0.extract27, @nil_typ
  br i1 %.not, label %.critedge, label %._crit_edge
...
define { ptr, i160 } @Iterable2_reduce_accumulatorT_fFunctionT._T_to_T({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr, i160 } %3, { ptr } %4) {
  ...
  %7 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %.fca.0.extract23, 0
  %8 = insertvalue { ptr, ptr, ptr, i32 } %7, ptr %.fca.1.extract25, 1
  %9 = insertvalue { ptr, ptr, ptr, i32 } %8, ptr %.fca.2.extract27, 2
  %10 = insertvalue { ptr, ptr, ptr, i32 } %9, i32 %offset.i.i, 3
  %11 = tail call ptr @llvm.invariant.start.p0(i64 184, ptr %.fca.0.extract23)
  %12 = sext i32 %offset.i.i to i64
  %13 = getelementptr ptr, ptr %.fca.0.extract23, i64 %12
  %14 = load ptr, ptr %13, align 8
  %15 = tail call ptr %14(ptr %.fca.1.extract25)
  %16 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %6)
  %17 = tail call ptr @llvm.invariant.start.p0(i64 184, ptr %.fca.0.extract23)
  ...
  %hash_coef.i.i73 = load i64, ptr %hash_coef_ptr.i.i56, align 4
  %tbl_size.i.i74 = load i64, ptr %tbl_size_ptr.i.i57, align 4
  %offset_tbl.i.i75 = load ptr, ptr %offset_tbl_ptr.i.i58, align 8
  %product.i.i.i76 = mul i64 %hash_coef.i.i73, 4189192806087951739
  ...
  %25 = insertvalue { ptr, ptr, ptr, i32 } %24, i32 %offset.i.i81, 3
  %26 = call ptr @llvm.invariant.start.p0(i64 184, ptr %.fca.0.extract23)
  %.sroa.0.0228 = extractvalue { ptr, i160 } %3, 0
  %27 = load ptr, ptr %13, align 8
  %28 = call ptr %27(ptr %.fca.1.extract25)
  %29 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %6)
  %30 = call ptr @llvm.invariant.start.p0(i64 24, ptr nonnull %.fca.0.extract)
  %31 = sext i32 %offset.i.i81 to i64
  %gep = getelementptr ptr, ptr %hash_coef_ptr.i.i56, i64 %31
  %32 = load ptr, ptr %gep, align 8
  %33 = call ptr %32({ ptr, ptr, ptr, i32 } %25, ptr nonnull %6)
  %34 = call { ptr, i160 } %33({ ptr, ptr, ptr, i32 } %25, { ptr, ptr, ptr, i32 } %25, ptr nonnull %6)
  %.fca.0.extract31229 = extractvalue { ptr, i160 } %34, 0
  %.not230 = icmp eq ptr %.fca.0.extract31229, @nil_typ
  br i1 %.not230, label %.critedge, label %._crit_edge

._crit_edge:                                      ; preds = %5, %._crit_edge
  %.fca.0.extract31233 = phi ptr [ %.fca.0.extract31, %._crit_edge ], [ %.fca.0.extract31229, %5 ]
  %35 = phi { ptr, i160 } [ %47, %._crit_edge ], [ %34, %5 ]
  %.sroa.0.0232 = phi ptr [ %.sroa.0.0, %._crit_edge ], [ %.sroa.0.0228, %5 ]
  %.sroa.5.sroa.0.0231 = phi i128 [ %.sroa.5.8.extract.trunc168, %._crit_edge ], [ %.sroa.5.8.extract.trunc, %5 ]
  %.fca.1.extract33 = extractvalue { ptr, i160 } %35, 1
  %hash_coef_ptr.i.i84 = getelementptr i8, ptr %.fca.0.extract31233, i64 8
  %tbl_size_ptr.i.i85 = getelementptr i8, ptr %.fca.0.extract31233, i64 16
  %offset_tbl_ptr.i.i86 = getelementptr i8, ptr %.fca.0.extract31233, i64 40
  ...
  %hash_coef_ptr.i.i98 = getelementptr i8, ptr %.sroa.0.0232, i64 8
  %tbl_size_ptr.i.i99 = getelementptr i8, ptr %.sroa.0.0232, i64 16
  %offset_tbl_ptr.i.i100 = getelementptr i8, ptr %.sroa.0.0232, i64 40
  ...
  %36 = insertvalue { ptr, i160 } undef, ptr %.sroa.0.0232, 0
  %.sroa.5.8.insert.ext196 = zext i32 %offset.i.i109 to i160
  %.sroa.5.8.insert.shift = shl nuw i160 %.sroa.5.8.insert.ext196, 128
  %.sroa.3.8.insert.ext = zext i128 %.sroa.5.sroa.0.0231 to i160
  %.sroa.3.8.insert.insert = or disjoint i160 %.sroa.5.8.insert.shift, %.sroa.3.8.insert.ext
  %37 = insertvalue { ptr, i160 } %36, i160 %.sroa.3.8.insert.insert, 1
  %.sroa.7.8.insert.ext = zext i32 %offset.i.i95 to i160
  %.sroa.7.8.insert.shift = shl nuw i160 %.sroa.7.8.insert.ext, 128
  %38 = insertvalue { ptr, i160 } undef, ptr %.fca.0.extract31233, 0
  %.sroa.3.8.insert.ext201 = and i160 %.fca.1.extract33, 340282366920938463463374607431768211455
  %.sroa.3.8.insert.insert203 = or disjoint i160 %.sroa.7.8.insert.shift, %.sroa.3.8.insert.ext201
  %39 = insertvalue { ptr, i160 } %38, i160 %.sroa.3.8.insert.insert203, 1
  %40 = call { ptr, i160 } %.fca.0.extract1({ ptr, i160 } %37, { ptr, i160 } %39)
  %.fca.1.extract37 = extractvalue { ptr, i160 } %40, 1
  %.sroa.5.8.extract.trunc168 = trunc i160 %.fca.1.extract37 to i128
  %.sroa.0.0 = extractvalue { ptr, i160 } %40, 0
  %41 = load ptr, ptr %13, align 8
  %42 = call ptr %41(ptr %.fca.1.extract25)
  %43 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %6)
  %44 = call ptr @llvm.invariant.start.p0(i64 24, ptr nonnull %.fca.0.extract)
  %45 = load ptr, ptr %gep, align 8
  %46 = call ptr %45({ ptr, ptr, ptr, i32 } %25, ptr nonnull %6)
  %47 = call { ptr, i160 } %46({ ptr, ptr, ptr, i32 } %25, { ptr, ptr, ptr, i32 } %25, ptr nonnull %6)
  %.fca.0.extract31 = extractvalue { ptr, i160 } %47, 0
  %.not = icmp eq ptr %.fca.0.extract31, @nil_typ
  br i1 %.not, label %.critedge, label %._crit_edge

.critedge:                                        ; preds = %._crit_edge, %5
  %.sroa.5.sroa.0.0.lcssa = phi i128 [ %.sroa.5.8.extract.trunc, %5 ], [ %.sroa.5.8.extract.trunc168, %._crit_edge ]
  %.sroa.0.0.lcssa = phi ptr [ %.sroa.0.0228, %5 ], [ %.sroa.0.0, %._crit_edge ]
  %hash_coef_ptr.i.i154 = getelementptr i8, ptr %.sroa.0.0.lcssa, i64 8
  %tbl_size_ptr.i.i155 = getelementptr i8, ptr %.sroa.0.0.lcssa, i64 16
  %offset_tbl_ptr.i.i156 = getelementptr i8, ptr %.sroa.0.0.lcssa, i64 40
  ...
  %48 = insertvalue { ptr, i160 } undef, ptr %.sroa.0.0.lcssa, 0
  %.sroa.5225.8.insert.ext = zext i32 %offset.i.i165 to i160
  %.sroa.5225.8.insert.shift = shl nuw i160 %.sroa.5225.8.insert.ext, 128
  %.sroa.3.8.insert.ext222 = zext i128 %.sroa.5.sroa.0.0.lcssa to i160
  %.sroa.3.8.insert.insert224 = or disjoint i160 %.sroa.5225.8.insert.shift, %.sroa.3.8.insert.ext222
  %49 = insertvalue { ptr, i160 } %48, i160 %.sroa.3.8.insert.insert224, 1
  ret { ptr, i160 } %49
}
...
define noundef i1 @Iterable2_all_fFunctionT_to_Ptri1({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr } %3) {
  ...
  %24 = insertvalue { ptr, ptr, ptr, i32 } %23, i32 %offset.i.i57, 3
  %25 = call ptr @llvm.invariant.start.p0(i64 184, ptr %.fca.0.extract19)
  %26 = sext i32 %offset.i.i57 to i64
  %gep = getelementptr ptr, ptr %hash_coef_ptr.i.i32, i64 %26
  br label %27
...
27:                                               ; preds = %35, %4
  ...
  %30 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %5)
  %31 = call ptr @llvm.invariant.start.p0(i64 24, ptr nonnull %.fca.0.extract)
  %32 = load ptr, ptr %gep, align 8
  %33 = call ptr %32({ ptr, ptr, ptr, i32 } %24, ptr nonnull %5)
  %34 = call { ptr, i160 } %33({ ptr, ptr, ptr, i32 } %24, { ptr, ptr, ptr, i32 } %24, ptr nonnull %5)
  %.fca.0.extract27 = extractvalue { ptr, i160 } %34, 0
  %.not = icmp eq ptr %.fca.0.extract27, @nil_typ
  br i1 %.not, label %.critedge.cont, label %35

35:                                               ; preds = %27
  %.fca.1.extract29 = extractvalue { ptr, i160 } %34, 1
  %hash_coef_ptr.i.i60 = getelementptr i8, ptr %.fca.0.extract27, i64 8
  %tbl_size_ptr.i.i61 = getelementptr i8, ptr %.fca.0.extract27, i64 16
  %offset_tbl_ptr.i.i62 = getelementptr i8, ptr %.fca.0.extract27, i64 40
  %hash_coef.i.i63 = load i64, ptr %hash_coef_ptr.i.i60, align 4
  %tbl_size.i.i64 = load i64, ptr %tbl_size_ptr.i.i61, align 4
  %offset_tbl.i.i65 = load ptr, ptr %offset_tbl_ptr.i.i62, align 8
  %product.i.i.i66 = mul i64 %hash_coef.i.i63, 3282773614056351330
  ...
  %.sroa.5.8.insert.shift = shl nuw i160 %.sroa.5.8.insert.ext, 128
  %36 = insertvalue { ptr, i160 } undef, ptr %.fca.0.extract27, 0
  %.sroa.3.8.insert.ext90 = and i160 %.fca.1.extract29, 340282366920938463463374607431768211455
  %.sroa.3.8.insert.insert92 = or disjoint i160 %.sroa.5.8.insert.shift, %.sroa.3.8.insert.ext90
  %37 = insertvalue { ptr, i160 } %36, i160 %.sroa.3.8.insert.insert92, 1
  %38 = call i1 %.fca.0.extract1({ ptr, i160 } %37)
  br i1 %38, label %27, label %.critedge.cont

.critedge.cont:                                   ; preds = %35, %27
  ret i1 %.not
}
...
27:                                               ; preds = %35, %4
  ...
  %34 = call { ptr, i160 } %33({ ptr, ptr, ptr, i32 } %24, { ptr, ptr, ptr, i32 } %24, ptr nonnull %5)
  %.fca.0.extract27 = extractvalue { ptr, i160 } %34, 0
  %.not.not.not.not.not = icmp ne ptr %.fca.0.extract27, @nil_typ
  br i1 %.not.not.not.not.not, label %35, label %.critedge.cont
...
35:                                               ; preds = %27
  ...
  %37 = insertvalue { ptr, i160 } %36, i160 %.sroa.3.8.insert.insert, 1
  %38 = call i1 %.fca.0.extract1({ ptr, i160 } %37)
  br i1 %38, label %.critedge.cont, label %27

.critedge.cont:                                   ; preds = %27, %35
...
define { ptr, ptr, ptr, i32 } @Iterable2_map_fFunctionT_to_U({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readonly %2, { ptr } %3) {
  ...
  %hash_coef.i.i49 = load i64, ptr %hash_coef_ptr.i.i, align 4
  %tbl_size.i.i50 = load i64, ptr %tbl_size_ptr.i.i, align 4
  %offset_tbl.i.i51 = load ptr, ptr %offset_tbl_ptr.i.i, align 8
  ...
  store i32 %offset.i.i57, ptr %26, align 4
...
define { ptr, ptr, ptr, i32 } @Iterable2_filter_fFunctionT_to_Ptri1({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr } %3) {
  ...
  store ptr %.fca.2.extract, ptr %21, align 8
  %22 = getelementptr i8, ptr %11, i64 24
  store i32 %offset.i.i57, ptr %22, align 4
  %.fca.0.extract.i = extractvalue { ptr } %3, 0
...
define { ptr, ptr, ptr, i32 } @Iterable2_chain_otherIterable2T({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr, ptr, ptr, i32 } %3) {
  ...
  %tbl_size.i.i112 = load i64, ptr %tbl_size_ptr.i.i, align 4
  %offset_tbl.i.i113 = load ptr, ptr %offset_tbl_ptr.i.i, align 8
  %product.i.i.i114 = mul i64 %hash_coef.i.i111, 5693646204635713916
  %shifted.i.i.i115 = lshr i64 %product.i.i.i114, 32
  %xored.i.i.i116 = xor i64 %shifted.i.i.i115, %product.i.i.i114
  %hash.i.i.i117 = and i64 %xored.i.i.i116, %tbl_size.i.i112
  %offset_ptr.i.i118 = getelementptr i32, ptr %offset_tbl.i.i113, i64 %hash.i.i.i117
  ...
  %22 = getelementptr i8, ptr %11, i64 24
  store i32 %offset.i.i119, ptr %22, align 4
  %23 = tail call ptr @llvm.invariant.start.p0(i64 400, ptr nonnull @ChainIterable2)
  %24 = getelementptr i8, ptr %11, i64 32
  %hash_coef.i.i84 = load i64, ptr %hash_coef_ptr.i.i26, align 4
  %tbl_size.i.i85 = load i64, ptr %tbl_size_ptr.i.i27, align 4
  %offset_tbl.i.i86 = load ptr, ptr %offset_tbl_ptr.i.i28, align 8
  %product.i.i.i87 = mul i64 %hash_coef.i.i84, 5693646204635713916
  ...
  store i32 %offset.i.i92, ptr %27, align 4
...
define { ptr, ptr, ptr, i32 } @Iterable2_zip_otherIterable2U({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readonly %2, { ptr, ptr, ptr, i32 } %3) {
  ...
  store i32 %offset.i.i119, ptr %31, align 4
  ...
  store i32 %offset.i.i92, ptr %36, align 4
...
thread-pre-split:
  ...
  %.fca.0.extract200 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract202 = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %.fca.2.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 2
  %.fca.3.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 3
  %5 = alloca { ptr, ptr, ptr, i32 }, align 8
  store ptr %.fca.0.extract200, ptr %5, align 8
  %6 = getelementptr inbounds i8, ptr %5, i64 8
  store ptr %.fca.1.extract202, ptr %6, align 8
  %7 = getelementptr inbounds i8, ptr %5, i64 16
  store ptr %.fca.2.extract, ptr %7, align 8
  %8 = getelementptr inbounds i8, ptr %5, i64 24
  store i32 %.fca.3.extract, ptr %8, align 8
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract200, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract200, i64 16
  %offset_tbl_ptr.i.i = getelementptr i8, ptr %.fca.0.extract200, i64 40
  %hash_coef.i.i = load i64, ptr %hash_coef_ptr.i.i, align 4
  %tbl_size.i.i = load i64, ptr %tbl_size_ptr.i.i, align 4
  %offset_tbl.i.i = load ptr, ptr %offset_tbl_ptr.i.i, align 8
  %product.i.i.i = mul i64 %hash_coef.i.i, 4440657219728359865
  ...
  %10 = tail call ptr @llvm.invariant.start.p0(i64 112, ptr %.fca.0.extract200)
  %11 = sext i32 %offset.i.i to i64
  %12 = getelementptr ptr, ptr %.fca.0.extract200, i64 %11
  %13 = getelementptr i8, ptr %12, i64 24
  %14 = load ptr, ptr %13, align 8
  %15 = tail call ptr %14(ptr %.fca.1.extract202)
  %.pr = load ptr, ptr %15, align 8
  %.not355 = icmp eq ptr %.pr, @nil_typ
  br i1 %.not355, label %.thread344, label %.lr.ph

.lr.ph:                                           ; preds = %thread-pre-split
  %16 = getelementptr i8, ptr %15, i64 8
  %17 = tail call ptr @llvm.invariant.start.p0(i64 112, ptr nonnull %.fca.0.extract200)
...
22:                                               ; preds = %.lr.ph, %52
  %23 = phi i160 [ %.pre, %.lr.ph ], [ %124, %52 ]
  %24 = phi ptr [ %.pr, %.lr.ph ], [ %122, %52 ]
  %25 = load ptr, ptr %18, align 8
  %26 = call ptr %25(ptr %.fca.1.extract202)
  ...
  %38 = call ptr @llvm.invariant.start.p0(i64 112, ptr nonnull %.fca.0.extract200)
  %39 = load ptr, ptr %19, align 8
  %40 = call ptr %39(ptr %.fca.1.extract202)
  %41 = call ptr @llvm.invariant.start.p0(i64 112, ptr nonnull %.fca.0.extract200)
  %42 = load ptr, ptr %20, align 8
  %43 = call ptr %42(ptr %.fca.1.extract202)
  %44 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %3)
  %45 = call ptr @llvm.invariant.start.p0(i64 24, ptr %27)
  %46 = sext i32 %36 to i64
  %47 = getelementptr ptr, ptr %27, i64 %46
  %48 = getelementptr i8, ptr %47, i64 8
  %49 = load ptr, ptr %48, align 8
  %50 = call ptr %49({ ptr, ptr, ptr, i32 } %37, ptr nonnull %3)
  %51 = call { ptr, i160 } %50({ ptr, ptr, ptr, i32 } %37, { ptr, ptr, ptr, i32 } %37, ptr nonnull %3)
  %.fca.0.extract206 = extractvalue { ptr, i160 } %51, 0
  %.not351 = icmp eq ptr %.fca.0.extract206, @nil_typ
  br i1 %.not351, label %52, label %125

52:                                               ; preds = %22
  %53 = call ptr @llvm.invariant.start.p0(i64 112, ptr nonnull %.fca.0.extract200)
  %54 = load ptr, ptr %12, align 8
  %55 = call ptr %54(ptr %.fca.1.extract202)
  ...
  %67 = call ptr @llvm.invariant.start.p0(i64 112, ptr nonnull %.fca.0.extract200)
  %68 = load ptr, ptr %19, align 8
  %69 = call ptr %68(ptr %.fca.1.extract202)
  %70 = call ptr @llvm.invariant.start.p0(i64 112, ptr nonnull %.fca.0.extract200)
  %71 = load ptr, ptr %20, align 8
  %72 = call ptr %71(ptr %.fca.1.extract202)
  %73 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %3)
  %74 = call ptr @llvm.invariant.start.p0(i64 24, ptr %56)
  %75 = sext i32 %65 to i64
  %76 = getelementptr ptr, ptr %56, i64 %75
  %77 = getelementptr i8, ptr %76, i64 8
  %78 = load ptr, ptr %77, align 8
  %79 = call ptr %78({ ptr, ptr, ptr, i32 } %66, ptr nonnull %3)
  %80 = call { ptr, i160 } %79({ ptr, ptr, ptr, i32 } %66, { ptr, ptr, ptr, i32 } %66, ptr nonnull %3)
  %.fca.0.extract211 = extractvalue { ptr, i160 } %80, 0
  %.fca.1.extract213 = extractvalue { ptr, i160 } %80, 1
  %81 = call ptr @llvm.invariant.start.p0(i64 112, ptr nonnull %.fca.0.extract200)
  %82 = load ptr, ptr %13, align 8
  %83 = call ptr %82(ptr %.fca.1.extract202)
  store ptr %.fca.0.extract211, ptr %83, align 8
  %84 = getelementptr i8, ptr %83, i64 8
  store i160 %.fca.1.extract213, ptr %84, align 4
  %85 = call ptr @llvm.invariant.start.p0(i64 112, ptr nonnull %.fca.0.extract200)
  %86 = load ptr, ptr %21, align 8
  %87 = call ptr %86(ptr %.fca.1.extract202)
  ...
  %99 = call ptr @llvm.invariant.start.p0(i64 112, ptr nonnull %.fca.0.extract200)
  %100 = load ptr, ptr %19, align 8
  %101 = call ptr %100(ptr %.fca.1.extract202)
  %102 = call ptr @llvm.invariant.start.p0(i64 112, ptr nonnull %.fca.0.extract200)
  %103 = load ptr, ptr %20, align 8
  %104 = call ptr %103(ptr %.fca.1.extract202)
  %105 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %3)
  %106 = call ptr @llvm.invariant.start.p0(i64 184, ptr %88)
  %107 = sext i32 %97 to i64
  %108 = getelementptr ptr, ptr %88, i64 %107
  %109 = getelementptr i8, ptr %108, i64 8
  %110 = load ptr, ptr %109, align 8
  %111 = call ptr %110({ ptr, ptr, ptr, i32 } %98, ptr nonnull %3)
  %112 = call { ptr, ptr, ptr, i32 } %111({ ptr, ptr, ptr, i32 } %98, { ptr, ptr, ptr, i32 } %98, ptr nonnull %3)
  %.fca.0.extract216 = extractvalue { ptr, ptr, ptr, i32 } %112, 0
  %.fca.1.extract218 = extractvalue { ptr, ptr, ptr, i32 } %112, 1
  %.fca.2.extract220 = extractvalue { ptr, ptr, ptr, i32 } %112, 2
  %hash_coef_ptr.i.i239 = getelementptr i8, ptr %.fca.0.extract216, i64 8
  %tbl_size_ptr.i.i240 = getelementptr i8, ptr %.fca.0.extract216, i64 16
  %offset_tbl_ptr.i.i241 = getelementptr i8, ptr %.fca.0.extract216, i64 40
  %113 = call ptr @llvm.invariant.start.p0(i64 112, ptr nonnull %.fca.0.extract200)
  %114 = load ptr, ptr %18, align 8
  %115 = call ptr %114(ptr %.fca.1.extract202)
  %hash_coef.i.i256 = load i64, ptr %hash_coef_ptr.i.i239, align 4
  %tbl_size.i.i257 = load i64, ptr %tbl_size_ptr.i.i240, align 4
  %offset_tbl.i.i258 = load ptr, ptr %offset_tbl_ptr.i.i241, align 8
  %product.i.i.i259 = mul i64 %hash_coef.i.i256, 4189192806087951739
  %shifted.i.i.i260 = lshr i64 %product.i.i.i259, 32
  %xored.i.i.i261 = xor i64 %shifted.i.i.i260, %product.i.i.i259
  %hash.i.i.i262 = and i64 %xored.i.i.i261, %tbl_size.i.i257
  %offset_ptr.i.i263 = getelementptr i32, ptr %offset_tbl.i.i258, i64 %hash.i.i.i262
  %offset.i.i264 = load i32, ptr %offset_ptr.i.i263, align 4
  store ptr %.fca.0.extract216, ptr %115, align 8
  %116 = getelementptr i8, ptr %115, i64 8
  store ptr %.fca.1.extract218, ptr %116, align 8
  %117 = getelementptr i8, ptr %115, i64 16
  store ptr %.fca.2.extract220, ptr %117, align 8
  %118 = getelementptr i8, ptr %115, i64 24
  store i32 %offset.i.i264, ptr %118, align 4
  %119 = call ptr @llvm.invariant.start.p0(i64 112, ptr nonnull %.fca.0.extract200)
  %120 = load ptr, ptr %13, align 8
  %121 = call ptr %120(ptr %.fca.1.extract202)
  %122 = load ptr, ptr %121, align 8
  store ptr %122, ptr %15, align 8
  %123 = getelementptr i8, ptr %121, i64 8
  %124 = load i160, ptr %123, align 4
  store i160 %124, ptr %16, align 4
  %.not = icmp eq ptr %122, @nil_typ
  br i1 %.not, label %.thread344, label %22

125:                                              ; preds = %22
  %.fca.1.extract208 = extractvalue { ptr, i160 } %51, 1
  %hash_coef_ptr.i.i267 = getelementptr i8, ptr %.fca.0.extract206, i64 8
  %tbl_size_ptr.i.i268 = getelementptr i8, ptr %.fca.0.extract206, i64 16
  %offset_tbl_ptr.i.i269 = getelementptr i8, ptr %.fca.0.extract206, i64 40
  %.fca.0.load146 = load ptr, ptr %5, align 8
  %.fca.1.load149 = load ptr, ptr %6, align 8
  %.fca.3.load155 = load i32, ptr %8, align 8
  %126 = call ptr @llvm.invariant.start.p0(i64 112, ptr %.fca.0.load146)
  %127 = sext i32 %.fca.3.load155 to i64
  %128 = getelementptr ptr, ptr %.fca.0.load146, i64 %127
  %129 = getelementptr i8, ptr %128, i64 32
  %130 = load ptr, ptr %129, align 8
  %131 = call ptr %130(ptr %.fca.1.load149)
  %132 = load ptr, ptr %131, align 8
  %133 = call ptr @llvm.invariant.start.p0(i64 112, ptr %.fca.0.load146)
  %134 = getelementptr i8, ptr %128, i64 40
  %135 = load ptr, ptr %134, align 8
  %136 = call ptr %135(ptr %.fca.1.load149)
  %137 = load ptr, ptr %136, align 8
  %138 = call dereferenceable_or_null(80) ptr @malloc(i64 80)
  ...
  %141 = call ptr @llvm.invariant.start.p0(i64 16, ptr nonnull %139)
  ...
  %144 = call ptr @llvm.invariant.start.p0(i64 16, ptr nonnull %4)
  %hash_coef_ptr.i.i281 = getelementptr i8, ptr %24, i64 8
  %tbl_size_ptr.i.i282 = getelementptr i8, ptr %24, i64 16
  %offset_tbl_ptr.i.i283 = getelementptr i8, ptr %24, i64 40
  %.sroa.3.8.insert.ext317 = and i160 %23, 340282366920938463463374607431768211455
  %.sroa.3.8.insert.ext324 = and i160 %.fca.1.extract208, 340282366920938463463374607431768211455
  %145 = call ptr @llvm.invariant.start.p0(i64 112, ptr %.fca.0.load146)
  %146 = load ptr, ptr %129, align 8
  %147 = call ptr %146(ptr %.fca.1.load149)
  %148 = call ptr @llvm.invariant.start.p0(i64 112, ptr %.fca.0.load146)
  %149 = load ptr, ptr %134, align 8
  %150 = call ptr %149(ptr %.fca.1.load149)
  %151 = call ptr @llvm.invariant.start.p0(i64 80, ptr nonnull @Pair)
  %hash_coef.i.i41.i = load i64, ptr %hash_coef_ptr.i.i281, align 4
  %tbl_size.i.i42.i = load i64, ptr %tbl_size_ptr.i.i282, align 4
  %offset_tbl.i.i43.i = load ptr, ptr %offset_tbl_ptr.i.i283, align 8
  ...
  %.sroa.3.8.insert.insert90.i = or disjoint i160 %.sroa.591.8.insert.shift.i, %.sroa.3.8.insert.ext317
  store i160 %.sroa.3.8.insert.insert90.i, ptr %152, align 4
  %153 = call ptr @llvm.invariant.start.p0(i64 80, ptr nonnull @Pair)
  %154 = getelementptr i8, ptr %138, i64 32
  %hash_coef.i.i69.i = load i64, ptr %hash_coef_ptr.i.i267, align 4
  %tbl_size.i.i70.i = load i64, ptr %tbl_size_ptr.i.i268, align 4
  %offset_tbl.i.i71.i = load ptr, ptr %offset_tbl_ptr.i.i269, align 8
  ...
  store ptr %.fca.0.extract206, ptr %154, align 8
  %155 = getelementptr i8, ptr %138, i64 40
  %.sroa.5.8.insert.ext.i = zext i32 %offset.i.i77.i to i160
  %.sroa.5.8.insert.shift.i = shl nuw i160 %.sroa.5.8.insert.ext.i, 128
  %.sroa.3.8.insert.insert.i = or disjoint i160 %.sroa.5.8.insert.shift.i, %.sroa.3.8.insert.ext324
  store i160 %.sroa.3.8.insert.insert.i, ptr %155, align 4
  %156 = load i160, ptr %142, align 8
  br label %.thread344

.thread344:                                       ; preds = %52, %thread-pre-split, %125
  %.reg2mem20.sroa.3.0 = phi i160 [ %156, %125 ], [ undef, %thread-pre-split ], [ undef, %52 ]
  %.reg2mem20.sroa.0.0 = phi ptr [ @Pair, %125 ], [ @nil_typ, %thread-pre-split ], [ @nil_typ, %52 ]
...
define { ptr, ptr, ptr, i32 } @ZipIterable2_iterator_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %.fca.2.extract213 = extractvalue { ptr, ptr, ptr, i32 } %0, 2
  %.fca.3.extract215 = extractvalue { ptr, ptr, ptr, i32 } %0, 3
  %5 = alloca { ptr, ptr, ptr, i32 }, align 8
  store ptr %.fca.0.extract209, ptr %5, align 8
  %6 = getelementptr inbounds i8, ptr %5, i64 8
  store ptr %.fca.1.extract211, ptr %6, align 8
  %7 = getelementptr inbounds i8, ptr %5, i64 16
  store ptr %.fca.2.extract213, ptr %7, align 8
  %8 = getelementptr inbounds i8, ptr %5, i64 24
  store i32 %.fca.3.extract215, ptr %8, align 8
  ...
  store i32 %offset.i.i, ptr %8, align 8
  %9 = call ptr @llvm.invariant.start.p0(i64 24, ptr nonnull %5)
  %10 = tail call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %11 = sext i32 %offset.i.i to i64
  %12 = getelementptr ptr, ptr %.fca.0.extract209, i64 %11
  %13 = load ptr, ptr %12, align 8
  %14 = tail call ptr %13(ptr %.fca.1.extract211)
  %15 = load ptr, ptr %14, align 8
  ...
  %26 = tail call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %27 = getelementptr i8, ptr %12, i64 16
  %28 = load ptr, ptr %27, align 8
  %29 = tail call ptr %28(ptr %.fca.1.extract211)
  %30 = tail call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %31 = getelementptr i8, ptr %12, i64 24
  %32 = load ptr, ptr %31, align 8
  %33 = tail call ptr %32(ptr %.fca.1.extract211)
  %34 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %4)
  %35 = tail call ptr @llvm.invariant.start.p0(i64 184, ptr %15)
  %36 = sext i32 %24 to i64
  %37 = getelementptr ptr, ptr %15, i64 %36
  %38 = getelementptr i8, ptr %37, i64 8
  %39 = load ptr, ptr %38, align 8
  %40 = call ptr %39({ ptr, ptr, ptr, i32 } %25, ptr nonnull %4)
  %41 = call { ptr, ptr, ptr, i32 } %40({ ptr, ptr, ptr, i32 } %25, { ptr, ptr, ptr, i32 } %25, ptr nonnull %4)
  %42 = call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %43 = getelementptr i8, ptr %12, i64 8
  %44 = load ptr, ptr %43, align 8
  %45 = call ptr %44(ptr %.fca.1.extract211)
  ...
  %57 = call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %58 = load ptr, ptr %27, align 8
  %59 = call ptr %58(ptr %.fca.1.extract211)
  %60 = call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %61 = load ptr, ptr %31, align 8
  %62 = call ptr %61(ptr %.fca.1.extract211)
  %63 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %4)
  %64 = call ptr @llvm.invariant.start.p0(i64 184, ptr %46)
  %65 = sext i32 %55 to i64
  %66 = getelementptr ptr, ptr %46, i64 %65
  ...
  %71 = call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %72 = load ptr, ptr %27, align 8
  %73 = call ptr %72(ptr %.fca.1.extract211)
  %74 = load ptr, ptr %73, align 8
  %75 = call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %76 = load ptr, ptr %31, align 8
  %77 = call ptr %76(ptr %.fca.1.extract211)
  %78 = load ptr, ptr %77, align 8
  %79 = call dereferenceable_or_null(24) ptr @malloc(i64 24)
  %80 = getelementptr i8, ptr %79, i64 16
  store ptr %78, ptr %80, align 8
  %81 = getelementptr i8, ptr %79, i64 8
  store ptr %74, ptr %81, align 8
  store ptr @Pair, ptr %79, align 8
  %82 = call dereferenceable_or_null(88) ptr @malloc(i64 88)
  %83 = getelementptr i8, ptr %82, i64 64
  store ptr %74, ptr %83, align 8
  %84 = getelementptr i8, ptr %82, i64 72
  store ptr %78, ptr %84, align 8
  %85 = getelementptr i8, ptr %82, i64 80
  store ptr %79, ptr %85, align 8
  %86 = call ptr @llvm.invariant.start.p0(i64 24, ptr nonnull %83)
  %87 = alloca { ptr, ptr, ptr, i32 }, align 8
  %88 = getelementptr inbounds i8, ptr %87, i64 8
  %89 = getelementptr inbounds i8, ptr %87, i64 24
  store ptr @ZipIterator2, ptr %87, align 8
  store ptr %82, ptr %88, align 8
  store i32 7, ptr %89, align 8
  %90 = call ptr @llvm.invariant.start.p0(i64 16, ptr nonnull %87)
  %91 = call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %92 = load ptr, ptr %12, align 8
  %93 = call ptr %92(ptr %.fca.1.extract211)
  %94 = load ptr, ptr %93, align 8
  ...
  %102 = getelementptr i8, ptr %93, i64 24
  %103 = load i32, ptr %102, align 4
  %104 = insertvalue { ptr, ptr, ptr, i32 } %101, i32 %103, 3
  %105 = call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %106 = load ptr, ptr %27, align 8
  %107 = call ptr %106(ptr %.fca.1.extract211)
  %108 = call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %109 = load ptr, ptr %31, align 8
  %110 = call ptr %109(ptr %.fca.1.extract211)
  %111 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %4)
  %112 = call ptr @llvm.invariant.start.p0(i64 184, ptr %94)
  %113 = sext i32 %103 to i64
  %114 = getelementptr ptr, ptr %94, i64 %113
  %115 = getelementptr i8, ptr %114, i64 8
  %116 = load ptr, ptr %115, align 8
  %117 = call ptr %116({ ptr, ptr, ptr, i32 } %104, ptr nonnull %4)
  %118 = call { ptr, ptr, ptr, i32 } %117({ ptr, ptr, ptr, i32 } %104, { ptr, ptr, ptr, i32 } %104, ptr nonnull %4)
  %.fca.0.extract1 = extractvalue { ptr, ptr, ptr, i32 } %118, 0
  %.fca.1.extract3 = extractvalue { ptr, ptr, ptr, i32 } %118, 1
  %.fca.2.extract5 = extractvalue { ptr, ptr, ptr, i32 } %118, 2
  ...
  %119 = call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %120 = load ptr, ptr %43, align 8
  %121 = call ptr %120(ptr %.fca.1.extract211)
  %122 = load ptr, ptr %121, align 8
  ...
  %130 = getelementptr i8, ptr %121, i64 24
  %131 = load i32, ptr %130, align 4
  %132 = insertvalue { ptr, ptr, ptr, i32 } %129, i32 %131, 3
  %133 = call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %134 = load ptr, ptr %27, align 8
  %135 = call ptr %134(ptr %.fca.1.extract211)
  %136 = call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.extract209)
  %137 = load ptr, ptr %31, align 8
  %138 = call ptr %137(ptr %.fca.1.extract211)
  %139 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %4)
  %140 = call ptr @llvm.invariant.start.p0(i64 184, ptr %122)
  %141 = sext i32 %131 to i64
  %142 = getelementptr ptr, ptr %122, i64 %141
  %143 = getelementptr i8, ptr %142, i64 8
  %144 = load ptr, ptr %143, align 8
  %145 = call ptr %144({ ptr, ptr, ptr, i32 } %132, ptr nonnull %4)
  %146 = call { ptr, ptr, ptr, i32 } %145({ ptr, ptr, ptr, i32 } %132, { ptr, ptr, ptr, i32 } %132, ptr nonnull %4)
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %146, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %146, 1
  %.fca.2.extract = extractvalue { ptr, ptr, ptr, i32 } %146, 2
  ...
  %147 = insertvalue { ptr, ptr, ptr, i32 } { ptr @ZipIterator2, ptr undef, ptr undef, i32 undef }, ptr %82, 1
  %148 = getelementptr inbounds i8, ptr %87, i64 16
  %149 = load ptr, ptr %148, align 8
  %150 = insertvalue { ptr, ptr, ptr, i32 } %147, ptr %149, 2
  %.fca.0.load186 = load ptr, ptr %5, align 8
  %.fca.1.load189 = load ptr, ptr %6, align 8
  %.fca.3.load195 = load i32, ptr %8, align 8
  %151 = call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.load186)
  %152 = sext i32 %.fca.3.load195 to i64
  %153 = getelementptr ptr, ptr %.fca.0.load186, i64 %152
  %154 = getelementptr i8, ptr %153, i64 16
  %155 = load ptr, ptr %154, align 8
  %156 = call ptr %155(ptr %.fca.1.load189)
  %157 = call ptr @llvm.invariant.start.p0(i64 416, ptr %.fca.0.load186)
  %158 = getelementptr i8, ptr %153, i64 24
  %159 = load ptr, ptr %158, align 8
  %160 = call ptr %159(ptr %.fca.1.load189)
  %161 = call ptr @llvm.invariant.start.p0(i64 96, ptr nonnull @ZipIterator2)
  %hash_coef.i.i51.i = load i64, ptr %hash_coef_ptr.i.i246, align 4
  %tbl_size.i.i52.i = load i64, ptr %tbl_size_ptr.i.i247, align 4
  %offset_tbl.i.i53.i = load ptr, ptr %offset_tbl_ptr.i.i248, align 8
  ...
  store ptr %.fca.0.extract1, ptr %82, align 8
  %162 = getelementptr i8, ptr %82, i64 8
  store ptr %.fca.1.extract3, ptr %162, align 8
  %163 = getelementptr i8, ptr %82, i64 16
  store ptr %.fca.2.extract5, ptr %163, align 8
  %164 = getelementptr i8, ptr %82, i64 24
  store i32 %offset.i.i59.i, ptr %164, align 4
  %165 = call ptr @llvm.invariant.start.p0(i64 96, ptr nonnull @ZipIterator2)
  %166 = getelementptr i8, ptr %82, i64 32
  %hash_coef.i.i79.i = load i64, ptr %hash_coef_ptr.i.i260, align 4
  %tbl_size.i.i80.i = load i64, ptr %tbl_size_ptr.i.i261, align 4
  %offset_tbl.i.i81.i = load ptr, ptr %offset_tbl_ptr.i.i262, align 8
  ...
  store ptr %.fca.0.extract, ptr %166, align 8
  %167 = getelementptr i8, ptr %82, i64 40
  store ptr %.fca.1.extract, ptr %167, align 8
  %168 = getelementptr i8, ptr %82, i64 48
  store ptr %.fca.2.extract, ptr %168, align 8
  %169 = getelementptr i8, ptr %82, i64 56
  store i32 %offset.i.i87.i, ptr %169, align 4
  %170 = insertvalue { ptr, ptr, ptr, i32 } %150, i32 16, 3
...
define { ptr, i160 } @ZipIterator2_next_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  %4 = alloca [0 x ptr], align 8
  %5 = alloca { ptr, ptr, ptr, i32 }, align 8
  %.fca.0.extract126 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract128 = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract126, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract126, i64 16
  %offset_tbl_ptr.i.i = getelementptr i8, ptr %.fca.0.extract126, i64 40
  %hash_coef.i.i = load i64, ptr %hash_coef_ptr.i.i, align 4
  %tbl_size.i.i = load i64, ptr %tbl_size_ptr.i.i, align 4
  %offset_tbl.i.i = load ptr, ptr %offset_tbl_ptr.i.i, align 8
  %product.i.i.i = mul i64 %hash_coef.i.i, 5502728639611621286
  ...
  %offset_ptr.i.i = getelementptr i32, ptr %offset_tbl.i.i, i64 %hash.i.i.i
  %offset.i.i = load i32, ptr %offset_ptr.i.i, align 4
  %6 = tail call ptr @llvm.invariant.start.p0(i64 96, ptr %.fca.0.extract126)
  %7 = sext i32 %offset.i.i to i64
  %8 = getelementptr ptr, ptr %.fca.0.extract126, i64 %7
  %9 = load ptr, ptr %8, align 8
  %10 = tail call ptr %9(ptr %.fca.1.extract128)
  %11 = load ptr, ptr %10, align 8
  ...
  %22 = tail call ptr @llvm.invariant.start.p0(i64 96, ptr %.fca.0.extract126)
  %23 = getelementptr i8, ptr %8, i64 16
  %24 = load ptr, ptr %23, align 8
  %25 = tail call ptr %24(ptr %.fca.1.extract128)
  %26 = tail call ptr @llvm.invariant.start.p0(i64 96, ptr %.fca.0.extract126)
  %27 = getelementptr i8, ptr %8, i64 24
  %28 = load ptr, ptr %27, align 8
  %29 = tail call ptr %28(ptr %.fca.1.extract128)
  %30 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %4)
  %31 = tail call ptr @llvm.invariant.start.p0(i64 24, ptr %11)
  %32 = sext i32 %20 to i64
  %33 = getelementptr ptr, ptr %11, i64 %32
  %34 = getelementptr i8, ptr %33, i64 8
  %35 = load ptr, ptr %34, align 8
  %36 = call ptr %35({ ptr, ptr, ptr, i32 } %21, ptr nonnull %4)
  %37 = call { ptr, i160 } %36({ ptr, ptr, ptr, i32 } %21, { ptr, ptr, ptr, i32 } %21, ptr nonnull %4)
  %.fca.0.extract2 = extractvalue { ptr, i160 } %37, 0
  %38 = call ptr @llvm.invariant.start.p0(i64 96, ptr %.fca.0.extract126)
  %39 = getelementptr i8, ptr %8, i64 8
  %40 = load ptr, ptr %39, align 8
  %41 = call ptr %40(ptr %.fca.1.extract128)
  %42 = load ptr, ptr %41, align 8
  ...
  %53 = call ptr @llvm.invariant.start.p0(i64 96, ptr %.fca.0.extract126)
  %54 = load ptr, ptr %23, align 8
  %55 = call ptr %54(ptr %.fca.1.extract128)
  %56 = call ptr @llvm.invariant.start.p0(i64 96, ptr %.fca.0.extract126)
  %57 = load ptr, ptr %27, align 8
  %58 = call ptr %57(ptr %.fca.1.extract128)
  %59 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %4)
  %60 = call ptr @llvm.invariant.start.p0(i64 24, ptr %42)
  %61 = sext i32 %51 to i64
  %62 = getelementptr ptr, ptr %42, i64 %61
  ...
  %.not132 = icmp eq ptr %.fca.0.extract, @nil_typ
  %or.cond = select i1 %.not, i1 true, i1 %.not132
  br i1 %or.cond, label %.thread, label %67

67:                                               ; preds = %3
  %.fca.1.extract = extractvalue { ptr, i160 } %66, 1
  %offset_tbl_ptr.i.i136 = getelementptr i8, ptr %.fca.0.extract2, i64 40
  %hash_coef_ptr.i.i134 = getelementptr i8, ptr %.fca.0.extract2, i64 8
  %tbl_size_ptr.i.i135 = getelementptr i8, ptr %.fca.0.extract2, i64 16
  %.fca.1.extract3 = extractvalue { ptr, i160 } %37, 1
  %hash_coef_ptr.i.i148 = getelementptr i8, ptr %.fca.0.extract, i64 8
  %tbl_size_ptr.i.i149 = getelementptr i8, ptr %.fca.0.extract, i64 16
  %offset_tbl_ptr.i.i150 = getelementptr i8, ptr %.fca.0.extract, i64 40
  %68 = call ptr @llvm.invariant.start.p0(i64 96, ptr nonnull %.fca.0.extract126)
  %69 = load ptr, ptr %23, align 8
  %70 = call ptr %69(ptr %.fca.1.extract128)
  %71 = load ptr, ptr %70, align 8
  %72 = call ptr @llvm.invariant.start.p0(i64 96, ptr nonnull %.fca.0.extract126)
  %73 = load ptr, ptr %27, align 8
  %74 = call ptr %73(ptr %.fca.1.extract128)
  ...
  %.sroa.3.8.insert.ext198 = and i160 %.fca.1.extract3, 340282366920938463463374607431768211455
  %.sroa.3.8.insert.ext205 = and i160 %.fca.1.extract, 340282366920938463463374607431768211455
  %83 = call ptr @llvm.invariant.start.p0(i64 96, ptr nonnull %.fca.0.extract126)
  %84 = load ptr, ptr %23, align 8
  %85 = call ptr %84(ptr %.fca.1.extract128)
  %86 = call ptr @llvm.invariant.start.p0(i64 96, ptr nonnull %.fca.0.extract126)
  %87 = load ptr, ptr %27, align 8
  %88 = call ptr %87(ptr %.fca.1.extract128)
  %89 = call ptr @llvm.invariant.start.p0(i64 80, ptr nonnull @Pair)
  %hash_coef.i.i41.i = load i64, ptr %hash_coef_ptr.i.i134, align 4
  %tbl_size.i.i42.i = load i64, ptr %tbl_size_ptr.i.i135, align 4
  %offset_tbl.i.i43.i = load ptr, ptr %offset_tbl_ptr.i.i136, align 8
  %product.i.i.i44.i = mul i64 %hash_coef.i.i41.i, 3282773614056351330
  %shifted.i.i.i45.i = lshr i64 %product.i.i.i44.i, 32
  %xored.i.i.i46.i = xor i64 %shifted.i.i.i45.i, %product.i.i.i44.i
  %hash.i.i.i47.i = and i64 %xored.i.i.i46.i, %tbl_size.i.i42.i
  %offset_ptr.i.i48.i = getelementptr i32, ptr %offset_tbl.i.i43.i, i64 %hash.i.i.i47.i
  %offset.i.i49.i = load i32, ptr %offset_ptr.i.i48.i, align 4
  store ptr %.fca.0.extract2, ptr %76, align 8
  %90 = getelementptr i8, ptr %76, i64 8
  %.sroa.591.8.insert.ext.i = zext i32 %offset.i.i49.i to i160
  %.sroa.591.8.insert.shift.i = shl nuw i160 %.sroa.591.8.insert.ext.i, 128
  %.sroa.3.8.insert.insert90.i = or disjoint i160 %.sroa.591.8.insert.shift.i, %.sroa.3.8.insert.ext198
  ...
  %hash_coef.i.i69.i = load i64, ptr %hash_coef_ptr.i.i148, align 4
  %tbl_size.i.i70.i = load i64, ptr %tbl_size_ptr.i.i149, align 4
  %offset_tbl.i.i71.i = load ptr, ptr %offset_tbl_ptr.i.i150, align 8
  %product.i.i.i72.i = mul i64 %hash_coef.i.i69.i, 3282773614056351330
  %shifted.i.i.i73.i = lshr i64 %product.i.i.i72.i, 32
  %xored.i.i.i74.i = xor i64 %shifted.i.i.i73.i, %product.i.i.i72.i
  %hash.i.i.i75.i = and i64 %xored.i.i.i74.i, %tbl_size.i.i70.i
  ...
  %.sroa.5.8.insert.ext.i = zext i32 %offset.i.i77.i to i160
  %.sroa.5.8.insert.shift.i = shl nuw i160 %.sroa.5.8.insert.ext.i, 128
  %.sroa.3.8.insert.insert.i = or disjoint i160 %.sroa.5.8.insert.shift.i, %.sroa.3.8.insert.ext205
  store i160 %.sroa.3.8.insert.insert.i, ptr %93, align 4
  %94 = load i160, ptr %80, align 8
  br label %.thread

.thread:                                          ; preds = %67, %3
  %.reg2mem15.sroa.3.0214 = phi i160 [ poison, %3 ], [ %94, %67 ]
  %95 = phi ptr [ @nil_typ, %3 ], [ @Pair, %67 ]
  %.reload12.fca.0.insert = insertvalue { ptr, i160 } poison, ptr %95, 0
  %.reload12.fca.1.insert = insertvalue { ptr, i160 } %.reload12.fca.0.insert, i160 %.reg2mem15.sroa.3.0214, 1
...
define { ptr, ptr, ptr, i32 } @InterleaveIterable2_iterator_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %120 = insertvalue { ptr, ptr, ptr, i32 } { ptr @InterleaveIterator2, ptr undef, ptr undef, i32 undef }, ptr %63, 1
  %121 = getelementptr inbounds i8, ptr %66, i64 16
  %122 = load ptr, ptr %121, align 8
  %123 = insertvalue { ptr, ptr, ptr, i32 } %120, ptr %122, 2
  %124 = call ptr @llvm.invariant.start.p0(i64 400, ptr %.fca.0.extract137)
  %125 = load ptr, ptr %22, align 8
  %126 = call ptr %125(ptr %.fca.1.extract139)
  %127 = call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull @InterleaveIterator2)
  %hash_coef.i.i63.i = load i64, ptr %hash_coef_ptr.i.i174, align 4
  %tbl_size.i.i64.i = load i64, ptr %tbl_size_ptr.i.i175, align 4
  %offset_tbl.i.i65.i = load ptr, ptr %offset_tbl_ptr.i.i176, align 8
  ...
  %128 = getelementptr i8, ptr %63, i64 8
  store ptr %.fca.1.extract3, ptr %128, align 8
  %129 = getelementptr i8, ptr %63, i64 16
  store ptr %.fca.2.extract5, ptr %129, align 8
  %130 = getelementptr i8, ptr %63, i64 24
  store i32 %offset.i.i71.i, ptr %130, align 4
  %131 = call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull @InterleaveIterator2)
  %132 = getelementptr i8, ptr %63, i64 32
  %hash_coef.i.i91.i = load i64, ptr %hash_coef_ptr.i.i188, align 4
  %tbl_size.i.i92.i = load i64, ptr %tbl_size_ptr.i.i189, align 4
  %offset_tbl.i.i93.i = load ptr, ptr %offset_tbl_ptr.i.i190, align 8
  ...
  store ptr %.fca.0.extract, ptr %132, align 8
  %133 = getelementptr i8, ptr %63, i64 40
  store ptr %.fca.1.extract, ptr %133, align 8
  %134 = getelementptr i8, ptr %63, i64 48
  store ptr %.fca.2.extract, ptr %134, align 8
  %135 = getelementptr i8, ptr %63, i64 56
  store i32 %offset.i.i99.i, ptr %135, align 4
  %136 = call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull @InterleaveIterator2)
  %137 = getelementptr i8, ptr %63, i64 64
  store i1 true, ptr %137, align 1
  %138 = insertvalue { ptr, ptr, ptr, i32 } %123, i32 15, 3
...
define { ptr, i160 } @InterleaveIterator2_next_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %12 = tail call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull %.fca.0.extract79)
  %13 = load ptr, ptr %8, align 8
  %14 = tail call ptr %13(ptr %.fca.1.extract81)
  br i1 %11, label %15, label %17

15:                                               ; preds = %3
  store i1 false, ptr %14, align 1
  %16 = tail call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull %.fca.0.extract79)
  br label %20

17:                                               ; preds = %3
  store i1 true, ptr %14, align 1
  %18 = tail call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull %.fca.0.extract79)
...
20:                                               ; preds = %17, %15
  ...
  %21 = tail call ptr %.sink(ptr %.fca.1.extract81)
  %22 = load ptr, ptr %21, align 8
  ...
  %33 = tail call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull %.fca.0.extract79)
  %34 = getelementptr i8, ptr %7, i64 24
  %35 = load ptr, ptr %34, align 8
  %36 = tail call ptr %35(ptr %.fca.1.extract81)
...
define { ptr, ptr, ptr, i32 } @ChainIterable2_iterator_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %tbl_size_ptr.i.i189 = getelementptr i8, ptr %.fca.0.extract, i64 16
  %offset_tbl_ptr.i.i190 = getelementptr i8, ptr %.fca.0.extract, i64 40
  %120 = insertvalue { ptr, ptr, ptr, i32 } { ptr @ChainIterator2, ptr undef, ptr undef, i32 undef }, ptr %63, 1
  %121 = getelementptr inbounds i8, ptr %66, i64 16
  %122 = load ptr, ptr %121, align 8
  %123 = insertvalue { ptr, ptr, ptr, i32 } %120, ptr %122, 2
  %124 = call ptr @llvm.invariant.start.p0(i64 400, ptr %.fca.0.extract137)
  %125 = load ptr, ptr %22, align 8
  %126 = call ptr %125(ptr %.fca.1.extract139)
  %127 = call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull @ChainIterator2)
  %hash_coef.i.i63.i = load i64, ptr %hash_coef_ptr.i.i174, align 4
  %tbl_size.i.i64.i = load i64, ptr %tbl_size_ptr.i.i175, align 4
  %offset_tbl.i.i65.i = load ptr, ptr %offset_tbl_ptr.i.i176, align 8
  %product.i.i.i66.i = mul i64 %hash_coef.i.i63.i, 4189192806087951739
  ...
  %130 = getelementptr i8, ptr %63, i64 24
  store i32 %offset.i.i71.i, ptr %130, align 4
  %131 = call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull @ChainIterator2)
  %132 = getelementptr i8, ptr %63, i64 32
  %hash_coef.i.i91.i = load i64, ptr %hash_coef_ptr.i.i188, align 4
  %tbl_size.i.i92.i = load i64, ptr %tbl_size_ptr.i.i189, align 4
  %offset_tbl.i.i93.i = load ptr, ptr %offset_tbl_ptr.i.i190, align 8
  ...
  %135 = getelementptr i8, ptr %63, i64 56
  store i32 %offset.i.i99.i, ptr %135, align 4
  %136 = call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull @ChainIterator2)
  %137 = getelementptr i8, ptr %63, i64 64
  store i1 true, ptr %137, align 1
  %138 = insertvalue { ptr, ptr, ptr, i32 } %123, i32 15, 3
  ret { ptr, ptr, ptr, i32 } %138
...
define { ptr, i160 } @ChainIterator2_next_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  store i32 %offset.i.i, ptr %8, align 8
  %9 = call ptr @llvm.invariant.start.p0(i64 24, ptr nonnull %5)
  %10 = tail call ptr @llvm.invariant.start.p0(i64 88, ptr %.fca.0.extract71)
  %11 = sext i32 %offset.i.i to i64
  %12 = getelementptr ptr, ptr %.fca.0.extract71, i64 %11
  %13 = getelementptr i8, ptr %12, i64 16
  %14 = load ptr, ptr %13, align 8
  %15 = tail call ptr %14(ptr %.fca.1.extract73)
  %16 = load i1, ptr %15, align 1
  br i1 %16, label %17, label %.thread

17:                                               ; preds = %3
  %18 = tail call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull %.fca.0.extract71)
  %19 = load ptr, ptr %12, align 8
  %20 = tail call ptr %19(ptr %.fca.1.extract73)
  %21 = load ptr, ptr %20, align 8
  ...
  %32 = tail call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull %.fca.0.extract71)
  %33 = getelementptr i8, ptr %12, i64 24
  %34 = load ptr, ptr %33, align 8
  %35 = tail call ptr %34(ptr %.fca.1.extract73)
  %36 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %4)
  %37 = tail call ptr @llvm.invariant.start.p0(i64 24, ptr %21)
  %38 = sext i32 %30 to i64
  %39 = getelementptr ptr, ptr %21, i64 %38
  %40 = getelementptr i8, ptr %39, i64 8
  %41 = load ptr, ptr %40, align 8
  %42 = call ptr %41({ ptr, ptr, ptr, i32 } %31, ptr nonnull %4)
  %43 = call { ptr, i160 } %42({ ptr, ptr, ptr, i32 } %31, { ptr, ptr, ptr, i32 } %31, ptr nonnull %4)
  %.fca.0.extract77 = extractvalue { ptr, i160 } %43, 0
  %.not = icmp eq ptr %.fca.0.extract77, @nil_typ
  br i1 %.not, label %44, label %48

44:                                               ; preds = %17
  %45 = call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull %.fca.0.extract71)
  %46 = load ptr, ptr %13, align 8
  %47 = call ptr %46(ptr %.fca.1.extract73)
  store i1 false, ptr %47, align 1
  %.fca.0.load38.pre = load ptr, ptr %5, align 8
  %.fca.1.load41.pre = load ptr, ptr %6, align 8
  %.fca.3.load47.pre = load i32, ptr %8, align 8
  %.pre = sext i32 %.fca.3.load47.pre to i64
  br label %.thread

48:                                               ; preds = %17
  %.fca.1.extract79 = extractvalue { ptr, i160 } %43, 1
  %hash_coef_ptr.i.i88 = getelementptr i8, ptr %.fca.0.extract77, i64 8
  %tbl_size_ptr.i.i89 = getelementptr i8, ptr %.fca.0.extract77, i64 16
  %offset_tbl_ptr.i.i90 = getelementptr i8, ptr %.fca.0.extract77, i64 40
  ...
  %.sroa.5.8.insert.shift = shl nuw i160 %.sroa.5.8.insert.ext, 128
  %.sroa.3.8.insert.ext = and i160 %.fca.1.extract79, 340282366920938463463374607431768211455
  %.sroa.3.8.insert.insert = or disjoint i160 %.sroa.5.8.insert.shift, %.sroa.3.8.insert.ext
  br label %77

.thread:                                          ; preds = %44, %3
  %.pre-phi = phi i64 [ %.pre, %44 ], [ %11, %3 ]
  %.fca.1.load41 = phi ptr [ %.fca.1.load41.pre, %44 ], [ %.fca.1.extract73, %3 ]
  %.fca.0.load38 = phi ptr [ %.fca.0.load38.pre, %44 ], [ %.fca.0.extract71, %3 ]
  %49 = call ptr @llvm.invariant.start.p0(i64 88, ptr %.fca.0.load38)
  %50 = getelementptr ptr, ptr %.fca.0.load38, i64 %.pre-phi
  %51 = getelementptr i8, ptr %50, i64 8
  %52 = load ptr, ptr %51, align 8
  %53 = call ptr %52(ptr %.fca.1.load41)
  ...
  %62 = getelementptr i8, ptr %53, i64 24
  %63 = load i32, ptr %62, align 4
  %64 = insertvalue { ptr, ptr, ptr, i32 } %61, i32 %63, 3
  %65 = call ptr @llvm.invariant.start.p0(i64 88, ptr %.fca.0.load38)
  %66 = getelementptr i8, ptr %50, i64 24
  %67 = load ptr, ptr %66, align 8
  %68 = call ptr %67(ptr %.fca.1.load41)
  %69 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %4)
  %70 = call ptr @llvm.invariant.start.p0(i64 24, ptr %54)
  %71 = sext i32 %63 to i64
  %72 = getelementptr ptr, ptr %54, i64 %71
  %73 = getelementptr i8, ptr %72, i64 8
  %74 = load ptr, ptr %73, align 8
  %75 = call ptr %74({ ptr, ptr, ptr, i32 } %64, ptr nonnull %4)
  %76 = call { ptr, i160 } %75({ ptr, ptr, ptr, i32 } %64, { ptr, ptr, ptr, i32 } %64, ptr nonnull %4)
  %.fca.0.extract82 = extractvalue { ptr, i160 } %76, 0
  %.fca.1.extract84 = extractvalue { ptr, i160 } %76, 1
  br label %77

77:                                               ; preds = %48, %.thread
  %.reg2mem11.sroa.3.0 = phi i160 [ %.fca.1.extract84, %.thread ], [ %.sroa.3.8.insert.insert, %48 ]
  %.reg2mem11.sroa.0.0 = phi ptr [ %.fca.0.extract82, %.thread ], [ %.fca.0.extract77, %48 ]
...
define { ptr, ptr, ptr, i32 } @FilterIterable2_iterator_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %76 = load ptr, ptr %75, align 8
  %77 = insertvalue { ptr, ptr, ptr, i32 } { ptr @FilterIterator2, ptr undef, ptr undef, i32 undef }, ptr %41, 1
  %78 = getelementptr inbounds i8, ptr %44, i64 16
  %79 = load ptr, ptr %78, align 8
  %80 = insertvalue { ptr, ptr, ptr, i32 } %77, ptr %79, 2
  %81 = call ptr @llvm.invariant.start.p0(i64 400, ptr %.fca.0.extract97)
  %82 = load ptr, ptr %22, align 8
  %83 = call ptr %82(ptr %.fca.1.extract99)
  %84 = call ptr @llvm.invariant.start.p0(i64 80, ptr nonnull @FilterIterator2)
  %hash_coef.i.i44.i = load i64, ptr %hash_coef_ptr.i.i120, align 4
  %tbl_size.i.i45.i = load i64, ptr %tbl_size_ptr.i.i121, align 4
  %offset_tbl.i.i46.i = load ptr, ptr %offset_tbl_ptr.i.i122, align 8
  ...
  store ptr %.fca.1.extract, ptr %85, align 8
  %86 = getelementptr i8, ptr %41, i64 16
  store ptr %.fca.2.extract, ptr %86, align 8
  %87 = getelementptr i8, ptr %41, i64 24
  store i32 %offset.i.i52.i, ptr %87, align 4
  %88 = call ptr @llvm.invariant.start.p0(i64 80, ptr nonnull @FilterIterator2)
  %89 = getelementptr i8, ptr %41, i64 32
  store ptr %76, ptr %89, align 8
  %90 = insertvalue { ptr, ptr, ptr, i32 } %80, i32 14, 3
...
define { ptr, i160 } @FilterIterator2_next_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %.fca.1.extract62 = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract60, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract60, i64 16
  %offset_tbl_ptr.i.i = getelementptr i8, ptr %.fca.0.extract60, i64 40
  %hash_coef.i.i = load i64, ptr %hash_coef_ptr.i.i, align 4
  %tbl_size.i.i = load i64, ptr %tbl_size_ptr.i.i, align 4
  %offset_tbl.i.i = load ptr, ptr %offset_tbl_ptr.i.i, align 8
  %product.i.i.i = mul i64 %hash_coef.i.i, 8213847504843366470
  ...
  %offset_ptr.i.i = getelementptr i32, ptr %offset_tbl.i.i, i64 %hash.i.i.i
  %offset.i.i = load i32, ptr %offset_ptr.i.i, align 4
  %5 = tail call ptr @llvm.invariant.start.p0(i64 80, ptr %.fca.0.extract60)
  %6 = sext i32 %offset.i.i to i64
  %7 = getelementptr ptr, ptr %.fca.0.extract60, i64 %6
  %8 = load ptr, ptr %7, align 8
  %9 = tail call ptr %8(ptr %.fca.1.extract62)
  %10 = load ptr, ptr %9, align 8
  %11 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %10, 0
  %12 = getelementptr i8, ptr %9, i64 8
  %13 = load ptr, ptr %12, align 8
  ...
  %19 = load i32, ptr %18, align 4
  %20 = insertvalue { ptr, ptr, ptr, i32 } %17, i32 %19, 3
  %21 = tail call ptr @llvm.invariant.start.p0(i64 80, ptr %.fca.0.extract60)
  %22 = getelementptr i8, ptr %7, i64 16
  %23 = load ptr, ptr %22, align 8
  %24 = tail call ptr %23(ptr %.fca.1.extract62)
  %25 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %4)
  ...
  %.sroa.0.0144 = extractvalue { ptr, i160 } %32, 0
  %.not145 = icmp eq ptr %.sroa.0.0144, @nil_typ
  br i1 %.not145, label %.loopexit, label %.lr.ph

.lr.ph:                                           ; preds = %3
  %33 = call ptr @llvm.invariant.start.p0(i64 80, ptr nonnull %.fca.0.extract60)
  %34 = getelementptr i8, ptr %7, i64 8
  br label %35

35:                                               ; preds = %.lr.ph, %42
  %.sroa.0.0147 = phi ptr [ %.sroa.0.0144, %.lr.ph ], [ %.sroa.0.0, %42 ]
  %.pn146 = phi { ptr, i160 } [ %32, %.lr.ph ], [ %67, %42 ]
  %.sroa.3.0 = extractvalue { ptr, i160 } %.pn146, 1
  %hash_coef_ptr.i.i71 = getelementptr i8, ptr %.sroa.0.0147, i64 8
  %tbl_size_ptr.i.i72 = getelementptr i8, ptr %.sroa.0.0147, i64 16
  %offset_tbl_ptr.i.i73 = getelementptr i8, ptr %.sroa.0.0147, i64 40
  ...
  %product.i.i.i77 = mul i64 %hash_coef.i.i74, 3282773614056351330
  ...
  %.sroa.7.8.insert.shift = shl nuw i160 %.sroa.7.8.insert.ext, 128
  %36 = insertvalue { ptr, i160 } undef, ptr %.sroa.0.0147, 0
  %.sroa.3111.8.insert.ext = and i160 %.sroa.3.0, 340282366920938463463374607431768211455
  %.sroa.3111.8.insert.insert = or disjoint i160 %.sroa.7.8.insert.shift, %.sroa.3111.8.insert.ext
  %37 = insertvalue { ptr, i160 } %36, i160 %.sroa.3111.8.insert.insert, 1
  %38 = load ptr, ptr %34, align 8
  %39 = call ptr %38(ptr %.fca.1.extract62)
  %40 = load ptr, ptr %39, align 8
  %41 = call i1 %40({ ptr, i160 } %37)
  br i1 %41, label %.loopexit, label %42

42:                                               ; preds = %35
  %43 = call ptr @llvm.invariant.start.p0(i64 80, ptr nonnull %.fca.0.extract60)
  %44 = load ptr, ptr %7, align 8
  %45 = call ptr %44(ptr %.fca.1.extract62)
  %46 = load ptr, ptr %45, align 8
  %47 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %46, 0
  %48 = getelementptr i8, ptr %45, i64 8
  %49 = load ptr, ptr %48, align 8
  ...
  %55 = load i32, ptr %54, align 4
  %56 = insertvalue { ptr, ptr, ptr, i32 } %53, i32 %55, 3
  %57 = call ptr @llvm.invariant.start.p0(i64 80, ptr nonnull %.fca.0.extract60)
  %58 = load ptr, ptr %22, align 8
  %59 = call ptr %58(ptr %.fca.1.extract62)
  ...
  %.sroa.0.0 = extractvalue { ptr, i160 } %67, 0
  %.not = icmp eq ptr %.sroa.0.0, @nil_typ
  br i1 %.not, label %.loopexit, label %35

.loopexit:                                        ; preds = %42, %35, %3
  %.pn143 = phi { ptr, i160 } [ %32, %3 ], [ %67, %42 ], [ %.pn146, %35 ]
  %68 = phi i160 [ undef, %3 ], [ %.sroa.3111.8.insert.insert, %35 ], [ %.sroa.3111.8.insert.insert, %42 ]
  %.reload15.fca.1.insert = insertvalue { ptr, i160 } %.pn143, i160 %68, 1
...
define { ptr, ptr, ptr, i32 } @MapIterable2_iterator_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %88 = load ptr, ptr %87, align 8
  %89 = insertvalue { ptr, ptr, ptr, i32 } { ptr @MapIterator2, ptr undef, ptr undef, i32 undef }, ptr %49, 1
  %90 = getelementptr inbounds i8, ptr %53, i64 16
  %91 = load ptr, ptr %90, align 8
  %92 = insertvalue { ptr, ptr, ptr, i32 } %89, ptr %91, 2
  %93 = call ptr @llvm.invariant.start.p0(i64 408, ptr %.fca.0.extract145)
  %94 = load ptr, ptr %22, align 8
  %95 = call ptr %94(ptr %.fca.1.extract147)
  %96 = call ptr @llvm.invariant.start.p0(i64 408, ptr %.fca.0.extract145)
  %97 = load ptr, ptr %26, align 8
  %98 = call ptr %97(ptr %.fca.1.extract147)
  %99 = call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull @MapIterator2)
  %hash_coef.i.i44.i = load i64, ptr %hash_coef_ptr.i.i168, align 4
  %tbl_size.i.i45.i = load i64, ptr %tbl_size_ptr.i.i169, align 4
  %offset_tbl.i.i46.i = load ptr, ptr %offset_tbl_ptr.i.i170, align 8
  %product.i.i.i47.i = mul i64 %hash_coef.i.i44.i, 4189192806087951739
  %shifted.i.i.i48.i = lshr i64 %product.i.i.i47.i, 32
  %xored.i.i.i49.i = xor i64 %shifted.i.i.i48.i, %product.i.i.i47.i
  %hash.i.i.i50.i = and i64 %xored.i.i.i49.i, %tbl_size.i.i45.i
  %offset_ptr.i.i51.i = getelementptr i32, ptr %offset_tbl.i.i46.i, i64 %hash.i.i.i50.i
  %offset.i.i52.i = load i32, ptr %offset_ptr.i.i51.i, align 4
  store ptr %.fca.0.extract, ptr %49, align 8
  %100 = getelementptr i8, ptr %49, i64 8
  store ptr %.fca.1.extract, ptr %100, align 8
  %101 = getelementptr i8, ptr %49, i64 16
  store ptr %.fca.2.extract, ptr %101, align 8
  %102 = getelementptr i8, ptr %49, i64 24
  store i32 %offset.i.i52.i, ptr %102, align 4
  %103 = call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull @MapIterator2)
  %104 = getelementptr i8, ptr %49, i64 32
  store ptr %88, ptr %104, align 8
  %105 = insertvalue { ptr, ptr, ptr, i32 } %92, i32 15, 3
...
define { ptr, i160 } @MapIterator2_next_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract46, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract46, i64 16
  %offset_tbl_ptr.i.i = getelementptr i8, ptr %.fca.0.extract46, i64 40
  %hash_coef.i.i = load i64, ptr %hash_coef_ptr.i.i, align 4
  %tbl_size.i.i = load i64, ptr %tbl_size_ptr.i.i, align 4
  %offset_tbl.i.i = load ptr, ptr %offset_tbl_ptr.i.i, align 8
  %product.i.i.i = mul i64 %hash_coef.i.i, -10255947709272500
  ...
  %offset_ptr.i.i = getelementptr i32, ptr %offset_tbl.i.i, i64 %hash.i.i.i
  %offset.i.i = load i32, ptr %offset_ptr.i.i, align 4
  %5 = tail call ptr @llvm.invariant.start.p0(i64 88, ptr %.fca.0.extract46)
  %6 = sext i32 %offset.i.i to i64
  %7 = getelementptr ptr, ptr %.fca.0.extract46, i64 %6
  %8 = load ptr, ptr %7, align 8
  %9 = tail call ptr %8(ptr %.fca.1.extract48)
  %10 = load ptr, ptr %9, align 8
  %11 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %10, 0
  %12 = getelementptr i8, ptr %9, i64 8
  %13 = load ptr, ptr %12, align 8
  ...
  %19 = load i32, ptr %18, align 4
  %20 = insertvalue { ptr, ptr, ptr, i32 } %17, i32 %19, 3
  %21 = tail call ptr @llvm.invariant.start.p0(i64 88, ptr %.fca.0.extract46)
  %22 = getelementptr i8, ptr %7, i64 16
  %23 = load ptr, ptr %22, align 8
  %24 = tail call ptr %23(ptr %.fca.1.extract48)
  %25 = tail call ptr @llvm.invariant.start.p0(i64 88, ptr %.fca.0.extract46)
  %26 = getelementptr i8, ptr %7, i64 24
  %27 = load ptr, ptr %26, align 8
  %28 = tail call ptr %27(ptr %.fca.1.extract48)
  %29 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %4)
...
37:                                               ; preds = %3
  ...
  %.sroa.5.8.insert.ext = zext i32 %offset.i.i69 to i160
  %.sroa.5.8.insert.shift = shl nuw i160 %.sroa.5.8.insert.ext, 128
  %38 = insertvalue { ptr, i160 } undef, ptr %.fca.0.extract, 0
  %.sroa.3.8.insert.ext87 = and i160 %.fca.1.extract, 340282366920938463463374607431768211455
  %.sroa.3.8.insert.insert89 = or disjoint i160 %.sroa.5.8.insert.shift, %.sroa.3.8.insert.ext87
  %39 = insertvalue { ptr, i160 } %38, i160 %.sroa.3.8.insert.insert89, 1
  %40 = call ptr @llvm.invariant.start.p0(i64 88, ptr nonnull %.fca.0.extract46)
  %41 = getelementptr i8, ptr %7, i64 8
  %42 = load ptr, ptr %41, align 8
  %43 = call ptr %42(ptr %.fca.1.extract48)
  %44 = load ptr, ptr %43, align 8
  %45 = call { ptr, i160 } %44({ ptr, i160 } %39)
  %.fca.0.extract52 = extractvalue { ptr, i160 } %45, 0
  %.fca.1.extract54 = extractvalue { ptr, i160 } %45, 1
  br label %46

46:                                               ; preds = %3, %37
  %.reg2mem5.sroa.0.0 = phi ptr [ %.fca.0.extract52, %37 ], [ @nil_typ, %3 ]
  %.reg2mem5.sroa.3.0 = phi i160 [ %.fca.1.extract54, %37 ], [ undef, %3 ]
...
define { ptr, i160 } @ArrayIterator_next_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %offset_ptr.i.i = getelementptr i32, ptr %offset_tbl.i.i, i64 %hash.i.i.i
  %offset.i.i = load i32, ptr %offset_ptr.i.i, align 4
  %7 = tail call ptr @llvm.invariant.start.p0(i64 80, ptr %.fca.0.extract91)
  %8 = sext i32 %offset.i.i to i64
  %9 = getelementptr ptr, ptr %.fca.0.extract91, i64 %8
  %10 = getelementptr i8, ptr %9, i64 8
  %11 = load ptr, ptr %10, align 8
  %12 = tail call ptr %11(ptr %.fca.1.extract93)
  %13 = tail call ptr @llvm.invariant.start.p0(i64 80, ptr %.fca.0.extract91)
  %14 = load ptr, ptr %9, align 8
  %15 = tail call ptr %14(ptr %.fca.1.extract93)
  %16 = load ptr, ptr %15, align 8
  ...
  %27 = tail call ptr @llvm.invariant.start.p0(i64 80, ptr %.fca.0.extract91)
  %28 = getelementptr i8, ptr %9, i64 16
  %29 = load ptr, ptr %28, align 8
  %30 = tail call ptr %29(ptr %.fca.1.extract93)
  %31 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %4)
  %32 = tail call ptr @llvm.invariant.start.p0(i64 552, ptr %16)
  ...
  %38 = call i32 %37({ ptr, ptr, ptr, i32 } %26, { ptr, ptr, ptr, i32 } %26, ptr nonnull %4)
  %39 = load i32, ptr %12, align 4
  %.not = icmp slt i32 %39, %38
  br i1 %.not, label %40, label %78

40:                                               ; preds = %3
  %41 = call ptr @llvm.invariant.start.p0(i64 80, ptr nonnull %.fca.0.extract91)
  %42 = load ptr, ptr %10, align 8
  %43 = call ptr %42(ptr %.fca.1.extract93)
  %44 = load i32, ptr %43, align 4
  %45 = add i32 %44, 1
  %46 = call ptr @llvm.invariant.start.p0(i64 80, ptr nonnull %.fca.0.extract91)
  %47 = load ptr, ptr %10, align 8
  %48 = call ptr %47(ptr %.fca.1.extract93)
  store i32 %45, ptr %48, align 4
  %49 = call ptr @llvm.invariant.start.p0(i64 80, ptr nonnull %.fca.0.extract91)
  %50 = load ptr, ptr %10, align 8
  %51 = call ptr %50(ptr %.fca.1.extract93)
  %52 = load i32, ptr %51, align 4
  %53 = add i32 %52, -1
  %54 = call ptr @llvm.invariant.start.p0(i64 80, ptr nonnull %.fca.0.extract91)
  %55 = load ptr, ptr %9, align 8
  %56 = call ptr %55(ptr %.fca.1.extract93)
  %57 = load ptr, ptr %56, align 8
  ...
  %68 = call ptr @llvm.invariant.start.p0(i64 80, ptr nonnull %.fca.0.extract91)
  %69 = load ptr, ptr %28, align 8
  %70 = call ptr %69(ptr %.fca.1.extract93)
  store ptr @_parameterization_Ptri32, ptr %6, align 8
  ...
  %75 = load ptr, ptr %74, align 8
  store ptr @i32_typ, ptr %5, align 8
  %76 = call ptr %75({ ptr, ptr, ptr, i32 } %67, ptr nonnull %5, i32 %53)
  %77 = call { ptr, i160 } %76({ ptr, ptr, ptr, i32 } %67, { ptr, ptr, ptr, i32 } %67, ptr nonnull %6, i32 %53)
  %.fca.0.extract97 = extractvalue { ptr, i160 } %77, 0
  %.fca.1.extract99 = extractvalue { ptr, i160 } %77, 1
  %hash_coef_ptr.i.i102 = getelementptr i8, ptr %.fca.0.extract97, i64 8
  %tbl_size_ptr.i.i103 = getelementptr i8, ptr %.fca.0.extract97, i64 16
  %offset_tbl_ptr.i.i104 = getelementptr i8, ptr %.fca.0.extract97, i64 40
  ...
  %product.i.i.i108 = mul i64 %hash_coef.i.i105, 3282773614056351330
  ...
  %.sroa.5.8.insert.ext = zext i32 %offset.i.i113 to i160
  %.sroa.5.8.insert.shift = shl nuw i160 %.sroa.5.8.insert.ext, 128
  %.sroa.3.8.insert.ext = and i160 %.fca.1.extract99, 340282366920938463463374607431768211455
  %.sroa.3.8.insert.insert = or disjoint i160 %.sroa.5.8.insert.shift, %.sroa.3.8.insert.ext
  br label %78

78:                                               ; preds = %3, %40
  %.reg2mem5.sroa.3.0 = phi i160 [ %.sroa.3.8.insert.insert, %40 ], [ undef, %3 ]
  %.reg2mem5.sroa.0.0 = phi ptr [ %.fca.0.extract97, %40 ], [ @nil_typ, %3 ]
  %.reload6.fca.0.insert = insertvalue { ptr, i160 } poison, ptr %.reg2mem5.sroa.0.0, 0
  %.reload6.fca.1.insert = insertvalue { ptr, i160 } %.reload6.fca.0.insert, i160 %.reg2mem5.sroa.3.0, 1
  ret { ptr, i160 } %.reload6.fca.1.insert
}
...
define ptr @IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable(ptr nocapture %0, { ptr, i160 } %1) #5 {
  %3 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr %0)
  ...
  %12 = load ptr, ptr %8, align 8
  %result.i = tail call i1 %11(i64 %10, i64 %9, i64 -5126806859456325683, i64 ptrtoint (ptr @nil_typ to i64), ptr readonly %12) #20
  br i1 %result.i, label %.thread19, label %13

13:                                               ; preds = %2
  %result.i4 = tail call i1 %11(i64 %10, i64 %9, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr readonly %12) #20
  br i1 %result.i4, label %.thread19, label %14

14:                                               ; preds = %13
  %result.i5 = tail call i1 %11(i64 %10, i64 %9, i64 6681222582356018452, i64 ptrtoint (ptr @Character to i64), ptr readonly %12) #20
  %result.i6 = tail call i1 %11(i64 %10, i64 %9, i64 6499063144389013426, i64 ptrtoint (ptr @String to i64), ptr readonly %12) #20
  %not.result.i5 = xor i1 %result.i5, true
  %.reg2mem119.0 = select i1 %not.result.i5, i1 true, i1 %result.i6
  br i1 %.reg2mem119.0, label %15, label %.thread19

15:                                               ; preds = %14
  %result.i7 = tail call i1 %11(i64 %10, i64 %9, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr readonly %12) #20
  br i1 %result.i7, label %.thread19, label %16

16:                                               ; preds = %15
  %not.result.i6 = xor i1 %result.i6, true
  %.reg2mem117.0 = or i1 %result.i5, %not.result.i6
  br i1 %.reg2mem117.0, label %17, label %.thread19

17:                                               ; preds = %16
  %result.i10 = tail call i1 %11(i64 %10, i64 %9, i64 -757315540097298781, i64 ptrtoint (ptr @f64_typ to i64), ptr readonly %12) #20
  br i1 %result.i10, label %.thread19, label %18

18:                                               ; preds = %17
  %result.i11 = tail call i1 %11(i64 %10, i64 %9, i64 2582149688529881115, i64 ptrtoint (ptr @i8_typ to i64), ptr readonly %12) #20
  br i1 %result.i11, label %.thread19, label %19

19:                                               ; preds = %18
  %result.i12 = tail call i1 %11(i64 %10, i64 %9, i64 -7260840641129990118, i64 ptrtoint (ptr @Representable to i64), ptr readonly %12) #20
  br i1 %result.i12, label %20, label %.thread19

20:                                               ; preds = %19
  %.reg2mem115.0 = or i1 %result.i5, %result.i6
  %.reg2mem115.0.fr = freeze i1 %.reg2mem115.0
  %spec.select = select i1 %.reg2mem115.0.fr, i32 5, i32 9
  br label %.thread19

.thread19:                                        ; preds = %20, %14, %16, %18, %17, %15, %13, %2, %19
  %21 = phi i32 [ 5, %19 ], [ 4, %14 ], [ 2, %16 ], [ 3, %18 ], [ 6, %17 ], [ 7, %15 ], [ 8, %13 ], [ 1, %2 ], [ %spec.select, %20 ]
...
String_c_string_.exit:                            ; preds = %6, %4
  %8 = phi ptr [ %7, %6 ], [ %5, %4 ]
  %.sink27 = phi i32 [ 5, %6 ], [ 4, %4 ]
  %9 = add nuw nsw i32 %.sink27, 1
  %10 = zext nneg i32 %9 to i64
  %11 = tail call ptr @malloc(i64 %10)
  %12 = zext nneg i32 %.sink27 to i64
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define noundef nonnull ptr @Math_B__Self_sqrt_xPtrf64(ptr nocapture %0, double %1) #3 {
  %3 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr %0)
  ret ptr @Math__Self_sqrt_xPtrf64
}

; Function Attrs: mustprogress willreturn memory(read, argmem: readwrite, inaccessiblemem: none)
define ptr @Math_B__Self_abs_xPtrf64__Self_abs_xPtri32(ptr nocapture %0, { ptr, i64 } %1) #5 {
  %3 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr %0)
  %4 = load ptr, ptr %0, align 8
  %5 = getelementptr i8, ptr %4, i64 8
  %6 = getelementptr i8, ptr %4, i64 16
...
; Function Attrs: mustprogress willreturn memory(read, argmem: readwrite, inaccessiblemem: none)
define ptr @Math_B__Self_max_aPtrf64_bPtrf64__Self_max_aPtri32_bPtri32(ptr nocapture %0, { ptr, i64 } %1, { ptr, i64 } %2) #5 {
  ...
  %result.i = tail call i1 %12(i64 %11, i64 %10, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr readonly %13) #20
...
; Function Attrs: mustprogress willreturn memory(read, argmem: readwrite, inaccessiblemem: none)
define ptr @Math_B__Self_min_aPtri32_bPtri32__Self_min_aPtrf64_bPtrf64(ptr nocapture %0, { ptr, i64 } %1, { ptr, i64 } %2) #5 {
  %4 = tail call ptr @llvm.invariant.start.p0(i64 16, ptr %0)
  %5 = load ptr, ptr %0, align 8
  %6 = getelementptr i8, ptr %5, i64 8
  %7 = getelementptr i8, ptr %5, i64 16
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define noundef nonnull ptr @Math_B__Self_round_xPtrf64(ptr nocapture %0, double %1) #3 {
  %3 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr %0)
  ret ptr @Math__Self_round_xPtrf64
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define noundef nonnull ptr @Math_B__Self_floor_xPtrf64(ptr nocapture %0, double %1) #3 {
  %3 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr %0)
  ret ptr @Math__Self_floor_xPtrf64
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define noundef nonnull ptr @Math_B__Self_ceiling_xPtrf64(ptr nocapture %0, double %1) #3 {
  %3 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr %0)
...
24:                                               ; preds = %4
  %25 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.extract)
  ...
  %46 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.extract)
  %47 = load ptr, ptr %14, align 8
...
.lr.ph:                                           ; preds = %24
  %51 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.extract)
  br label %._crit_edge
...
.thread:                                          ; preds = %._crit_edge, %24, %4
  ...
  %70 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.extract)
  ...
  %77 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.extract)
  ...
  %82 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.extract)
...
define { ptr, ptr, ptr, i32 } @String_extend_strString({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr, ptr, ptr, i32 } %3) {
  ...
  %20 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr %.fca.0.extract1)
  ...
  %26 = call { ptr } %25({ ptr, ptr, ptr, i32 } %18, { ptr, ptr, ptr, i32 } %18, ptr nonnull %5)
  ...
  %30 = call ptr @llvm.invariant.start.p0(i64 280, ptr %.fca.0.extract1)
  %31 = getelementptr i8, ptr %22, i64 40
  %32 = load ptr, ptr %31, align 8
  %33 = call ptr %32({ ptr, ptr, ptr, i32 } %18, ptr nonnull %5)
  %34 = call i32 %33({ ptr, ptr, ptr, i32 } %18, { ptr, ptr, ptr, i32 } %18, ptr nonnull %5)
  %35 = call ptr @llvm.invariant.start.p0(i64 280, ptr %.fca.0.extract199)
  %36 = sext i32 %offset.i.i to i64
  %37 = getelementptr ptr, ptr %.fca.0.extract199, i64 %36
  %38 = getelementptr i8, ptr %37, i64 8
  %39 = load ptr, ptr %38, align 8
  %40 = call ptr %39(ptr %.fca.1.extract201)
  %41 = load i32, ptr %40, align 4
  %42 = add i32 %41, %34
  %.fca.0.load7 = load ptr, ptr %10, align 8
  %.fca.1.load10 = load ptr, ptr %11, align 8
  %.fca.3.load16 = load i32, ptr %13, align 8
  %43 = call ptr @llvm.invariant.start.p0(i64 280, ptr %.fca.0.load7)
  %44 = sext i32 %.fca.3.load16 to i64
  %45 = getelementptr ptr, ptr %.fca.0.load7, i64 %44
  %46 = getelementptr i8, ptr %45, i64 16
  %47 = load ptr, ptr %46, align 8
  %48 = call ptr %47(ptr %.fca.1.load10)
  %49 = load i32, ptr %48, align 4
  ...
  %51 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.load7)
  %52 = getelementptr i8, ptr %45, i64 8
  %53 = load ptr, ptr %52, align 8
  %54 = call ptr %53(ptr %.fca.1.load10)
  br i1 %50, label %55, label %83

55:                                               ; preds = %4
  %56 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.load7)
  %57 = load ptr, ptr %52, align 8
  %58 = call ptr %57(ptr %.fca.1.load10)
  %59 = load i32, ptr %58, align 4
  %60 = add i32 %59, %34
  %61 = load i32, ptr %54, align 4
  %62 = icmp slt i32 %61, %60
  br i1 %62, label %.lr.ph255, label %.thread

.lr.ph255:                                        ; preds = %55
  %63 = load ptr, ptr %27, align 8
  %64 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.load7)
  br label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph255, %._crit_edge
  %.reg2mem78.0253 = phi i32 [ 0, %.lr.ph255 ], [ %76, %._crit_edge ]
  %65 = sext i32 %.reg2mem78.0253 to i64
  %66 = getelementptr i8, ptr %63, i64 %65
  %67 = load ptr, ptr %45, align 8
  %68 = call ptr %67(ptr %.fca.1.load10)
  ...
  %76 = add i32 %.reg2mem78.0253, 1
  %77 = load ptr, ptr %52, align 8
  %78 = call ptr %77(ptr %.fca.1.load10)
  %79 = load i32, ptr %78, align 4
  %80 = add i32 %79, %34
  %81 = load i32, ptr %54, align 4
  %82 = icmp slt i32 %81, %80
  br i1 %82, label %._crit_edge, label %.thread

83:                                               ; preds = %4
  %84 = load i32, ptr %54, align 4
  %85 = add i32 %84, %34
  %86 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.load7)
  %87 = load ptr, ptr %46, align 8
  %88 = call ptr %87(ptr %.fca.1.load10)
  store i32 %85, ptr %88, align 4
  %89 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.load7)
  %90 = load ptr, ptr %45, align 8
  %91 = call ptr %90(ptr %.fca.1.load10)
  %92 = load ptr, ptr %91, align 8
  %93 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.load7)
  %94 = load ptr, ptr %46, align 8
  %95 = call ptr %94(ptr %.fca.1.load10)
  %96 = load i32, ptr %95, align 4
  %97 = sext i32 %96 to i64
  %98 = call ptr @malloc(i64 %97)
  %99 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.load7)
  %100 = load ptr, ptr %45, align 8
  %101 = call ptr %100(ptr %.fca.1.load10)
  store ptr %98, ptr %101, align 8
  %102 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.load7)
  %103 = load ptr, ptr %52, align 8
  %104 = call ptr %103(ptr %.fca.1.load10)
...
.lr.ph:                                           ; preds = %83
  %108 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.load7)
  %109 = load ptr, ptr %27, align 8
  br label %110

110:                                              ; preds = %.lr.ph, %._crit_edge1
  ...
  %112 = call ptr %111(ptr %.fca.1.load10)
  %113 = load i32, ptr %112, align 4
  %114 = icmp slt i32 %.reg2mem72.0250, %113
  %115 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.load7)
  %116 = load ptr, ptr %45, align 8
  %117 = call ptr %116(ptr %.fca.1.load10)
  %118 = load ptr, ptr %117, align 8
  br i1 %114, label %119, label %124

119:                                              ; preds = %110
  %120 = zext nneg i32 %.reg2mem72.0250 to i64
...
124:                                              ; preds = %110
  %125 = sext i32 %.reg2mem74.0251 to i64
  %126 = getelementptr i8, ptr %109, i64 %125
  %127 = zext nneg i32 %.reg2mem72.0250 to i64
  %128 = getelementptr i8, ptr %118, i64 %127
  %129 = load i8, ptr %126, align 1
  store i8 %129, ptr %128, align 1
  %130 = add i32 %.reg2mem74.0251, 1
  br label %._crit_edge1

._crit_edge1:                                     ; preds = %119, %124
  %.reg2mem70.0 = phi i32 [ %.reg2mem74.0251, %119 ], [ %130, %124 ]
  %.reg2mem68.0 = add nuw nsw i32 %.reg2mem72.0250, 1
  %131 = load ptr, ptr %52, align 8
  %132 = call ptr %131(ptr %.fca.1.load10)
  %133 = load i32, ptr %132, align 4
  %134 = add i32 %133, %34
  %135 = icmp slt i32 %.reg2mem68.0, %134
  br i1 %135, label %110, label %.thread

.thread:                                          ; preds = %._crit_edge1, %._crit_edge, %83, %55
  %.sroa.phi = phi ptr [ %.sroa.gep235, %55 ], [ %.sroa.gep, %83 ], [ %.sroa.gep235, %._crit_edge ], [ %.sroa.gep, %._crit_edge1 ]
  %.sroa.phi236 = phi ptr [ %.sroa.gep238, %55 ], [ %.sroa.gep237, %83 ], [ %.sroa.gep238, %._crit_edge ], [ %.sroa.gep237, %._crit_edge1 ]
  %.sroa.phi239 = phi ptr [ %.sroa.gep241, %55 ], [ %.sroa.gep240, %83 ], [ %.sroa.gep241, %._crit_edge ], [ %.sroa.gep240, %._crit_edge1 ]
  %136 = phi ptr [ %8, %55 ], [ %6, %83 ], [ %8, %._crit_edge ], [ %6, %._crit_edge1 ]
  %137 = phi ptr [ %9, %55 ], [ %7, %83 ], [ %9, %._crit_edge ], [ %7, %._crit_edge1 ]
  %138 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.load7)
  %139 = getelementptr i8, ptr %45, i64 8
  %140 = load ptr, ptr %139, align 8
  %141 = call ptr %140(ptr %.fca.1.load10)
  %142 = load i32, ptr %141, align 4
  %143 = add i32 %142, %34
  store i32 %143, ptr %137, align 4
  %144 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.load7)
  ...
  store ptr %148, ptr %.sroa.phi236, align 8
  ...
  %149 = call ptr @llvm.invariant.start.p0(i64 24, ptr nonnull %136)
  %150 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %.fca.0.load7, 0
  %151 = insertvalue { ptr, ptr, ptr, i32 } %150, ptr %.fca.1.load10, 1
  %152 = insertvalue { ptr, ptr, ptr, i32 } %151, ptr %148, 2
  %153 = insertvalue { ptr, ptr, ptr, i32 } %152, i32 %offset.i.i233, 3
...
define noundef i1 @String__EQ_otherString({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr, ptr, ptr, i32 } %3) {
  ...
  %offset_ptr.i.i55 = getelementptr i32, ptr %offset_tbl.i.i50, i64 %hash.i.i.i54
  %offset.i.i56 = load i32, ptr %offset_ptr.i.i55, align 4
  %9 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr %.fca.0.extract33)
  %10 = sext i32 %offset.i.i to i64
  %11 = getelementptr ptr, ptr %.fca.0.extract33, i64 %10
  %12 = getelementptr i8, ptr %11, i64 8
  %13 = load ptr, ptr %12, align 8
  %14 = tail call ptr %13(ptr %.fca.1.extract35)
  %15 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %.fca.0.extract, 0
  %16 = insertvalue { ptr, ptr, ptr, i32 } %15, ptr %.fca.1.extract, 1
  %17 = insertvalue { ptr, ptr, ptr, i32 } %16, ptr %.fca.2.extract, 2
  %18 = insertvalue { ptr, ptr, ptr, i32 } %17, i32 %offset.i.i56, 3
  %19 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %5)
  ...
  %24 = load ptr, ptr %23, align 8
  %25 = call ptr %24({ ptr, ptr, ptr, i32 } %18, ptr nonnull %5)
  %26 = call i32 %25({ ptr, ptr, ptr, i32 } %18, { ptr, ptr, ptr, i32 } %18, ptr nonnull %5)
  %27 = load i32, ptr %14, align 4
  %.not = icmp eq i32 %27, %26
  br i1 %.not, label %.preheader, label %.thread

.preheader:                                       ; preds = %4
  %28 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.extract33)
  %29 = getelementptr i8, ptr %22, i64 56
  br label %30

30:                                               ; preds = %.preheader, %34
  %.reg2mem40.0 = phi i32 [ %49, %34 ], [ 0, %.preheader ]
  %31 = load ptr, ptr %12, align 8
  %32 = call ptr %31(ptr %.fca.1.extract35)
  %33 = load i32, ptr %32, align 4
  %.not63 = icmp sge i32 %.reg2mem40.0, %33
  br i1 %.not63, label %.thread, label %34

34:                                               ; preds = %30
  %35 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.extract33)
  %36 = load ptr, ptr %11, align 8
  %37 = call ptr %36(ptr %.fca.1.extract35)
  %38 = load ptr, ptr %37, align 8
  %39 = zext nneg i32 %.reg2mem40.0 to i64
  %40 = getelementptr i8, ptr %38, i64 %39
  ...
  %44 = call ptr %43({ ptr, ptr, ptr, i32 } %18, ptr nonnull %5)
  %45 = call { ptr } %44({ ptr, ptr, ptr, i32 } %18, { ptr, ptr, ptr, i32 } %18, ptr nonnull %5)
  %.fca.0.extract41 = extractvalue { ptr } %45, 0
  %46 = getelementptr i8, ptr %.fca.0.extract41, i64 %39
  %47 = load i8, ptr %40, align 1
  %48 = load i8, ptr %46, align 1
  %.not43 = icmp eq i8 %47, %48
  %49 = add nuw nsw i32 %.reg2mem40.0, 1
  br i1 %.not43, label %30, label %.thread

.thread:                                          ; preds = %34, %30, %4
  %.reg2mem30.0 = phi i1 [ false, %4 ], [ %.not63, %30 ], [ %.not63, %34 ]
  %.reg2mem28.0 = phi ptr [ %8, %4 ], [ %7, %34 ], [ %6, %30 ]
  store i1 %.reg2mem30.0, ptr %.reg2mem28.0, align 1
  ret i1 %.reg2mem30.0
}
...
define { ptr, i8 } @String_pop_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %offset_ptr.i.i = getelementptr i32, ptr %offset_tbl.i.i, i64 %hash.i.i.i
  %offset.i.i = load i32, ptr %offset_ptr.i.i, align 4
  %4 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr %.fca.0.extract55)
  %5 = sext i32 %offset.i.i to i64
...
12:                                               ; preds = %3
  %13 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.extract55)
  %14 = load ptr, ptr %7, align 8
  %15 = tail call ptr %14(ptr %.fca.1.extract57)
  %16 = load i32, ptr %15, align 4
  %17 = add i32 %16, -1
  %18 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.extract55)
  %19 = load ptr, ptr %7, align 8
  %20 = tail call ptr %19(ptr %.fca.1.extract57)
  store i32 %17, ptr %20, align 4
  %21 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.extract55)
  %22 = load ptr, ptr %6, align 8
  %23 = tail call ptr %22(ptr %.fca.1.extract57)
  %24 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull %.fca.0.extract55)
...
define { ptr, i160 } @StringIterator_next_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %27 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr %15)
  %28 = sext i32 %24 to i64
  %29 = getelementptr ptr, ptr %15, i64 %28
  %30 = getelementptr i8, ptr %29, i64 40
  %31 = load ptr, ptr %30, align 8
  %32 = call ptr %31({ ptr, ptr, ptr, i32 } %25, ptr nonnull %4)
  %33 = call i32 %32({ ptr, ptr, ptr, i32 } %25, { ptr, ptr, ptr, i32 } %25, ptr nonnull %4)
  %34 = load i32, ptr %11, align 4
  %35 = icmp slt i32 %34, %33
  br i1 %35, label %36, label %106

36:                                               ; preds = %3
  %37 = call ptr @llvm.invariant.start.p0(i64 48, ptr nonnull %.fca.0.extract91)
  %38 = load ptr, ptr %9, align 8
  %39 = call ptr %38(ptr %.fca.1.extract93)
  %40 = load i32, ptr %39, align 4
  %41 = add i32 %40, 1
  %42 = call ptr @llvm.invariant.start.p0(i64 48, ptr nonnull %.fca.0.extract91)
  %43 = load ptr, ptr %9, align 8
  %44 = call ptr %43(ptr %.fca.1.extract93)
  store i32 %41, ptr %44, align 4
  %45 = call ptr @llvm.invariant.start.p0(i64 48, ptr nonnull %.fca.0.extract91)
  %46 = load ptr, ptr %8, align 8
  %47 = call ptr %46(ptr %.fca.1.extract93)
  %48 = load ptr, ptr %47, align 8
  ...
  %59 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %4)
  %60 = call ptr @llvm.invariant.start.p0(i64 280, ptr %48)
  %61 = sext i32 %57 to i64
  %62 = getelementptr ptr, ptr %48, i64 %61
  %63 = getelementptr i8, ptr %62, i64 56
  %64 = load ptr, ptr %63, align 8
  %65 = call ptr %64({ ptr, ptr, ptr, i32 } %58, ptr nonnull %4)
  %66 = call { ptr } %65({ ptr, ptr, ptr, i32 } %58, { ptr, ptr, ptr, i32 } %58, ptr nonnull %4)
  %67 = call ptr @llvm.invariant.start.p0(i64 48, ptr nonnull %.fca.0.extract91)
  %68 = load ptr, ptr %9, align 8
  %69 = call ptr %68(ptr %.fca.1.extract93)
  %70 = call dereferenceable_or_null(1) ptr @malloc(i64 1)
  %71 = getelementptr inbounds i8, ptr %5, i64 8
  %72 = getelementptr inbounds i8, ptr %5, i64 24
  store ptr @Character, ptr %5, align 8
  store ptr %70, ptr %71, align 8
  store i32 7, ptr %72, align 8
  %73 = call ptr @llvm.invariant.start.p0(i64 16, ptr nonnull %5)
  %74 = call ptr @llvm.invariant.start.p0(i64 48, ptr nonnull %.fca.0.extract91)
  %75 = load ptr, ptr %8, align 8
  %76 = call ptr %75(ptr %.fca.1.extract93)
  ...
  %.fca.0.extract97 = extractvalue { ptr } %95, 0
  %96 = call ptr @llvm.invariant.start.p0(i64 48, ptr nonnull %.fca.0.extract91)
  %97 = load ptr, ptr %9, align 8
  %98 = call ptr %97(ptr %.fca.1.extract93)
  %99 = load i32, ptr %98, align 4
  %100 = add i32 %99, -1
  %101 = sext i32 %100 to i64
  %102 = getelementptr i8, ptr %.fca.0.extract97, i64 %101
  %103 = load i8, ptr %102, align 1
  %104 = call ptr @llvm.invariant.start.p0(i64 40, ptr nonnull @Character)
  store i8 %103, ptr %70, align 1
  %105 = load i160, ptr %71, align 8
  br label %106

106:                                              ; preds = %3, %36
  %.reg2mem5.sroa.3.0 = phi i160 [ %105, %36 ], [ undef, %3 ]
  %.reg2mem5.sroa.0.0 = phi ptr [ @Character, %36 ], [ @nil_typ, %3 ]
  %.reload6.fca.0.insert = insertvalue { ptr, i160 } poison, ptr %.reg2mem5.sroa.0.0, 0
  %.reload6.fca.1.insert = insertvalue { ptr, i160 } %.reload6.fca.0.insert, i160 %.reg2mem5.sroa.3.0, 1
  ret { ptr, i160 } %.reload6.fca.1.insert
}
...
String_c_string_.exit169:
  ...
  %10 = tail call dereferenceable_or_null(10) ptr @malloc(i64 10)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(9) %10, ptr noundef nonnull align 1 dereferenceable(9) %9, i64 9, i1 false)
  ...
  store i208 162981253831880068406196778880323066739289769709874582355408965, ptr %12, align 4
  %13 = tail call dereferenceable_or_null(27) ptr @malloc(i64 27)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(26) %13, ptr noundef nonnull align 1 dereferenceable(26) %12, i64 26, i1 false)
  ...
  %34 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr %22)
  %35 = sext i32 %31 to i64
  %36 = getelementptr ptr, ptr %22, i64 %35
  %37 = getelementptr i8, ptr %36, i64 112
  %38 = load ptr, ptr %37, align 8
  %39 = call ptr %38({ ptr, ptr, ptr, i32 } %32, ptr nonnull %3)
  %40 = call { ptr } %39({ ptr, ptr, ptr, i32 } %32, { ptr, ptr, ptr, i32 } %32, ptr nonnull %3)
  %.fca.0.extract8 = extractvalue { ptr } %40, 0
  %puts34 = call i32 @puts(ptr nonnull dereferenceable(1) %.fca.0.extract8)
  %41 = call dereferenceable_or_null(8) ptr @malloc(i64 8)
  store i56 28550371712463937, ptr %41, align 4
  %42 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %3)
  %43 = call dereferenceable_or_null(8) ptr @malloc(i64 8)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %43, ptr noundef nonnull align 1 dereferenceable(7) %41, i64 7, i1 false)
  %44 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull @String)
  %45 = getelementptr i8, ptr %43, i64 7
  store i8 0, ptr %45, align 1
  %puts35 = call i32 @puts(ptr nonnull dereferenceable(1) %43)
  %46 = call ptr @llvm.invariant.start.p0(i64 104, ptr nonnull %.fca.0.extract28)
  %47 = load ptr, ptr %18, align 8
  %48 = call ptr %47(ptr %.fca.1.extract)
  %49 = load i32, ptr %48, align 4
  %50 = call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @i32_string, i32 %49)
  %51 = call dereferenceable_or_null(13) ptr @malloc(i64 13)
  store i96 31382965550615737851350116695, ptr %51, align 4
  %52 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %3)
  %53 = call dereferenceable_or_null(13) ptr @malloc(i64 13)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(12) %53, ptr noundef nonnull align 1 dereferenceable(12) %51, i64 12, i1 false)
  %54 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull @String)
  %55 = getelementptr i8, ptr %53, i64 12
  store i8 0, ptr %55, align 1
  %puts36 = call i32 @puts(ptr nonnull dereferenceable(1) %53)
  %56 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %.fca.0.extract28, 0
  %57 = insertvalue { ptr, ptr, ptr, i32 } %56, ptr %.fca.1.extract, 1
  %58 = load ptr, ptr %6, align 8
  %59 = insertvalue { ptr, ptr, ptr, i32 } %57, ptr %58, 2
  %60 = insertvalue { ptr, ptr, ptr, i32 } %59, i32 %offset.i.i, 3
  %61 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %3)
  %62 = call ptr @llvm.invariant.start.p0(i64 104, ptr nonnull %.fca.0.extract28)
  %63 = getelementptr i8, ptr %18, i64 56
  %64 = load ptr, ptr %63, align 8
  %65 = call ptr %64({ ptr, ptr, ptr, i32 } %60, ptr nonnull %3)
  call void %65({ ptr, ptr, ptr, i32 } %60, { ptr, ptr, ptr, i32 } %60, ptr nonnull %3)
  %66 = call dereferenceable_or_null(10) ptr @malloc(i64 10)
  store i72 833358791094643273005, ptr %66, align 4
  %67 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %3)
  %68 = call dereferenceable_or_null(10) ptr @malloc(i64 10)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(9) %68, ptr noundef nonnull align 1 dereferenceable(9) %66, i64 9, i1 false)
  %69 = call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull @String)
  %70 = getelementptr i8, ptr %68, i64 9
  store i8 0, ptr %70, align 1
  %puts37 = call i32 @puts(ptr nonnull dereferenceable(1) %68)
  ret void
}
...
define void @IntIterable_each_fFunctionPtri32_to_Nothing({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr } %3) {
  ...
  %11 = tail call ptr @llvm.invariant.start.p0(i64 192, ptr %.fca.0.extract3)
  %12 = sext i32 %offset.i.i to i64
  ...
  %21 = insertvalue { ptr, ptr, ptr, i32 } %20, i32 %offset.i.i41, 3
  ...
  %24 = sext i32 %offset.i.i41 to i64
  ...
  %.fca.0.extract1143 = extractvalue { ptr, i32 } %28, 0
...
._crit_edge:                                      ; preds = %4, %._crit_edge
  ...
  %.fca.0.extract11 = extractvalue { ptr, i32 } %32, 0
...
define i32 @IntIterable_reduce_initial_valPtri32_fFunctionPtri32._Ptri32_to_Ptri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3, { ptr } %4) {
  ...
  %12 = tail call ptr @llvm.invariant.start.p0(i64 192, ptr %.fca.0.extract5)
  %13 = sext i32 %offset.i.i to i64
  ...
  %22 = insertvalue { ptr, ptr, ptr, i32 } %21, i32 %offset.i.i43, 3
  ...
  %25 = sext i32 %offset.i.i43 to i64
  ...
  %.fca.0.extract1346 = extractvalue { ptr, i32 } %29, 0
  %.not47 = icmp eq ptr %.fca.0.extract1346, @nil_typ
  br i1 %.not47, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %5, %.lr.ph
  %30 = phi { ptr, i32 } [ %34, %.lr.ph ], [ %29, %5 ]
  %.reg2mem26.048 = phi i32 [ %31, %.lr.ph ], [ %3, %5 ]
  %.fca.1.extract15 = extractvalue { ptr, i32 } %30, 1
  %31 = call i32 %.fca.0.extract1(i32 %.reg2mem26.048, i32 %.fca.1.extract15)
  ...
  %.fca.0.extract13 = extractvalue { ptr, i32 } %34, 0
...
26:                                               ; preds = %30, %4
  ...
  %.not = icmp eq ptr %.fca.0.extract11, @nil_typ
  br i1 %.not, label %.critedge.cont, label %30

30:                                               ; preds = %26
  %.fca.1.extract13 = extractvalue { ptr, i32 } %29, 1
  %31 = call i1 %.fca.0.extract1(i32 %.fca.1.extract13)
  br i1 %31, label %26, label %.critedge.cont

.critedge.cont:                                   ; preds = %30, %26
  ret i1 %.not
}
...
define noundef i1 @IntIterable_any_fFunctionPtri32_to_Ptri1({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr } %3) {
  ...
  %9 = insertvalue { ptr, ptr, ptr, i32 } %8, i32 %offset.i.i, 3
  %10 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %5)
  %11 = tail call ptr @llvm.invariant.start.p0(i64 192, ptr %.fca.0.extract4)
  %12 = sext i32 %offset.i.i to i64
...
26:                                               ; preds = %30, %4
  ...
  %28 = call ptr %27({ ptr, ptr, ptr, i32 } %21, ptr nonnull %5)
  %29 = call { ptr, i32 } %28({ ptr, ptr, ptr, i32 } %21, { ptr, ptr, ptr, i32 } %21, ptr nonnull %5)
  %.fca.0.extract12 = extractvalue { ptr, i32 } %29, 0
  %.not.not.not.not.not = icmp ne ptr %.fca.0.extract12, @nil_typ
  br i1 %.not.not.not.not.not, label %30, label %.critedge.cont

30:                                               ; preds = %26
  %.fca.1.extract14 = extractvalue { ptr, i32 } %29, 1
  %31 = call i1 %.fca.0.extract1(i32 %.fca.1.extract14)
  br i1 %31, label %.critedge.cont, label %26

.critedge.cont:                                   ; preds = %26, %30
  ret i1 %.not.not.not.not.not
}

; Function Attrs: mustprogress nofree nounwind willreturn memory(readwrite, argmem: read)
define { ptr, ptr, ptr, i32 } @IntIterable_map_fFunctionPtri32_to_Ptri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr } %3) #9 {
  %.fca.0.extract1 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %.fca.2.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 2
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract1, i64 8
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(readwrite, argmem: read)
define { ptr, ptr, ptr, i32 } @IntIterable_filter_fFunctionPtri32_to_Ptri1({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr } %3) #9 {
  %.fca.0.extract1 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %.fca.2.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 2
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract1, i64 8
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(readwrite, argmem: read)
define { ptr, ptr, ptr, i32 } @IntIterable_chain_otherIntIterable({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr, ptr, ptr, i32 } %3) #9 {
  %.fca.0.extract1 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(readwrite, argmem: read)
define { ptr, ptr, ptr, i32 } @IntIterable_interleave_otherIntIterable({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr, ptr, ptr, i32 } %3) #9 {
  %.fca.0.extract1 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract3 = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %.fca.2.extract5 = extractvalue { ptr, ptr, ptr, i32 } %0, 2
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract1, i64 8
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(readwrite, argmem: read)
define { ptr, ptr, ptr, i32 } @IntIterable_zip_otherIntIterable({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr, ptr, ptr, i32 } %3) #9 {
  %.fca.0.extract1 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract3 = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %.fca.2.extract5 = extractvalue { ptr, ptr, ptr, i32 } %0, 2
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract1, i64 8
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(readwrite, argmem: read)
define { ptr, ptr, ptr, i32 } @IntIterable_product_otherIntIterable({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr, ptr, ptr, i32 } %3) #9 {
  %.fca.0.extract1 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract3 = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %.fca.2.extract5 = extractvalue { ptr, ptr, ptr, i32 } %0, 2
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract1, i64 8
...
define { ptr, ptr, ptr, i32 } @MapIterable_iterator_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %63 = load ptr, ptr %62, align 8
  %64 = insertvalue { ptr, ptr, ptr, i32 } { ptr @MapIterator, ptr undef, ptr undef, i32 undef }, ptr %33, 1
  %65 = getelementptr inbounds i8, ptr %34, i64 16
  %66 = load ptr, ptr %65, align 8
  %67 = insertvalue { ptr, ptr, ptr, i32 } %64, ptr %66, 2
  %68 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @MapIterator)
  ...
  %70 = getelementptr i8, ptr %33, i64 16
  store ptr %.fca.2.extract, ptr %70, align 8
  %71 = getelementptr i8, ptr %33, i64 24
  store i32 %offset.i.i52.i, ptr %71, align 4
  %72 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @MapIterator)
  %73 = getelementptr i8, ptr %33, i64 32
  store ptr %63, ptr %73, align 8
  %74 = insertvalue { ptr, ptr, ptr, i32 } %67, i32 15, 3
...
28:                                               ; preds = %3
  ...
  %29 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull %.fca.0.extract21)
  %30 = getelementptr i8, ptr %7, i64 8
  %31 = load ptr, ptr %30, align 8
  %32 = call ptr %31(ptr %.fca.1.extract23)
  %33 = load ptr, ptr %32, align 8
...
define void @ProductIterator_init_first_iterableIntIterable_second_iterableIntIterable({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr, ptr, ptr, i32 } %3, { ptr, ptr, ptr, i32 } %4) {
  ...
  %25 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %6)
  %26 = tail call ptr @llvm.invariant.start.p0(i64 192, ptr %.fca.0.extract19)
  %27 = sext i32 %offset.i.i111 to i64
  %28 = getelementptr ptr, ptr %.fca.0.extract19, i64 %27
  %29 = getelementptr i8, ptr %28, i64 80
  %30 = load ptr, ptr %29, align 8
  %31 = call ptr %30({ ptr, ptr, ptr, i32 } %24, ptr nonnull %6)
  %32 = call { ptr, ptr, ptr, i32 } %31({ ptr, ptr, ptr, i32 } %24, { ptr, ptr, ptr, i32 } %24, ptr nonnull %6)
  %.fca.0.extract3 = extractvalue { ptr, ptr, ptr, i32 } %32, 0
  %.fca.1.extract5 = extractvalue { ptr, ptr, ptr, i32 } %32, 1
  %.fca.2.extract7 = extractvalue { ptr, ptr, ptr, i32 } %32, 2
  ...
  %33 = call ptr @llvm.invariant.start.p0(i64 64, ptr %.fca.0.load32)
  %34 = getelementptr ptr, ptr %.fca.0.load32, i64 %13
  %35 = load ptr, ptr %34, align 8
  %36 = call ptr %35(ptr %.fca.1.load35)
  ...
  store ptr %.fca.0.extract3, ptr %36, align 8
  %37 = getelementptr i8, ptr %36, i64 8
  store ptr %.fca.1.extract5, ptr %37, align 8
  %38 = getelementptr i8, ptr %36, i64 16
  store ptr %.fca.2.extract7, ptr %38, align 8
  %39 = getelementptr i8, ptr %36, i64 24
  store i32 %offset.i.i167, ptr %39, align 4
  %40 = call ptr @llvm.invariant.start.p0(i64 64, ptr %.fca.0.load32)
  %41 = getelementptr i8, ptr %34, i64 16
  %42 = load ptr, ptr %41, align 8
  %43 = call ptr %42(ptr %.fca.1.load35)
  %44 = load ptr, ptr %43, align 8
  ...
  %55 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %6)
  %56 = call ptr @llvm.invariant.start.p0(i64 192, ptr %44)
  %57 = sext i32 %53 to i64
  %58 = getelementptr ptr, ptr %44, i64 %57
  %59 = getelementptr i8, ptr %58, i64 80
  %60 = load ptr, ptr %59, align 8
  %61 = call ptr %60({ ptr, ptr, ptr, i32 } %54, ptr nonnull %6)
  %62 = call { ptr, ptr, ptr, i32 } %61({ ptr, ptr, ptr, i32 } %54, { ptr, ptr, ptr, i32 } %54, ptr nonnull %6)
  ...
  %63 = call ptr @llvm.invariant.start.p0(i64 64, ptr %.fca.0.load32)
  %64 = getelementptr i8, ptr %34, i64 8
  %65 = load ptr, ptr %64, align 8
  %66 = call ptr %65(ptr %.fca.1.load35)
  ...
  store ptr %.fca.0.extract1, ptr %66, align 8
  %67 = getelementptr i8, ptr %66, i64 8
  store ptr %.fca.1.extract2, ptr %67, align 8
  %68 = getelementptr i8, ptr %66, i64 16
  store ptr %.fca.2.extract, ptr %68, align 8
  %69 = getelementptr i8, ptr %66, i64 24
  store i32 %offset.i.i195, ptr %69, align 4
  %70 = call ptr @llvm.invariant.start.p0(i64 64, ptr %.fca.0.load32)
  %71 = load ptr, ptr %34, align 8
  %72 = call ptr %71(ptr %.fca.1.load35)
  %73 = load ptr, ptr %72, align 8
  %74 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %73, 0
  %75 = getelementptr i8, ptr %72, i64 8
  %76 = load ptr, ptr %75, align 8
  ...
  %82 = load i32, ptr %81, align 4
  %83 = insertvalue { ptr, ptr, ptr, i32 } %80, i32 %82, 3
  %84 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %6)
  %85 = call ptr @llvm.invariant.start.p0(i64 16, ptr %73)
  %86 = sext i32 %82 to i64
  %87 = getelementptr ptr, ptr %73, i64 %86
  %88 = load ptr, ptr %87, align 8
  %89 = call ptr %88({ ptr, ptr, ptr, i32 } %83, ptr nonnull %6)
  %90 = call { ptr, i32 } %89({ ptr, ptr, ptr, i32 } %83, { ptr, ptr, ptr, i32 } %83, ptr nonnull %6)
  %.fca.0.extract = extractvalue { ptr, i32 } %90, 0
  %.fca.1.extract = extractvalue { ptr, i32 } %90, 1
  %91 = call ptr @llvm.invariant.start.p0(i64 64, ptr %.fca.0.load32)
  %92 = getelementptr i8, ptr %34, i64 24
  %93 = load ptr, ptr %92, align 8
  %94 = call ptr %93(ptr %.fca.1.load35)
  store ptr %.fca.0.extract, ptr %94, align 8
  %95 = getelementptr i8, ptr %94, i64 8
  store i32 %.fca.1.extract, ptr %95, align 4
  ret void
}
...
14:                                               ; preds = %.lr.ph, %36
  ...
  %30 = call ptr @llvm.invariant.start.p0(i64 16, ptr %18)
  %31 = sext i32 %27 to i64
  %32 = getelementptr ptr, ptr %18, i64 %31
  %33 = load ptr, ptr %32, align 8
  %34 = call ptr %33({ ptr, ptr, ptr, i32 } %28, ptr nonnull %3)
  %35 = call { ptr, i32 } %34({ ptr, ptr, ptr, i32 } %28, { ptr, ptr, ptr, i32 } %28, ptr nonnull %3)
  %.fca.0.extract87 = extractvalue { ptr, i32 } %35, 0
  %.not156 = icmp eq ptr %.fca.0.extract87, @nil_typ
  br i1 %.not156, label %36, label %96

36:                                               ; preds = %14
  %37 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull %.fca.0.extract81)
  %38 = load ptr, ptr %6, align 8
  %39 = call ptr %38(ptr %.fca.1.extract83)
  %40 = load ptr, ptr %39, align 8
  ...
  %52 = call ptr @llvm.invariant.start.p0(i64 16, ptr %40)
  %53 = sext i32 %49 to i64
  %54 = getelementptr ptr, ptr %40, i64 %53
  %55 = load ptr, ptr %54, align 8
  %56 = call ptr %55({ ptr, ptr, ptr, i32 } %50, ptr nonnull %3)
  %57 = call { ptr, i32 } %56({ ptr, ptr, ptr, i32 } %50, { ptr, ptr, ptr, i32 } %50, ptr nonnull %3)
  %.fca.0.extract94 = extractvalue { ptr, i32 } %57, 0
  %.fca.1.extract96 = extractvalue { ptr, i32 } %57, 1
  %58 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull %.fca.0.extract81)
  %59 = load ptr, ptr %7, align 8
  %60 = call ptr %59(ptr %.fca.1.extract83)
  store ptr %.fca.0.extract94, ptr %60, align 8
  %61 = getelementptr i8, ptr %60, i64 8
  store i32 %.fca.1.extract96, ptr %61, align 4
  %62 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull %.fca.0.extract81)
  %63 = load ptr, ptr %13, align 8
  %64 = call ptr %63(ptr %.fca.1.extract83)
  %65 = load ptr, ptr %64, align 8
  ...
  %77 = call ptr @llvm.invariant.start.p0(i64 192, ptr %65)
  %78 = sext i32 %74 to i64
  %79 = getelementptr ptr, ptr %65, i64 %78
  %80 = getelementptr i8, ptr %79, i64 80
  %81 = load ptr, ptr %80, align 8
  %82 = call ptr %81({ ptr, ptr, ptr, i32 } %75, ptr nonnull %3)
  %83 = call { ptr, ptr, ptr, i32 } %82({ ptr, ptr, ptr, i32 } %75, { ptr, ptr, ptr, i32 } %75, ptr nonnull %3)
  %.fca.0.extract100 = extractvalue { ptr, ptr, ptr, i32 } %83, 0
  %.fca.1.extract102 = extractvalue { ptr, ptr, ptr, i32 } %83, 1
  %.fca.2.extract104 = extractvalue { ptr, ptr, ptr, i32 } %83, 2
  ...
  %84 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull %.fca.0.extract81)
  %85 = load ptr, ptr %12, align 8
  %86 = call ptr %85(ptr %.fca.1.extract83)
  ...
  store ptr %.fca.0.extract100, ptr %86, align 8
  %87 = getelementptr i8, ptr %86, i64 8
  store ptr %.fca.1.extract102, ptr %87, align 8
  %88 = getelementptr i8, ptr %86, i64 16
  store ptr %.fca.2.extract104, ptr %88, align 8
  %89 = getelementptr i8, ptr %86, i64 24
  store i32 %offset.i.i136, ptr %89, align 4
  %90 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull %.fca.0.extract81)
  %91 = load ptr, ptr %7, align 8
  %92 = call ptr %91(ptr %.fca.1.extract83)
  %93 = load ptr, ptr %92, align 8
  store ptr %93, ptr %9, align 8
  %94 = getelementptr i8, ptr %92, i64 8
  %95 = load i32, ptr %94, align 4
  store i32 %95, ptr %10, align 4
  %.not = icmp eq ptr %93, @nil_typ
  br i1 %.not, label %.thread, label %14

96:                                               ; preds = %14
  %.fca.1.extract89 = extractvalue { ptr, i32 } %35, 1
...
.thread:                                          ; preds = %36, %thread-pre-split, %96
  %97 = phi i64 [ %.sroa.092.0.insert.insert, %96 ], [ undef, %thread-pre-split ], [ undef, %36 ]
  %98 = phi ptr [ @tuple_typ, %96 ], [ @nil_typ, %thread-pre-split ], [ @nil_typ, %36 ]
  %.reload25.fca.0.insert = insertvalue { ptr, i64 } poison, ptr %98, 0
  %.reload25.fca.1.insert = insertvalue { ptr, i64 } %.reload25.fca.0.insert, i64 %97, 1
...
define { ptr, ptr, ptr, i32 } @ZipIterable_iterator_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %101 = insertvalue { ptr, ptr, ptr, i32 } { ptr @ZipIterator, ptr undef, ptr undef, i32 undef }, ptr %52, 1
  ...
  store ptr %.fca.1.extract3, ptr %106, align 8
  %107 = getelementptr i8, ptr %52, i64 16
  store ptr %.fca.2.extract5, ptr %107, align 8
  %108 = getelementptr i8, ptr %52, i64 24
  store i32 %offset.i.i59.i, ptr %108, align 4
  %109 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @ZipIterator)
  %110 = getelementptr i8, ptr %52, i64 32
  ...
  %111 = getelementptr i8, ptr %52, i64 40
  store ptr %.fca.1.extract, ptr %111, align 8
  %112 = getelementptr i8, ptr %52, i64 48
  store ptr %.fca.2.extract, ptr %112, align 8
  %113 = getelementptr i8, ptr %52, i64 56
  store i32 %offset.i.i87.i, ptr %113, align 4
  %114 = insertvalue { ptr, ptr, ptr, i32 } %104, i32 15, 3
...
define { ptr, i64 } @ZipIterator_next_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %26 = call ptr %25({ ptr, ptr, ptr, i32 } %20, ptr nonnull %4)
  %27 = call { ptr, i32 } %26({ ptr, ptr, ptr, i32 } %20, { ptr, ptr, ptr, i32 } %20, ptr nonnull %4)
  %.fca.0.extract1 = extractvalue { ptr, i32 } %27, 0
  %28 = call ptr @llvm.invariant.start.p0(i64 64, ptr %.fca.0.extract29)
  %29 = getelementptr i8, ptr %7, i64 8
  %30 = load ptr, ptr %29, align 8
  %31 = call ptr %30(ptr %.fca.1.extract31)
  %32 = load ptr, ptr %31, align 8
...
50:                                               ; preds = %3
  ...
  %.fca.1.extract2 = extractvalue { ptr, i32 } %27, 1
...
.thread:                                          ; preds = %50, %3
  %.reg2mem18.sroa.3.046 = phi i64 [ poison, %3 ], [ %.sroa.036.0.insert.insert, %50 ]
  %51 = phi ptr [ @nil_typ, %3 ], [ %spec.select, %50 ]
  %.reload15.fca.0.insert = insertvalue { ptr, i64 } poison, ptr %51, 0
...
define { ptr, ptr, ptr, i32 } @InterleaveIterable_iterator_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %tbl_size_ptr.i.i117 = getelementptr i8, ptr %.fca.0.extract, i64 16
  %offset_tbl_ptr.i.i118 = getelementptr i8, ptr %.fca.0.extract, i64 40
  %101 = insertvalue { ptr, ptr, ptr, i32 } { ptr @InterleaveIterator, ptr undef, ptr undef, i32 undef }, ptr %52, 1
  %102 = getelementptr inbounds i8, ptr %53, i64 16
  %103 = load ptr, ptr %102, align 8
  %104 = insertvalue { ptr, ptr, ptr, i32 } %101, ptr %103, 2
  ...
  store ptr %.fca.2.extract5, ptr %107, align 8
  %108 = getelementptr i8, ptr %52, i64 24
  store i32 %offset.i.i71.i, ptr %108, align 4
  ...
  store ptr %.fca.2.extract, ptr %112, align 8
  %113 = getelementptr i8, ptr %52, i64 56
  store i32 %offset.i.i99.i, ptr %113, align 4
  %114 = call ptr @llvm.invariant.start.p0(i64 72, ptr nonnull @InterleaveIterator)
  %115 = getelementptr i8, ptr %52, i64 64
  store i1 true, ptr %115, align 1
  %116 = insertvalue { ptr, ptr, ptr, i32 } %104, i32 16, 3
...
define { ptr, ptr, ptr, i32 } @ChainIterable_iterator_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %tbl_size_ptr.i.i117 = getelementptr i8, ptr %.fca.0.extract, i64 16
  %offset_tbl_ptr.i.i118 = getelementptr i8, ptr %.fca.0.extract, i64 40
  %101 = insertvalue { ptr, ptr, ptr, i32 } { ptr @ChainIterator, ptr undef, ptr undef, i32 undef }, ptr %52, 1
  %102 = getelementptr inbounds i8, ptr %53, i64 16
  %103 = load ptr, ptr %102, align 8
  %104 = insertvalue { ptr, ptr, ptr, i32 } %101, ptr %103, 2
  ...
  %113 = getelementptr i8, ptr %52, i64 56
  store i32 %offset.i.i99.i, ptr %113, align 4
  %114 = call ptr @llvm.invariant.start.p0(i64 72, ptr nonnull @ChainIterator)
  %115 = getelementptr i8, ptr %52, i64 64
  store i1 true, ptr %115, align 1
  %116 = insertvalue { ptr, ptr, ptr, i32 } %104, i32 16, 3
  ret { ptr, ptr, ptr, i32 } %116
...
17:                                               ; preds = %3
  ...
  %33 = tail call ptr @llvm.invariant.start.p0(i64 16, ptr %21)
  %34 = sext i32 %30 to i64
  %35 = getelementptr ptr, ptr %21, i64 %34
  %36 = load ptr, ptr %35, align 8
  %37 = call ptr %36({ ptr, ptr, ptr, i32 } %31, ptr nonnull %4)
  %38 = call { ptr, i32 } %37({ ptr, ptr, ptr, i32 } %31, { ptr, ptr, ptr, i32 } %31, ptr nonnull %4)
  %.fca.0.extract53 = extractvalue { ptr, i32 } %38, 0
  %.not = icmp eq ptr %.fca.0.extract53, @nil_typ
  br i1 %.not, label %39, label %66

39:                                               ; preds = %17
  %40 = call ptr @llvm.invariant.start.p0(i64 72, ptr nonnull %.fca.0.extract47)
  %41 = load ptr, ptr %13, align 8
...
.thread:                                          ; preds = %39, %3
  ...
  %43 = call ptr @llvm.invariant.start.p0(i64 72, ptr %.fca.0.load26)
  %44 = getelementptr ptr, ptr %.fca.0.load26, i64 %.pre-phi
  %45 = getelementptr i8, ptr %44, i64 8
  %46 = load ptr, ptr %45, align 8
  %47 = call ptr %46(ptr %.fca.1.load29)
  %48 = load ptr, ptr %47, align 8
  %49 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %48, 0
  %50 = getelementptr i8, ptr %47, i64 8
  %51 = load ptr, ptr %50, align 8
  ...
  %62 = getelementptr ptr, ptr %48, i64 %61
  %63 = load ptr, ptr %62, align 8
  %64 = call ptr %63({ ptr, ptr, ptr, i32 } %58, ptr nonnull %4)
  %65 = call { ptr, i32 } %64({ ptr, ptr, ptr, i32 } %58, { ptr, ptr, ptr, i32 } %58, ptr nonnull %4)
  %.fca.0.extract57 = extractvalue { ptr, i32 } %65, 0
  br label %66

66:                                               ; preds = %17, %.thread
  %.pn = phi { ptr, i32 } [ %65, %.thread ], [ %38, %17 ]
...
define { ptr, ptr, ptr, i32 } @FilterIterable_iterator_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %62 = call ptr %61(ptr %.fca.1.extract51)
  %63 = load ptr, ptr %62, align 8
  %64 = insertvalue { ptr, ptr, ptr, i32 } { ptr @FilterIterator, ptr undef, ptr undef, i32 undef }, ptr %33, 1
  %65 = getelementptr inbounds i8, ptr %34, i64 16
  %66 = load ptr, ptr %65, align 8
  %67 = insertvalue { ptr, ptr, ptr, i32 } %64, ptr %66, 2
  %68 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @FilterIterator)
  %hash_coef.i.i44.i = load i64, ptr %hash_coef_ptr.i.i72, align 4
  %tbl_size.i.i45.i = load i64, ptr %tbl_size_ptr.i.i73, align 4
  %offset_tbl.i.i46.i = load ptr, ptr %offset_tbl_ptr.i.i74, align 8
  %product.i.i.i47.i = mul i64 %hash_coef.i.i44.i, -933084275656658555
  ...
  %71 = getelementptr i8, ptr %33, i64 24
  store i32 %offset.i.i52.i, ptr %71, align 4
  %72 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @FilterIterator)
  %73 = getelementptr i8, ptr %33, i64 32
  store ptr %63, ptr %73, align 8
  %74 = insertvalue { ptr, ptr, ptr, i32 } %67, i32 15, 3
  ret { ptr, ptr, ptr, i32 } %74
...
define { ptr, i32 } @FilterIterator_next_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %26 = call ptr %25({ ptr, ptr, ptr, i32 } %20, ptr nonnull %4)
  %27 = call { ptr, i32 } %26({ ptr, ptr, ptr, i32 } %20, { ptr, ptr, ptr, i32 } %20, ptr nonnull %4)
  %.sroa.0.058 = extractvalue { ptr, i32 } %27, 0
  %.sroa.3.059 = extractvalue { ptr, i32 } %27, 1
  %.not60 = icmp eq ptr %.sroa.0.058, @nil_typ
  br i1 %.not60, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %3
  %28 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull %.fca.0.extract38)
  %29 = getelementptr i8, ptr %7, i64 8
  br label %30

30:                                               ; preds = %.lr.ph, %35
  %.sroa.3.061 = phi i32 [ %.sroa.3.059, %.lr.ph ], [ %.sroa.3.0, %35 ]
  %31 = load ptr, ptr %29, align 8
  %32 = call ptr %31(ptr %.fca.1.extract40)
  %33 = load ptr, ptr %32, align 8
  %34 = call i1 %33(i32 %.sroa.3.061)
  br i1 %34, label %._crit_edge, label %35

35:                                               ; preds = %30
  %36 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull %.fca.0.extract38)
  %37 = load ptr, ptr %7, align 8
  %38 = call ptr %37(ptr %.fca.1.extract40)
  %39 = load ptr, ptr %38, align 8
  ...
  %.sroa.3.0 = extractvalue { ptr, i32 } %56, 1
  %.not = icmp eq ptr %.sroa.0.0, @nil_typ
  br i1 %.not, label %._crit_edge, label %30

._crit_edge:                                      ; preds = %35, %30, %3
  %.sroa.3.0.lcssa = phi i32 [ %.sroa.3.059, %3 ], [ %.sroa.3.061, %30 ], [ %.sroa.3.0, %35 ]
  %57 = phi ptr [ @nil_typ, %3 ], [ @i32_typ, %30 ], [ @nil_typ, %35 ]
  %.reload21.fca.0.insert = insertvalue { ptr, i32 } poison, ptr %57, 0
...
IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit73:
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 16
  ...
  %4 = load i352, ptr @aaqcj_The_size_of_the_collection_being_indexed_was, align 16
...
.lr.ph.i:                                         ; preds = %IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit73
...
String_c_string_.exit:                            ; preds = %.lr.ph.i, %IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit73
  ...
  %.sroa.2.8.extract.trunc.i88 = trunc i160 %43 to i64
  %45 = inttoptr i64 %.sroa.2.8.extract.trunc.i88 to ptr
  ...
  br i1 %52, label %.lr.ph.i121, label %String_c_string_.exit124

.lr.ph.i121:                                      ; preds = %String_c_string_.exit
...
String_c_string_.exit124:                         ; preds = %.lr.ph.i121, %String_c_string_.exit
  %56 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull @String)
  %57 = sext i32 %48 to i64
  %58 = getelementptr i8, ptr %51, i64 %57
  store i8 0, ptr %58, align 1
  %puts.i104 = tail call i32 @puts(ptr nonnull dereferenceable(1) %51)
...
define void @OutOfBounds_init_boundsPtri32_indexPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3, i32 %4) {
  ...
  %36 = load i520, ptr @fwxwa_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
...
define void @OutOfBounds_print_message_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %result.i.i = tail call i1 %25(i64 %24, i64 %23, i64 -5126806859456325683, i64 ptrtoint (ptr @nil_typ to i64), ptr readonly %26) #20
  br i1 %result.i.i, label %IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit, label %27

27:                                               ; preds = %3
  %result.i4.i = tail call i1 %25(i64 %24, i64 %23, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr readonly %26) #20
  br i1 %result.i4.i, label %IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit, label %28

28:                                               ; preds = %27
  %result.i5.i = tail call i1 %25(i64 %24, i64 %23, i64 6681222582356018452, i64 ptrtoint (ptr @Character to i64), ptr readonly %26) #20
  %result.i6.i = tail call i1 %25(i64 %24, i64 %23, i64 6499063144389013426, i64 ptrtoint (ptr @String to i64), ptr readonly %26) #20
  %not.result.i5.i = xor i1 %result.i5.i, true
  %.reg2mem119.0.i = select i1 %not.result.i5.i, i1 true, i1 %result.i6.i
  br i1 %.reg2mem119.0.i, label %29, label %IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit

29:                                               ; preds = %28
  %result.i7.i = tail call i1 %25(i64 %24, i64 %23, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr readonly %26) #20
  br i1 %result.i7.i, label %IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit, label %30

30:                                               ; preds = %29
  %not.result.i6.i = xor i1 %result.i6.i, true
  %.reg2mem117.0.i = or i1 %result.i5.i, %not.result.i6.i
  br i1 %.reg2mem117.0.i, label %31, label %IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit

31:                                               ; preds = %30
  %result.i10.i = tail call i1 %25(i64 %24, i64 %23, i64 -757315540097298781, i64 ptrtoint (ptr @f64_typ to i64), ptr readonly %26) #20
  br i1 %result.i10.i, label %IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit, label %32

32:                                               ; preds = %31
  %result.i11.i = tail call i1 %25(i64 %24, i64 %23, i64 2582149688529881115, i64 ptrtoint (ptr @i8_typ to i64), ptr readonly %26) #20
  br i1 %result.i11.i, label %IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit, label %33

33:                                               ; preds = %32
  %result.i12.i = tail call i1 %25(i64 %24, i64 %23, i64 -7260840641129990118, i64 ptrtoint (ptr @Representable to i64), ptr readonly %26) #20
  br i1 %result.i12.i, label %34, label %IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit

34:                                               ; preds = %33
  %.reg2mem115.0.i = or i1 %result.i5.i, %result.i6.i
  %.reg2mem115.0.fr.i = freeze i1 %.reg2mem115.0.i
  %spec.select.i = select i1 %.reg2mem115.0.fr.i, i32 5, i32 9
  br label %IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit

IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit: ; preds = %3, %27, %28, %29, %30, %31, %32, %33, %34
  %35 = phi i32 [ 5, %33 ], [ 4, %28 ], [ 2, %30 ], [ 3, %32 ], [ 6, %31 ], [ 7, %29 ], [ 8, %27 ], [ 1, %3 ], [ %spec.select.i, %34 ]
  %36 = zext nneg i32 %35 to i64
  %37 = getelementptr [10 x ptr], ptr @IO, i64 0, i64 %36
  %38 = getelementptr i8, ptr %37, i64 56
  %39 = load ptr, ptr %38, align 8
  call void %39(ptr nonnull %17, { ptr, i160 } %16)
  %40 = call ptr @llvm.invariant.start.p0(i64 232, ptr nonnull %.fca.0.extract)
  %41 = load ptr, ptr %8, align 8
  %42 = call ptr %41(ptr %.fca.1.extract)
  %43 = load ptr, ptr %42, align 8
  %.not = icmp eq ptr %43, @nil_typ
  br i1 %.not, label %._crit_edge, label %44

44:                                               ; preds = %IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit
  ...
  %hash_coef_ptr.i.i18 = getelementptr i8, ptr %43, i64 8
  %tbl_size_ptr.i.i19 = getelementptr i8, ptr %43, i64 16
  %offset_tbl_ptr.i.i20 = getelementptr i8, ptr %43, i64 40
  ...
  store i32 %offset.i.i29, ptr %51, align 8
  %52 = call ptr @llvm.invariant.start.p0(i64 24, ptr nonnull %5)
  %53 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %43, 0
  %54 = insertvalue { ptr, ptr, ptr, i32 } %53, ptr %47, 1
  %55 = insertvalue { ptr, ptr, ptr, i32 } %54, ptr %50, 2
  %56 = insertvalue { ptr, ptr, ptr, i32 } %55, i32 %offset.i.i29, 3
  %57 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %4)
  %58 = call ptr @llvm.invariant.start.p0(i64 48, ptr %43)
  %59 = sext i32 %offset.i.i29 to i64
  %60 = getelementptr ptr, ptr %43, i64 %59
  %61 = getelementptr i8, ptr %60, i64 24
  %62 = load ptr, ptr %61, align 8
  %63 = call ptr %62({ ptr, ptr, ptr, i32 } %56, ptr nonnull %4)
  call void %63({ ptr, ptr, ptr, i32 } %56, { ptr, ptr, ptr, i32 } %56, ptr nonnull %4)
  store ptr %43, ptr %42, align 8
  %64 = load i160, ptr %46, align 8
  store i160 %64, ptr %45, align 4
  br label %._crit_edge

._crit_edge:                                      ; preds = %IO_B__Self_print_xNil__Self_print_xString__Self_print_xPtri8__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtrf64__Self_print_xPtri1__Self_print_xPtri32__Self_print_xRepresentable.exit, %44
  ret void
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define noundef nonnull ptr @IntArray_B__Self_from_iterable_iterableIntIterable(ptr nocapture %0, { ptr, ptr, ptr, i32 } %1) #3 {
  %3 = tail call ptr @llvm.invariant.start.p0(i64 8, ptr %0)
...
define { ptr, ptr, ptr, i32 } @IntArray__Self_from_iterable_iterableIntIterable(ptr nocapture readnone %0, { ptr, ptr, ptr, i32 } %1) {
  ...
  %30 = insertvalue { ptr, ptr, ptr, i32 } %29, i32 %offset.i.i61, 3
  %31 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %3)
  %32 = call ptr @llvm.invariant.start.p0(i64 16, ptr nonnull %.fca.0.extract)
  %33 = sext i32 %offset.i.i61 to i64
  %34 = getelementptr ptr, ptr %.fca.0.extract, i64 %33
  %35 = load ptr, ptr %34, align 8
  %36 = call ptr %35({ ptr, ptr, ptr, i32 } %30, ptr nonnull %3)
  %37 = call { ptr, i32 } %36({ ptr, ptr, ptr, i32 } %30, { ptr, ptr, ptr, i32 } %30, ptr nonnull %3)
  %.fca.0.extract991 = extractvalue { ptr, i32 } %37, 0
  %.not92 = icmp eq ptr %.fca.0.extract991, @nil_typ
  %.sroa.gep = getelementptr inbounds i8, ptr %4, i64 8
  %.sroa.gep131 = getelementptr inbounds i8, ptr %7, i64 8
  %.sroa.gep136 = getelementptr inbounds i8, ptr %4, i64 24
  %.sroa.gep137 = getelementptr inbounds i8, ptr %7, i64 24
  br i1 %.not92, label %.critedge, label %._crit_edge

._crit_edge:                                      ; preds = %2, %IntArray_append_xPtri32.exit
  %38 = phi { ptr, i32 } [ %69, %IntArray_append_xPtri32.exit ], [ %37, %2 ]
  %.fca.1.extract11 = extractvalue { ptr, i32 } %38, 1
  ...
  br i1 %41, label %IntArray_append_xPtri32.exit, label %42
...
42:                                               ; preds = %._crit_edge
  ...
  %45 = call ptr @malloc(i64 %.idx.i)
  store ptr %45, ptr %11, align 8
  %46 = call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull @IntArray)
  %47 = icmp sgt i32 %39, 0
  br i1 %47, label %._crit_edge.i, label %IntArray_append_xPtri32.exit

._crit_edge.i:                                    ; preds = %42, %._crit_edge.i
  %.reg2mem30.0.i142 = phi i32 [ %53, %._crit_edge.i ], [ 0, %42 ]
  %48 = zext nneg i32 %.reg2mem30.0.i142 to i64
  %.idx152.i = shl nuw nsw i64 %48, 2
  %49 = getelementptr i8, ptr %.pre144, i64 %.idx152.i
  %50 = load ptr, ptr %11, align 8
  %51 = getelementptr i8, ptr %50, i64 %.idx152.i
  %52 = load i32, ptr %49, align 4
  store i32 %52, ptr %51, align 4
  %53 = add nuw nsw i32 %.reg2mem30.0.i142, 1
  %54 = load i32, ptr %12, align 4
  %55 = icmp slt i32 %53, %54
  br i1 %55, label %._crit_edge.i, label %IntArray_append_xPtri32.exit.loopexit

IntArray_append_xPtri32.exit.loopexit:            ; preds = %._crit_edge.i
  %.pre = load ptr, ptr %11, align 8
  br label %IntArray_append_xPtri32.exit

IntArray_append_xPtri32.exit:                     ; preds = %IntArray_append_xPtri32.exit.loopexit, %42, %._crit_edge
  %56 = phi ptr [ %.pre144, %._crit_edge ], [ %45, %42 ], [ %.pre, %IntArray_append_xPtri32.exit.loopexit ]
  %57 = phi i32 [ %39, %._crit_edge ], [ %39, %42 ], [ %54, %IntArray_append_xPtri32.exit.loopexit ]
  %.sroa.phi = phi ptr [ %.sroa.gep131, %._crit_edge ], [ %.sroa.gep, %42 ], [ %.sroa.gep, %IntArray_append_xPtri32.exit.loopexit ]
  %.sroa.phi135 = phi ptr [ %.sroa.gep137, %._crit_edge ], [ %.sroa.gep136, %42 ], [ %.sroa.gep136, %IntArray_append_xPtri32.exit.loopexit ]
  %58 = phi ptr [ %7, %._crit_edge ], [ %4, %42 ], [ %4, %IntArray_append_xPtri32.exit.loopexit ]
  %59 = phi ptr [ %8, %._crit_edge ], [ %5, %42 ], [ %5, %IntArray_append_xPtri32.exit.loopexit ]
  %60 = phi ptr [ %9, %._crit_edge ], [ %6, %42 ], [ %6, %IntArray_append_xPtri32.exit.loopexit ]
  %61 = sext i32 %57 to i64
  %.idx153.i = shl nsw i64 %61, 2
  %62 = getelementptr i8, ptr %56, i64 %.idx153.i
  ...
  store ptr %11, ptr %.sroa.phi, align 8
  store i32 7, ptr %.sroa.phi135, align 4
  %66 = call ptr @llvm.invariant.start.p0(i64 24, ptr nonnull %58)
  ...
  %68 = call ptr %67({ ptr, ptr, ptr, i32 } %30, ptr nonnull %3)
  %69 = call { ptr, i32 } %68({ ptr, ptr, ptr, i32 } %30, { ptr, ptr, ptr, i32 } %30, ptr nonnull %3)
  %.fca.0.extract9 = extractvalue { ptr, i32 } %69, 0
  %.not = icmp eq ptr %.fca.0.extract9, @nil_typ
  br i1 %.not, label %.critedge, label %._crit_edge

.critedge:                                        ; preds = %IntArray_append_xPtri32.exit, %2
  %70 = insertvalue { ptr, ptr, ptr, i32 } { ptr @IntArray, ptr undef, ptr undef, i32 undef }, ptr %11, 1
  %71 = insertvalue { ptr, ptr, ptr, i32 } %70, ptr undef, 2
  %72 = insertvalue { ptr, ptr, ptr, i32 } %71, i32 7, 3
...
define { ptr, ptr, ptr, i32 } @IntArray_extend_aryIntArray({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, { ptr, ptr, ptr, i32 } %3) {
  ...
  %28 = call ptr @llvm.invariant.start.p0(i64 16, ptr nonnull %27)
  %29 = call ptr @llvm.invariant.start.p0(i64 0, ptr nonnull %5)
  %30 = call ptr @llvm.invariant.start.p0(i64 616, ptr %.fca.0.extract1)
  %31 = getelementptr i8, ptr %22, i64 48
  %32 = load ptr, ptr %31, align 8
  %33 = call ptr %32({ ptr, ptr, ptr, i32 } %18, ptr nonnull %5)
  %34 = call i32 %33({ ptr, ptr, ptr, i32 } %18, { ptr, ptr, ptr, i32 } %18, ptr nonnull %5)
  %35 = call ptr @llvm.invariant.start.p0(i64 616, ptr %.fca.0.extract199)
  %36 = sext i32 %offset.i.i to i64
  %37 = getelementptr ptr, ptr %.fca.0.extract199, i64 %36
  %38 = getelementptr i8, ptr %37, i64 8
  %39 = load ptr, ptr %38, align 8
  ...
  %.fca.1.load10 = load ptr, ptr %11, align 8
  %.fca.3.load16 = load i32, ptr %13, align 8
  %43 = call ptr @llvm.invariant.start.p0(i64 616, ptr %.fca.0.load7)
  %44 = sext i32 %.fca.3.load16 to i64
  %45 = getelementptr ptr, ptr %.fca.0.load7, i64 %44
  %46 = getelementptr i8, ptr %45, i64 16
  %47 = load ptr, ptr %46, align 8
  ...
  %51 = call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull %.fca.0.load7)
  %52 = getelementptr i8, ptr %45, i64 8
  %53 = load ptr, ptr %52, align 8
  %54 = call ptr %53(ptr %.fca.1.load10)
  br i1 %50, label %55, label %83
...
55:                                               ; preds = %4
  %56 = call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull %.fca.0.load7)
  %57 = load ptr, ptr %52, align 8
  %58 = call ptr %57(ptr %.fca.1.load10)
  %59 = load i32, ptr %58, align 4
  %60 = add i32 %59, %34
  %61 = load i32, ptr %54, align 4
  %62 = icmp slt i32 %61, %60
  br i1 %62, label %.lr.ph260, label %.thread

.lr.ph260:                                        ; preds = %55
  %63 = load ptr, ptr %27, align 8
  %64 = call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull %.fca.0.load7)
  br label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph260, %._crit_edge
  %.reg2mem78.0258 = phi i32 [ 0, %.lr.ph260 ], [ %76, %._crit_edge ]
  %65 = sext i32 %.reg2mem78.0258 to i64
  %.idx210 = shl nsw i64 %65, 2
  %66 = getelementptr i8, ptr %63, i64 %.idx210
  %67 = load ptr, ptr %45, align 8
  %68 = call ptr %67(ptr %.fca.1.load10)
  %69 = load ptr, ptr %68, align 8
  %70 = load i32, ptr %54, align 4
  %71 = sext i32 %70 to i64
  %.idx211 = shl nsw i64 %71, 2
  %72 = getelementptr i8, ptr %69, i64 %.idx211
  %73 = load i32, ptr %66, align 4
  store i32 %73, ptr %72, align 4
  %74 = load i32, ptr %54, align 4
  %75 = add i32 %74, 1
  store i32 %75, ptr %54, align 4
  %76 = add i32 %.reg2mem78.0258, 1
  %77 = load ptr, ptr %52, align 8
  %78 = call ptr %77(ptr %.fca.1.load10)
  %79 = load i32, ptr %78, align 4
  %80 = add i32 %79, %34
...
83:                                               ; preds = %4
  %84 = load i32, ptr %54, align 4
  %85 = add i32 %84, %34
  %86 = call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull %.fca.0.load7)
  %87 = load ptr, ptr %46, align 8
  %88 = call ptr %87(ptr %.fca.1.load10)
  store i32 %85, ptr %88, align 4
  %89 = call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull %.fca.0.load7)
  %90 = load ptr, ptr %45, align 8
  %91 = call ptr %90(ptr %.fca.1.load10)
  %92 = load ptr, ptr %91, align 8
  %93 = call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull %.fca.0.load7)
  %94 = load ptr, ptr %46, align 8
  %95 = call ptr %94(ptr %.fca.1.load10)
  %96 = load i32, ptr %95, align 4
  %97 = sext i32 %96 to i64
  %.idx = shl nsw i64 %97, 2
  %98 = call ptr @malloc(i64 %.idx)
  %99 = call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull %.fca.0.load7)
  %100 = load ptr, ptr %45, align 8
  %101 = call ptr %100(ptr %.fca.1.load10)
  store ptr %98, ptr %101, align 8
  %102 = call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull %.fca.0.load7)
  %103 = load ptr, ptr %52, align 8
  %104 = call ptr %103(ptr %.fca.1.load10)
  %105 = load i32, ptr %104, align 4
  %106 = add i32 %105, %34
...
.lr.ph:                                           ; preds = %83
  %108 = call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull %.fca.0.load7)
  %109 = load ptr, ptr %27, align 8
  br label %110
...
110:                                              ; preds = %.lr.ph, %._crit_edge1
  ...
  %112 = call ptr %111(ptr %.fca.1.load10)
  %113 = load i32, ptr %112, align 4
  %114 = icmp slt i32 %.reg2mem72.0255, %113
  %115 = call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull %.fca.0.load7)
  %116 = load ptr, ptr %45, align 8
  %117 = call ptr %116(ptr %.fca.1.load10)
  %118 = load ptr, ptr %117, align 8
  br i1 %114, label %119, label %124
...
119:                                              ; preds = %110
  %120 = zext nneg i32 %.reg2mem72.0255 to i64
  %.idx209 = shl nuw nsw i64 %120, 2
  %121 = getelementptr i8, ptr %92, i64 %.idx209
  %122 = getelementptr i8, ptr %118, i64 %.idx209
  %123 = load i32, ptr %121, align 4
  store i32 %123, ptr %122, align 4
  br label %._crit_edge1

124:                                              ; preds = %110
  %125 = sext i32 %.reg2mem74.0256 to i64
  %.idx207 = shl nsw i64 %125, 2
  %126 = getelementptr i8, ptr %109, i64 %.idx207
  %127 = zext nneg i32 %.reg2mem72.0255 to i64
  %.idx208 = shl nuw nsw i64 %127, 2
  %128 = getelementptr i8, ptr %118, i64 %.idx208
  %129 = load i32, ptr %126, align 4
  store i32 %129, ptr %128, align 4
  %130 = add i32 %.reg2mem74.0256, 1
  br label %._crit_edge1

._crit_edge1:                                     ; preds = %119, %124
  %.reg2mem70.0 = phi i32 [ %.reg2mem74.0256, %119 ], [ %130, %124 ]
...
.thread:                                          ; preds = %._crit_edge1, %._crit_edge, %83, %55
  %.sroa.phi = phi ptr [ %.sroa.gep240, %55 ], [ %.sroa.gep, %83 ], [ %.sroa.gep240, %._crit_edge ], [ %.sroa.gep, %._crit_edge1 ]
  %.sroa.phi241 = phi ptr [ %.sroa.gep243, %55 ], [ %.sroa.gep242, %83 ], [ %.sroa.gep243, %._crit_edge ], [ %.sroa.gep242, %._crit_edge1 ]
  %.sroa.phi244 = phi ptr [ %.sroa.gep246, %55 ], [ %.sroa.gep245, %83 ], [ %.sroa.gep246, %._crit_edge ], [ %.sroa.gep245, %._crit_edge1 ]
  %136 = phi ptr [ %8, %55 ], [ %6, %83 ], [ %8, %._crit_edge ], [ %6, %._crit_edge1 ]
  %137 = phi ptr [ %9, %55 ], [ %7, %83 ], [ %9, %._crit_edge ], [ %7, %._crit_edge1 ]
  ...
  store ptr %.fca.1.load10, ptr %.sroa.phi, align 8
  %148 = load ptr, ptr %12, align 8
  store ptr %148, ptr %.sroa.phi241, align 8
  ...
  %151 = insertvalue { ptr, ptr, ptr, i32 } %150, ptr %.fca.1.load10, 1
  %152 = insertvalue { ptr, ptr, ptr, i32 } %151, ptr %148, 2
  %153 = insertvalue { ptr, ptr, ptr, i32 } %152, i32 %offset.i.i238, 3
  ret { ptr, ptr, ptr, i32 } %153
}
...
18:                                               ; preds = %4
  ...
  %43 = load i520, ptr @fwxwa_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %50 = tail call dereferenceable_or_null(9) ptr @malloc(i64 9)
  store i64 7597125539071292531, ptr %50, align 4
  %51 = tail call dereferenceable_or_null(16) ptr @malloc(i64 16)
...
62:                                               ; preds = %._crit_edge
  ...
  %64 = tail call ptr %63(ptr %.fca.1.extract)
...
72:                                               ; preds = %66
  ...
  %76 = tail call dereferenceable_or_null(104) ptr @malloc(i64 104)
  ...
  %79 = call ptr @llvm.invariant.start.p0(i64 16, ptr nonnull %7)
  %80 = tail call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull %.fca.0.extract)
  %81 = load ptr, ptr %12, align 8
  %82 = tail call ptr %81(ptr %.fca.1.extract)
  %83 = load i32, ptr %82, align 4
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %5)
  %84 = tail call dereferenceable_or_null(8) ptr @malloc(i64 8)
  %85 = getelementptr inbounds i8, ptr %5, i64 8
  %86 = getelementptr inbounds i8, ptr %5, i64 24
  store ptr @OutOfBoundsDetails, ptr %5, align 8
  store ptr %84, ptr %85, align 8
  store i32 7, ptr %86, align 8
  %87 = call ptr @llvm.invariant.start.p0(i64 16, ptr nonnull %5)
  store i32 %83, ptr %84, align 4
  %88 = tail call ptr @llvm.invariant.start.p0(i64 48, ptr nonnull @OutOfBoundsDetails)
  %89 = getelementptr i8, ptr %84, i64 4
  store i32 %3, ptr %89, align 4
  store ptr @OutOfBoundsDetails, ptr %76, align 8
  %90 = getelementptr i8, ptr %76, i64 8
  %91 = load i160, ptr %85, align 8
  store i160 %91, ptr %90, align 4
  %92 = getelementptr i8, ptr %76, i64 32
  %93 = getelementptr i8, ptr %76, i64 40
  %94 = getelementptr i8, ptr %76, i64 48
  %95 = getelementptr i8, ptr %76, i64 64
  %96 = tail call dereferenceable_or_null(66) ptr @malloc(i64 66)
  %97 = load i520, ptr @fwxwa_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  store i520 %97, ptr %96, align 4
  %98 = tail call dereferenceable_or_null(16) ptr @malloc(i64 16)
  store ptr %96, ptr %98, align 8
  %99 = getelementptr i8, ptr %98, i64 8
  store i32 65, ptr %99, align 4
  %100 = getelementptr i8, ptr %98, i64 12
  store i32 66, ptr %100, align 4
  %101 = getelementptr i8, ptr %76, i64 72
  store ptr @String, ptr %101, align 8
  %102 = getelementptr i8, ptr %76, i64 80
  store ptr %98, ptr %102, align 8
  %103 = getelementptr i8, ptr %76, i64 96
  store i32 7, ptr %103, align 4
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %5)
  %104 = tail call dereferenceable_or_null(9) ptr @malloc(i64 9)
  store i64 7597125539071292531, ptr %104, align 4
  %105 = tail call dereferenceable_or_null(16) ptr @malloc(i64 16)
  store ptr %104, ptr %105, align 8
  %106 = getelementptr i8, ptr %105, i64 8
  store i32 8, ptr %106, align 4
  %107 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull @String)
  %108 = getelementptr i8, ptr %105, i64 12
  store i32 9, ptr %108, align 4
  %109 = tail call ptr @llvm.invariant.start.p0(i64 232, ptr nonnull @OutOfBounds)
  store i32 110, ptr %92, align 4
  %110 = tail call ptr @llvm.invariant.start.p0(i64 104, ptr nonnull @OutOfBounds)
  store ptr @String, ptr %93, align 8
  store ptr %105, ptr %94, align 8
  store i32 7, ptr %95, align 4
  %111 = load i160, ptr %77, align 8
  %112 = insertvalue { ptr, i160 } { ptr @OutOfBounds, i160 undef }, i160 %111, 1
  %current_coroutine.i131 = load ptr, ptr @current_coroutine, align 8
  %113 = getelementptr i8, ptr %current_coroutine.i131, i64 48
...
._crit_edge1:                                     ; preds = %66, %72
  %114 = tail call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull %.fca.0.extract)
  %115 = load ptr, ptr %11, align 8
  %116 = tail call ptr %115(ptr %.fca.1.extract)
  %117 = tail call ptr @llvm.invariant.start.p0(i64 616, ptr nonnull %.fca.0.extract)
  %118 = load ptr, ptr %12, align 8
  %119 = tail call ptr %118(ptr %.fca.1.extract)
  %120 = load i32, ptr %119, align 4
  %121 = add i32 %120, %3
  %122 = sext i32 %121 to i64
  br label %123

123:                                              ; preds = %._crit_edge1, %62
  %.sink133 = phi i64 [ %122, %._crit_edge1 ], [ %65, %62 ]
  %.sink.in = phi ptr [ %116, %._crit_edge1 ], [ %64, %62 ]
  %.sink = load ptr, ptr %.sink.in, align 8
  %.idx = shl nsw i64 %.sink133, 2
  %124 = getelementptr i8, ptr %.sink, i64 %.idx
  %.reg2mem6.0 = load i32, ptr %124, align 4
  ret i32 %.reg2mem6.0
}
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(readwrite, argmem: read)
define { ptr, ptr, ptr, i32 } @IntArray_iterator_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) #9 {
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %.fca.2.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 2
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 8
...
35:                                               ; preds = %3
  %36 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull %.fca.0.extract67)
  %37 = load ptr, ptr %8, align 8
  %38 = call ptr %37(ptr %.fca.1.extract69)
  %39 = load i32, ptr %38, align 4
  %40 = add i32 %39, 1
  %41 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull %.fca.0.extract67)
  %42 = load ptr, ptr %8, align 8
  %43 = call ptr %42(ptr %.fca.1.extract69)
  store i32 %40, ptr %43, align 4
  %44 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull %.fca.0.extract67)
  %45 = load ptr, ptr %7, align 8
  %46 = call ptr %45(ptr %.fca.1.extract69)
  %47 = load ptr, ptr %46, align 8
  ...
  %.fca.0.extract73 = extractvalue { ptr } %65, 0
  %66 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull %.fca.0.extract67)
  %67 = load ptr, ptr %8, align 8
  %68 = call ptr %67(ptr %.fca.1.extract69)
  %69 = load i32, ptr %68, align 4
  %70 = add i32 %69, -1
  %71 = sext i32 %70 to i64
  %.idx = shl nsw i64 %71, 2
  %72 = getelementptr i8, ptr %.fca.0.extract73, i64 %.idx
...
define i1 @returns_one() local_unnamed_addr #11 {
...
landing_pad:                                      ; preds = %0
  %ok = tail call i32 @printf(ptr nonnull @string_string.11, ptr nonnull @exception_message)
...
define i1 @subtype_test(i64 %tbl_size, i64 %hash_coef, i64 %cand_id, i64 %candidate, ptr nocapture readonly %supertype_tbl) #14 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind speculatable willreturn memory(argmem: read)
define i1 @subtype_test_wrapper(ptr nocapture readonly %f, i64 %tbl_size, i64 %hash_coef, i64 %cand_id, i64 %candidate, ptr readonly %supertype_tbl) local_unnamed_addr #14 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: none, inaccessiblemem: none)
define ptr @get_current_coroutine() local_unnamed_addr #11 {
  %current_coroutine = load ptr, ptr @current_coroutine, align 8
  ret ptr %current_coroutine
}

; Function Attrs: noinline nounwind memory(readwrite)
define preserve_nonecc void @context_switch(ptr nocapture writeonly %from_buf, ptr %to_buf) #15 {
...
define void @coroutine_yield(ptr nocapture writeonly %current_coroutine) local_unnamed_addr #16 {
...
; Function Attrs: nounwind
define void @coroutine_call(ptr %coroutine) local_unnamed_addr #16 {
...
attributes #11 = { mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: none, inaccessiblemem: none) }
...
attributes #15 = { noinline nounwind memory(readwrite) }
