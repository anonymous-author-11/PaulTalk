...
@tadko_CUsersPaulKOneDriveDocumentsPLPyPLtmpkhuyxcimini = internal unnamed_addr constant [58 x i8] c"C:\\Users\\PaulK\\OneDrive\\Documents\\PL\\PyPL\\tmpkh7uyxci.mini"
@lhqks_An_outofbounds_error_occurred_while_indexing_into_a_collection = internal unnamed_addr constant [65 x i8] c"An out-of-bounds error occurred while indexing into a collection."
@nmdnp_The_size_of_the_collection_being_indexed_was = internal unnamed_addr constant [44 x i8] c"The size of the collection being indexed was"
...
@IO = constant { [3 x i64], [4 x ptr], [10 x ptr] } { [3 x i64] [i64 5359822646784595218, i64 4611686018427388073, i64 1], [4 x ptr] [ptr @subtype_test, ptr @IO_hashtbl, ptr @IO_offset_tbl, ptr getelementptr ({}, ptr null, i32 1)], [10 x ptr] [ptr @IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64, ptr @IO__Self_print_xRepresentable, ptr @IO__Self_print_xPtri64, ptr @IO__Self_print_xPtri1, ptr @IO__Self_print_xPtri8, ptr @IO__Self_print_xNil, ptr @IO__Self_print_xPtri32, ptr @IO__Self_print_xString, ptr @IO__Self_print_xCharacter, ptr @IO__Self_print_xPtrf64] }
...
define ptr @IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64(ptr nocapture %0, { ptr, i160 } %1) #8 {
...
16:                                               ; preds = %15
  %result.i8 = tail call i1 %11(i64 %10, i64 %9, i64 -5126806859456325683, i64 ptrtoint (ptr @nil_typ to i64), ptr readonly %12) #20
  br i1 %result.i8, label %.thread, label %17

17:                                               ; preds = %16
  %not.result.i4 = xor i1 %result.i4, true
  %.reg2mem109.0 = or i1 %result.i, %not.result.i4
  br i1 %.reg2mem109.0, label %18, label %.thread

18:                                               ; preds = %17
  %result.i11 = tail call i1 %11(i64 %10, i64 %9, i64 -7260840641129990118, i64 ptrtoint (ptr @Representable to i64), ptr readonly %12) #20
  %result.i11.not = xor i1 %result.i11, true
  %.reg2mem107.0 = or i1 %result.i, %result.i4
  %or.cond = select i1 %result.i11.not, i1 true, i1 %.reg2mem107.0
  br i1 %or.cond, label %19, label %.thread

19:                                               ; preds = %18
  %result.i14 = tail call i1 %11(i64 %10, i64 %9, i64 2582149688529881115, i64 ptrtoint (ptr @i8_typ to i64), ptr readonly %12) #20
  %cond.fr = freeze i1 %result.i14
  %spec.select = select i1 %cond.fr, i32 4, i32 2
  br label %.thread

.thread:                                          ; preds = %19, %18, %2, %17, %16, %15, %14, %13
  %20 = phi i32 [ 8, %2 ], [ 7, %17 ], [ 5, %16 ], [ 3, %15 ], [ 9, %14 ], [ 6, %13 ], [ 1, %18 ], [ %spec.select, %19 ]
...
IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit79:
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 16
  ...
  %4 = load i352, ptr @nmdnp_The_size_of_the_collection_being_indexed_was, align 16
...
.lr.ph.i:                                         ; preds = %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit79
...
String_c_string_.exit:                            ; preds = %.lr.ph.i, %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit79
  ...
  %.sroa.2.8.extract.trunc.i94 = trunc i160 %43 to i64
  %45 = inttoptr i64 %.sroa.2.8.extract.trunc.i94 to ptr
  ...
  br i1 %52, label %.lr.ph.i127, label %String_c_string_.exit130

.lr.ph.i127:                                      ; preds = %String_c_string_.exit
...
String_c_string_.exit130:                         ; preds = %.lr.ph.i127, %String_c_string_.exit
  %56 = tail call ptr @llvm.invariant.start.p0(i64 280, ptr nonnull @String)
  %57 = sext i32 %48 to i64
  %58 = getelementptr i8, ptr %51, i64 %57
  store i8 0, ptr %58, align 1
  %puts.i110 = tail call i32 @puts(ptr nonnull dereferenceable(1) %51)
...
define void @OutOfBounds_init_boundsPtri32_indexPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3, i32 %4) {
  ...
  %36 = load i520, ptr @lhqks_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
...
define void @OutOfBounds_print_message_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  %.reg2mem111.0.i = select i1 %not.result.i.i, i1 true, i1 %result.i4.i
  br i1 %.reg2mem111.0.i, label %27, label %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit

27:                                               ; preds = %3
  %result.i5.i = tail call i1 %25(i64 %24, i64 %23, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr readonly %26) #20
  br i1 %result.i5.i, label %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit, label %28

28:                                               ; preds = %27
  %result.i6.i = tail call i1 %25(i64 %24, i64 %23, i64 -757315540097298781, i64 ptrtoint (ptr @f64_typ to i64), ptr readonly %26) #20
  br i1 %result.i6.i, label %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit, label %29

29:                                               ; preds = %28
  %result.i7.i = tail call i1 %25(i64 %24, i64 %23, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr readonly %26) #20
  br i1 %result.i7.i, label %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit, label %30

30:                                               ; preds = %29
  %result.i8.i = tail call i1 %25(i64 %24, i64 %23, i64 -5126806859456325683, i64 ptrtoint (ptr @nil_typ to i64), ptr readonly %26) #20
  br i1 %result.i8.i, label %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit, label %31

31:                                               ; preds = %30
  %not.result.i4.i = xor i1 %result.i4.i, true
  %.reg2mem109.0.i = or i1 %result.i.i, %not.result.i4.i
  br i1 %.reg2mem109.0.i, label %32, label %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit

32:                                               ; preds = %31
  %result.i11.i = tail call i1 %25(i64 %24, i64 %23, i64 -7260840641129990118, i64 ptrtoint (ptr @Representable to i64), ptr readonly %26) #20
  %result.i11.not.i = xor i1 %result.i11.i, true
  %.reg2mem107.0.i = or i1 %result.i.i, %result.i4.i
  %or.cond.i = select i1 %result.i11.not.i, i1 true, i1 %.reg2mem107.0.i
  br i1 %or.cond.i, label %33, label %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit

33:                                               ; preds = %32
  %result.i14.i = tail call i1 %25(i64 %24, i64 %23, i64 2582149688529881115, i64 ptrtoint (ptr @i8_typ to i64), ptr readonly %26) #20
  %cond.fr.i = freeze i1 %result.i14.i
  %spec.select.i = select i1 %cond.fr.i, i32 4, i32 2
  br label %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit

IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit: ; preds = %3, %27, %28, %29, %30, %31, %32, %33
  %34 = phi i32 [ 8, %3 ], [ 7, %31 ], [ 5, %30 ], [ 3, %29 ], [ 9, %28 ], [ 6, %27 ], [ 1, %32 ], [ %spec.select.i, %33 ]
...
43:                                               ; preds = %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit
...
._crit_edge:                                      ; preds = %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit, %43
  ret void
}
...
18:                                               ; preds = %4
  ...
  %43 = load i520, ptr @lhqks_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %51 = load i464, ptr @tadko_CUsersPaulKOneDriveDocumentsPLPyPLtmpkhuyxcimini, align 16
...
73:                                               ; preds = %67
  ...
  %98 = load i520, ptr @lhqks_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %106 = load i464, ptr @tadko_CUsersPaulKOneDriveDocumentsPLPyPLtmpkhuyxcimini, align 16
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3) {
  ...
  %42 = load i520, ptr @lhqks_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %52 = load i464, ptr @tadko_CUsersPaulKOneDriveDocumentsPLPyPLtmpkhuyxcimini, align 16
...
IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit44:
...
.lr.ph.i:                                         ; preds = %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit44
...
String_c_string_.exit:                            ; preds = %.lr.ph.i, %IO_B__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xPtri8__Self_print_xNil__Self_print_xPtri32__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64.exit44
...
IO__Self_print_xPtri1.exit:                       ; preds = %26, %28
  ...
  %puts.i45 = tail call i32 @puts(ptr nonnull dereferenceable(1) %33)
  ret i32 0
}
