...
@ktzis_CUsersPaulKOneDriveDocumentsPLPyPLtmpfvczidfmini = internal unnamed_addr constant [58 x i8] c"C:\\Users\\PaulK\\OneDrive\\Documents\\PL\\PyPL\\tmpf6vczidf.mini"
@fiscf_An_outofbounds_error_occurred_while_indexing_into_a_collection = internal unnamed_addr constant [65 x i8] c"An out-of-bounds error occurred while indexing into a collection."
@fpunt_The_size_of_the_collection_being_indexed_was = internal unnamed_addr constant [44 x i8] c"The size of the collection being indexed was"
...
@IO = constant { [3 x i64], [4 x ptr], [10 x ptr] } { [3 x i64] [i64 5359822646784595218, i64 4611686018427388073, i64 1], [4 x ptr] [ptr @subtype_test, ptr @IO_hashtbl, ptr @IO_offset_tbl, ptr getelementptr ({}, ptr null, i32 1)], [10 x ptr] [ptr @IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil, ptr @IO__Self_print_xPtri32, ptr @IO__Self_print_xPtri1, ptr @IO__Self_print_xRepresentable, ptr @IO__Self_print_xPtri64, ptr @IO__Self_print_xPtri8, ptr @IO__Self_print_xString, ptr @IO__Self_print_xCharacter, ptr @IO__Self_print_xPtrf64, ptr @IO__Self_print_xNil] }
...
define ptr @IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil(ptr nocapture %0, { ptr, i160 } %1) #8 {
...
14:                                               ; preds = %13
  ...
  br i1 %result.i5, label %15, label %.critedge
...
15:                                               ; preds = %14
  ...
  %.reg2mem113.0 = select i1 %result.i6, i1 true, i1 %result.i7
  br i1 %.reg2mem113.0, label %.critedge, label %.thread

.critedge:                                        ; preds = %14, %15
  %result.i8 = tail call i1 %11(i64 %10, i64 %9, i64 6681222582356018452, i64 ptrtoint (ptr @Character to i64), ptr readonly %12) #20
  %result.i9 = tail call i1 %11(i64 %10, i64 %9, i64 6499063144389013426, i64 ptrtoint (ptr @String to i64), ptr readonly %12) #20
  %not.result.i8 = xor i1 %result.i8, true
  %.reg2mem109.0 = select i1 %not.result.i8, i1 true, i1 %result.i9
  br i1 %.reg2mem109.0, label %16, label %.thread

16:                                               ; preds = %.critedge
  %result.i10 = tail call i1 %11(i64 %10, i64 %9, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr readonly %12) #20
  br i1 %result.i10, label %.thread, label %17

17:                                               ; preds = %16
  %result.i11 = tail call i1 %11(i64 %10, i64 %9, i64 -757315540097298781, i64 ptrtoint (ptr @f64_typ to i64), ptr readonly %12) #20
  br i1 %result.i11, label %.thread, label %18

18:                                               ; preds = %17
  %not.result.i9 = xor i1 %result.i9, true
  %.reg2mem107.0 = or i1 %result.i8, %not.result.i9
  br i1 %.reg2mem107.0, label %19, label %.thread

19:                                               ; preds = %18
  %result.i14 = tail call i1 %11(i64 %10, i64 %9, i64 -5126806859456325683, i64 ptrtoint (ptr @nil_typ to i64), ptr readonly %12) #20
  %cond.fr = freeze i1 %result.i14
  %spec.select = select i1 %cond.fr, i32 9, i32 4
  br label %.thread

.thread:                                          ; preds = %19, %15, %.critedge, %18, %17, %16, %13, %2
  %20 = phi i32 [ 3, %15 ], [ 7, %.critedge ], [ 6, %18 ], [ 8, %17 ], [ 1, %16 ], [ 2, %13 ], [ 5, %2 ], [ %spec.select, %19 ]
...
IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit82:
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 16
  ...
  %4 = load i352, ptr @fpunt_The_size_of_the_collection_being_indexed_was, align 16
...
.lr.ph.i:                                         ; preds = %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit82
...
String_c_string_.exit:                            ; preds = %.lr.ph.i, %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit82
  ...
  %.sroa.2.8.extract.trunc.i97 = trunc i160 %43 to i64
  %45 = inttoptr i64 %.sroa.2.8.extract.trunc.i97 to ptr
  ...
  br i1 %52, label %.lr.ph.i130, label %String_c_string_.exit133
...
String_c_string_.exit133:                         ; preds = %.lr.ph.i130, %String_c_string_.exit
  ...
  %puts.i113 = tail call i32 @puts(ptr nonnull dereferenceable(1) %51)
...
define void @OutOfBounds_init_boundsPtri32_indexPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3, i32 %4) {
  ...
  %36 = load i520, ptr @fiscf_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
...
define void @OutOfBounds_print_message_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  br i1 %result.i.i, label %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit, label %27

27:                                               ; preds = %3
  %result.i4.i = tail call i1 %25(i64 %24, i64 %23, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr readonly %26) #20
  br i1 %result.i4.i, label %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit, label %28
...
28:                                               ; preds = %27
  ...
  br i1 %result.i5.i, label %29, label %.critedge.i
...
29:                                               ; preds = %28
  ...
  %.reg2mem113.0.i = select i1 %result.i6.i, i1 true, i1 %result.i7.i
  br i1 %.reg2mem113.0.i, label %.critedge.i, label %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit

.critedge.i:                                      ; preds = %29, %28
  %result.i8.i = tail call i1 %25(i64 %24, i64 %23, i64 6681222582356018452, i64 ptrtoint (ptr @Character to i64), ptr readonly %26) #20
  %result.i9.i = tail call i1 %25(i64 %24, i64 %23, i64 6499063144389013426, i64 ptrtoint (ptr @String to i64), ptr readonly %26) #20
  %not.result.i8.i = xor i1 %result.i8.i, true
  %.reg2mem109.0.i = select i1 %not.result.i8.i, i1 true, i1 %result.i9.i
  br i1 %.reg2mem109.0.i, label %30, label %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit

30:                                               ; preds = %.critedge.i
  %result.i10.i = tail call i1 %25(i64 %24, i64 %23, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr readonly %26) #20
  br i1 %result.i10.i, label %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit, label %31

31:                                               ; preds = %30
  %result.i11.i = tail call i1 %25(i64 %24, i64 %23, i64 -757315540097298781, i64 ptrtoint (ptr @f64_typ to i64), ptr readonly %26) #20
  br i1 %result.i11.i, label %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit, label %32

32:                                               ; preds = %31
  %not.result.i9.i = xor i1 %result.i9.i, true
  %.reg2mem107.0.i = or i1 %result.i8.i, %not.result.i9.i
  br i1 %.reg2mem107.0.i, label %33, label %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit

33:                                               ; preds = %32
  %result.i14.i = tail call i1 %25(i64 %24, i64 %23, i64 -5126806859456325683, i64 ptrtoint (ptr @nil_typ to i64), ptr readonly %26) #20
  %cond.fr.i = freeze i1 %result.i14.i
  %spec.select.i = select i1 %cond.fr.i, i32 9, i32 4
  br label %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit

IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit: ; preds = %3, %27, %29, %.critedge.i, %30, %31, %32, %33
  %34 = phi i32 [ 3, %29 ], [ 7, %.critedge.i ], [ 6, %32 ], [ 8, %31 ], [ 1, %30 ], [ 2, %27 ], [ 5, %3 ], [ %spec.select.i, %33 ]
...
43:                                               ; preds = %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit
...
._crit_edge:                                      ; preds = %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit, %43
  ret void
}
...
18:                                               ; preds = %4
  ...
  %43 = load i520, ptr @fiscf_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %51 = load i464, ptr @ktzis_CUsersPaulKOneDriveDocumentsPLPyPLtmpfvczidfmini, align 16
...
73:                                               ; preds = %67
  ...
  %98 = load i520, ptr @fiscf_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %106 = load i464, ptr @ktzis_CUsersPaulKOneDriveDocumentsPLPyPLtmpfvczidfmini, align 16
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3) {
  ...
  %42 = load i520, ptr @fiscf_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %52 = load i464, ptr @ktzis_CUsersPaulKOneDriveDocumentsPLPyPLtmpfvczidfmini, align 16
...
IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit46:
...
.lr.ph.i:                                         ; preds = %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit46
...
String_c_string_.exit:                            ; preds = %.lr.ph.i, %IO_B__Self_print_xPtri32__Self_print_xPtri1__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri8__Self_print_xString__Self_print_xCharacter__Self_print_xPtrf64__Self_print_xNil.exit46
...
IO__Self_print_xPtri1.exit:                       ; preds = %26, %28
  ...
  %puts.i47 = tail call i32 @puts(ptr nonnull dereferenceable(1) %33)
  ret i32 0
}
