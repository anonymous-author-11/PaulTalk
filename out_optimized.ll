...
@IO = constant { [3 x i64], [7 x ptr], [10 x ptr] } { [3 x i64] [i64 5359822646784595218, i64 4611686018427388247, i64 3], [7 x ptr] [ptr @subtype_test, ptr @IO_hashtbl, ptr @IO_offset_tbl, ptr @_data_size_IO, ptr @_box_Default, ptr @_unbox_Default, ptr @_size_Default], [10 x ptr] [ptr @IO_B__Self_print_xPtri32__Self_print_xString__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xCharacter__Self_print_xNil__Self_print_xPtri8__Self_print_xPtrf64, ptr @IO__Self_print_xPtri32, ptr @IO__Self_print_xString, ptr @IO__Self_print_xRepresentable, ptr @IO__Self_print_xPtri64, ptr @IO__Self_print_xPtri1, ptr @IO__Self_print_xCharacter, ptr @IO__Self_print_xNil, ptr @IO__Self_print_xPtri8, ptr @IO__Self_print_xPtrf64] }
...
define ptr @Float64_B__ADD_otherFloat64__ADD_otherInt32({ ptr, ptr, ptr, i32 } %0, ptr nocapture nofree noundef nonnull align 8 dereferenceable(8) %1) #13 {
  ...
  %result.i = call i1 %11(i64 %10, i64 %9, i64 -3157560240565274503, i64 ptrtoint (ptr @Int32 to i64), ptr readonly %12) #41
  br i1 %result.i, label %13, label %.critedge

13:                                               ; preds = %2
  %result.i1 = call i1 %11(i64 %10, i64 %9, i64 8748823673944961442, i64 ptrtoint (ptr @Float64 to i64), ptr readonly %12) #41
...
IO_B__Self_print_xPtri32__Self_print_xString__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xCharacter__Self_print_xNil__Self_print_xPtri8__Self_print_xPtrf64.exit:
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 16
...
define { ptr, i160 } @navjmtllau(ptr nest nocapture nofree noundef nonnull readonly %0, { ptr, i160 } %1) #20 {
...
define { ptr, i160 } @ulbpovolvq(ptr nest nocapture nofree noundef nonnull readonly %0, { ptr, i160 } %1) #20 {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
  %.sroa.1.8.extract.trunc = trunc i160 %.fca.1.extract to i32
...
define { ptr, i160 } @ngxkvrqvyj(ptr nest nocapture nofree noundef nonnull readonly %0, { ptr, i160 } %1) #20 {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
  %.sroa.1.8.extract.trunc = trunc i160 %.fca.1.extract to i32
  %3 = tail call i32 %0(i32 %.sroa.1.8.extract.trunc)
  %.sroa.0.0.insert.ext = zext i32 %3 to i160
...
define { ptr, i160 } @wrnidqoeot(ptr nest nocapture nofree noundef nonnull readonly %0, { ptr, i160 } %1, { ptr, i160 } %2) #20 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define i32 @_functionliteral_otqemehpgd(i32 %0, i32 %1) #1 {
  %3 = add i32 %1, %0
  ret i32 %3
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define range(i32 0, -1) i32 @_functionliteral_xemvsqnxcu(i32 %0) #1 {
  %2 = shl i32 %0, 1
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define double @_functionliteral_mreyfgpssa(double %0) local_unnamed_addr #1 {
  %2 = fmul double %0, 2.000000e+00
  ret double %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define i32 @_functionliteral_tdfclbxrpf(i32 returned %0) #1 {
  ret i32 %0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define nofpclass(nan inf nzero sub) double @_functionliteral_bvjxsvdyyz(i32 %0) #1 {
...
Int32_B__ADD_otherInt32__ADD_otherFloat64.exit1400:
  ...
  call void @llvm.init.trampoline(ptr nocapture nofree noundef writeonly dereferenceable_or_null(24) %result.i141, ptr noalias nofree noundef nonnull readnone @wrnidqoeot, ptr noalias nofree noundef nonnull readnone @_functionliteral_otqemehpgd)
  ...
  call void @llvm.init.trampoline(ptr nocapture nofree noundef writeonly dereferenceable_or_null(24) %result.i145, ptr noalias nofree noundef nonnull readnone @ngxkvrqvyj, ptr noalias nofree noundef nonnull readnone @_functionliteral_xemvsqnxcu)
  ...
  call void @llvm.init.trampoline(ptr nocapture nofree noundef writeonly dereferenceable_or_null(24) %result.i178, ptr noalias nofree noundef nonnull readnone @ulbpovolvq, ptr noalias nofree noundef nonnull readnone @_functionliteral_bvjxsvdyyz)
  ...
  call void @llvm.init.trampoline(ptr nocapture nofree noundef writeonly dereferenceable_or_null(24) %result.i182, ptr noalias nofree noundef nonnull readnone @navjmtllau, ptr noalias nofree noundef nonnull readnone @_functionliteral_tdfclbxrpf)
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: readwrite, inaccessiblemem: none)
define ptr @Array_B__set_index_xPtri32_valueT({ ptr, ptr, ptr, i32 } %0, ptr nocapture nofree noundef align 8 %1) #4 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: readwrite, inaccessiblemem: none)
define ptr @Array_B_unchecked_insert_xPtri32_valueT({ ptr, ptr, ptr, i32 } %0, ptr nocapture nofree noundef align 8 %1) #4 {
  %3 = tail call ptr @llvm.invariant.start.p0(i64 noundef 16, ptr nocapture nofree noundef align 8 %1) #37
  %4 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
...
; Function Attrs: mustprogress nounwind willreturn
define void @Array_reserve_new_capacityPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture nofree readnone %2, i32 %3) #6 {
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 16
...
define noundef i1 @Iterable_all_fFunctionT_to_Ptri1({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture nofree readnone %2, { ptr } %3) #20 {
  %5 = alloca [0 x ptr], align 8
  %.fca.0.extract5 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract6 = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %.fca.2.extract7 = extractvalue { ptr, ptr, ptr, i32 } %0, 2
...
define noundef i1 @Iterable_any_fFunctionT_to_Ptri1({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture nofree readnone %2, { ptr } %3) #20 {
  %5 = alloca [0 x ptr], align 8
  %.fca.0.extract5 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract6 = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %.fca.2.extract7 = extractvalue { ptr, ptr, ptr, i32 } %0, 2
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define { ptr, ptr, ptr, i32 } @Iterable_filter_fFunctionT_to_Ptri1({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture nofree readnone %2, { ptr } %3) #17 {
  %.fca.0.extract8 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %.fca.2.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 2
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract8, i64 8
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define noundef nonnull ptr @String_B__Self_from_c_string_c_stringBufferPtri8(ptr nocapture nofree %0) #30 {
...
define { ptr, ptr, ptr, i32 } @String__Self_from_c_string_c_stringBufferPtri8(ptr nocapture nofree readnone %0, { ptr } %1) #32 {
...
; Function Attrs: mustprogress nounwind willreturn
define { ptr, ptr, ptr, i32 } @String_append_xPtri8({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture nofree readnone %2, i8 %3) #6 {
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 16
...
define { ptr, ptr, ptr, i32 } @String_iterator_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture nofree readnone %2) #33 {
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %.fca.2.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 2
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 8
...
47:                                               ; preds = %43
  ...
  %result.i.i = call { i64, i64 } %54(ptr nocapture nofree nonnull readonly align 8 %result.i2) #41, !alias.scope !288
  ...
  %result.i1.i = call { i64, i64 } %65(ptr nocapture nofree nonnull readonly align 8 %result.i3) #41, !alias.scope !288
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: readwrite, inaccessiblemem: none)
define ptr @Exception_B_set_info_line_numberPtri32_file_nameString({ ptr, ptr, ptr, i32 } %0, ptr nocapture nofree noundef align 8 %1) #4 {
  %3 = tail call ptr @llvm.invariant.start.p0(i64 noundef 16, ptr nocapture nofree noundef align 8 %1) #37
  %4 = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %5 = getelementptr i8, ptr %4, i64 160
  %6 = load ptr, ptr %5, align 8
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(read, argmem: readwrite, inaccessiblemem: none)
define ptr @IO_B__Self_print_xPtri32__Self_print_xString__Self_print_xRepresentable__Self_print_xPtri64__Self_print_xPtri1__Self_print_xCharacter__Self_print_xNil__Self_print_xPtri8__Self_print_xPtrf64(ptr nocapture nofree noundef nonnull align 8 dereferenceable(8) %0) #13 {
  %2 = tail call ptr @llvm.invariant.start.p0(i64 noundef 8, ptr nocapture nofree noundef nonnull align 8 dereferenceable(8) %0) #37
  %3 = load ptr, ptr %0, align 8
...
7:                                                ; preds = %5
  ...
  %result.i = call i1 %14(i64 %13, i64 %12, i64 6681222582356018452, i64 ptrtoint (ptr @Character to i64), ptr readonly %15) #41
  br i1 %result.i, label %16, label %.critedge

16:                                               ; preds = %7
  %result.i1 = call i1 %14(i64 %13, i64 %12, i64 6499063144389013426, i64 ptrtoint (ptr @String to i64), ptr readonly %15) #41
  br i1 %result.i1, label %.critedge, label %27

.critedge:                                        ; preds = %16, %7
  %17 = icmp eq ptr %3, @i64_typ
  br i1 %17, label %27, label %18

18:                                               ; preds = %.critedge
  %result.i2 = call i1 %14(i64 %13, i64 %12, i64 6499063144389013426, i64 ptrtoint (ptr @String to i64), ptr readonly %15) #41
...
24:                                               ; preds = %22
  %result.i4 = call i1 %14(i64 %13, i64 %12, i64 -7260840641129990118, i64 ptrtoint (ptr @Representable to i64), ptr readonly %15) #41
  br i1 %result.i4, label %25, label %27

25:                                               ; preds = %24
  %26 = or i1 %result.i, %result.i2
  %spec.select = select i1 %26, i32 8, i32 3
  br label %27

27:                                               ; preds = %25, %18, %24, %22, %.critedge15, %.critedge, %16, %5, %1
  %.reg2mem29.0 = phi i32 [ 9, %1 ], [ 1, %5 ], [ 4, %.critedge ], [ 7, %.critedge15 ], [ 5, %22 ], [ 6, %16 ], [ 8, %24 ], [ 2, %18 ], [ %spec.select, %25 ]
  %28 = zext nneg i32 %.reg2mem29.0 to i64
...
define void @IO__Self_print_xRepresentable(ptr nocapture nofree readnone %0, { ptr, i160 } %1) #14 {
  ...
  %tbl_size_ptr.i.i3 = getelementptr i8, ptr %.fca.0.extract1, i64 16
  %offset_tbl_ptr.i.i4 = getelementptr i8, ptr %.fca.0.extract1, i64 40
  %hash_coef.i.i5 = load i64, ptr %hash_coef_ptr.i.i2, align 4, !noalias !417
  %tbl_size.i.i6 = load i64, ptr %tbl_size_ptr.i.i3, align 4, !noalias !417
  %offset_tbl.i.i7 = load ptr, ptr %offset_tbl_ptr.i.i4, align 8, !noalias !417
  %product.i.i.i8 = mul i64 %hash_coef.i.i5, 6499063144389013426
  %shifted.i.i.i9 = lshr i64 %product.i.i.i8, 32
  %xored.i.i.i10 = xor i64 %shifted.i.i.i9, %product.i.i.i8
  %hash.i.i.i11 = and i64 %xored.i.i.i10, %tbl_size.i.i6
  %offset_ptr.i.i12 = getelementptr i32, ptr %offset_tbl.i.i7, i64 %hash.i.i.i11
  %offset.i.i13 = load i32, ptr %offset_ptr.i.i12, align 4, !noalias !417
  %16 = insertvalue { ptr, ptr, ptr, i32 } undef, ptr %.fca.0.extract1, 0
  %17 = insertvalue { ptr, ptr, ptr, i32 } %16, ptr %.fca.1.extract, 1
  %18 = insertvalue { ptr, ptr, ptr, i32 } %17, ptr %.fca.2.extract, 2
...
attributes #32 = { nofree norecurse nosync nounwind memory(readwrite, argmem: read, inaccessiblemem: none) "disable-tail-calls"="true" }
attributes #33 = { mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: read, inaccessiblemem: none) "disable-tail-calls"="true" }
