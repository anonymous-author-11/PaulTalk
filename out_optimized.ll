...
define { ptr, i160 } @bvukdcsaki(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
...
define { ptr, i160 } @bhcrlojrmn(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
  %.sroa.1.8.extract.trunc = trunc i160 %.fca.1.extract to i32
...
define { ptr, i160 } @bacyisjxhv(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
  %.sroa.1.8.extract.trunc = trunc i160 %.fca.1.extract to i32
  %3 = tail call i32 %0(i32 %.sroa.1.8.extract.trunc)
  %.sroa.3.8.insert.ext = zext i32 %3 to i160
...
define { ptr, i160 } @fkyjqgaujb(ptr nest nocapture readonly %0, { ptr, i160 } %1, { ptr, i160 } %2) {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define i32 @_functionliteral_hbjwqzysne(i32 %0, i32 %1) #4 {
  %3 = add i32 %1, %0
  ret i32 %3
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define range(i32 0, -1) i32 @_functionliteral_bzqtslthpo(i32 %0) #4 {
  %2 = shl i32 %0, 1
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define double @_functionliteral_nqvlkdufpf(double %0) local_unnamed_addr #4 {
  %2 = fmul double %0, 2.000000e+00
  ret double %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define i32 @_functionliteral_rrbfxuuwli(i32 returned %0) #4 {
  ret i32 %0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define double @_functionliteral_hjhveiysiz(i32 %0) #4 {
...
ArrayIterator_next_.exit2913:
  ...
  %result.i453 = tail call noalias dereferenceable_or_null(24) ptr @bump_malloc_inner(i64 noundef 24, ptr nonnull @current_ptr) #28
  ...
  call void @llvm.lifetime.end.p0(i64 0, ptr nonnull %0)
  %result.i594 = tail call noalias dereferenceable_or_null(24) ptr @bump_malloc_inner(i64 noundef 24, ptr nonnull @current_ptr) #28
  ...
  call void @llvm.init.trampoline(ptr %result.i594, ptr nonnull @fkyjqgaujb, ptr nonnull @_functionliteral_hbjwqzysne)
  ...
  %result.i615 = call noalias dereferenceable_or_null(24) ptr @bump_malloc_inner(i64 noundef 24, ptr nonnull @current_ptr) #28
  ...
  call void @llvm.init.trampoline(ptr %result.i615, ptr nonnull @bacyisjxhv, ptr nonnull @_functionliteral_bzqtslthpo)
  %ret.i618 = call ptr @llvm.adjust.trampoline(ptr readonly %result.i615) #30
  ...
  call void @llvm.init.trampoline(ptr %result.i647, ptr nonnull @bhcrlojrmn, ptr nonnull @_functionliteral_hjhveiysiz)
  ...
  %result.i651 = call noalias dereferenceable_or_null(24) ptr @bump_malloc_inner(i64 noundef 24, ptr nonnull @current_ptr) #28
  ...
  call void @llvm.init.trampoline(ptr %result.i651, ptr nonnull @bvukdcsaki, ptr nonnull @_functionliteral_rrbfxuuwli)
  %ret.i654 = call ptr @llvm.adjust.trampoline(ptr readonly %result.i651) #30
...
IO_B__Self_print_xPtri8__Self_print_xPtri1__Self_print_xNil__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtri32__Self_print_xRepresentable__Self_print_xString__Self_print_xPtrf64.exit1040: ; preds = %ZipIterator2_next_.exit3359.thread, %ZipIterator2_next_.exit.thread
  %result.i914 = call noalias dereferenceable_or_null(4) ptr @bump_malloc_inner(i64 noundef 4, ptr nonnull @current_ptr) #28
