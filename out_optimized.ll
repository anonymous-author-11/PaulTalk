...
define { ptr, i160 } @skqauawvaw(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
...
define { ptr, i160 } @adxrqfjbvr(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
  %.sroa.1.8.extract.trunc = trunc i160 %.fca.1.extract to i32
...
define { ptr, i160 } @vuwseojogb(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
  %.sroa.1.8.extract.trunc = trunc i160 %.fca.1.extract to i32
  %3 = tail call i32 %0(i32 %.sroa.1.8.extract.trunc)
  %.sroa.3.8.insert.ext = zext i32 %3 to i160
...
define { ptr, i160 } @rcxwiwzagz(ptr nest nocapture readonly %0, { ptr, i160 } %1, { ptr, i160 } %2) {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define i32 @_functionliteral_utmsttzlxo(i32 %0, i32 %1) #4 {
  %3 = add i32 %1, %0
  ret i32 %3
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define range(i32 0, -1) i32 @_functionliteral_loiracshjv(i32 %0) #4 {
  %2 = shl i32 %0, 1
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define double @_functionliteral_puwuzoasnf(double %0) local_unnamed_addr #4 {
  %2 = fmul double %0, 2.000000e+00
  ret double %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define i32 @_functionliteral_kslwwnpdrx(i32 returned %0) #4 {
  ret i32 %0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define double @_functionliteral_pksphqlhxi(i32 %0) #4 {
...
ArrayIterator_next_.exit2913:
  ...
  %result.i.i1743 = tail call noalias dereferenceable_or_null(128) ptr @bump_malloc_inner(i64 noundef 128, ptr nonnull @current_ptr) #27
  ...
  call void @llvm.init.trampoline(ptr %result.i594, ptr nonnull @rcxwiwzagz, ptr nonnull @_functionliteral_utmsttzlxo)
  ...
  call void @llvm.init.trampoline(ptr %result.i615, ptr nonnull @vuwseojogb, ptr nonnull @_functionliteral_loiracshjv)
  ...
  %result.i.i1461 = call noalias dereferenceable_or_null(56) ptr @bump_malloc_inner(i64 noundef 56, ptr nonnull @current_ptr) #27
  ...
  call void @llvm.init.trampoline(ptr %result.i647, ptr nonnull @adxrqfjbvr, ptr nonnull @_functionliteral_pksphqlhxi)
  ...
  call void @llvm.init.trampoline(ptr %result.i651, ptr nonnull @skqauawvaw, ptr nonnull @_functionliteral_kslwwnpdrx)
  ...
  %result.i.i1510 = call noalias dereferenceable_or_null(56) ptr @bump_malloc_inner(i64 noundef 56, ptr nonnull @current_ptr) #27
  ...
  %result.i.i1732 = call noalias dereferenceable_or_null(56) ptr @bump_malloc_inner(i64 noundef 56, ptr nonnull @current_ptr) #27
  ...
  call void @llvm.assume(i1 %eq.i.i2091) #26
  call void @llvm.lifetime.start.p0(i64 0, ptr nonnull %0)
...
.critedge.sink.split.sink.split.sink.split:       ; preds = %ArrayIterator_next_.exit3055, %.critedge.sink.split.sink.split.sink.split.sink.split, %ArrayIterator_next_.exit2984, %ArrayIterator_next_.exit2913
  ...
  call void @llvm.assume(i1 %eq.i.i3744) #26
  ...
  call void @llvm.assume(i1 %eq.i77.i3758) #26
  ...
  %result.i.i3247 = call noalias dereferenceable_or_null(24) ptr @bump_malloc_inner(i64 noundef 24, ptr nonnull @current_ptr) #27
  ...
  %result.i.i3406 = call noalias dereferenceable_or_null(48) ptr @bump_malloc_inner(i64 noundef 48, ptr nonnull @current_ptr) #27
  ...
  call void @llvm.assume(i1 %eq.i.i3445) #26
  ...
  %result.i.i3446 = call noalias dereferenceable_or_null(56) ptr @bump_malloc_inner(i64 noundef 56, ptr nonnull @current_ptr) #27
  ...
  call void @llvm.assume(i1 %eq.i77.i3463) #26
  ...
  call void @llvm.assume(i1 %eq.i.i3574) #26
...
ArrayIterator_next_.exit:                         ; preds = %.critedge.sink.split.sink.split.sink.split, %270
  ...
  call void @llvm.assume(i1 %eq.i.i3594) #26
...
._crit_edge2.lr.ph:                               ; preds = %319
  ...
  %result.i.i3269 = call noalias dereferenceable_or_null(80) ptr @bump_malloc_inner(i64 noundef 80, ptr nonnull @current_ptr) #27
...
._crit_edge2:                                     ; preds = %ZipIterator2_next_.exit3359, %._crit_edge2.lr.ph
  ...
  call void @llvm.assume(i1 %eq.i.i3502) #26
  ...
  %product.i.i.i12.i3526 = mul i64 %hash_coef.i.i9.i3523, 3084208142191802847
  ...
  call void @llvm.assume(i1 %eq.i.i3532) #26
  ...
  call void @llvm.assume(i1 %eq.i.i3299) #26
  call void @llvm.lifetime.start.p0(i64 0, ptr nonnull %0)
  ...
  call void @llvm.assume(i1 %eq.i.i3633) #26
...
376:                                              ; preds = %._crit_edge2
  ...
  call void @llvm.assume(i1 %eq.i63.i3655) #26
...
ArrayIterator_next_.exit3674:                     ; preds = %._crit_edge2, %376
  ...
  call void @llvm.assume(i1 %eq.i.i3704) #26
...
416:                                              ; preds = %ArrayIterator_next_.exit3674
  ...
  %product.i.i.i49.i3718 = mul i64 %hash_coef.i.i46.i3715, 3084208142191802847
...
ZipIterator2_next_.exit3359:                      ; preds = %425
  ...
  %result.i.i3332 = call noalias dereferenceable_or_null(80) ptr @bump_malloc_inner(i64 noundef 80, ptr nonnull @current_ptr) #27
  ...
  %product.i.i.i14.i.i3338 = mul i64 %hash_coef.i.i11.i.i3335, 3084208142191802847
  ...
  %product.i.i.i42.i.i3350 = mul i64 %hash_coef.i.i39.i.i3347, 3084208142191802847
...
IO_B__Self_print_xPtri8__Self_print_xPtri1__Self_print_xNil__Self_print_xCharacter__Self_print_xPtri64__Self_print_xPtri32__Self_print_xRepresentable__Self_print_xString__Self_print_xPtrf64.exit1040: ; preds = %ZipIterator2_next_.exit3359.thread, %ZipIterator2_next_.exit.thread
  ...
  %result.i.i1478 = call noalias dereferenceable_or_null(4) ptr @bump_malloc_inner(i64 noundef 4, ptr nonnull @current_ptr) #27
  ...
  %result.i.i1683 = call noalias dereferenceable_or_null(8) ptr @bump_malloc_inner(i64 noundef 8, ptr nonnull @current_ptr) #27
  ...
  %result.i.i1715 = call noalias dereferenceable_or_null(8) ptr @bump_malloc_inner(i64 noundef 8, ptr nonnull @current_ptr) #27
