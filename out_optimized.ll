...
@uxuwx_CUsersPaulKOneDriveDocumentsPLPyPLtmptssxdmini = internal unnamed_addr constant [58 x i8] c"C:\\Users\\PaulK\\OneDrive\\Documents\\PL\\PyPL\\tmp80t4ssxd.mini"
@uhbea_An_outofbounds_error_occurred_while_indexing_into_a_collection = internal unnamed_addr constant [65 x i8] c"An out-of-bounds error occurred while indexing into a collection."
@hfnnp_The_size_of_the_collection_being_indexed_was = internal unnamed_addr constant [44 x i8] c"The size of the collection being indexed was"
...
@IO = constant { [3 x i64], [4 x ptr], [10 x ptr] } { [3 x i64] [i64 5359822646784595218, i64 4611686018427388073, i64 1], [4 x ptr] [ptr @subtype_test, ptr @IO_hashtbl, ptr @IO_offset_tbl, ptr getelementptr ({}, ptr null, i32 1)], [10 x ptr] [ptr @IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter, ptr @IO__Self_print_xString, ptr @IO__Self_print_xNil, ptr @IO__Self_print_xPtri32, ptr @IO__Self_print_xPtri8, ptr @IO__Self_print_xRepresentable, ptr @IO__Self_print_xPtri1, ptr @IO__Self_print_xPtrf64, ptr @IO__Self_print_xPtri64, ptr @IO__Self_print_xCharacter] }
...
define ptr @IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter(ptr nocapture %0, { ptr, i160 } %1) #8 {
...
14:                                               ; preds = %13
  ...
  %.reg2mem43.0 = select i1 %not.result.i3, i1 true, i1 %result.i4
  br i1 %.reg2mem43.0, label %15, label %._crit_edge
...
18:                                               ; preds = %17
  ...
  %.reg2mem41.0 = or i1 %result.i3, %result.i4
  %or.cond = select i1 %result.i8.not, i1 true, i1 %.reg2mem41.0
  br i1 %or.cond, label %.critedge, label %._crit_edge

.critedge:                                        ; preds = %18
  %result.i11 = tail call i1 %11(i64 %10, i64 %9, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr readonly %12) #20
  %19 = select i1 %result.i11, i32 6, i32 1
  br label %._crit_edge

._crit_edge:                                      ; preds = %18, %.critedge, %13, %14, %15, %17, %16, %2
  %.reg2mem25.0 = phi i32 [ 2, %2 ], [ 4, %13 ], [ 8, %15 ], [ 3, %16 ], [ 7, %17 ], [ 9, %14 ], [ %19, %.critedge ], [ 5, %18 ]
  %20 = zext nneg i32 %.reg2mem25.0 to i64
...
IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit76:
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 16
  ...
  %4 = load i352, ptr @hfnnp_The_size_of_the_collection_being_indexed_was, align 16
...
.lr.ph.i:                                         ; preds = %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit76
...
String_c_string_.exit:                            ; preds = %.lr.ph.i, %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit76
...
define void @OutOfBounds_init_boundsPtri32_indexPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3, i32 %4) {
  ...
  %36 = load i520, ptr @uhbea_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
...
define void @OutOfBounds_print_message_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  br i1 %result.i.i, label %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit, label %27

27:                                               ; preds = %3
  %result.i2.i = tail call i1 %25(i64 %24, i64 %23, i64 2582149688529881115, i64 ptrtoint (ptr @i8_typ to i64), ptr readonly %26) #20
  br i1 %result.i2.i, label %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit, label %28
...
28:                                               ; preds = %27
  ...
  %.reg2mem43.0.i = select i1 %not.result.i3.i, i1 true, i1 %result.i4.i
  br i1 %.reg2mem43.0.i, label %29, label %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit

29:                                               ; preds = %28
  %result.i5.i = tail call i1 %25(i64 %24, i64 %23, i64 -7469797244461771922, i64 ptrtoint (ptr @i64_typ to i64), ptr readonly %26) #20
  br i1 %result.i5.i, label %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit, label %30

30:                                               ; preds = %29
  %result.i6.i = tail call i1 %25(i64 %24, i64 %23, i64 -2253724949814257982, i64 ptrtoint (ptr @i32_typ to i64), ptr readonly %26) #20
  br i1 %result.i6.i, label %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit, label %31

31:                                               ; preds = %30
  %result.i7.i = tail call i1 %25(i64 %24, i64 %23, i64 -757315540097298781, i64 ptrtoint (ptr @f64_typ to i64), ptr readonly %26) #20
  br i1 %result.i7.i, label %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit, label %32
...
32:                                               ; preds = %31
  ...
  %.reg2mem41.0.i = or i1 %result.i3.i, %result.i4.i
  %or.cond.i = select i1 %result.i8.not.i, i1 true, i1 %.reg2mem41.0.i
  br i1 %or.cond.i, label %.critedge.i, label %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit

.critedge.i:                                      ; preds = %32
  %result.i11.i = tail call i1 %25(i64 %24, i64 %23, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr readonly %26) #20
  %33 = select i1 %result.i11.i, i32 6, i32 1
  br label %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit

IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit: ; preds = %3, %27, %28, %29, %30, %31, %32, %.critedge.i
  %.reg2mem25.0.i = phi i32 [ 2, %3 ], [ 4, %27 ], [ 8, %29 ], [ 3, %30 ], [ 7, %31 ], [ 9, %28 ], [ %33, %.critedge.i ], [ 5, %32 ]
  %34 = zext nneg i32 %.reg2mem25.0.i to i64
...
42:                                               ; preds = %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit
...
._crit_edge:                                      ; preds = %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit, %42
  ret void
}
...
18:                                               ; preds = %4
  ...
  %43 = load i520, ptr @uhbea_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %51 = load i464, ptr @uxuwx_CUsersPaulKOneDriveDocumentsPLPyPLtmptssxdmini, align 16
...
73:                                               ; preds = %67
  ...
  %98 = load i520, ptr @uhbea_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %106 = load i464, ptr @uxuwx_CUsersPaulKOneDriveDocumentsPLPyPLtmptssxdmini, align 16
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3) {
  ...
  %42 = load i520, ptr @uhbea_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %52 = load i464, ptr @uxuwx_CUsersPaulKOneDriveDocumentsPLPyPLtmptssxdmini, align 16
...
IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit42:
...
.lr.ph.i:                                         ; preds = %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit42
...
String_c_string_.exit:                            ; preds = %.lr.ph.i, %IO_B__Self_print_xString__Self_print_xNil__Self_print_xPtri32__Self_print_xPtri8__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtrf64__Self_print_xPtri64__Self_print_xCharacter.exit42
