...
define { ptr, i160 } @zlnfzmcxjb(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
...
define { ptr, i160 } @rmzptwbtjb(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
  %.sroa.1.8.extract.trunc = trunc i160 %.fca.1.extract to i32
...
define { ptr, i160 } @zwpvekbymb(ptr nest nocapture readonly %0, { ptr, i160 } %1) {
  %.fca.1.extract = extractvalue { ptr, i160 } %1, 1
  %.sroa.1.8.extract.trunc = trunc i160 %.fca.1.extract to i32
  %3 = tail call i32 %0(i32 %.sroa.1.8.extract.trunc)
  %.sroa.3.8.insert.ext = zext i32 %3 to i160
...
define { ptr, i160 } @vpxoxpxeci(ptr nest nocapture readonly %0, { ptr, i160 } %1, { ptr, i160 } %2) {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define i32 @_functionliteral_deihodqmof(i32 %0, i32 %1) #4 {
  %3 = add i32 %1, %0
  ret i32 %3
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define range(i32 0, -1) i32 @_functionliteral_yuewehlqyn(i32 %0) #4 {
  %2 = shl i32 %0, 1
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define double @_functionliteral_wsuaufdkly(double %0) local_unnamed_addr #4 {
  %2 = fmul double %0, 2.000000e+00
  ret double %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define i32 @_functionliteral_zbmkswwwko(i32 returned %0) #4 {
  ret i32 %0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define double @_functionliteral_rqzbpotswb(i32 %0) #4 {
...
ArrayIterator_next_.exit2865:
  ...
  call void @llvm.init.trampoline(ptr %result.i579, ptr nonnull @vpxoxpxeci, ptr nonnull @_functionliteral_deihodqmof)
  ...
  call void @llvm.init.trampoline(ptr %result.i595, ptr nonnull @zwpvekbymb, ptr nonnull @_functionliteral_yuewehlqyn)
  ...
  call void @llvm.init.trampoline(ptr %result.i627, ptr nonnull @rmzptwbtjb, ptr nonnull @_functionliteral_rqzbpotswb)
  ...
  call void @llvm.init.trampoline(ptr %result.i631, ptr nonnull @zlnfzmcxjb, ptr nonnull @_functionliteral_zbmkswwwko)
