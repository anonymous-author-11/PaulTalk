...
@zooeu_CUsersPaulKOneDriveDocumentsPLPyPLtmphuq_akemini = internal unnamed_addr constant [58 x i8] c"C:\\Users\\PaulK\\OneDrive\\Documents\\PL\\PyPL\\tmphuq_ak6e.mini"
@szkxb_An_outofbounds_error_occurred_while_indexing_into_a_collection = internal unnamed_addr constant [65 x i8] c"An out-of-bounds error occurred while indexing into a collection."
@qsovt_The_size_of_the_collection_being_indexed_was = internal unnamed_addr constant [44 x i8] c"The size of the collection being indexed was"
...
@IO = constant { [3 x i64], [4 x ptr], [10 x ptr] } { [3 x i64] [i64 5359822646784595218, i64 4611686018427388073, i64 1], [4 x ptr] [ptr @subtype_test, ptr @IO_hashtbl, ptr @IO_offset_tbl, ptr getelementptr ({}, ptr null, i32 1)], [10 x ptr] [ptr @IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil, ptr @IO__Self_print_xPtri32, ptr @IO__Self_print_xCharacter, ptr @IO__Self_print_xRepresentable, ptr @IO__Self_print_xPtri1, ptr @IO__Self_print_xPtri8, ptr @IO__Self_print_xPtri64, ptr @IO__Self_print_xString, ptr @IO__Self_print_xPtrf64, ptr @IO__Self_print_xNil] }
...
define ptr @IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil(ptr nocapture %0, { ptr, i160 } %1) #8 {
...
13:                                               ; preds = %2
  %result.i2 = tail call i1 %11(i64 %10, i64 %9, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr readonly %12) #20
  br i1 %result.i2, label %._crit_edge, label %14

14:                                               ; preds = %13
  %result.i3 = tail call i1 %11(i64 %10, i64 %9, i64 2582149688529881115, i64 ptrtoint (ptr @i8_typ to i64), ptr readonly %12) #20
...
16:                                               ; preds = %15
  ...
  %.reg2mem45.0 = select i1 %not.result.i5, i1 true, i1 %result.i6
  br i1 %.reg2mem45.0, label %17, label %._crit_edge
...
18:                                               ; preds = %17
  ...
  br i1 %result.i8, label %._crit_edge, label %19

19:                                               ; preds = %18
  %result.i9 = tail call i1 %11(i64 %10, i64 %9, i64 -7260840641129990118, i64 ptrtoint (ptr @Representable to i64), ptr readonly %12) #20
  %result.i9.not = xor i1 %result.i9, true
  %20 = or i1 %result.i5, %result.i9.not
  %or.cond = select i1 %20, i1 true, i1 %result.i6
  %spec.select = select i1 %or.cond, i32 2, i32 3
  br label %._crit_edge

._crit_edge:                                      ; preds = %19, %13, %15, %16, %17, %18, %14, %2
  %.reg2mem25.0 = phi i32 [ 1, %2 ], [ 4, %13 ], [ 5, %14 ], [ 6, %15 ], [ 9, %17 ], [ 8, %18 ], [ 7, %16 ], [ %spec.select, %19 ]
...
IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit73:
  %.fca.0.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 0
  %.fca.1.extract = extractvalue { ptr, ptr, ptr, i32 } %0, 1
  %hash_coef_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 8
  %tbl_size_ptr.i.i = getelementptr i8, ptr %.fca.0.extract, i64 16
  ...
  %4 = load i352, ptr @qsovt_The_size_of_the_collection_being_indexed_was, align 16
...
.lr.ph.i:                                         ; preds = %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit73
...
String_c_string_.exit:                            ; preds = %.lr.ph.i, %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit73
...
define void @OutOfBounds_init_boundsPtri32_indexPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3, i32 %4) {
  ...
  %36 = load i520, ptr @szkxb_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
...
define void @OutOfBounds_print_message_({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2) {
  ...
  br i1 %result.i.i, label %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit, label %27

27:                                               ; preds = %3
  %result.i2.i = tail call i1 %25(i64 %24, i64 %23, i64 5801531371504802705, i64 ptrtoint (ptr @bool_typ to i64), ptr readonly %26) #20
  br i1 %result.i2.i, label %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit, label %28

28:                                               ; preds = %27
  %result.i3.i = tail call i1 %25(i64 %24, i64 %23, i64 2582149688529881115, i64 ptrtoint (ptr @i8_typ to i64), ptr readonly %26) #20
  br i1 %result.i3.i, label %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit, label %29

29:                                               ; preds = %28
  %result.i4.i = tail call i1 %25(i64 %24, i64 %23, i64 -7469797244461771922, i64 ptrtoint (ptr @i64_typ to i64), ptr readonly %26) #20
  br i1 %result.i4.i, label %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit, label %30
...
30:                                               ; preds = %29
  ...
  %.reg2mem45.0.i = select i1 %not.result.i5.i, i1 true, i1 %result.i6.i
  br i1 %.reg2mem45.0.i, label %31, label %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit

31:                                               ; preds = %30
  %result.i7.i = tail call i1 %25(i64 %24, i64 %23, i64 -5126806859456325683, i64 ptrtoint (ptr @nil_typ to i64), ptr readonly %26) #20
  br i1 %result.i7.i, label %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit, label %32

32:                                               ; preds = %31
  %result.i8.i = tail call i1 %25(i64 %24, i64 %23, i64 -757315540097298781, i64 ptrtoint (ptr @f64_typ to i64), ptr readonly %26) #20
  br i1 %result.i8.i, label %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit, label %33

33:                                               ; preds = %32
  %result.i9.i = tail call i1 %25(i64 %24, i64 %23, i64 -7260840641129990118, i64 ptrtoint (ptr @Representable to i64), ptr readonly %26) #20
  %result.i9.not.i = xor i1 %result.i9.i, true
  %34 = or i1 %result.i5.i, %result.i9.not.i
  %or.cond.i = select i1 %34, i1 true, i1 %result.i6.i
  %spec.select.i = select i1 %or.cond.i, i32 2, i32 3
  br label %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit

IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit: ; preds = %3, %27, %28, %29, %30, %31, %32, %33
  %.reg2mem25.0.i = phi i32 [ 1, %3 ], [ 4, %27 ], [ 5, %28 ], [ 6, %29 ], [ 9, %31 ], [ 8, %32 ], [ 7, %30 ], [ %spec.select.i, %33 ]
...
43:                                               ; preds = %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit
...
._crit_edge:                                      ; preds = %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit, %43
  ret void
}
...
18:                                               ; preds = %4
  ...
  %43 = load i520, ptr @szkxb_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %51 = load i464, ptr @zooeu_CUsersPaulKOneDriveDocumentsPLPyPLtmphuq_akemini, align 16
...
73:                                               ; preds = %67
  ...
  %98 = load i520, ptr @szkxb_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %106 = load i464, ptr @zooeu_CUsersPaulKOneDriveDocumentsPLPyPLtmphuq_akemini, align 16
...
define void @Array_throw_oob_xPtri32({ ptr, ptr, ptr, i32 } %0, { ptr, ptr, ptr, i32 } %1, ptr nocapture readnone %2, i32 %3) {
  ...
  %42 = load i520, ptr @szkxb_An_outofbounds_error_occurred_while_indexing_into_a_collection, align 16
  ...
  %52 = load i464, ptr @zooeu_CUsersPaulKOneDriveDocumentsPLPyPLtmphuq_akemini, align 16
...
IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit40:
...
.lr.ph.i:                                         ; preds = %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit40
...
String_c_string_.exit:                            ; preds = %.lr.ph.i, %IO_B__Self_print_xPtri32__Self_print_xCharacter__Self_print_xRepresentable__Self_print_xPtri1__Self_print_xPtri8__Self_print_xPtri64__Self_print_xString__Self_print_xPtrf64__Self_print_xNil.exit40
