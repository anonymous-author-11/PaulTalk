builtin.module attributes  {"sym_name" = "ir"} {
  ...
  ^bb128(%1205 : !llvm.struct<(!llvm.ptr, !llvm.ptr, !llvm.ptr, i32)>, %1206 : !llvm.struct<(!llvm.ptr, !llvm.ptr, !llvm.ptr, i32)>, %1207 : !llvm.ptr):
    ...
    %1225 = "hi.cast"(%1222) {"from_typ" = !mini.buffer<!mini.union<[!mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMap">, !mini.type_param<"V", !mini.any, "CuckooMap">]>, !mini.nil]>>, "to_typ" = !mini.buffer<!mini.union<[!mini.nil, !mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMapIterator">, !mini.type_param<"V", !mini.any, "CuckooMapIterator">]>]>>, "from_typ_name" = "buffer_typ", "to_typ_name" = "buffer_typ"} : (!mini.buffer<!mini.union<[!mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMap">, !mini.type_param<"V", !mini.any, "CuckooMap">]>, !mini.nil]>>) -> !mini.buffer<!mini.union<[!mini.nil, !mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMapIterator">, !mini.type_param<"V", !mini.any, "CuckooMapIterator">]>]>>
    ...
    %1227 = "hi.cast"(%1223) {"from_typ" = !mini.buffer<!mini.union<[!mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMap">, !mini.type_param<"V", !mini.any, "CuckooMap">]>, !mini.nil]>>, "to_typ" = !mini.buffer<!mini.union<[!mini.nil, !mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMapIterator">, !mini.type_param<"V", !mini.any, "CuckooMapIterator">]>]>>, "from_typ_name" = "buffer_typ", "to_typ_name" = "buffer_typ"} : (!mini.buffer<!mini.union<[!mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMap">, !mini.type_param<"V", !mini.any, "CuckooMap">]>, !mini.nil]>>) -> !mini.buffer<!mini.union<[!mini.nil, !mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMapIterator">, !mini.type_param<"V", !mini.any, "CuckooMapIterator">]>]>>
  ...
  ^bb185(%1469 : !llvm.struct<(!llvm.ptr, !llvm.ptr, !llvm.ptr, i32)>, %1470 : !llvm.struct<(!llvm.ptr, !llvm.ptr, !llvm.ptr, i32)>, %1471 : !llvm.ptr):
    ...
    "mini.if"(%1480) ({
      ...
      "mini.if"(%1490) ({
        ...
        %1493 = "hi.cast"(%1492) {"from_typ" = !mini.fatptr<"Pair", [!mini.type_param<"K", !mini.any, "CuckooMapIterator">, !mini.type_param<"V", !mini.any, "CuckooMapIterator">]>, "to_typ" = !mini.union<[!mini.nil, !mini.type_param<"T", !mini.any, "Iterator">]>, "from_typ_name" = "Pair", "to_typ_name" = "union_typ"} : (!mini.fatptr<"Pair", [!mini.type_param<"K", !mini.any, "CuckooMapIterator">, !mini.type_param<"V", !mini.any, "CuckooMapIterator">]>) -> !mini.union<[!mini.nil, !mini.type_param<"T", !mini.any, "Iterator">]>
        "mini.return"(%1493) : (!mini.union<[!mini.nil, !mini.type_param<"T", !mini.any, "Iterator">]>) -> ()
    ...
    %1507 = "hi.cast"(%1506) {"from_typ" = !mini.union<[!mini.fatptr<"Pair", [!mini.type_param<"K", !mini.any, "CuckooMapIterator">, !mini.type_param<"V", !mini.any, "CuckooMapIterator">]>, !mini.nil]>, "to_typ" = !mini.union<[!mini.nil, !mini.type_param<"T", !mini.any, "Iterator">]>, "from_typ_name" = "union_typ", "to_typ_name" = "union_typ"} : (!mini.union<[!mini.fatptr<"Pair", [!mini.type_param<"K", !mini.any, "CuckooMapIterator">, !mini.type_param<"V", !mini.any, "CuckooMapIterator">]>, !mini.nil]>) -> !mini.union<[!mini.nil, !mini.type_param<"T", !mini.any, "Iterator">]>
    "mini.return"(%1507) : (!mini.union<[!mini.nil, !mini.type_param<"T", !mini.any, "Iterator">]>) -> ()
