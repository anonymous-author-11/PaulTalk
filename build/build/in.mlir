builtin.module attributes  {"sym_name" = "ir"} {
  ...
  ^bb128(%1205 : !llvm.struct<(!llvm.ptr, !llvm.ptr, !llvm.ptr, i32)>, %1206 : !llvm.struct<(!llvm.ptr, !llvm.ptr, !llvm.ptr, i32)>, %1207 : !llvm.ptr):
    ...
    %1225 = "hi.cast"(%1222) {"from_typ" = !mini.buffer<!mini.union<[!mini.nil, !mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMap">, !mini.type_param<"V", !mini.any, "CuckooMap">]>]>>, "to_typ" = !mini.buffer<!mini.union<[!mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMapIterator">, !mini.type_param<"V", !mini.any, "CuckooMapIterator">]>, !mini.nil]>>, "from_typ_name" = "buffer_typ", "to_typ_name" = "buffer_typ"} : (!mini.buffer<!mini.union<[!mini.nil, !mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMap">, !mini.type_param<"V", !mini.any, "CuckooMap">]>]>>) -> !mini.buffer<!mini.union<[!mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMapIterator">, !mini.type_param<"V", !mini.any, "CuckooMapIterator">]>, !mini.nil]>>
    ...
    %1227 = "hi.cast"(%1223) {"from_typ" = !mini.buffer<!mini.union<[!mini.nil, !mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMap">, !mini.type_param<"V", !mini.any, "CuckooMap">]>]>>, "to_typ" = !mini.buffer<!mini.union<[!mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMapIterator">, !mini.type_param<"V", !mini.any, "CuckooMapIterator">]>, !mini.nil]>>, "from_typ_name" = "buffer_typ", "to_typ_name" = "buffer_typ"} : (!mini.buffer<!mini.union<[!mini.nil, !mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMap">, !mini.type_param<"V", !mini.any, "CuckooMap">]>]>>) -> !mini.buffer<!mini.union<[!mini.fatptr<"Entry", [!mini.type_param<"K", !mini.any, "CuckooMapIterator">, !mini.type_param<"V", !mini.any, "CuckooMapIterator">]>, !mini.nil]>>
