...
def main():
    ...
    opt = f"opt -S out_reg2mem{debug_extension}.ll --passes=\"default<O3>\" --use-noalias-intrinsic-during-inlining --enable-noalias-to-md-conversion --enable-heap-to-stack-conversion --max-devirt-iterations=1000 --abort-on-max-devirt-iterations-reached --inline-threshold=10000 -o out_optimized.ll"
